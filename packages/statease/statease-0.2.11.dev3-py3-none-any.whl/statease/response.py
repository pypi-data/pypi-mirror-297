class Response:
    ...
    def __init__(self, client, name):
        ...
        self._is_equation_only = result['payload'].get('is_equation_only',False)

    def __str__(self):
        return 'name: "{}"\nunits: "{}"\nlength: {}\nis_equation_only: {}'.format(self._name, self._units, len(self._values),self._is_equation_only)
    ...
    def simulate(self, equation, std_dev=1, variance_ratio=1,is_simulation=True):
        ...
        :param bool is_simulation: If False, sets the std_dev parameter to 0 and sets the 
                                   ...
                                   analysis, but will availble in numerical optimization.
                                   Note: The default is true, but this parameter takes 
                                   precendance over the std_dev parameter when False.
        :Example:
