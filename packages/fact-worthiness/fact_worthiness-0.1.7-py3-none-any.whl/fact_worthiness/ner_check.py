...
save_directory = os.path.join("src", "fact_worthiness", "models", "onnx_model")
tokenizer = Tokenizer.from_file(os.path.join(save_directory, "tokenizer.json"))
model_path = os.path.join(save_directory, "model_quantized.onnx")
