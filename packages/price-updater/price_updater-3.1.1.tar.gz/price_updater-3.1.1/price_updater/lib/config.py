...
VERSION: str = "Price Updater© 3.1.1"

with importlib.resources.path("price_updater", "Gabarito-SemiBold.ttf") as font_path:
    LabelBase.register(name="standard", fn_regular=str(font_path))
