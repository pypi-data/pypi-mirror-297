...
from kontur.httptoolkitcore.response import OriginalResponse
...
class RetryManager:
    ...
    def __init__(
        ...
        self._status_codes = frozenset(status_codes) if status_codes is not None else self.DEFAULT_STATUS_CODES
