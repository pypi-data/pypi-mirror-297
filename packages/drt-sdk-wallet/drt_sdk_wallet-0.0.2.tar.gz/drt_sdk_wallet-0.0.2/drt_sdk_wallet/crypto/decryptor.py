...
from drt_sdk_wallet.crypto.constants import (
...
from drt_sdk_wallet.errors import (ErrInvalidKeystoreFilePassword,
                                          ErrUnknownCipher,
...
def decrypt(encrypted_data: EncryptedData, password: str) -> bytes:
    """
    Also see: https://github.com/DharitriOne/drt-sdk-js-wallet/blob/main/src/crypto/decryptor.ts
    """
