...
from drt_sdk_wallet.validator_keys import ValidatorSecretKey
...
def test_sign_message():
    signer = ValidatorSigner.from_pem_file(Path("./drt_sdk_wallet/testdata/validatorKey00.pem"))
    message = b"hello"
...
def test_pem_save():
    path = Path("./drt_sdk_wallet/testdata/validatorKey00.pem")
