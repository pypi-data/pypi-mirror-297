...
class OpenAIPricing:
    ...
    def calculate_token_usage_for_messages(self, messages, model="gpt-3.5-turbo-0613"):
        ...
        if "gpt-3.5-turbo" in model:
            print("[scalexi-pricing] Warning: gpt-3.5-turbo may update over time. Assuming gpt-3.5-turbo-0613.")
            tokens_per_message, tokens_per_name = tokens_allocation["gpt-3.5-turbo-0613"]
        elif "gpt-4o" in model:
            print("[scalexi-pricing] Warning: gpt-4o may update over time.")
        elif "gpt-4" in model:
            print("[scalexi-pricing] Warning: gpt-4 may update over time. Assuming gpt-4-0613.")
