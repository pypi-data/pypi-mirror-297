...
class Classificador(ft.Container):
    def __init__(self,
        ...
        self.content =  ft.Row([ft.Text(self.value, theme_style=self.theme_style,color = self.color,width = width),self.icone], width=width+20 if not width is None else None, alignment='center')
