...
class SftpNas:
    ...
    def copy_file(self, remote_source: Path, remote_target: Path, local_temp: Path, overwrite_temp: bool = True) -> None:
        """
    ...
    def copy_folder(self, remote_source: Path, remote_target: Path, local_temp: Path) -> None:
        """
