...
class UnsupportedGraphType(RAIValueError):
    def __init__(self, message: str):
        super().__init__(message)
        self.name = "Unsupported graph type"
...
class HexSessionException(RAIException):
    ...
    def format_message(self):
        ...
        To use RelationalAI in Hex, get your Snowflake session and supply it as a connection parameter:
