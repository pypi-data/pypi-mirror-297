    ...
    def query(self, query: Task, parent=None):
        ...
        def process_grouped_effects():
            ...
            if len(grouped_effects) > 1:
                ...
                fetch = None
                if non_effects:
                    fetch = self.create_fetch(non_effects, non_effects_vars)
                ...
                neue_items.append(build.call(Task(items=non_effects + effects), []))
        ...
        if grouped_effects:
            ...
            neue_items.append(build.call(Task(items=[*non_effects]), []))
