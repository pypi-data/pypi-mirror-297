...
table_lookup[('sy', 'ar')] = SY_AR
table_lookup[('ar', 'sy')] = AR_SY
...
# Update the table_lookup dictionary
table_lookup[('sy', 'he')] = SY_HE
table_lookup[('he', 'sy')] = HE_SY

SY_EN = {
    "ܐ": ["a", "e", "i", "o"],  # Alaph can represent vowels or a glottal stop
    "ܒ": "b",                   # Beth
    "ܓ": "g",                   # Gamal
    "ܕ": "d",                   # Dalath
    "ܗ": "h",                   # Heh
...
# Update the table_lookup dictionary
table_lookup[('sy', 'en')] = SY_EN
table_lookup[('en', 'sy')] = EN_SY
