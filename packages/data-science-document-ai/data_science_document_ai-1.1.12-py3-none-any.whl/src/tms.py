...
def set_tms_service_token():
    ...
    url = f"https://auth.forto.{os.environ['TMS_DOMAIN']}/auth/realms/forto-eu/protocol/openid-connect/token"
...
def download_document_api(shipment_id, doc_id):
    """
    Download a document for a specific shipment.
    ...
    response = requests.get(
        f"https://tms.forto.com/api/documents/documents/shipment/{shipment_id}/{doc_id}/download",
        headers=headers,
    )
