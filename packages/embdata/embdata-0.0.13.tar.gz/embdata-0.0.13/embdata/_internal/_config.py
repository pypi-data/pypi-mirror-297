...
from pydantic.config import ConfigDict, ExtraValues, JsonDict, JsonEncoder, JsonSchemaExtraCallable
...
if TYPE_CHECKING:
    from pydantic._internal._schema_generation_shared import GenerateSchema
