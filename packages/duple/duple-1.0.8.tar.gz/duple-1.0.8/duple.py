...
@click.option('--numdirs', '-nd', type = click.INT, default = 5, help = 'number of directories to make for the test')
@click.option('--numfiles', '-nf', type = click.INT, default = 5, help = 'number of files to make in each directory, spread through the directories')
