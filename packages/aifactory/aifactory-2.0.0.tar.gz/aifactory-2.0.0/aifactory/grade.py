...
def make_zip_by_user(key, main_name, func):
  run_type = 0
  main_filename = ''
  main_pyfilename = ''
  current_cwd = os.getcwd()  
...
def make_zip_v2(key, main_name, func):
  run_type = 0
  main_filename = ''
  main_pyfilename = ''
  current_cwd = os.getcwd()  
...
def submit_v2(model_name, key, main_name, func):
  main_pyfilename = make_zip_v2(key, main_name, func)
...
def submit_by_user(model_name, key, main_name, func):
  main_pyfilename = make_zip_by_user(key, main_name, func)
