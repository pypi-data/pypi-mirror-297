...
class TestHistoricaleventsAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = HistoricaleventsAPIClient(self.api_key)

    @patch('apiverve_historicalevents.apiClient.requests.get')
