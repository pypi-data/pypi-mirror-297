...
def test_generate_bubble_layout():
    ...
    compare = f"{compare}<rect x=\"80\" y=\"80\" width=\"1040\" height=\"806\" rx=\"40\" ry=\"40\" "
    compare = f"{compare}fill=\"#ff0000\" />"
    compare = f"{compare}<text y=\"483.0\" text-anchor=\"middle\" dominant-baseline=\"central\" "
    compare = f"{compare}style=\"font-size:242px;font-style:italic;font-weight:bold;"
    compare = f"{compare}font-family:Noto Serif,Serif;fill:#000000\">"
    compare = f"{compare}<tspan x=\"600\" dy=\"-266\">A</tspan><tspan x=\"600\" dy=\"266\">BASIC</tspan>"
    compare = f"{compare}<tspan x=\"600\" dy=\"266\">TITLE</tspan></text>"
