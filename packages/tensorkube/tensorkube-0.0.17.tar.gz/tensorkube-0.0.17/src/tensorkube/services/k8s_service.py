    ...
    try:
        ...
        if force:
            ...
            click.echo(click.style("Updated already existing secret ", fg=CliColors.SUCCESS.value) 
                       + click.style(name, italic=True, bold=True, fg=CliColors.SUCCESS.value) 
                       + click.style(" in namespace ", fg=CliColors.SUCCESS.value) 
                       + click.style(namespace, italic=True, bold=True, fg=CliColors.SUCCESS.value))
        else:
            click.echo(click.style("Secret ", fg=CliColors.WARNING.value) 
                       + click.style(name, italic=True, bold=True, fg=CliColors.WARNING.value) 
                       + click.style(" already exists in namespace ", fg=CliColors.WARNING.value)
                       + click.style(namespace, italic=True, bold=True, fg=CliColors.WARNING.value) 
