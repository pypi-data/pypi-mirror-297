...
if __name__ == '__main__':
    ...
    with RemoteTerminal('10.22.0.44',
        ...
        # 异步执行命令
        p = ssh_client.async_execute_command("/home/temp/BolePack-2.1_linux_2024-0426/bolepack.sh -fillback /home/temp/auto_package/auto_package-develop/project/fillback/pc2/config/fill_back.json")
        print(p)
