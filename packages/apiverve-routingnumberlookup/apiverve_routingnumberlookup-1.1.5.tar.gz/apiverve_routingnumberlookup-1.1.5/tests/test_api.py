...
class TestRoutinglookupAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = RoutinglookupAPIClient(self.api_key)

    @patch('apiverve_routingnumberlookup.apiClient.requests.get')
