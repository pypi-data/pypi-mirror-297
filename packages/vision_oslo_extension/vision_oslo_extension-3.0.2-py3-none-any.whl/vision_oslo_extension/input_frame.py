...
class S04(BasePage):
    def __init__(self, parent, controller):
        ...
        explain1 = tk.Label(master=self.headframe, text = 'NOTE: Option 3-5 requires a csv file called "CIF_selection.csv".', font = controller.text_font)
        explain1.pack()
        ...
        choice2 = tk.Radiobutton(master=self.optionframe, text = 'Option 2: Filter out / Remove Diesel Services',value="2", variable=option1)
