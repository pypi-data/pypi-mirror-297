...
arg_json = {
    ...
    "max_len": 512,
    "target_max_len": 153,
    "output_dir": "./model/bart-base/hotpotqa",
    ...
    "do_eval": true,
    "logging_steps": 100,
    "logging_dir": "./model/bart-base/logs",
    "train_file_path": "./data/data_bart/hotpotqa/pt/train.pt",
    "valid_file_path": "./data/data_bart/hotpotqa/pt/dev.pt",
...
train_qg(arg_path, train_path, dev_path, test_path, arg_dict=arg_json)
