...
class ConductorPayload:
    ...
    instance_type: str = "cw-xeonv3-16"
    ...
    environment: dict = field(
        default_factory=lambda: {
            "HFS": "/opt/sidefx/houdini/20/houdini-20.0.547",
            "HOUDINI_HSERVER_USE_HTTP": "0",
            "HB": "/opt/sidefx/houdini/20/houdini-20.0.547/bin",
            "PATH": "/opt/sidefx/houdini/20/houdini-20.0.547/bin:/opt/sidefx/houdini/20/houdini-20.0.547/houdini/sbin",
            "HOUDINI_PATH": "&",
