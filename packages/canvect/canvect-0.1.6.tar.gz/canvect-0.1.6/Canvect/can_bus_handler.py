...
if __name__ == "__main__":
    ...
    data_accel = [
        ...
        int(input("Enter Byte 7 (will be calculated if checksum is used): "), 16)  # Input for Byte 7
    ]
...
"""
Created by Gnanesh on 23-9-24
Mods on pypi:- 
1. Add ring buffer and add user specific can frames with pre-built checkusm 
2. Added few more necessary Buffering settings to run parallel
