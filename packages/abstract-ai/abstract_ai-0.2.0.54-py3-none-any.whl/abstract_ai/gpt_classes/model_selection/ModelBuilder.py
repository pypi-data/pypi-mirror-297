class ModelManager:
    ...
    def __init__(self, input_model_name:str=None, input_endpoint:str=None, default_selection:bool=True)->None:
        ...
        self.all_models = [{'model': 'whisper-1', 'endpoint': 'https://api.openai.com/v1/audio/transcriptions', 'tokens': None},
                               {'model': 'gpt-4o', 'endpoint': 'https://api.openai.com/v1/chat/completions', 'tokens': 4096},  
                               {'model': 'gpt-4', 'endpoint': 'https://api.openai.com/v1/chat/completions', 'tokens': 4096},
                               {'model': 'chatgpt-4o-latest', 'endpoint': 'https://api.openai.com/v1/chat/completions', 'tokens': 4096},
