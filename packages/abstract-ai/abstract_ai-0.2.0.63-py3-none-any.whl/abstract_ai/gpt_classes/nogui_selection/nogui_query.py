...
class nogui_setup_module():
    def __init__(self,api_key=None,
        ...
        self.prompt_mgr = get_prompt_manager(prompt=self.prompt,prompt_data=self.prompt_data,instruction_mgr=self.inst_mgr,model_mgr=self.model_mgr,instruction_data=instruction_mgr.instructions,completion_percentage = self.completion_percentage)
