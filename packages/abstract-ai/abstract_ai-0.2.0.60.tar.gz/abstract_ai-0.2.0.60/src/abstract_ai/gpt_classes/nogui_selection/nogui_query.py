...
class nogui_setup_module(env_key=None,
                   env_path=None,
                   model=None,
                   prompt=None,
...
def make_query(nogui_setup_module=None):
    nogui_setup_module = nogui_setup_module or nogui_setup_module()
    return asyncio.run(nogui_setup_module.make_query())
