    ...
    **The following constraints are created:**
    ...
    def _create(self, group=None):
        ...
        def _output_group_relation(block, n, g, p, t):
            ...
            rhs = sum(
                m.flow[n, o, p, t] / n.conversion_factors[o].iloc[t]
                for o in n.output_groups[g]
            )
            return lhs == rhs

# /home/pierre-francois/.virtualenvs/oemof-tabular-plugins/lib/python3.9/site-packages/oemof_industry/mimo_converter.py:446: FutureWarning: Series.__getitem__ treating keys as positions is deprecated.
        ...
        #     rhs = sum(
        #         [
        #             m.flow[n, o, p, t] / n.conversion_factors[o][t] if n.conversion_factors[o][t] != 0 else 0
        #             for o in n.output_groups[g]
        #         ]
        #     )
        #     return lhs == rhs
