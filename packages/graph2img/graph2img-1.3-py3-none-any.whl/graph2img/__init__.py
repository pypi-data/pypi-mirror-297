...
def check_optional():
    ...
    return save_temp_files, temp_path, output_format, shape, pop_up, directed
...
def generate_code(EdgeSet, shape="circle", directed=False):
...
def main(save_temp_files=False, temp_path='temp', output_format='png', shape="circle", pop_up=True, input_file='graph.txt', output_file='graph', directed=False):

    if save_temp_files == False and temp_path == 'temp' and output_format == 'png' and shape == "circle" and pop_up and directed == False:
        save_temp_files, temp_path, output_format, shape, pop_up, directed = check_optional()
    
    EdgeSet = read_graph(input_file)

    completeLaTeXCode = generate_code(EdgeSet, shape, directed)
