    ...
    def __init__(self, api_client=None):
        ...
        def __get_assistant(
            ...
            **kwargs
            ...
            The name of the assistant to get a status on. For guidance and examples, see [Check assistant status](https://docs.pinecone.io/guides/assistant/check-assistant-status).  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __update_assistant(
            ...
            **kwargs
            ...
            This operation updates an existing Pinecone Assistant. You can modify the assistant's instructions and metadata.  For guidance and examples, see [Update an assistant](https://docs.pinecone.io/guides/assistant/update-assistant).  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
            ...
            Args:
                assistant_name (AssistantName): The name of the assistant to update.
