...
def batch_completion(model,messages,temperature,n,max_tokens,
    ...
    for message in messages:
        ...
        logger.debug(f"Got model response",response)
        try:
            ...
            logger.debug(f"Exception in parsing model response, response:",response)
            logger.debug(f"Exception in parsing model response, Exception:",response)
            logger.debug('Error trace',traceback.format_exc())
