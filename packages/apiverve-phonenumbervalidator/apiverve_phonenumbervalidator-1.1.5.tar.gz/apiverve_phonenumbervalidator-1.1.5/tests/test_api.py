...
class TestPhonenumbervalidatorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = PhonenumbervalidatorAPIClient(self.api_key)

    @patch('apiverve_phonenumbervalidator.apiClient.requests.get')
