...
Development
-----------
A prerequisite for test execution is a running instance of redis on the local machine.
For Redis the tests will use the default host ip of localhost and port of 6379 to connect to the database.
