...
class Service(enum.Enum, metaclass=EnumMeta):
    taxi: str = 'taxi'
    drive: str = 'drive'
    eats: str = 'eats2'
    tanker: str = 'tanker'
...
class Role(enum.Enum, metaclass=EnumMeta):
    department_manager: str = 'department_manager'
    department_secretary: str = 'department_secretary'
    client_manager: str = 'client_manager'


class Geo(enum.Enum, metaclass=EnumMeta):
    circle: str = 'circle'


class SupportedRequirementType(enum.Enum, metaclass=EnumMeta):
    select: str = 'select'
    boolean: str = 'boolean'


class PromocodeOrderStatus(enum.Enum, metaclass=EnumMeta):
...
class PromocodeOrderService(enum.Enum, metaclass=EnumMeta):
    taxi: str = 'taxi'
    grocery: str = 'grocery'
    eats: str = 'eats'


class PromocodeOrderCancelStatus(enum.Enum, metaclass=EnumMeta):
    cancelled: str = 'cancelled'


class SortingOrder(enum.Enum, metaclass=EnumMeta):
    asc: str = 'asc'
    desc: str = 'desc'


class TimeRestrictionType(enum.Enum, metaclass=EnumMeta):
    weekly_date: str = 'weekly_date'
    range_date: str = 'range_date'


class Day(enum.Enum, metaclass=EnumMeta):
    monday: str = 'mo'
    tuesday: str = 'tu'
    wednesday: str = 'we'
    thursday: str = 'th'
...
class MeasureKind(enum.Enum, metaclass=EnumMeta):
    money: str = 'money'
    volume: str = 'volume'


class MeasurePeriod(enum.Enum, metaclass=EnumMeta):
    day: str = 'day'
    week: str = 'week'
    month: str = 'month'


class CostCenterFormat(enum.Enum, metaclass=EnumMeta):
    select: str = 'select'
    text: str = 'text'
    mixed: str = 'mixed'


class TaxiOrderDetailsTariffItemType(enum.Enum, metaclass=EnumMeta):
    price: str = 'price'
    icon: str = 'icon'
    comment: str = 'comment'
...
class ApproveRole(enum.Enum, metaclass=EnumMeta):
    client: str = 'client'
    manager: str = 'department_manager'


class GeoHotelPolicyType(enum.Enum, metaclass=EnumMeta):
    included: str = 'included'
    excluded: str = 'excluded'


class CountriesRestriction(enum.Enum, metaclass=EnumMeta):
    rus: str = 'rus'
    cis: str = 'cis'


class TravelClass(enum.Enum, metaclass=EnumMeta):
    economy: str = 'economy'
...
class SortingField(enum.Enum, metaclass=EnumMeta):
    due_date: str = 'due_date'
    finished_date: str = 'finished_date'


class SortingDirection(enum.Enum, metaclass=EnumMeta):
    asc: int = 1
    desc: int = -1


class TaxiOrderCancelRulesState(enum.Enum, metaclass=EnumMeta):
    free: str = 'free'
    paid: str = 'paid'
    minimal: str = 'minimal'


class TaxiOrderCancelStatus(enum.Enum, metaclass=EnumMeta):
    cancelled: str = 'cancelled'


class AccumulationPeriod(enum.Enum, metaclass=EnumMeta):
    week: str = 'week'
    month: str = 'month'
    quarter: str = 'quarter'
...
class EatOrderListResponse:
    ...
    sorting_order: Optional[Union[SortingOrder, str]] = None
    ...
    def serialize(self) -> Dict[str, Any]:
        ...
        if self.sorting_order is not None:
            data['sorting_order'] = (
                self.sorting_order if isinstance(self.sorting_order, str) else self.sorting_order.value
            )
...
class SupportedRequirementItemResponse:
    ...
    type: Optional[Union[SupportedRequirementType, str]] = None
...
class GeoRestrictions:
    ...
    def __init__(self, name: str, geo_type: Geo, geo: Union[GeoCircle]):
        ...
        self.name = name
        if not isinstance(geo_type, (Geo, str)):
            raise ValidationError(error_string('geo_type', geo_type, '(Geo, str)'))
    ...
    def serialize(self) -> Dict[str, Any]:
        data: Dict[str, Any] = {
            'name': self.name,
            'geo_type': self.geo_type if isinstance(self.geo_type, str) else self.geo_type.value,
...
class Promocode(BasePromocodeOrder):
    ...
    service: Optional[Union[PromocodeOrderService, str]] = None
    ...
    def serialize(self) -> Dict[str, Any]:
        ...
        if self.service is not None:
            data['service'] = self.service if isinstance(self.service, str) else self.service.value
...
class PromocodeOrderResponse(BasePromocodeOrder):
    order_id: str
    status: Union[PromocodeOrderStatus, str]
    pricing: PromocodeOrderPrice
    service: Union[PromocodeOrderService, str]
    ...
    def serialize(self) -> Dict[str, Any]:
        data: Dict[str, Any] = {
            **super().serialize(),
            ...
            'service': self.service if isinstance(self.service, str) else self.service.value,
        }
        if self.geo_restrictions is not None:
            data['geo_restrictions'] = [geo.serialize() for geo in self.geo_restrictions]
...
class PromocodeOrderCancelResponse:
    status: Union[PromocodeOrderCancelStatus, str]

    def __init__(self, status: Union[PromocodeOrderCancelStatus, str]):
        self.status = status

    def serialize(self) -> Dict[str, Any]:
        data: Dict[str, Any] = {'status': self.status if isinstance(self.status, str) else self.status.value}
...
class Limit:
    ...
    def __init__(
        ...
        if not isinstance(service, (Service, str)):
            raise ValidationError(error_string('service', service, '(Service, str)'))
        self.service = service
...
class Measure:
    value: float
    period: Union[MeasurePeriod, str]
    kind: Optional[Union[MeasureKind, str]] = None
    ...
    def serialize(self) -> Dict[str, Any]:
        ...
        if self.kind is not None:
            data['kind'] = self.kind if isinstance(self.kind, str) else self.kind.value
...
class AccumulationRules:
    accumulation_period: Union[AccumulationPeriod, str]
    started_at: Optional[str]

    def __init__(self, accumulation_period: Union[AccumulationPeriod, str], started_at: Optional[str]):
    ...
    def serialize(self) -> Dict[str, Any]:
        data: Dict[str, Any] = {
            'accumulation_period': (
                ...
                if isinstance(self.accumulation_period, str)
                else self.accumulation_period.value
            )
        }
    ...
    def new(cls, json):
        return cls(
            accumulation_period=AccumulationPeriod(json['accumulation_period']),
            started_at=json.get('started_at'),
        )


class Limits:
    orders_cost: Optional[Measure] = None
    orders_amount: Optional[Measure] = None
    accumulation_rules: Optional[AccumulationRules] = None

    def __init__(
        self,
        orders_cost: Optional[Measure],
        orders_amount: Optional[Measure] = None,
        accumulation_rules: Optional[AccumulationRules] = None,
    ):
        self.orders_cost = orders_cost
    ...
    def new(cls, json: Dict[str, Any]):
        ...
        orders_cost = None
        if 'orders_cost' in json:
            orders_cost = Measure.new(json['orders_cost'])
        accumulation_rules = None
        if 'accumulation_rules' in json:
            accumulation_rules = AccumulationRules.new(json['accumulation_rules'])
        return cls(
            orders_cost=orders_cost,
            orders_amount=orders_amount,
            accumulation_rules=accumulation_rules,
        )
...
class TimeRestriction:
    type: Union[TimeRestrictionType, str]
    days: Optional[List[Union[Day, str]]] = None
    ...
    def serialize(self) -> Dict[str, Any]:
        data: Dict[str, Any] = {'type': self.type if isinstance(self.type, str) else self.type.value}
        if self.days is not None:
            data['days'] = [day if isinstance(day, str) else day.value for day in self.days]
...
class GeoHotelPolicy:
    geo_id: int
    name: str
    type: Union[GeoHotelPolicyType, str]
    ...
    def __init__(
        ...
        if not isinstance(type, (GeoHotelPolicyType, str)):
            raise ValidationError(error_string('type', type, '(GeoHotelPolicyType, str)'))
        self.type = type
        self.geo_id = geo_id
        self.name = name
    ...
    def new(cls, json):
        return cls(
            geo_id=json['geo_id'],
            name=json['name'],
            type=GeoHotelPolicyType(json['type']),
...
class HotelPolicy:
    ...
    max_price_per_day: Optional[int] = None
    min_price_per_day: Optional[int] = None
    weekly_restrictions: Optional[List[Union[Day, str]]] = None
    ...
    def serialize(self) -> Dict[str, Any]:
        ...
        if self.weekly_restrictions is not None:
            data['weekly_restrictions'] = [
                day if isinstance(day, str) else day.value for day in self.weekly_restrictions
            ]
    ...
    def new(cls, json):
        geo = None
        if 'geo' in json:
            geo = GeoHotelPolicy.new(json['geo'])
        weekly_restrictions = None
        if 'weekly_restrictions' in json:
            weekly_restrictions = [Day(day) for day in json['days']]
        ...
        return cls(
            ...
            max_price_per_day=json.get('max_price_per_day'),
            min_price_per_day=json.get('min_price_per_day'),
            weekly_restrictions=weekly_restrictions,
        )
...
class AviaPolicy:
    ...
    countries_restrictions: Optional[List[Union[CountriesRestriction, str]]] = None
    classes: Optional[List[Union[TravelClass, str]]] = None
    ...
    def serialize(self) -> Dict[str, Any]:
        ...
        if self.countries_restrictions is not None:
            data['countries_restrictions'] = [
                item if isinstance(item, str) else item.value for item in self.countries_restrictions
            ]
        if self.classes is not None:
            data['classes'] = [item if isinstance(item, str) else item.value for item in self.classes]
    ...
    @classmethod
    def new(cls, json):
        countries_restrictions = None
        if 'countries_restrictions' in json:
            countries_restrictions = [CountriesRestriction(item) for item in json['countries_restrictions']]
        classes = None
        if 'classes' in json:
            classes = [TravelClass(item) for item in json['classes']]
        return cls(
            ...
            countries_restrictions=countries_restrictions,
            classes=classes,
        )
...
class BudgetLimit:
    ...
    approve_roles: Optional[List[Union[ApproveRole, str]]] = None
    ...
    def serialize(self) -> Dict[str, Any]:
        ...
        if self.geo_restrictions is not None:
            data['geo_restrictions'] = [geo_restriction.serialize() for geo_restriction in self.geo_restrictions]
        if self.time_restrictions is not None:
            data['time_restrictions'] = [time_restriction.serialize() for time_restriction in self.time_restrictions]
        ...
        if self.approve_roles is not None:
            data['approve_roles'] = [role if isinstance(role, str) else role.value for role in self.approve_roles]
...
class BudgetLimitTravelRequest(BudgetLimitRequest):
    ...
    avia_policy: Optional[AviaPolicy] = None
    allow_reservations_without_approve: Optional[bool] = None
    approve_role: Optional[Union[ApproveRole, str]] = None
    approve_roles: Optional[List[Union[ApproveRole, str]]] = None
    ...
    def serialize(self) -> Dict[str, Any]:
        ...
        if self.approve_role is not None:
            data['approve_role'] = self.approve_role if isinstance(self.approve_role, str) else self.approve_role.value
        if self.approve_roles is not None:
            data['approve_roles'] = [item if isinstance(item, str) else item.value for item in self.approve_roles]
...
class BudgetLimitItemResponse(BudgetLimit):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            cities=cities,
            tariffs=tariffs,
            cars_classes=cars_classes,
            enable_toll_roads=enable_toll_roads,
            is_fleet_limit=is_fleet_limit,
            allow_reservations_without_approve=allow_reservations_without_approve,
            approve_roles=approve_roles,
            hotel_policy=hotel_policy,
            avia_policy=avia_policy,
        )
        self.id = id
    ...
    def new(cls, json: Dict[str, Any]):
        ...
        approve_roles: Optional[List[Union[ApproveRole, str]]] = None
        if 'approve_roles' in json:
            approve_roles = [ApproveRole(role) for role in json['approve_roles']]
        hotel_policy = None
        if 'hotel_policy' in json:
            hotel_policy = HotelPolicy.new(json['hotel_policy'])
        avia_policy = None
        if 'avia_policy' in json:
            avia_policy = AviaPolicy.new(json['avia_policy'])
        ...
        return cls(
            ...
            allow_reservations_without_approve=json.get('allow_reservations_without_approve'),
            approve_roles=approve_roles,
            hotel_policy=hotel_policy,
            avia_policy=avia_policy,
        )
...
class FieldSetting:
    title: str
    required: bool
    services: List[Union[Service, str]]
    format: Union[CostCenterFormat, str]
    values: List[str]
    ...
    def serialize(self) -> Dict[str, Any]:
        data: Dict[str, Any] = {
            ...
            'services': [service.value if isinstance(service, Service) else service for service in self.services],
            'format': self.format.value if isinstance(self.format, CostCenterFormat) else self.format,
            'values': self.values,
        }
...
class TaxiOrderCancelRules:
    ...
    state: Optional[Union[TaxiOrderCancelRulesState, str]] = None
    ...
    def serialize(self) -> Dict[str, Any]:
        ...
        if self.state is not None:
            data['state'] = self.state if isinstance(self.state, str) else self.state.value
...
class TaxiOrderCancelResponse:
    status: Union[TaxiOrderCancelStatus, str]

    def __init__(self, status: Union[TaxiOrderCancelStatus, str]):
        self.status = status
...
class TaxiActiveOrderItemResponse:
    id: str
    status: Union[TaxiActiveOrderStatus, str]

    def __init__(self, id: str, status: Union[TaxiActiveOrderStatus, str]):
        self.id = id
        self.status = status
...
class TaxiOrderDetailsTariffItem:
    type_tariff: Union[TaxiOrderDetailsTariffItemType, str]
    value: str
    ...
    def serialize(self) -> Dict[str, Any]:
        data: Dict[str, Any] = {
            'type': self.type_tariff if isinstance(self.type_tariff, str) else self.type_tariff.value,
            'value': self.value,
        }
...
class OrdersCancelRequest:
    state: Union[TaxiOrderCancelRulesState, str]

    def __init__(self, state: Union[TaxiOrderCancelRulesState, str]):
        self.state = state

    def serialize(self) -> Dict[str, Any]:
        data: Dict[str, Any] = {'state': self.state if isinstance(self.state, str) else self.state.value}
