...
BASE_BUDGET_LIMIT_REQUEST = {
    ...
    'limits': Limits(orders_cost=Measure(value=10, period=MeasurePeriod.day)),
}
...
def mock_budget_limit_update(method, params, json, headers, **kwargs):
    ...
    if method == 'PUT':
        ...
        elif json.get('geo_restrictions') == 'invalid_geo_restrictions':
            response.status = 400
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            {
                **BASE_BUDGET_LIMIT_REQUEST,
                'geo_restrictions': 'invalid_geo_restrictions',
            },
            RESPONSE_BUDGET_LIMIT_UPDATE_400,
