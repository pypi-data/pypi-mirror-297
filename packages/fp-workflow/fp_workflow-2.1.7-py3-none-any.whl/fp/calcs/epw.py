...
{self.input.scheduler.get_sched_mpi_prefix(self.input.epw.job_desc)}{self.input.epw.exec_loc} {self.input.scheduler.get_sched_mpi_infix(self.input.epw.job_desc, add_ni_too=True)} < epw.in &> epw.in.out 
# cp ./tmp/struct_elph* ./
'''
