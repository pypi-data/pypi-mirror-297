...
class ModelbitJobWrapper:
  ...
  def __init__(self, func: Callable[..., Any], desc: Union[JobDesc, Dict[str, Any]], standalone: bool):
    self.func = func
...
def add_job(
  ...
  if deployment_name is not None and func.__name__ == "source":  # avoid collisions with source.py
  ...
  job = ModelbitJobWrapper(func, jobDesc, deployment_name is None)
