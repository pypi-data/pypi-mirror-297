...
class TestHashtaggeneratorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = HashtaggeneratorAPIClient(self.api_key)

    @patch('apiverve_hashtaggenerator.apiClient.requests.get')
