...
class JetInput:
    ...
    def typeName(self, t: func_adl_servicex_xaodr21.xAOD.jetinput.JetInput.Type) -> func_adl_servicex_xaodr21.str.str:
        "A method"
        ...

    def inputType(self, n: func_adl_servicex_xaodr21.str.str) -> func_adl_servicex_xaodr21.xAOD.jetinput.JetInput.Type:
        "A method"
        ...
