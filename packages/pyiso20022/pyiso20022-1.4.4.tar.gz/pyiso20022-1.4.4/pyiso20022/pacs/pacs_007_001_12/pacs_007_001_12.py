...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.12"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.12",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class FitoFipaymentReversalV12:
    class Meta:
    ...
    tx_inf: List[PaymentTransaction143] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_rvsl: Optional[FitoFipaymentReversalV12] = field(
        default=None,
        metadata={
            "name": "FIToFIPmtRvsl",
            "type": "Element",
