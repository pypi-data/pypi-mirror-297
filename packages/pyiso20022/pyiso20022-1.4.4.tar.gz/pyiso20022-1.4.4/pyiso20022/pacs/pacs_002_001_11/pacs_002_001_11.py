...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.11"
...
class PaymentTransaction123:
    ...
    fctv_intr_bk_sttlm_dt: Optional[DateAndDateTime2Choice] = field(
        default=None,
        metadata={
...
@dataclass
class FitoFipaymentStatusReportV11:
    class Meta:
        name = "FIToFIPaymentStatusReportV11"

    grp_hdr: Optional[GroupHeader91] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    orgnl_grp_inf_and_sts: List[OriginalGroupHeader17] = field(
        default_factory=list,
        metadata={
    ...
    tx_inf_and_sts: List[PaymentTransaction123] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_sts_rpt: Optional[FitoFipaymentStatusReportV11] = field(
        default=None,
        metadata={
