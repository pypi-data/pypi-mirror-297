...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.07"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.07",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
class OriginalGroupHeader3:
    ...
    rvsl_rsn_inf: List[PaymentReversalReason7] = field(
        default_factory=list,
        metadata={
            "name": "RvslRsnInf",
            "type": "Element",
...
@dataclass
class FitoFipaymentReversalV07:
    class Meta:
        name = "FIToFIPaymentReversalV07"

    grp_hdr: Optional[GroupHeader71] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    orgnl_grp_inf: Optional[OriginalGroupHeader3] = field(
        default=None,
        metadata={
            "name": "OrgnlGrpInf",
            "type": "Element",
    ...
    tx_inf: List[PaymentTransaction81] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_rvsl: Optional[FitoFipaymentReversalV07] = field(
        default=None,
        metadata={
            "name": "FIToFIPmtRvsl",
            "type": "Element",
