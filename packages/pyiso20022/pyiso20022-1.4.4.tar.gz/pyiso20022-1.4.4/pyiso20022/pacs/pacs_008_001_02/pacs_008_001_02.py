...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.008.001.02"
...
@dataclass
class CreditTransferTransactionInformation11:
...
@dataclass
class FitoFicustomerCreditTransferV02:
    class Meta:
        name = "FIToFICustomerCreditTransferV02"

    grp_hdr: Optional[GroupHeader33] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    cdt_trf_tx_inf: List[CreditTransferTransactionInformation11] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTxInf",
            "type": "Element",
...
class Document:
    ...
    fito_ficstmr_cdt_trf: Optional[FitoFicustomerCreditTransferV02] = field(
        default=None,
        metadata={
