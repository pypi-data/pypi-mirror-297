...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.10"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.10",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
class GroupHeader89:
    ...
    ttl_rvsd_intr_bk_sttlm_amt: Optional[ActiveCurrencyAndAmount] = field(
        default=None,
        metadata={
...
class PaymentTransaction119:
    ...
    rvsd_intr_bk_sttlm_amt: Optional[ActiveCurrencyAndAmount] = field(
        default=None,
        metadata={
...
@dataclass
class FitoFipaymentReversalV10:
    class Meta:
        name = "FIToFIPaymentReversalV10"

    grp_hdr: Optional[GroupHeader89] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    orgnl_grp_inf: Optional[OriginalGroupHeader16] = field(
        default=None,
        metadata={
            "name": "OrgnlGrpInf",
            "type": "Element",
    ...
    tx_inf: List[PaymentTransaction119] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_rvsl: Optional[FitoFipaymentReversalV10] = field(
        default=None,
        metadata={
            "name": "FIToFIPmtRvsl",
            "type": "Element",
