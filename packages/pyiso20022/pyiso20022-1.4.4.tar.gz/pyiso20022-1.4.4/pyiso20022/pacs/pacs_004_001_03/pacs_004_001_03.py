...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.004.001.03"
...
class PaymentReturnV03:
    ...
    tx_inf: List[PaymentTransaction34] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class Document:
    ...
    pmt_rtr: Optional[PaymentReturnV03] = field(
        default=None,
        metadata={
            "name": "PmtRtr",
            "type": "Element",
