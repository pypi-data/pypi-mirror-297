...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06"
...
@dataclass
class CreditTransferTransaction25:
...
@dataclass
class FitoFicustomerCreditTransferV06:
    class Meta:
    ...
    cdt_trf_tx_inf: List[CreditTransferTransaction25] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTxInf",
            "type": "Element",
...
class Document:
    ...
    fito_ficstmr_cdt_trf: Optional[FitoFicustomerCreditTransferV06] = field(
        default=None,
        metadata={
