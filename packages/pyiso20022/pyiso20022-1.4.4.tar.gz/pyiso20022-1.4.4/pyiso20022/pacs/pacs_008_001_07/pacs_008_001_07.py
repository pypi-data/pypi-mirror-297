...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.008.001.07"
...
@dataclass
class CreditTransferTransaction30:
...
@dataclass
class FitoFicustomerCreditTransferV07:
    class Meta:
    ...
    cdt_trf_tx_inf: List[CreditTransferTransaction30] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTxInf",
            "type": "Element",
...
class Document:
    ...
    fito_ficstmr_cdt_trf: Optional[FitoFicustomerCreditTransferV07] = field(
        default=None,
        metadata={
