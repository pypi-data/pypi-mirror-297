...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.03"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.03",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class FitoFipaymentReversalV03:
    class Meta:
    ...
    tx_inf: List[PaymentTransaction36] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_rvsl: Optional[FitoFipaymentReversalV03] = field(
        default=None,
        metadata={
            "name": "FIToFIPmtRvsl",
            "type": "Element",
