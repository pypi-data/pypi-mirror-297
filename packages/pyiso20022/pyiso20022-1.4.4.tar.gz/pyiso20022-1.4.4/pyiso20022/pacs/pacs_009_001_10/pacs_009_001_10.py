...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.009.001.10"
...
@dataclass
class CreditTransferTransaction56:
...
class FinancialInstitutionCreditTransferV10:
    grp_hdr: Optional[GroupHeader96] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    cdt_trf_tx_inf: List[CreditTransferTransaction56] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTxInf",
            "type": "Element",
...
class Document:
    ...
    ficdt_trf: Optional[FinancialInstitutionCreditTransferV10] = field(
        default=None,
        metadata={
            "name": "FICdtTrf",
            "type": "Element",
