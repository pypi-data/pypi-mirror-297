...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.028.001.04"
...
@dataclass
class FitoFipaymentStatusRequestV04:
    class Meta:
    ...
    orgnl_grp_inf: List[OriginalGroupInformation27] = field(
        default_factory=list,
        metadata={
            "name": "OrgnlGrpInf",
            "type": "Element",
    ...
    tx_inf: List[PaymentTransaction121] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_sts_req: Optional[FitoFipaymentStatusRequestV04] = field(
        default=None,
        metadata={
