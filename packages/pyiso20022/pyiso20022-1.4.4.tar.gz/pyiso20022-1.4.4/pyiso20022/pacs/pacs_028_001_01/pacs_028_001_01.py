...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.028.001.01"
...
@dataclass
class FitoFipaymentStatusRequestV01:
    class Meta:
    ...
    tx_inf: List[PaymentTransaction73] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_sts_req: Optional[FitoFipaymentStatusRequestV01] = field(
        default=None,
        metadata={
