...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.11"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.055.001.11",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
class OriginalPaymentInstruction44:
    ...
    tx_inf: List[PaymentTransaction140] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class UnderlyingTransaction30:
    ...
    orgnl_pmt_inf_and_cxl: List[OriginalPaymentInstruction44] = field(
        default_factory=list,
        metadata={
...
@dataclass
class CustomerPaymentCancellationRequestV11:
    ...
    undrlyg: List[UnderlyingTransaction30] = field(
        default_factory=list,
        metadata={
            "name": "Undrlyg",
            "type": "Element",
...
class Document:
    ...
    cstmr_pmt_cxl_req: Optional[CustomerPaymentCancellationRequestV11] = field(
        default=None,
        metadata={
            "name": "CstmrPmtCxlReq",
            "type": "Element",
