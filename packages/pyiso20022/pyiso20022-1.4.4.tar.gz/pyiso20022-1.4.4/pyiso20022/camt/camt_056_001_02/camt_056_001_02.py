...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.056.001.02"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.056.001.02",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
class UnderlyingTransaction5:
    ...
    tx_inf: List[PaymentTransaction38] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
@dataclass
class FitoFipaymentCancellationRequestV02:
    class Meta:
    ...
    undrlyg: List[UnderlyingTransaction5] = field(
        default_factory=list,
        metadata={
            "name": "Undrlyg",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_cxl_req: Optional[FitoFipaymentCancellationRequestV02] = field(
        default=None,
        metadata={
