...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.026.001.09"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.026.001.09",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class UnderlyingPaymentInstruction7:
...
@dataclass
class UnderlyingPaymentTransaction6:
    orgnl_grp_inf: Optional[UnderlyingGroupInformation1] = field(
        default=None,
        metadata={
            "name": "OrgnlGrpInf",
...
@dataclass
class UnderlyingTransaction7Choice:
    initn: Optional[UnderlyingPaymentInstruction7] = field(
        default=None,
        metadata={
            "name": "Initn",
            "type": "Element",
    ...
    intr_bk: Optional[UnderlyingPaymentTransaction6] = field(
        default=None,
        metadata={
            "name": "IntrBk",
            "type": "Element",
...
class UnableToApplyV09:
    ...
    undrlyg: Optional[UnderlyingTransaction7Choice] = field(
        default=None,
        metadata={
            "name": "Undrlyg",
            "type": "Element",
...
class Document:
    ...
    ubl_to_apply: Optional[UnableToApplyV09] = field(
        default=None,
        metadata={
            "name": "UblToApply",
            "type": "Element",
