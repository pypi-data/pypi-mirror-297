...
@dataclass
class CorrectiveInterbankTransaction3:
...
@dataclass
class CorrectivePaymentInitiation5:
    grp_hdr: Optional[CorrectiveGroupInformation1] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
...
@dataclass
class CorrectiveTransaction5Choice:
    initn: Optional[CorrectivePaymentInitiation5] = field(
        default=None,
        metadata={
            "name": "Initn",
            "type": "Element",
    ...
    intr_bk: Optional[CorrectiveInterbankTransaction3] = field(
        default=None,
        metadata={
            "name": "IntrBk",
            "type": "Element",
...
class AmendmentInformationDetails15:
    ...
    orgnl_cdtr_schme_id: Optional[PartyIdentification272] = field(
        default=None,
        metadata={
    ...
    orgnl_cdtr_agt: Optional[BranchAndFinancialInstitutionIdentification8] = (
        field(
            default=None,
            metadata={
                "name": "OrgnlCdtrAgt",
    ...
    orgnl_dbtr: Optional[PartyIdentification272] = field(
        default=None,
        metadata={
            "name": "OrgnlDbtr",
            "type": "Element",
    ...
    orgnl_dbtr_agt: Optional[BranchAndFinancialInstitutionIdentification8] = (
        field(
            default=None,
            metadata={
                "name": "OrgnlDbtrAgt",
...
@dataclass
class CancellationStatusReason5:
...
class Charges14:
    ...
    agt_acct: Optional[CashAccount40] = field(
        default=None,
        metadata={
            "name": "AgtAcct",
            "type": "Element",
...
class ClaimNonReceipt3:
    ...
    orgnl_nxt_agt: Optional[BranchAndFinancialInstitutionIdentification8] = (
        field(
            default=None,
            metadata={
                "name": "OrgnlNxtAgt",
...
@dataclass
class ModificationStatusReason3:
    orgtr: Optional[PartyIdentification272] = field(
        default=None,
        metadata={
            "name": "Orgtr",
...
class Case6:
    ...
    cretr: Optional[Party50Choice] = field(
        default=None,
        metadata={
            "name": "Cretr",
            "type": "Element",
...
class CaseAssignment6:
    ...
    assgnr: Optional[Party50Choice] = field(
        default=None,
        metadata={
            "name": "Assgnr",
            "type": "Element",
    ...
    assgne: Optional[Party50Choice] = field(
        default=None,
        metadata={
            "name": "Assgne",
            "type": "Element",
...
class ClaimNonReceipt3Choice:
    accptd: Optional[ClaimNonReceipt3] = field(
        default=None,
        metadata={
            "name": "Accptd",
            "type": "Element",
...
class MandateRelatedInformation16:
    ...
    amdmnt_inf_dtls: Optional[AmendmentInformationDetails15] = field(
        default=None,
        metadata={
            "name": "AmdmntInfDtls",
            "type": "Element",
...
class ResolutionData5:
    ...
    compstn: Optional[Compensation5] = field(
        default=None,
        metadata={
            "name": "Compstn",
            "type": "Element",
    ...
    chrgs_inf: List[Charges14] = field(
        default_factory=list,
        metadata={
            "name": "ChrgsInf",
            "type": "Element",
...
class MandateRelatedData3Choice:
    drct_dbt_mndt: Optional[MandateRelatedInformation16] = field(
        default=None,
        metadata={
            "name": "DrctDbtMndt",
            "type": "Element",
...
class OriginalGroupHeader23:
    ...
    rslvd_case: Optional[Case6] = field(
        default=None,
        metadata={
            "name": "RslvdCase",
            "type": "Element",
    ...
    cxl_sts_rsn_inf: List[CancellationStatusReason5] = field(
        default_factory=list,
        metadata={
            "name": "CxlStsRsnInf",
            "type": "Element",
...
@dataclass
class StatementResolutionEntry5:
...
class OriginalTransactionReference42:
    ...
    mndt_rltd_inf: Optional[MandateRelatedData3Choice] = field(
        default=None,
        metadata={
            "name": "MndtRltdInf",
            "type": "Element",
...
class PaymentTransaction152:
    ...
    rsltn_rltd_inf: Optional[ResolutionData5] = field(
        default=None,
        metadata={
            "name": "RsltnRltdInf",
            "type": "Element",
    ...
    orgnl_tx_ref: Optional[OriginalTransactionReference42] = field(
        default=None,
        metadata={
            "name": "OrgnlTxRef",
            "type": "Element",
...
class PaymentTransaction157:
    ...
    mod_sts_rsn_inf: List[ModificationStatusReason3] = field(
        default_factory=list,
        metadata={
            "name": "ModStsRsnInf",
            "type": "Element",
...
@dataclass
class OriginalPaymentInstruction48:
    ...
    tx_inf_and_sts: List[PaymentTransaction153] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
@dataclass
class UnderlyingTransaction32:
    orgnl_grp_inf_and_sts: Optional[OriginalGroupHeader23] = field(
        default=None,
        metadata={
    ...
    orgnl_pmt_inf_and_sts: List[OriginalPaymentInstruction48] = field(
        default_factory=list,
        metadata={
    ...
    tx_inf_and_sts: List[PaymentTransaction152] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
@dataclass
class ResolutionOfInvestigationV13:
    assgnmt: Optional[CaseAssignment6] = field(
        default=None,
        metadata={
            "name": "Assgnmt",
            "type": "Element",
    ...
    sts: Optional[InvestigationStatus6Choice] = field(
        default=None,
        metadata={
            "name": "Sts",
            "type": "Element",
    ...
    cxl_dtls: List[UnderlyingTransaction32] = field(
        default_factory=list,
        metadata={
            "name": "CxlDtls",
            "type": "Element",
    ...
    mod_dtls: Optional[PaymentTransaction157] = field(
        default=None,
        metadata={
            "name": "ModDtls",
            "type": "Element",
    ...
    clm_non_rct_dtls: Optional[ClaimNonReceipt3Choice] = field(
        default=None,
        metadata={
            "name": "ClmNonRctDtls",
            "type": "Element",
    ...
    stmt_dtls: Optional[StatementResolutionEntry5] = field(
        default=None,
        metadata={
            "name": "StmtDtls",
            "type": "Element",
    ...
    crrctn_tx: Optional[CorrectiveTransaction5Choice] = field(
        default=None,
        metadata={
            "name": "CrrctnTx",
            "type": "Element",
...
class Document:
    ...
    rsltn_of_invstgtn: Optional[ResolutionOfInvestigationV13] = field(
        default=None,
        metadata={
