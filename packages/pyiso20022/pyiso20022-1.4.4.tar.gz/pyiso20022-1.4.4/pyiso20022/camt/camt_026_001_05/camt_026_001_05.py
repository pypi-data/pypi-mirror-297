...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.026.001.05"
...
class ClearingSystemIdentification2Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.026.001.05",
            "min_length": 1,
            "max_length": 5,
        },
    )
...
class Document:
    ...
    ubl_to_apply: Optional[UnableToApplyV05] = field(
        default=None,
        metadata={
            "name": "UblToApply",
            "type": "Element",
