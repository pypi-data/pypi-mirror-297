...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.11"
...
class EntryDetails12:
    ...
    tx_dtls: List[EntryTransaction13] = field(
        default_factory=list,
        metadata={
            "name": "TxDtls",
            "type": "Element",
...
class ReportEntry13:
    ...
    ntry_dtls: List[EntryDetails12] = field(
        default_factory=list,
        metadata={
            "name": "NtryDtls",
            "type": "Element",
...
@dataclass
class BankToCustomerAccountReportV11:
    ...
    rpt: List[AccountReport32] = field(
        default_factory=list,
        metadata={
            "name": "Rpt",
            "type": "Element",
...
class Document:
    ...
    bk_to_cstmr_acct_rpt: Optional[BankToCustomerAccountReportV11] = field(
        default=None,
        metadata={
