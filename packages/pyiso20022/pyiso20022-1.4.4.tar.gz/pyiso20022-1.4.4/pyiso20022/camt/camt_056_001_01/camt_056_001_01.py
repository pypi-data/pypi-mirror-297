...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.056.001.01"
...
class CancellationReason2Choice:
    cd: Optional[CancellationReason4Code] = field(
        default=None,
        metadata={
            "name": "Cd",
            "type": "Element",
...
class CancellationReasonInformation3:
    ...
    rsn: Optional[CancellationReason2Choice] = field(
        default=None,
        metadata={
            "name": "Rsn",
            "type": "Element",
...
@dataclass
class PaymentTransactionInformation31:
    ...
    assgnr: Optional[BranchAndFinancialInstitutionIdentification4] = field(
        default=None,
        metadata={
            "name": "Assgnr",
            "type": "Element",
    ...
    assgne: Optional[BranchAndFinancialInstitutionIdentification4] = field(
        default=None,
        metadata={
            "name": "Assgne",
            "type": "Element",
...
@dataclass
class UnderlyingTransaction2:
    orgnl_grp_inf_and_cxl: Optional[OriginalGroupInformation23] = field(
        default=None,
        metadata={
    ...
    tx_inf: List[PaymentTransactionInformation31] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
@dataclass
class FitoFipaymentCancellationRequestV01:
    class Meta:
    ...
    undrlyg: List[UnderlyingTransaction2] = field(
        default_factory=list,
        metadata={
            "name": "Undrlyg",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_cxl_req: Optional[FitoFipaymentCancellationRequestV01] = field(
        default=None,
        metadata={
