...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.10"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.055.001.10",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class CustomerPaymentCancellationRequestV10:
...
class Document:
    ...
    cstmr_pmt_cxl_req: Optional[CustomerPaymentCancellationRequestV10] = field(
        default=None,
        metadata={
            "name": "CstmrPmtCxlReq",
            "type": "Element",
