...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.056.001.07"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.056.001.07",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class PaymentCancellationReason4:
...
class OriginalGroupHeader10:
    ...
    cxl_rsn_inf: List[PaymentCancellationReason4] = field(
        default_factory=list,
        metadata={
            "name": "CxlRsnInf",
            "type": "Element",
...
@dataclass
class UnderlyingTransaction20:
    orgnl_grp_inf_and_cxl: Optional[OriginalGroupHeader10] = field(
        default=None,
        metadata={
    ...
    tx_inf: List[PaymentTransaction89] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
@dataclass
class FitoFipaymentCancellationRequestV07:
    class Meta:
    ...
    undrlyg: List[UnderlyingTransaction20] = field(
        default_factory=list,
        metadata={
            "name": "Undrlyg",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_cxl_req: Optional[FitoFipaymentCancellationRequestV07] = field(
        default=None,
        metadata={
