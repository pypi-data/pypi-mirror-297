...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.06"
...
class OriginalPaymentInstruction17:
    ...
    tx_inf_and_sts: List[PaymentTransaction66] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
class UnderlyingTransaction14:
    ...
    orgnl_pmt_inf_and_sts: List[OriginalPaymentInstruction17] = field(
        default_factory=list,
        metadata={
    ...
    tx_inf_and_sts: List[PaymentTransaction67] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
@dataclass
class ResolutionOfInvestigationV06:
    ...
    cxl_dtls: List[UnderlyingTransaction14] = field(
        default_factory=list,
        metadata={
            "name": "CxlDtls",
            "type": "Element",
...
class Document:
    ...
    rsltn_of_invstgtn: Optional[ResolutionOfInvestigationV06] = field(
        default=None,
        metadata={
