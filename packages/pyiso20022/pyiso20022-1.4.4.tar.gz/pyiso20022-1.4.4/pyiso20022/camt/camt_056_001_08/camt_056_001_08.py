...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.056.001.08"
...
class UnderlyingTransaction23:
    ...
    tx_inf: List[PaymentTransaction106] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
@dataclass
class FitoFipaymentCancellationRequestV08:
    class Meta:
    ...
    undrlyg: List[UnderlyingTransaction23] = field(
        default_factory=list,
        metadata={
            "name": "Undrlyg",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_cxl_req: Optional[FitoFipaymentCancellationRequestV08] = field(
        default=None,
        metadata={
