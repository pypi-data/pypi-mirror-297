...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.03"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.053.001.03",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class BankToCustomerStatementV03:
    ...
    stmt: List[AccountStatement3] = field(
        default_factory=list,
        metadata={
            "name": "Stmt",
            "type": "Element",
...
class Document:
    ...
    bk_to_cstmr_stmt: Optional[BankToCustomerStatementV03] = field(
        default=None,
        metadata={
            "name": "BkToCstmrStmt",
            "type": "Element",
