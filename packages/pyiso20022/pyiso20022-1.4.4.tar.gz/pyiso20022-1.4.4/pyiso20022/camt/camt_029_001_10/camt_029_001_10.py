...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.10"
...
@dataclass
class CorrectiveInterbankTransaction2:
...
@dataclass
class CorrectivePaymentInitiation4:
    grp_hdr: Optional[CorrectiveGroupInformation1] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
...
@dataclass
class CorrectiveTransaction4Choice:
    initn: Optional[CorrectivePaymentInitiation4] = field(
        default=None,
        metadata={
            "name": "Initn",
            "type": "Element",
    ...
    intr_bk: Optional[CorrectiveInterbankTransaction2] = field(
        default=None,
        metadata={
            "name": "IntrBk",
            "type": "Element",
...
class AmendmentInformationDetails13:
    ...
    orgnl_cdtr_agt_acct: Optional[CashAccount38] = field(
        default=None,
        metadata={
    ...
    orgnl_dbtr_acct: Optional[CashAccount38] = field(
        default=None,
        metadata={
            "name": "OrgnlDbtrAcct",
            "type": "Element",
    ...
    orgnl_dbtr_agt_acct: Optional[CashAccount38] = field(
        default=None,
        metadata={
...
@dataclass
class CancellationStatusReason4:
...
class Charges8:
    ...
    agt_acct: Optional[CashAccount38] = field(
        default=None,
        metadata={
            "name": "AgtAcct",
            "type": "Element",
...
class ClaimNonReceipt2:
    ...
    orgnl_nxt_agt: Optional[BranchAndFinancialInstitutionIdentification6] = (
        field(
            default=None,
            metadata={
                "name": "OrgnlNxtAgt",
...
class SettlementInstruction7:
    ...
    sttlm_acct: Optional[CashAccount38] = field(
        default=None,
        metadata={
            "name": "SttlmAcct",
            "type": "Element",
    ...
    instg_rmbrsmnt_agt_acct: Optional[CashAccount38] = field(
        default=None,
        metadata={
    ...
    instd_rmbrsmnt_agt_acct: Optional[CashAccount38] = field(
        default=None,
        metadata={
    ...
    thrd_rmbrsmnt_agt_acct: Optional[CashAccount38] = field(
        default=None,
        metadata={
...
@dataclass
class ClaimNonReceipt2Choice:
    accptd: Optional[ClaimNonReceipt2] = field(
        default=None,
        metadata={
            "name": "Accptd",
            "type": "Element",
...
class MandateRelatedInformation14:
    ...
    amdmnt_inf_dtls: Optional[AmendmentInformationDetails13] = field(
        default=None,
        metadata={
            "name": "AmdmntInfDtls",
            "type": "Element",
...
class ResolutionData2:
    ...
    compstn: Optional[Compensation3] = field(
        default=None,
        metadata={
            "name": "Compstn",
            "type": "Element",
...
@dataclass
class MandateRelatedData1Choice:
    drct_dbt_mndt: Optional[MandateRelatedInformation14] = field(
        default=None,
        metadata={
            "name": "DrctDbtMndt",
            "type": "Element",
...
class OriginalGroupHeader14:
    ...
    rslvd_case: Optional[Case5] = field(
        default=None,
        metadata={
            "name": "RslvdCase",
            "type": "Element",
    ...
    cxl_sts_rsn_inf: List[CancellationStatusReason4] = field(
        default_factory=list,
        metadata={
            "name": "CxlStsRsnInf",
            "type": "Element",
...
class OriginalTransactionReference31:
    ...
    sttlm_inf: Optional[SettlementInstruction7] = field(
        default=None,
        metadata={
            "name": "SttlmInf",
            "type": "Element",
    ...
    mndt_rltd_inf: Optional[MandateRelatedData1Choice] = field(
        default=None,
        metadata={
            "name": "MndtRltdInf",
            "type": "Element",
    ...
    rmt_inf: Optional[RemittanceInformation16] = field(
        default=None,
        metadata={
            "name": "RmtInf",
            "type": "Element",
...
class PaymentTransaction116:
    ...
    mod_sts_rsn_inf: List[ModificationStatusReason2] = field(
        default_factory=list,
        metadata={
            "name": "ModStsRsnInf",
            "type": "Element",
    ...
    rsltn_rltd_inf: Optional[ResolutionData2] = field(
        default=None,
        metadata={
            "name": "RsltnRltdInf",
            "type": "Element",
    ...
    orgnl_tx_ref: Optional[OriginalTransactionReference31] = field(
        default=None,
        metadata={
            "name": "OrgnlTxRef",
            "type": "Element",
...
@dataclass
class OriginalPaymentInstruction35:
    ...
    tx_inf_and_sts: List[PaymentTransaction122] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
@dataclass
class UnderlyingTransaction25:
    orgnl_grp_inf_and_sts: Optional[OriginalGroupHeader14] = field(
        default=None,
        metadata={
    ...
    orgnl_pmt_inf_and_sts: List[OriginalPaymentInstruction35] = field(
        default_factory=list,
        metadata={
    ...
    tx_inf_and_sts: List[PaymentTransaction127] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
@dataclass
class ResolutionOfInvestigationV10:
    ...
    sts: Optional[InvestigationStatus5Choice] = field(
        default=None,
        metadata={
            "name": "Sts",
            "type": "Element",
    ...
    cxl_dtls: List[UnderlyingTransaction25] = field(
        default_factory=list,
        metadata={
            "name": "CxlDtls",
            "type": "Element",
    ...
    mod_dtls: Optional[PaymentTransaction116] = field(
        default=None,
        metadata={
            "name": "ModDtls",
            "type": "Element",
    ...
    clm_non_rct_dtls: Optional[ClaimNonReceipt2Choice] = field(
        default=None,
        metadata={
            "name": "ClmNonRctDtls",
            "type": "Element",
    ...
    stmt_dtls: Optional[StatementResolutionEntry4] = field(
        default=None,
        metadata={
            "name": "StmtDtls",
            "type": "Element",
    ...
    crrctn_tx: Optional[CorrectiveTransaction4Choice] = field(
        default=None,
        metadata={
            "name": "CrrctnTx",
            "type": "Element",
...
class Document:
    ...
    rsltn_of_invstgtn: Optional[ResolutionOfInvestigationV10] = field(
        default=None,
        metadata={
