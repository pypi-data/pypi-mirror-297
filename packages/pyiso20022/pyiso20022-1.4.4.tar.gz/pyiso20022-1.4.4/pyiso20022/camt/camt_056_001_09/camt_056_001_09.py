...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.056.001.09"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.056.001.09",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
class UnderlyingTransaction26:
    ...
    tx_inf: List[PaymentTransaction120] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
@dataclass
class FitoFipaymentCancellationRequestV09:
    class Meta:
    ...
    undrlyg: List[UnderlyingTransaction26] = field(
        default_factory=list,
        metadata={
            "name": "Undrlyg",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_cxl_req: Optional[FitoFipaymentCancellationRequestV09] = field(
        default=None,
        metadata={
