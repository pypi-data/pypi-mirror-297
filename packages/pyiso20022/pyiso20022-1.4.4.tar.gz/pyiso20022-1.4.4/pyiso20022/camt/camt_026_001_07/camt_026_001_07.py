...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.026.001.07"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.026.001.07",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class UnderlyingPaymentInstruction5:
...
@dataclass
class UnderlyingPaymentTransaction4:
    orgnl_grp_inf: Optional[UnderlyingGroupInformation1] = field(
        default=None,
        metadata={
            "name": "OrgnlGrpInf",
...
@dataclass
class UnderlyingTransaction5Choice:
    initn: Optional[UnderlyingPaymentInstruction5] = field(
        default=None,
        metadata={
            "name": "Initn",
            "type": "Element",
    ...
    intr_bk: Optional[UnderlyingPaymentTransaction4] = field(
        default=None,
        metadata={
            "name": "IntrBk",
            "type": "Element",
...
class UnableToApplyV07:
    ...
    undrlyg: Optional[UnderlyingTransaction5Choice] = field(
        default=None,
        metadata={
            "name": "Undrlyg",
            "type": "Element",
...
class Document:
    ...
    ubl_to_apply: Optional[UnableToApplyV07] = field(
        default=None,
        metadata={
            "name": "UblToApply",
            "type": "Element",
