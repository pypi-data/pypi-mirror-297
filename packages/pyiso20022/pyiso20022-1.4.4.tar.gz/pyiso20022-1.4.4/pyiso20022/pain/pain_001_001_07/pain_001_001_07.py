...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.07"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pain.001.001.07",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class CreditTransferTransaction26:
    ...
    chq_instr: Optional[Cheque7] = field(
        default=None,
        metadata={
            "name": "ChqInstr",
            "type": "Element",
...
class PaymentInstruction20:
    ...
    cdt_trf_tx_inf: List[CreditTransferTransaction26] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTxInf",
            "type": "Element",
...
@dataclass
class CustomerCreditTransferInitiationV07:
    grp_hdr: Optional[GroupHeader48] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    pmt_inf: List[PaymentInstruction20] = field(
        default_factory=list,
        metadata={
            "name": "PmtInf",
            "type": "Element",
...
class Document:
    ...
    cstmr_cdt_trf_initn: Optional[CustomerCreditTransferInitiationV07] = field(
        default=None,
        metadata={
