...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.12"
...
@dataclass
class OriginalPaymentInstruction40:
    ...
    tx_inf_and_sts: List[PaymentTransaction129] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
class CustomerPaymentStatusReportV12:
    ...
    orgnl_pmt_inf_and_sts: List[OriginalPaymentInstruction40] = field(
        default_factory=list,
        metadata={
...
class Document:
    ...
    cstmr_pmt_sts_rpt: Optional[CustomerPaymentStatusReportV12] = field(
        default=None,
        metadata={
            "name": "CstmrPmtStsRpt",
            "type": "Element",
