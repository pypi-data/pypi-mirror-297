...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.013.001.01"
...
class PaymentInstruction5:
    ...
    cdt_trf_tx: List[CreditTransferTransactionInformation14] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTx",
            "type": "Element",
...
@dataclass
class CreditorPaymentActivationRequestV01:
    grp_hdr: Optional[GroupHeader45] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    pmt_inf: List[PaymentInstruction5] = field(
        default_factory=list,
        metadata={
            "name": "PmtInf",
            "type": "Element",
...
class Document:
    ...
    cdtr_pmt_actvtn_req: Optional[CreditorPaymentActivationRequestV01] = field(
        default=None,
        metadata={
