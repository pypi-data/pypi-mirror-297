...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.09"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pain.008.001.09",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
class DirectDebitTransactionInformation23:
    ...
    pmt_tp_inf: Optional[PaymentTypeInformation29] = field(
        default=None,
        metadata={
            "name": "PmtTpInf",
            "type": "Element",
    ...
    drct_dbt_tx: Optional[DirectDebitTransaction10] = field(
        default=None,
        metadata={
            "name": "DrctDbtTx",
            "type": "Element",
...
class PaymentInstruction37:
    ...
    chrgs_acct: Optional[CashAccount38] = field(
        default=None,
        metadata={
            "name": "ChrgsAcct",
            "type": "Element",
    ...
    chrgs_acct_agt: Optional[BranchAndFinancialInstitutionIdentification6] = (
        field(
            default=None,
            metadata={
                "name": "ChrgsAcctAgt",
    ...
    drct_dbt_tx_inf: List[DirectDebitTransactionInformation23] = field(
        default_factory=list,
        metadata={
            "name": "DrctDbtTxInf",
            "type": "Element",
...
@dataclass
class CustomerDirectDebitInitiationV09:
    grp_hdr: Optional[GroupHeader83] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    pmt_inf: List[PaymentInstruction37] = field(
        default_factory=list,
        metadata={
            "name": "PmtInf",
            "type": "Element",
...
class Document:
    ...
    cstmr_drct_dbt_initn: Optional[CustomerDirectDebitInitiationV09] = field(
        default=None,
        metadata={
