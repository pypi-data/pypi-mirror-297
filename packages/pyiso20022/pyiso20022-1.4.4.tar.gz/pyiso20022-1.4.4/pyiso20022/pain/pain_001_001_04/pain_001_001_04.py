...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.04"
...
@dataclass
class CreditTransferTransaction1:
...
class PaymentInstruction6:
    ...
    cdt_trf_tx_inf: List[CreditTransferTransaction1] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTxInf",
            "type": "Element",
...
@dataclass
class CustomerCreditTransferInitiationV04:
    ...
    pmt_inf: List[PaymentInstruction6] = field(
        default_factory=list,
        metadata={
            "name": "PmtInf",
            "type": "Element",
...
class Document:
    ...
    cstmr_cdt_trf_initn: Optional[CustomerCreditTransferInitiationV04] = field(
        default=None,
        metadata={
