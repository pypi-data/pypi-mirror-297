...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.007.001.11"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pain.007.001.11",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class OriginalPaymentInstruction41:
    ...
    tx_inf: List[PaymentTransaction134] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
@dataclass
class CustomerPaymentReversalV11:
    grp_hdr: Optional[GroupHeader88] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    orgnl_pmt_inf_and_rvsl: List[OriginalPaymentInstruction41] = field(
        default_factory=list,
        metadata={
...
class Document:
    ...
    cstmr_pmt_rvsl: Optional[CustomerPaymentReversalV11] = field(
        default=None,
        metadata={
            "name": "CstmrPmtRvsl",
            "type": "Element",
