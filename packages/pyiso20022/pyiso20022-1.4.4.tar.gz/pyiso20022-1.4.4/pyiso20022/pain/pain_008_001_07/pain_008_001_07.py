...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.07"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pain.008.001.07",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class DirectDebitTransactionInformation22:
...
class PaymentInstruction21:
    ...
    drct_dbt_tx_inf: List[DirectDebitTransactionInformation22] = field(
        default_factory=list,
        metadata={
            "name": "DrctDbtTxInf",
            "type": "Element",
...
@dataclass
class CustomerDirectDebitInitiationV07:
    ...
    pmt_inf: List[PaymentInstruction21] = field(
        default_factory=list,
        metadata={
            "name": "PmtInf",
            "type": "Element",
...
class Document:
    ...
    cstmr_drct_dbt_initn: Optional[CustomerDirectDebitInitiationV07] = field(
        default=None,
        metadata={
