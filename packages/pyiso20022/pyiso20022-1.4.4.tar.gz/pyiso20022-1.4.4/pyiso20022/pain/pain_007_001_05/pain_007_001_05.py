...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.007.001.05"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pain.007.001.05",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
class OriginalPaymentInstruction11:
    ...
    tx_inf: List[PaymentTransaction56] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
@dataclass
class CustomerPaymentReversalV05:
    ...
    orgnl_pmt_inf_and_rvsl: List[OriginalPaymentInstruction11] = field(
        default_factory=list,
        metadata={
...
class Document:
    ...
    cstmr_pmt_rvsl: Optional[CustomerPaymentReversalV05] = field(
        default=None,
        metadata={
            "name": "CstmrPmtRvsl",
            "type": "Element",
