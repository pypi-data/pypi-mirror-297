...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.06"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pain.002.001.06",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class OriginalPaymentInstruction12:
    ...
    tx_inf_and_sts: List[PaymentTransaction57] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
@dataclass
class CustomerPaymentStatusReportV06:
    grp_hdr: Optional[GroupHeader52] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    orgnl_grp_inf_and_sts: Optional[OriginalGroupHeader1] = field(
        default=None,
        metadata={
    ...
    orgnl_pmt_inf_and_sts: List[OriginalPaymentInstruction12] = field(
        default_factory=list,
        metadata={
...
class Document:
    ...
    cstmr_pmt_sts_rpt: Optional[CustomerPaymentStatusReportV06] = field(
        default=None,
        metadata={
            "name": "CstmrPmtStsRpt",
            "type": "Element",
