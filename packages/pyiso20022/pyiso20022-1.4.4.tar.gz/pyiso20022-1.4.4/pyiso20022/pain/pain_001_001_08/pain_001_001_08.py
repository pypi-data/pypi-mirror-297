...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.08"
...
@dataclass
class CustomerCreditTransferInitiationV08:
    ...
    pmt_inf: List[PaymentInstruction22] = field(
        default_factory=list,
        metadata={
            "name": "PmtInf",
            "type": "Element",
...
class Document:
    ...
    cstmr_cdt_trf_initn: Optional[CustomerCreditTransferInitiationV08] = field(
        default=None,
        metadata={
