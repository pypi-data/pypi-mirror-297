...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.014.001.03"
...
@dataclass
class OriginalTransactionReference19:
...
class PaymentTransaction49:
    ...
    orgnl_tx_ref: Optional[OriginalTransactionReference19] = field(
        default=None,
        metadata={
            "name": "OrgnlTxRef",
            "type": "Element",
...
@dataclass
class OriginalPaymentInstruction9:
    ...
    tx_inf_and_sts: List[PaymentTransaction49] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
@dataclass
class CreditorPaymentActivationRequestStatusReportV03:
    ...
    orgnl_pmt_inf_and_sts: List[OriginalPaymentInstruction9] = field(
        default_factory=list,
        metadata={
