...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.008.001.08"
...
@dataclass
class FitoFicustomerCreditTransferV08:
    class Meta:
...
class Document:
    ...
    fito_ficstmr_cdt_trf: Optional[FitoFicustomerCreditTransferV08] = field(
        default=None,
        metadata={
