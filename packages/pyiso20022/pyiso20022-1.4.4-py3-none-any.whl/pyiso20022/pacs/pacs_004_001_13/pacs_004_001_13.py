...
class OriginalGroupHeader19:
    ...
    rtr_rsn_inf: List[PaymentReturnReason7] = field(
        default_factory=list,
        metadata={
            "name": "RtrRsnInf",
            "type": "Element",
...
@dataclass
class CreditTransferTransaction63:
...
@dataclass
class OriginalTransactionReference41:
    ...
    undrlyg_cstmr_cdt_trf: Optional[CreditTransferTransaction63] = field(
        default=None,
        metadata={
...
class PaymentTransaction159:
    ...
    rtr_chain: Optional[TransactionParties11] = field(
        default=None,
        metadata={
            "name": "RtrChain",
            "type": "Element",
    ...
    orgnl_tx_ref: Optional[OriginalTransactionReference41] = field(
        default=None,
        metadata={
            "name": "OrgnlTxRef",
            "type": "Element",
...
@dataclass
class PaymentReturnV13:
    grp_hdr: Optional[GroupHeader123] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    orgnl_grp_inf: Optional[OriginalGroupHeader19] = field(
        default=None,
        metadata={
            "name": "OrgnlGrpInf",
            "type": "Element",
    ...
    tx_inf: List[PaymentTransaction159] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class Document:
    ...
    pmt_rtr: Optional[PaymentReturnV13] = field(
        default=None,
        metadata={
            "name": "PmtRtr",
            "type": "Element",
