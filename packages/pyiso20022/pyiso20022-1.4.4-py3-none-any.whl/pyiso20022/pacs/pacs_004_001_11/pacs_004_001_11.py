...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.004.001.11"
...
@dataclass
class CreditTransferTransaction52:
...
@dataclass
class OriginalTransactionReference36:
    ...
    undrlyg_cstmr_cdt_trf: Optional[CreditTransferTransaction52] = field(
        default=None,
        metadata={
...
class PaymentTransaction133:
    ...
    rtr_chain: Optional[TransactionParties10] = field(
        default=None,
        metadata={
            "name": "RtrChain",
            "type": "Element",
    ...
    orgnl_tx_ref: Optional[OriginalTransactionReference36] = field(
        default=None,
        metadata={
            "name": "OrgnlTxRef",
            "type": "Element",
...
class PaymentReturnV11:
    grp_hdr: Optional[GroupHeader99] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    tx_inf: List[PaymentTransaction133] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class Document:
    ...
    pmt_rtr: Optional[PaymentReturnV11] = field(
        default=None,
        metadata={
            "name": "PmtRtr",
            "type": "Element",
