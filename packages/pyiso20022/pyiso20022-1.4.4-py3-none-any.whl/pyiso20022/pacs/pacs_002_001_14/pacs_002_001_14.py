...
@dataclass
class FitoFipaymentStatusReportV14:
    class Meta:
        name = "FIToFIPaymentStatusReportV14"

    grp_hdr: Optional[GroupHeader120] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    orgnl_grp_inf_and_sts: List[OriginalGroupHeader22] = field(
        default_factory=list,
        metadata={
    ...
    tx_inf_and_sts: List[PaymentTransaction161] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_sts_rpt: Optional[FitoFipaymentStatusReportV14] = field(
        default=None,
        metadata={
