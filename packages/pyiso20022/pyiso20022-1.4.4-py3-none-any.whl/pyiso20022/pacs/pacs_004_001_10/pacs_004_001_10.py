...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.004.001.10"
...
class GroupHeader90:
    ...
    ttl_rtrd_intr_bk_sttlm_amt: Optional[ActiveCurrencyAndAmount] = field(
        default=None,
        metadata={
...
class OriginalGroupHeader18:
    ...
    rtr_rsn_inf: List[PaymentReturnReason6] = field(
        default_factory=list,
        metadata={
            "name": "RtrRsnInf",
            "type": "Element",
...
class TransactionParties8:
    ...
    initg_pty: Optional[Party40Choice] = field(
        default=None,
        metadata={
            "name": "InitgPty",
            "type": "Element",
    ...
    prvs_instg_agt1: Optional[BranchAndFinancialInstitutionIdentification6] = (
        field(
            default=None,
            metadata={
                "name": "PrvsInstgAgt1",
    ...
    prvs_instg_agt1_acct: Optional[CashAccount38] = field(
        default=None,
        metadata={
    ...
    prvs_instg_agt2: Optional[BranchAndFinancialInstitutionIdentification6] = (
        field(
            default=None,
            metadata={
                "name": "PrvsInstgAgt2",
    ...
    prvs_instg_agt2_acct: Optional[CashAccount38] = field(
        default=None,
        metadata={
    ...
    prvs_instg_agt3: Optional[BranchAndFinancialInstitutionIdentification6] = (
        field(
            default=None,
            metadata={
                "name": "PrvsInstgAgt3",
    ...
    prvs_instg_agt3_acct: Optional[CashAccount38] = field(
        default=None,
        metadata={
...
@dataclass
class CreditTransferTransaction45:
    ...
    tax: Optional[TaxInformation8] = field(
        default=None,
        metadata={
            "name": "Tax",
            "type": "Element",
...
@dataclass
class OriginalTransactionReference32:
    ...
    undrlyg_cstmr_cdt_trf: Optional[CreditTransferTransaction45] = field(
        default=None,
        metadata={
...
class PaymentTransaction118:
    ...
    rtrd_intr_bk_sttlm_amt: Optional[ActiveCurrencyAndAmount] = field(
        default=None,
        metadata={
    ...
    rtrd_instd_amt: Optional[ActiveOrHistoricCurrencyAndAmount] = field(
        default=None,
        metadata={
            "name": "RtrdInstdAmt",
            "type": "Element",
    ...
    compstn_amt: Optional[ActiveOrHistoricCurrencyAndAmount] = field(
        default=None,
        metadata={
            "name": "CompstnAmt",
            "type": "Element",
    ...
    rtr_chain: Optional[TransactionParties8] = field(
        default=None,
        metadata={
            "name": "RtrChain",
            "type": "Element",
    ...
    orgnl_tx_ref: Optional[OriginalTransactionReference32] = field(
        default=None,
        metadata={
            "name": "OrgnlTxRef",
            "type": "Element",
...
@dataclass
class PaymentReturnV10:
    grp_hdr: Optional[GroupHeader90] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    orgnl_grp_inf: Optional[OriginalGroupHeader18] = field(
        default=None,
        metadata={
            "name": "OrgnlGrpInf",
            "type": "Element",
    ...
    tx_inf: List[PaymentTransaction118] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class Document:
    ...
    pmt_rtr: Optional[PaymentReturnV10] = field(
        default=None,
        metadata={
            "name": "PmtRtr",
            "type": "Element",
