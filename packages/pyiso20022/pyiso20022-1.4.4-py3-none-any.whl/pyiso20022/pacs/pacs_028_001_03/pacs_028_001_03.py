...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.028.001.03"
...
class FitoFipaymentStatusRequestV03:
    class Meta:
        name = "FIToFIPaymentStatusRequestV03"
    ...
    tx_inf: List[PaymentTransaction113] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_sts_req: Optional[FitoFipaymentStatusRequestV03] = field(
        default=None,
        metadata={
