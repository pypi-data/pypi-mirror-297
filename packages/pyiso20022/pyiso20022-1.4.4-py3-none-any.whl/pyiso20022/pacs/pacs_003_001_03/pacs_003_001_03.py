...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.003.001.03"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pacs.003.001.03",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class DirectDebitTransactionInformation12:
...
@dataclass
class FitoFicustomerDirectDebitV03:
    class Meta:
    ...
    drct_dbt_tx_inf: List[DirectDebitTransactionInformation12] = field(
        default_factory=list,
        metadata={
            "name": "DrctDbtTxInf",
            "type": "Element",
...
class Document:
    ...
    fito_ficstmr_drct_dbt: Optional[FitoFicustomerDirectDebitV03] = field(
        default=None,
        metadata={
