...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.008.001.03"
...
@dataclass
class CreditTransferTransaction2:
...
@dataclass
class FitoFicustomerCreditTransferV03:
    class Meta:
    ...
    cdt_trf_tx_inf: List[CreditTransferTransaction2] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTxInf",
            "type": "Element",
...
class Document:
    ...
    fito_ficstmr_cdt_trf: Optional[FitoFicustomerCreditTransferV03] = field(
        default=None,
        metadata={
