...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.08"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.08",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
class OriginalGroupHeader11:
    ...
    rvsl_rsn_inf: List[PaymentReversalReason8] = field(
        default_factory=list,
        metadata={
            "name": "RvslRsnInf",
            "type": "Element",
...
@dataclass
class FitoFipaymentReversalV08:
    class Meta:
    ...
    orgnl_grp_inf: Optional[OriginalGroupHeader11] = field(
        default=None,
        metadata={
            "name": "OrgnlGrpInf",
            "type": "Element",
    ...
    tx_inf: List[PaymentTransaction88] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_rvsl: Optional[FitoFipaymentReversalV08] = field(
        default=None,
        metadata={
            "name": "FIToFIPmtRvsl",
            "type": "Element",
