...
@dataclass
class FitoFipaymentStatusRequestV06:
    class Meta:
        name = "FIToFIPaymentStatusRequestV06"

    grp_hdr: Optional[GroupHeader109] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    tx_inf: List[PaymentTransaction158] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_sts_req: Optional[FitoFipaymentStatusRequestV06] = field(
        default=None,
        metadata={
