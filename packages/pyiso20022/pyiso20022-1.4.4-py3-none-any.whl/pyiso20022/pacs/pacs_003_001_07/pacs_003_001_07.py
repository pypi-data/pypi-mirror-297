...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.003.001.07"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pacs.003.001.07",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
class GroupHeader50:
    ...
    sttlm_inf: Optional[SettlementInstruction2] = field(
        default=None,
        metadata={
            "name": "SttlmInf",
            "type": "Element",
...
@dataclass
class DirectDebitTransactionInformation21:
    ...
    drct_dbt_tx: Optional[DirectDebitTransaction9] = field(
        default=None,
        metadata={
            "name": "DrctDbtTx",
            "type": "Element",
...
@dataclass
class FitoFicustomerDirectDebitV07:
    class Meta:
        name = "FIToFICustomerDirectDebitV07"

    grp_hdr: Optional[GroupHeader50] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    drct_dbt_tx_inf: List[DirectDebitTransactionInformation21] = field(
        default_factory=list,
        metadata={
            "name": "DrctDbtTxInf",
            "type": "Element",
...
class Document:
    ...
    fito_ficstmr_drct_dbt: Optional[FitoFicustomerDirectDebitV07] = field(
        default=None,
        metadata={
