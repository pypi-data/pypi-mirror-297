...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:head.001.001.03"
...
@dataclass
class BusinessApplicationHeader7:
...
class BusinessApplicationHeaderV03:
    ...
    rltd: List[BusinessApplicationHeader7] = field(
        default_factory=list,
        metadata={
            "name": "Rltd",
            "type": "Element",
...
@dataclass
class AppHdr(BusinessApplicationHeaderV03):
    class Meta:
        namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.03"
