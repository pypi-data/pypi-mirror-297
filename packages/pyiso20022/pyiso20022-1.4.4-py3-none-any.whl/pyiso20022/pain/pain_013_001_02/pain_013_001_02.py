...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.013.001.02"
...
@dataclass
class CreditTransferTransaction5:
...
class PaymentInstruction8:
    ...
    cdt_trf_tx: List[CreditTransferTransaction5] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTx",
            "type": "Element",
...
@dataclass
class CreditorPaymentActivationRequestV02:
    ...
    pmt_inf: List[PaymentInstruction8] = field(
        default_factory=list,
        metadata={
            "name": "PmtInf",
            "type": "Element",
...
class Document:
    ...
    cdtr_pmt_actvtn_req: Optional[CreditorPaymentActivationRequestV02] = field(
        default=None,
        metadata={
