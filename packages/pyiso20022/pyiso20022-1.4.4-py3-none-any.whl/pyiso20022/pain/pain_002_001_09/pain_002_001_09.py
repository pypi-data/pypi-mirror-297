...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.09"
...
@dataclass
class StatusReasonInformation11:
...
class OriginalGroupHeader13:
    ...
    sts_rsn_inf: List[StatusReasonInformation11] = field(
        default_factory=list,
        metadata={
            "name": "StsRsnInf",
            "type": "Element",
...
@dataclass
class OriginalPaymentInstruction27:
    ...
    tx_inf_and_sts: List[PaymentTransaction92] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
@dataclass
class CustomerPaymentStatusReportV09:
    grp_hdr: Optional[GroupHeader74] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    orgnl_grp_inf_and_sts: Optional[OriginalGroupHeader13] = field(
        default=None,
        metadata={
    ...
    orgnl_pmt_inf_and_sts: List[OriginalPaymentInstruction27] = field(
        default_factory=list,
        metadata={
...
class Document:
    ...
    cstmr_pmt_sts_rpt: Optional[CustomerPaymentStatusReportV09] = field(
        default=None,
        metadata={
            "name": "CstmrPmtStsRpt",
            "type": "Element",
