...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.013.001.05"
...
@dataclass
class CreditorPaymentActivationRequestV05:
    ...
    pmt_inf: List[PaymentInstruction19] = field(
        default_factory=list,
        metadata={
            "name": "PmtInf",
            "type": "Element",
...
class Document:
    ...
    cdtr_pmt_actvtn_req: Optional[CreditorPaymentActivationRequestV05] = field(
        default=None,
        metadata={
