...
class Cheque19:
    ...
    chq_fr: Optional[NameAndAddress18] = field(
        default=None,
        metadata={
            "name": "ChqFr",
            "type": "Element",
    ...
    dlvr_to: Optional[NameAndAddress18] = field(
        default=None,
        metadata={
            "name": "DlvrTo",
            "type": "Element",
...
@dataclass
class CreditTransferTransaction65:
    ...
    chq_instr: Optional[Cheque19] = field(
        default=None,
        metadata={
            "name": "ChqInstr",
            "type": "Element",
...
class PaymentInstruction46:
    ...
    cdt_trf_tx: List[CreditTransferTransaction65] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTx",
            "type": "Element",
...
@dataclass
class CreditorPaymentActivationRequestV11:
    grp_hdr: Optional[GroupHeader112] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    pmt_inf: List[PaymentInstruction46] = field(
        default_factory=list,
        metadata={
            "name": "PmtInf",
            "type": "Element",
...
class Document:
    ...
    cdtr_pmt_actvtn_req: Optional[CreditorPaymentActivationRequestV11] = field(
        default=None,
        metadata={
