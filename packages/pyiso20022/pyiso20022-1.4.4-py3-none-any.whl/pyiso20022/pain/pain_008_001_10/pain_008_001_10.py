...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.10"
...
class PaymentInstruction39:
    ...
    drct_dbt_tx_inf: List[DirectDebitTransactionInformation28] = field(
        default_factory=list,
        metadata={
            "name": "DrctDbtTxInf",
            "type": "Element",
...
class CustomerDirectDebitInitiationV10:
    ...
    pmt_inf: List[PaymentInstruction39] = field(
        default_factory=list,
        metadata={
            "name": "PmtInf",
            "type": "Element",
...
class Document:
    ...
    cstmr_drct_dbt_initn: Optional[CustomerDirectDebitInitiationV10] = field(
        default=None,
        metadata={
