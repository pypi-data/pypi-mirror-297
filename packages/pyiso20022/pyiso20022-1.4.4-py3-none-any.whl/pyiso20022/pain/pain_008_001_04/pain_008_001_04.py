...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.04"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pain.008.001.04",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
class PaymentInstruction10:
    ...
    drct_dbt_tx_inf: List[DirectDebitTransactionInformation13] = field(
        default_factory=list,
        metadata={
            "name": "DrctDbtTxInf",
            "type": "Element",
...
class CustomerDirectDebitInitiationV04:
    ...
    pmt_inf: List[PaymentInstruction10] = field(
        default_factory=list,
        metadata={
            "name": "PmtInf",
            "type": "Element",
...
class Document:
    ...
    cstmr_drct_dbt_initn: Optional[CustomerDirectDebitInitiationV04] = field(
        default=None,
        metadata={
