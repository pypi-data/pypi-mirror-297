...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.10"
...
class OriginalPaymentInstruction32:
    ...
    tx_inf_and_sts: List[PaymentTransaction105] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
class CustomerPaymentStatusReportV10:
    ...
    orgnl_pmt_inf_and_sts: List[OriginalPaymentInstruction32] = field(
        default_factory=list,
        metadata={
...
class Document:
    ...
    cstmr_pmt_sts_rpt: Optional[CustomerPaymentStatusReportV10] = field(
        default=None,
        metadata={
            "name": "CstmrPmtStsRpt",
            "type": "Element",
