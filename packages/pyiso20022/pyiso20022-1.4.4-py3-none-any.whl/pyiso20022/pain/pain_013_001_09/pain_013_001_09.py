...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.013.001.09"
...
class PaymentInstruction41:
    ...
    cdt_trf_tx: List[CreditTransferTransaction55] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTx",
            "type": "Element",
...
@dataclass
class CreditorPaymentActivationRequestV09:
    ...
    pmt_inf: List[PaymentInstruction41] = field(
        default_factory=list,
        metadata={
            "name": "PmtInf",
            "type": "Element",
...
class Document:
    ...
    cdtr_pmt_actvtn_req: Optional[CreditorPaymentActivationRequestV09] = field(
        default=None,
        metadata={
