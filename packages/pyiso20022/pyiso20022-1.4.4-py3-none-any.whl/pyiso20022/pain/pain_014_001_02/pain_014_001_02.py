...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.014.001.02"
...
@dataclass
class AmendmentInformationDetails9:
...
@dataclass
class MandateRelatedInformation9:
    ...
    amdmnt_inf_dtls: Optional[AmendmentInformationDetails9] = field(
        default=None,
        metadata={
            "name": "AmdmntInfDtls",
            "type": "Element",
...
@dataclass
class OriginalTransactionReference17:
    ...
    mndt_rltd_inf: Optional[MandateRelatedInformation9] = field(
        default=None,
        metadata={
            "name": "MndtRltdInf",
            "type": "Element",
...
class PaymentTransaction41:
    ...
    orgnl_tx_ref: Optional[OriginalTransactionReference17] = field(
        default=None,
        metadata={
            "name": "OrgnlTxRef",
            "type": "Element",
...
class OriginalPaymentInstruction5:
    ...
    tx_inf_and_sts: List[PaymentTransaction41] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
@dataclass
class CreditorPaymentActivationRequestStatusReportV02:
    ...
    orgnl_pmt_inf_and_sts: List[OriginalPaymentInstruction5] = field(
        default_factory=list,
        metadata={
