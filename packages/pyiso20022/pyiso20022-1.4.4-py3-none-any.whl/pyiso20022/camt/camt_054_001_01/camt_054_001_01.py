...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.01"
...
class AlternateSecurityIdentification2:
    tp: Optional[str] = field(
        ...
        metadata={
            "name": "Tp",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.054.001.01",
            "required": True,
            "min_length": 1,
            "max_length": 35,
        },
...
class NotificationEntry1:
    ...
    sts: Optional[EntryStatus4Code] = field(
        default=None,
        metadata={
            "name": "Sts",
            "type": "Element",
...
class AccountNotification1:
    ...
    ntry: List[NotificationEntry1] = field(
        default_factory=list,
        metadata={
            "name": "Ntry",
            "type": "Element",
...
@dataclass
class BankToCustomerDebitCreditNotificationV01:
    ...
    ntfctn: List[AccountNotification1] = field(
        default_factory=list,
        metadata={
            "name": "Ntfctn",
            "type": "Element",
...
class Document:
    ...
    bk_to_cstmr_dbt_cdt_ntfctn_v01: Optional[
        BankToCustomerDebitCreditNotificationV01
    ] = field(
        default=None,
        metadata={
            "name": "BkToCstmrDbtCdtNtfctnV01",
            "type": "Element",
            "required": True,
        },
    )
