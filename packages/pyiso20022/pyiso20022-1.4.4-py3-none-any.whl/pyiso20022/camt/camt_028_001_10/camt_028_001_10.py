...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.028.001.10"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.028.001.10",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class PaymentComplementaryInformation9:
...
@dataclass
class AdditionalPaymentInformationV10:
    ...
    inf: Optional[PaymentComplementaryInformation9] = field(
        default=None,
        metadata={
            "name": "Inf",
            "type": "Element",
...
class Document:
    ...
    addtl_pmt_inf: Optional[AdditionalPaymentInformationV10] = field(
        default=None,
        metadata={
            "name": "AddtlPmtInf",
            "type": "Element",
