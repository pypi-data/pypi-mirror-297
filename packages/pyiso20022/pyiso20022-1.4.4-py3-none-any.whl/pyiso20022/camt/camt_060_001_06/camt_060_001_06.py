...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.060.001.06"
...
@dataclass
class ReportingPeriod5:
    fr_to_dt: Optional[DatePeriod3] = field(
        default=None,
        metadata={
            "name": "FrToDt",
            "type": "Element",
    ...
    fr_to_tm: Optional[TimePeriodDetails1] = field(
        default=None,
        metadata={
            "name": "FrToTm",
            "type": "Element",
...
class GroupHeader77:
    ...
    msg_sndr: Optional[Party40Choice] = field(
        default=None,
        metadata={
            "name": "MsgSndr",
            "type": "Element",
...
class ReportingRequest6:
    ...
    acct_ownr: Optional[Party40Choice] = field(
        default=None,
        metadata={
            "name": "AcctOwnr",
            "type": "Element",
    ...
    acct_svcr: Optional[BranchAndFinancialInstitutionIdentification6] = field(
        default=None,
        metadata={
            "name": "AcctSvcr",
            "type": "Element",
    ...
    rptg_prd: Optional[ReportingPeriod5] = field(
        default=None,
        metadata={
            "name": "RptgPrd",
            "type": "Element",
    ...
    reqd_tx_tp: Optional[TransactionType2] = field(
        default=None,
        metadata={
            "name": "ReqdTxTp",
            "type": "Element",
...
@dataclass
class AccountReportingRequestV06:
    grp_hdr: Optional[GroupHeader77] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    rptg_req: List[ReportingRequest6] = field(
        default_factory=list,
        metadata={
            "name": "RptgReq",
            "type": "Element",
...
class Document:
    ...
    acct_rptg_req: Optional[AccountReportingRequestV06] = field(
        default=None,
        metadata={
            "name": "AcctRptgReq",
            "type": "Element",
