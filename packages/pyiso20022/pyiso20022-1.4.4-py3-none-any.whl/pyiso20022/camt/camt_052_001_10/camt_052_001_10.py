...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.10"
...
class BankToCustomerAccountReportV10:
    ...
    rpt: List[AccountReport31] = field(
        default_factory=list,
        metadata={
            "name": "Rpt",
            "type": "Element",
...
class Document:
    ...
    bk_to_cstmr_acct_rpt: Optional[BankToCustomerAccountReportV10] = field(
        default=None,
        metadata={
