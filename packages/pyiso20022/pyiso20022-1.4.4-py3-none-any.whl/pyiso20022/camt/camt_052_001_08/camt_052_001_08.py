...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.08"
...
@dataclass
class BalanceType13:
    cd_or_prtry: Optional[BalanceType10Choice] = field(
        default=None,
        metadata={
            "name": "CdOrPrtry",
            "type": "Element",
...
class CreditLine3:
    ...
    tp: Optional[CreditLineType1Choice] = field(
        default=None,
        metadata={
            "name": "Tp",
            "type": "Element",
...
@dataclass
class CashBalance8:
    tp: Optional[BalanceType13] = field(
        default=None,
        metadata={
            "name": "Tp",
            "type": "Element",
...
class CardEntry4:
    ...
    pre_pd_acct: Optional[CashAccount38] = field(
        default=None,
        metadata={
            "name": "PrePdAcct",
            "type": "Element",
...
class CashAccount39:
    ...
    ownr: Optional[PartyIdentification135] = field(
        default=None,
        metadata={
            "name": "Ownr",
            "type": "Element",
    ...
    svcr: Optional[BranchAndFinancialInstitutionIdentification6] = field(
        default=None,
        metadata={
            "name": "Svcr",
            "type": "Element",
...
class ProprietaryParty5:
    ...
    pty: Optional[Party40Choice] = field(
        default=None,
        metadata={
            "name": "Pty",
            "type": "Element",
...
class TransactionAgents5:
    ...
    rcvg_agt: Optional[BranchAndFinancialInstitutionIdentification6] = field(
        default=None,
        metadata={
            "name": "RcvgAgt",
            "type": "Element",
    ...
    dlvrg_agt: Optional[BranchAndFinancialInstitutionIdentification6] = field(
        default=None,
        metadata={
            "name": "DlvrgAgt",
            "type": "Element",
    ...
    issg_agt: Optional[BranchAndFinancialInstitutionIdentification6] = field(
        default=None,
        metadata={
            "name": "IssgAgt",
            "type": "Element",
    ...
    sttlm_plc: Optional[BranchAndFinancialInstitutionIdentification6] = field(
        default=None,
        metadata={
            "name": "SttlmPlc",
            "type": "Element",
...
class TransactionParties6:
    ...
    tradg_pty: Optional[Party40Choice] = field(
        default=None,
        metadata={
            "name": "TradgPty",
            "type": "Element",
...
class EntryTransaction10:
    ...
    rltd_pties: Optional[TransactionParties6] = field(
        default=None,
        metadata={
            "name": "RltdPties",
            "type": "Element",
    ...
    rltd_agts: Optional[TransactionAgents5] = field(
        default=None,
        metadata={
            "name": "RltdAgts",
            "type": "Element",
    ...
    rtr_inf: Optional[PaymentReturnReason5] = field(
        default=None,
        metadata={
            "name": "RtrInf",
            "type": "Element",
    ...
    card_tx: Optional[CardTransaction17] = field(
        default=None,
        metadata={
            "name": "CardTx",
            "type": "Element",
...
class ReportEntry10:
    ...
    card_tx: Optional[CardEntry4] = field(
        default=None,
        metadata={
            "name": "CardTx",
            "type": "Element",
...
class AccountReport25:
    ...
    rpt_pgntn: Optional[Pagination1] = field(
        default=None,
        metadata={
            "name": "RptPgntn",
            "type": "Element",
    ...
    acct: Optional[CashAccount39] = field(
        default=None,
        metadata={
            "name": "Acct",
            "type": "Element",
    ...
    rltd_acct: Optional[CashAccount38] = field(
        default=None,
        metadata={
            "name": "RltdAcct",
            "type": "Element",
...
@dataclass
class BankToCustomerAccountReportV08:
    grp_hdr: Optional[GroupHeader81] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    rpt: List[AccountReport25] = field(
        default_factory=list,
        metadata={
            "name": "Rpt",
            "type": "Element",
...
class Document:
    ...
    bk_to_cstmr_acct_rpt: Optional[BankToCustomerAccountReportV08] = field(
        default=None,
        metadata={
