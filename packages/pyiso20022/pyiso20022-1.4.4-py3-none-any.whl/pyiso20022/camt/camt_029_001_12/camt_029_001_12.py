...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.12"
...
class ResolutionData4:
    ...
    compstn: Optional[Compensation4] = field(
        default=None,
        metadata={
            "name": "Compstn",
            "type": "Element",
    ...
    chrgs_inf: List[Charges13] = field(
        default_factory=list,
        metadata={
            "name": "ChrgsInf",
            "type": "Element",
...
class PaymentTransaction147:
    ...
    rsltn_rltd_inf: Optional[ResolutionData4] = field(
        default=None,
        metadata={
            "name": "RsltnRltdInf",
            "type": "Element",
...
class OriginalPaymentInstruction43:
    ...
    tx_inf_and_sts: List[PaymentTransaction139] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
class UnderlyingTransaction31:
    ...
    orgnl_pmt_inf_and_sts: List[OriginalPaymentInstruction43] = field(
        default_factory=list,
        metadata={
    ...
    tx_inf_and_sts: List[PaymentTransaction148] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
@dataclass
class ResolutionOfInvestigationV12:
    ...
    cxl_dtls: List[UnderlyingTransaction31] = field(
        default_factory=list,
        metadata={
            "name": "CxlDtls",
            "type": "Element",
    ...
    mod_dtls: Optional[PaymentTransaction147] = field(
        default=None,
        metadata={
            "name": "ModDtls",
            "type": "Element",
...
class Document:
    ...
    rsltn_of_invstgtn: Optional[ResolutionOfInvestigationV12] = field(
        default=None,
        metadata={
