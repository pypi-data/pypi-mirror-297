...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.028.001.06"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.028.001.06",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class PaymentComplementaryInformation5:
...
@dataclass
class AdditionalPaymentInformationV06:
    ...
    inf: Optional[PaymentComplementaryInformation5] = field(
        default=None,
        metadata={
            "name": "Inf",
            "type": "Element",
...
class Document:
    ...
    addtl_pmt_inf: Optional[AdditionalPaymentInformationV06] = field(
        default=None,
        metadata={
            "name": "AddtlPmtInf",
            "type": "Element",
