...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.03"
...
@dataclass
class TotalTransactions3:
    ttl_ntries: Optional[NumberAndSumOfTransactions3] = field(
        default=None,
        metadata={
            "name": "TtlNtries",
            "type": "Element",
...
class EntryTransaction3:
    ...
    intrst: List[TransactionInterest3] = field(
        default_factory=list,
        metadata={
            "name": "Intrst",
            "type": "Element",
...
class EntryDetails2:
    ...
    tx_dtls: List[EntryTransaction3] = field(
        default_factory=list,
        metadata={
            "name": "TxDtls",
            "type": "Element",
...
class ReportEntry3:
    ...
    ntry_dtls: List[EntryDetails2] = field(
        default_factory=list,
        metadata={
            "name": "NtryDtls",
            "type": "Element",
...
class AccountReport12:
    ...
    txs_summry: Optional[TotalTransactions3] = field(
        default=None,
        metadata={
            "name": "TxsSummry",
            "type": "Element",
...
@dataclass
class BankToCustomerAccountReportV03:
    ...
    rpt: List[AccountReport12] = field(
        default_factory=list,
        metadata={
            "name": "Rpt",
            "type": "Element",
...
class Document:
    ...
    bk_to_cstmr_acct_rpt: Optional[BankToCustomerAccountReportV03] = field(
        default=None,
        metadata={
