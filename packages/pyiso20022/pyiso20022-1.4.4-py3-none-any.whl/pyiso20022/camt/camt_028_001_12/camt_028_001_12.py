...
@dataclass
class PaymentComplementaryInformation11:
...
@dataclass
class AdditionalPaymentInformationV12:
    ...
    inf: Optional[PaymentComplementaryInformation11] = field(
        default=None,
        metadata={
            "name": "Inf",
            "type": "Element",
...
class Document:
    ...
    addtl_pmt_inf: Optional[AdditionalPaymentInformationV12] = field(
        default=None,
        metadata={
            "name": "AddtlPmtInf",
            "type": "Element",
