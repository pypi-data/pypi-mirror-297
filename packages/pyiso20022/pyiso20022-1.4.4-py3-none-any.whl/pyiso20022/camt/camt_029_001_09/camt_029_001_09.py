...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.09"
...
class ResolutionData1:
    ...
    compstn: Optional[Compensation2] = field(
        default=None,
        metadata={
            "name": "Compstn",
            "type": "Element",
...
class OriginalTransactionReference28:
    ...
    mndt_rltd_inf: Optional[MandateRelatedInformation14] = field(
        default=None,
        metadata={
            "name": "MndtRltdInf",
            "type": "Element",
...
class PaymentTransaction102:
    ...
    rsltn_rltd_inf: Optional[ResolutionData1] = field(
        default=None,
        metadata={
            "name": "RsltnRltdInf",
            "type": "Element",
    ...
    orgnl_tx_ref: Optional[OriginalTransactionReference28] = field(
        default=None,
        metadata={
            "name": "OrgnlTxRef",
            "type": "Element",
...
@dataclass
class OriginalPaymentInstruction30:
    ...
    tx_inf_and_sts: List[PaymentTransaction103] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
class UnderlyingTransaction22:
    ...
    orgnl_pmt_inf_and_sts: List[OriginalPaymentInstruction30] = field(
        default_factory=list,
        metadata={
    ...
    tx_inf_and_sts: List[PaymentTransaction102] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
@dataclass
class ResolutionOfInvestigationV09:
    ...
    cxl_dtls: List[UnderlyingTransaction22] = field(
        default_factory=list,
        metadata={
            "name": "CxlDtls",
            "type": "Element",
    ...
    mod_dtls: Optional[PaymentTransaction107] = field(
        default=None,
        metadata={
            "name": "ModDtls",
            "type": "Element",
...
class Document:
    ...
    rsltn_of_invstgtn: Optional[ResolutionOfInvestigationV09] = field(
        default=None,
        metadata={
