...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.026.001.08"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.026.001.08",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
class UnableToApplyIncorrectInformation4Code(Enum):
    IN01 = "IN01"
    IN02 = "IN02"
    IN03 = "IN03"
    IN04 = "IN04"
...
class UnableToApplyMissingInformation3Code(Enum):
    MS01 = "MS01"
    MS02 = "MS02"
    MS03 = "MS03"
    MS04 = "MS04"
...
@dataclass
class UnableToApplyIncorrect1:
    cd: Optional[UnableToApplyIncorrectInformation4Code] = field(
        default=None,
        metadata={
            "name": "Cd",
            "type": "Element",
...
@dataclass
class UnableToApplyMissing1:
    cd: Optional[UnableToApplyMissingInformation3Code] = field(
        default=None,
        metadata={
            "name": "Cd",
            "type": "Element",
...
@dataclass
class UnderlyingStatementEntry3:
...
@dataclass
class MissingOrIncorrectInformation3:
    ...
    mssng_inf: List[UnableToApplyMissing1] = field(
        default_factory=list,
        metadata={
            "name": "MssngInf",
            "type": "Element",
    ...
    incrrct_inf: List[UnableToApplyIncorrect1] = field(
        default_factory=list,
        metadata={
            "name": "IncrrctInf",
            "type": "Element",
...
@dataclass
class UnableToApplyJustification3Choice:
    ...
    mssng_or_incrrct_inf: Optional[MissingOrIncorrectInformation3] = field(
        default=None,
        metadata={
...
@dataclass
class UnderlyingPaymentInstruction6:
...
@dataclass
class UnderlyingPaymentTransaction5:
    orgnl_grp_inf: Optional[UnderlyingGroupInformation1] = field(
        default=None,
        metadata={
            "name": "OrgnlGrpInf",
...
@dataclass
class UnderlyingTransaction6Choice:
    initn: Optional[UnderlyingPaymentInstruction6] = field(
        default=None,
        metadata={
            "name": "Initn",
            "type": "Element",
    ...
    intr_bk: Optional[UnderlyingPaymentTransaction5] = field(
        default=None,
        metadata={
            "name": "IntrBk",
            "type": "Element",
    ...
    stmt_ntry: Optional[UnderlyingStatementEntry3] = field(
        default=None,
        metadata={
            "name": "StmtNtry",
            "type": "Element",
...
class UnableToApplyV08:
    ...
    undrlyg: Optional[UnderlyingTransaction6Choice] = field(
        default=None,
        metadata={
            "name": "Undrlyg",
            "type": "Element",
    ...
    justfn: Optional[UnableToApplyJustification3Choice] = field(
        default=None,
        metadata={
            "name": "Justfn",
            "type": "Element",
...
class Document:
    ...
    ubl_to_apply: Optional[UnableToApplyV08] = field(
        default=None,
        metadata={
            "name": "UblToApply",
            "type": "Element",
