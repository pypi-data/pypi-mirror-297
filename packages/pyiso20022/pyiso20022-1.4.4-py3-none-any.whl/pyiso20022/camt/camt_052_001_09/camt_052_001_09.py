...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.09"
...
@dataclass
class BankToCustomerAccountReportV09:
    ...
    rpt: List[AccountReport30] = field(
        default_factory=list,
        metadata={
            "name": "Rpt",
            "type": "Element",
...
class Document:
    ...
    bk_to_cstmr_acct_rpt: Optional[BankToCustomerAccountReportV09] = field(
        default=None,
        metadata={
