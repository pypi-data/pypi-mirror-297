...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.056.001.04"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.056.001.04",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
class CancellationReason5Code(Enum):
    DUPL = "DUPL"
    AGNT = "AGNT"
    CURR = "CURR"
    CUST = "CUST"
...
@dataclass
class CancellationReason14Choice:
    cd: Optional[CancellationReason5Code] = field(
        default=None,
        metadata={
            "name": "Cd",
            "type": "Element",
...
@dataclass
class PaymentCancellationReason2:
    ...
    rsn: Optional[CancellationReason14Choice] = field(
        default=None,
        metadata={
            "name": "Rsn",
            "type": "Element",
...
class OriginalGroupHeader4:
    ...
    cxl_rsn_inf: List[PaymentCancellationReason2] = field(
        default_factory=list,
        metadata={
            "name": "CxlRsnInf",
            "type": "Element",
...
@dataclass
class OriginalTransactionReference20:
...
class PaymentTransaction55:
    ...
    orgnl_tx_ref: Optional[OriginalTransactionReference20] = field(
        default=None,
        metadata={
            "name": "OrgnlTxRef",
            "type": "Element",
...
@dataclass
class UnderlyingTransaction10:
    orgnl_grp_inf_and_cxl: Optional[OriginalGroupHeader4] = field(
        default=None,
        metadata={
    ...
    tx_inf: List[PaymentTransaction55] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
@dataclass
class FitoFipaymentCancellationRequestV04:
    class Meta:
    ...
    undrlyg: List[UnderlyingTransaction10] = field(
        default_factory=list,
        metadata={
            "name": "Undrlyg",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_cxl_req: Optional[FitoFipaymentCancellationRequestV04] = field(
        default=None,
        metadata={
