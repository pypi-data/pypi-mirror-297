...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class BankToCustomerDebitCreditNotificationV04:
    ...
    ntfctn: List[AccountNotification7] = field(
        default_factory=list,
        metadata={
            "name": "Ntfctn",
            "type": "Element",
