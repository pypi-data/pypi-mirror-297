...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.013.001.07"
...
class PaymentInstruction31:
    ...
    cdt_trf_tx: List[CreditTransferTransaction35] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTx",
            "type": "Element",
...
@dataclass
class CreditorPaymentActivationRequestV07:
    grp_hdr: Optional[GroupHeader78] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    pmt_inf: List[PaymentInstruction31] = field(
        default_factory=list,
        metadata={
            "name": "PmtInf",
            "type": "Element",
...
class Document:
    ...
    cdtr_pmt_actvtn_req: Optional[CreditorPaymentActivationRequestV07] = field(
        default=None,
        metadata={
