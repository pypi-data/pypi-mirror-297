...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.10"
...
class PaymentInstruction34:
    ...
    cdt_trf_tx_inf: List[CreditTransferTransaction40] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTxInf",
            "type": "Element",
...
class CustomerCreditTransferInitiationV10:
    ...
    pmt_inf: List[PaymentInstruction34] = field(
        default_factory=list,
        metadata={
            "name": "PmtInf",
            "type": "Element",
...
class Document:
    ...
    cstmr_cdt_trf_initn: Optional[CustomerCreditTransferInitiationV10] = field(
        default=None,
        metadata={
