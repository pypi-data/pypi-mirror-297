...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.013.001.04"
...
@dataclass
class CreditTransferTransaction21:
...
class PaymentInstruction17:
    ...
    cdt_trf_tx: List[CreditTransferTransaction21] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTx",
            "type": "Element",
...
class CreditorPaymentActivationRequestV04:
    ...
    pmt_inf: List[PaymentInstruction17] = field(
        default_factory=list,
        metadata={
            "name": "PmtInf",
            "type": "Element",
...
class Document:
    ...
    cdtr_pmt_actvtn_req: Optional[CreditorPaymentActivationRequestV04] = field(
        default=None,
        metadata={
