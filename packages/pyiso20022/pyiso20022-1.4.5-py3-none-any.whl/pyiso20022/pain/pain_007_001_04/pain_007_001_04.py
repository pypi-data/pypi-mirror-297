...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.007.001.04"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pain.007.001.04",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class OriginalPaymentInstruction7:
    ...
    tx_inf: List[PaymentTransaction42] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
@dataclass
class CustomerPaymentReversalV04:
    ...
    orgnl_pmt_inf_and_rvsl: List[OriginalPaymentInstruction7] = field(
        default_factory=list,
        metadata={
...
class Document:
    ...
    cstmr_pmt_rvsl: Optional[CustomerPaymentReversalV04] = field(
        default=None,
        metadata={
            "name": "CstmrPmtRvsl",
            "type": "Element",
