...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.013.001.10"
...
@dataclass
class CreditTransferTransaction57:
    ...
    chq_instr: Optional[Cheque16] = field(
        default=None,
        metadata={
            "name": "ChqInstr",
            "type": "Element",
...
class PaymentInstruction42:
    ...
    cdt_trf_tx: List[CreditTransferTransaction57] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTx",
            "type": "Element",
...
@dataclass
class CreditorPaymentActivationRequestV10:
    grp_hdr: Optional[GroupHeader105] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    pmt_inf: List[PaymentInstruction42] = field(
        default_factory=list,
        metadata={
            "name": "PmtInf",
            "type": "Element",
...
class Document:
    ...
    cdtr_pmt_actvtn_req: Optional[CreditorPaymentActivationRequestV10] = field(
        default=None,
        metadata={
