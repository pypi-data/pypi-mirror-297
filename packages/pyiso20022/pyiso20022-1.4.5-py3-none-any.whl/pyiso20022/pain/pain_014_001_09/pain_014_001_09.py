...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.014.001.09"
...
@dataclass
class OriginalGroupInformation30:
...
@dataclass
class OriginalTransactionReference37:
    ...
    pmt_cond: Optional[PaymentCondition1] = field(
        default=None,
        metadata={
            "name": "PmtCond",
            "type": "Element",
...
class PaymentTransaction136:
    ...
    pmt_cond_sts: Optional[PaymentConditionStatus1] = field(
        default=None,
        metadata={
            "name": "PmtCondSts",
            "type": "Element",
    ...
    orgnl_tx_ref: Optional[OriginalTransactionReference37] = field(
        default=None,
        metadata={
            "name": "OrgnlTxRef",
            "type": "Element",
...
@dataclass
class OriginalPaymentInstruction42:
    ...
    tx_inf_and_sts: List[PaymentTransaction136] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
@dataclass
class CreditorPaymentActivationRequestStatusReportV09:
    grp_hdr: Optional[GroupHeader87] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    orgnl_grp_inf_and_sts: Optional[OriginalGroupInformation30] = field(
        default=None,
        metadata={
    ...
    orgnl_pmt_inf_and_sts: List[OriginalPaymentInstruction42] = field(
        default_factory=list,
        metadata={
...
class Document:
    ...
    cdtr_pmt_actvtn_req_sts_rpt: Optional[
        CreditorPaymentActivationRequestStatusReportV09
    ] = field(
        default=None,
        metadata={
