...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.013.001.03"
...
@dataclass
class CreditTransferTransaction10:
...
class PaymentInstruction11:
    ...
    cdt_trf_tx: List[CreditTransferTransaction10] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTx",
            "type": "Element",
...
@dataclass
class CreditorPaymentActivationRequestV03:
    ...
    pmt_inf: List[PaymentInstruction11] = field(
        default_factory=list,
        metadata={
            "name": "PmtInf",
            "type": "Element",
...
class Document:
    ...
    cdtr_pmt_actvtn_req: Optional[CreditorPaymentActivationRequestV03] = field(
        default=None,
        metadata={
