...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.014.001.07"
...
@dataclass
class OriginalTransactionReference29:
...
class PaymentTransaction104:
    ...
    orgnl_tx_ref: Optional[OriginalTransactionReference29] = field(
        default=None,
        metadata={
            "name": "OrgnlTxRef",
            "type": "Element",
...
class OriginalPaymentInstruction31:
    ...
    tx_inf_and_sts: List[PaymentTransaction104] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
class CreditorPaymentActivationRequestStatusReportV07:
    ...
    orgnl_pmt_inf_and_sts: List[OriginalPaymentInstruction31] = field(
        default_factory=list,
        metadata={
