...
class PaymentCondition2:
    ...
    imdt_pmt_rbt: Optional[AmountOrRate1Choice] = field(
        default=None,
        metadata={
            "name": "ImdtPmtRbt",
            "type": "Element",
...
class Document15:
    ...
    dgtl_sgntr: Optional[PartyAndSignature4] = field(
        default=None,
        metadata={
            "name": "DgtlSgntr",
            "type": "Element",
...
@dataclass
class OriginalGroupInformation32:
...
@dataclass
class OriginalTransactionReference40:
    ...
    xpry_dt: Optional[DateAndDateTime2Choice] = field(
        default=None,
        metadata={
            "name": "XpryDt",
            "type": "Element",
    ...
    pmt_cond: Optional[PaymentCondition2] = field(
        default=None,
        metadata={
            "name": "PmtCond",
            "type": "Element",
    ...
    nclsd_file: List[Document15] = field(
        default_factory=list,
        metadata={
            "name": "NclsdFile",
            "type": "Element",
...
class PaymentTransaction150:
    ...
    pmt_cond_sts: Optional[PaymentConditionStatus2] = field(
        default=None,
        metadata={
            "name": "PmtCondSts",
            "type": "Element",
    ...
    orgnl_tx_ref: Optional[OriginalTransactionReference40] = field(
        default=None,
        metadata={
            "name": "OrgnlTxRef",
            "type": "Element",
...
@dataclass
class OriginalPaymentInstruction47:
    ...
    tx_inf_and_sts: List[PaymentTransaction150] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
@dataclass
class CreditorPaymentActivationRequestStatusReportV11:
    grp_hdr: Optional[GroupHeader111] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    orgnl_grp_inf_and_sts: Optional[OriginalGroupInformation32] = field(
        default=None,
        metadata={
    ...
    orgnl_pmt_inf_and_sts: List[OriginalPaymentInstruction47] = field(
        default_factory=list,
        metadata={
