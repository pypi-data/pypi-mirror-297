...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.014.001.04"
...
@dataclass
class OriginalTransactionReference21:
...
class PaymentTransaction59:
    ...
    orgnl_tx_ref: Optional[OriginalTransactionReference21] = field(
        default=None,
        metadata={
            "name": "OrgnlTxRef",
            "type": "Element",
...
@dataclass
class OriginalPaymentInstruction14:
    ...
    tx_inf_and_sts: List[PaymentTransaction59] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
@dataclass
class CreditorPaymentActivationRequestStatusReportV04:
    ...
    orgnl_pmt_inf_and_sts: List[OriginalPaymentInstruction14] = field(
        default_factory=list,
        metadata={
