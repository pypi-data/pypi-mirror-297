...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.05"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pain.001.001.05",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class CreditTransferTransaction6:
...
class PaymentInstruction9:
    ...
    cdt_trf_tx_inf: List[CreditTransferTransaction6] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTxInf",
            "type": "Element",
...
@dataclass
class CustomerCreditTransferInitiationV05:
    ...
    pmt_inf: List[PaymentInstruction9] = field(
        default_factory=list,
        metadata={
            "name": "PmtInf",
            "type": "Element",
...
class Document:
    ...
    cstmr_cdt_trf_initn: Optional[CustomerCreditTransferInitiationV05] = field(
        default=None,
        metadata={
