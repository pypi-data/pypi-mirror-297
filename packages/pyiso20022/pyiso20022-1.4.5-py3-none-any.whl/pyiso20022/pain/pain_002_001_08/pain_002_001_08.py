...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.08"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pain.002.001.08",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class OriginalPaymentInstruction23:
    ...
    tx_inf_and_sts: List[PaymentTransaction82] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
@dataclass
class CustomerPaymentStatusReportV08:
    ...
    orgnl_grp_inf_and_sts: Optional[OriginalGroupHeader7] = field(
        default=None,
        metadata={
    ...
    orgnl_pmt_inf_and_sts: List[OriginalPaymentInstruction23] = field(
        default_factory=list,
        metadata={
...
class Document:
    ...
    cstmr_pmt_sts_rpt: Optional[CustomerPaymentStatusReportV08] = field(
        default=None,
        metadata={
            "name": "CstmrPmtStsRpt",
            "type": "Element",
