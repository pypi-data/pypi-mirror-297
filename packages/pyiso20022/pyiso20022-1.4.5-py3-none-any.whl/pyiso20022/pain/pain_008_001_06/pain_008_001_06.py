...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.06"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pain.008.001.06",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class DirectDebitTransactionInformation19:
...
class PaymentInstruction18:
    ...
    drct_dbt_tx_inf: List[DirectDebitTransactionInformation19] = field(
        default_factory=list,
        metadata={
            "name": "DrctDbtTxInf",
            "type": "Element",
...
@dataclass
class CustomerDirectDebitInitiationV06:
    ...
    pmt_inf: List[PaymentInstruction18] = field(
        default_factory=list,
        metadata={
            "name": "PmtInf",
            "type": "Element",
...
class Document:
    ...
    cstmr_drct_dbt_initn: Optional[CustomerDirectDebitInitiationV06] = field(
        default=None,
        metadata={
