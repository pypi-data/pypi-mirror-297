...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.004.001.05"
...
class OriginalGroupHeader2:
    ...
    rtr_rsn_inf: List[PaymentReturnReason1] = field(
        default_factory=list,
        metadata={
            "name": "RtrRsnInf",
            "type": "Element",
...
@dataclass
class PaymentReturnV05:
    grp_hdr: Optional[GroupHeader54] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    orgnl_grp_inf: Optional[OriginalGroupHeader2] = field(
        default=None,
        metadata={
            "name": "OrgnlGrpInf",
            "type": "Element",
    ...
    tx_inf: List[PaymentTransaction50] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class Document:
    ...
    pmt_rtr: Optional[PaymentReturnV05] = field(
        default=None,
        metadata={
            "name": "PmtRtr",
            "type": "Element",
