...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.01"
...
class ClearingSystemMemberIdentification3Choice:
    id: Optional[str] = field(
        ...
        metadata={
            "name": "Id",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.01",
            "min_length": 1,
            "max_length": 35,
        },
    )
...
class TransactionReversalReason1Code(Enum):
    AC04 = "AC04"
    AM05 = "AM05"
    AG02 = "AG02"
    MD01 = "MD01"
...
@dataclass
class ReversalReason1Choice:
    cd: Optional[TransactionReversalReason1Code] = field(
        default=None,
        metadata={
            "name": "Cd",
            "type": "Element",
...
class ReversalReasonInformation1:
    rvsl_orgtr: Optional[PartyIdentification8] = field(
        default=None,
        metadata={
            "name": "RvslOrgtr",
            "type": "Element",
    ...
    rvsl_rsn: Optional[ReversalReason1Choice] = field(
        default=None,
        metadata={
            "name": "RvslRsn",
            "type": "Element",
    ...
    addtl_rvsl_rsn_inf: List[str] = field(
        default_factory=list,
        metadata={
            "name": "AddtlRvslRsnInf",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.01",
            "min_length": 1,
            "max_length": 105,
...
class OriginalGroupInformation5:
    ...
    rvsl_rsn_inf: List[ReversalReasonInformation1] = field(
        default_factory=list,
        metadata={
            "name": "RvslRsnInf",
            "type": "Element",
...
class GroupHeader9:
    ...
    ttl_rvsd_intr_bk_sttlm_amt: Optional[CurrencyAndAmount] = field(
        default=None,
        metadata={
...
class PaymentTransactionInformation5:
    ...
    orgnl_intr_bk_sttlm_amt: Optional[CurrencyAndAmount] = field(
        default=None,
        metadata={
    ...
    rvsd_intr_bk_sttlm_amt: Optional[CurrencyAndAmount] = field(
        default=None,
        metadata={
    ...
    rvsd_instd_amt: Optional[CurrencyAndAmount] = field(
        default=None,
        metadata={
            "name": "RvsdInstdAmt",
            "type": "Element",
    ...
    compstn_amt: Optional[CurrencyAndAmount] = field(
        default=None,
        metadata={
            "name": "CompstnAmt",
            "type": "Element",
...
class Pacs00700101:
    class Meta:
        name = "pacs.007.001.01"

    grp_hdr: Optional[GroupHeader9] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    orgnl_grp_inf: Optional[OriginalGroupInformation5] = field(
        default=None,
        metadata={
            "name": "OrgnlGrpInf",
            "type": "Element",
    ...
    tx_inf: List[PaymentTransactionInformation5] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class Document:
    ...
    pacs_007_001_01: Optional[Pacs00700101] = field(
        default=None,
        metadata={
            "name": "pacs.007.001.01",
            "type": "Element",
