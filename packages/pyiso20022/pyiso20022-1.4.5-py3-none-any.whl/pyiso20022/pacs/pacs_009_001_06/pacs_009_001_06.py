...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.009.001.06"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pacs.009.001.06",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class CreditTransferTransaction23:
    ...
    undrlyg_cstmr_cdt_trf: Optional[CreditTransferTransaction24] = field(
        default=None,
        metadata={
...
@dataclass
class FinancialInstitutionCreditTransferV06:
    ...
    cdt_trf_tx_inf: List[CreditTransferTransaction23] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTxInf",
            "type": "Element",
...
class Document:
    ...
    ficdt_trf: Optional[FinancialInstitutionCreditTransferV06] = field(
        default=None,
        metadata={
            "name": "FICdtTrf",
            "type": "Element",
