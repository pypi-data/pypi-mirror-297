...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.003.001.08"
...
class GroupHeader94:
    ...
    sttlm_inf: Optional[SettlementInstruction8] = field(
        default=None,
        metadata={
            "name": "SttlmInf",
            "type": "Element",
...
@dataclass
class DirectDebitTransactionInformation24:
...
@dataclass
class FitoFicustomerDirectDebitV08:
    class Meta:
        name = "FIToFICustomerDirectDebitV08"

    grp_hdr: Optional[GroupHeader94] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    drct_dbt_tx_inf: List[DirectDebitTransactionInformation24] = field(
        default_factory=list,
        metadata={
            "name": "DrctDbtTxInf",
            "type": "Element",
...
class Document:
    ...
    fito_ficstmr_drct_dbt: Optional[FitoFicustomerDirectDebitV08] = field(
        default=None,
        metadata={
