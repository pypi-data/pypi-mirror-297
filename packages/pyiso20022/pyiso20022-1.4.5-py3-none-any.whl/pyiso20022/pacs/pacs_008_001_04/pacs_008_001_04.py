...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.008.001.04"
...
@dataclass
class CreditTransferTransaction7:
...
@dataclass
class FitoFicustomerCreditTransferV04:
    class Meta:
    ...
    cdt_trf_tx_inf: List[CreditTransferTransaction7] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTxInf",
            "type": "Element",
...
class Document:
    ...
    fito_ficstmr_cdt_trf: Optional[FitoFicustomerCreditTransferV04] = field(
        default=None,
        metadata={
