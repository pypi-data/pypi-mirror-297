...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.06"
...
@dataclass
class FitoFipaymentStatusReportV06:
    class Meta:
    ...
    orgnl_grp_inf_and_sts: List[OriginalGroupHeader1] = field(
        default_factory=list,
        metadata={
    ...
    tx_inf_and_sts: List[PaymentTransaction52] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_sts_rpt: Optional[FitoFipaymentStatusReportV06] = field(
        default=None,
        metadata={
