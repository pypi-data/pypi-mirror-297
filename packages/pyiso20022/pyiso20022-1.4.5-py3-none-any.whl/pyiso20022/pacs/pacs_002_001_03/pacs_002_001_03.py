...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.03"
...
@dataclass
class FitoFipaymentStatusReportV03:
    class Meta:
        name = "FIToFIPaymentStatusReportV03"

    grp_hdr: Optional[GroupHeader37] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    tx_inf_and_sts: List[PaymentTransactionInformation26] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_sts_rpt: Optional[FitoFipaymentStatusReportV03] = field(
        default=None,
        metadata={
