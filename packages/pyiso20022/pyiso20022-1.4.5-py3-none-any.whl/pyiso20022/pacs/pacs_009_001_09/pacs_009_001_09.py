...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.009.001.09"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pacs.009.001.09",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class CreditTransferTransaction44:
...
@dataclass
class FinancialInstitutionCreditTransferV09:
    grp_hdr: Optional[GroupHeader93] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    cdt_trf_tx_inf: List[CreditTransferTransaction44] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTxInf",
            "type": "Element",
...
class Document:
    ...
    ficdt_trf: Optional[FinancialInstitutionCreditTransferV09] = field(
        default=None,
        metadata={
            "name": "FICdtTrf",
            "type": "Element",
