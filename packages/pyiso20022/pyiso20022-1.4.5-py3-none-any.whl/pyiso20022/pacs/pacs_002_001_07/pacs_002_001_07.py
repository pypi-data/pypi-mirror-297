...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.07"
...
@dataclass
class FitoFipaymentStatusReportV07:
    class Meta:
    ...
    tx_inf_and_sts: List[PaymentTransaction63] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_sts_rpt: Optional[FitoFipaymentStatusReportV07] = field(
        default=None,
        metadata={
