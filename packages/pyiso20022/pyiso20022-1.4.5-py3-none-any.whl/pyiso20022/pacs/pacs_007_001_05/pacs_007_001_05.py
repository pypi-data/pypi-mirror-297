...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.05"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.05",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class FitoFipaymentReversalV05:
    class Meta:
        name = "FIToFIPaymentReversalV05"

    grp_hdr: Optional[GroupHeader57] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    tx_inf: List[PaymentTransaction51] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_rvsl: Optional[FitoFipaymentReversalV05] = field(
        default=None,
        metadata={
            "name": "FIToFIPmtRvsl",
            "type": "Element",
