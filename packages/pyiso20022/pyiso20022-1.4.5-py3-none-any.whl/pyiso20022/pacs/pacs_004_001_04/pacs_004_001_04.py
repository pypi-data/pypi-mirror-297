...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.004.001.04"
...
class PaymentReturnV04:
    ...
    tx_inf: List[PaymentTransaction44] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class Document:
    ...
    pmt_rtr: Optional[PaymentReturnV04] = field(
        default=None,
        metadata={
            "name": "PmtRtr",
            "type": "Element",
