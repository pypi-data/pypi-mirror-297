...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.003.001.05"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pacs.003.001.05",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class DirectDebitTransactionInformation17:
...
@dataclass
class FitoFicustomerDirectDebitV05:
    class Meta:
    ...
    drct_dbt_tx_inf: List[DirectDebitTransactionInformation17] = field(
        default_factory=list,
        metadata={
            "name": "DrctDbtTxInf",
            "type": "Element",
...
class Document:
    ...
    fito_ficstmr_drct_dbt: Optional[FitoFicustomerDirectDebitV05] = field(
        default=None,
        metadata={
