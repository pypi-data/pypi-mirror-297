...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.008.001.05"
...
@dataclass
class CreditTransferTransaction19:
...
@dataclass
class FitoFicustomerCreditTransferV05:
    class Meta:
    ...
    cdt_trf_tx_inf: List[CreditTransferTransaction19] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTxInf",
            "type": "Element",
...
class Document:
    ...
    fito_ficstmr_cdt_trf: Optional[FitoFicustomerCreditTransferV05] = field(
        default=None,
        metadata={
