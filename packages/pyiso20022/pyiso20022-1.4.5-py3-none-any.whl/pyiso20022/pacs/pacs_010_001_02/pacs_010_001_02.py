...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.010.001.02"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pacs.010.001.02",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class DirectDebitTransactionInformation15:
...
@dataclass
class CreditTransferTransaction9:
    ...
    drct_dbt_tx_inf: List[DirectDebitTransactionInformation15] = field(
        default_factory=list,
        metadata={
            "name": "DrctDbtTxInf",
            "type": "Element",
...
@dataclass
class FinancialInstitutionDirectDebitV02:
    grp_hdr: Optional[GroupHeader63] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    cdt_instr: List[CreditTransferTransaction9] = field(
        default_factory=list,
        metadata={
            "name": "CdtInstr",
            "type": "Element",
...
class Document:
    ...
    fidrct_dbt: Optional[FinancialInstitutionDirectDebitV02] = field(
        default=None,
        metadata={
            "name": "FIDrctDbt",
            "type": "Element",
