...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.04"
...
@dataclass
class FitoFipaymentStatusReportV04:
    class Meta:
    ...
    tx_inf_and_sts: List[PaymentTransaction33] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_sts_rpt: Optional[FitoFipaymentStatusReportV04] = field(
        default=None,
        metadata={
