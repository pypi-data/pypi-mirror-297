...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.028.001.02"
...
@dataclass
class FitoFipaymentStatusRequestV02:
    class Meta:
    ...
    tx_inf: List[PaymentTransaction94] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_sts_req: Optional[FitoFipaymentStatusRequestV02] = field(
        default=None,
        metadata={
