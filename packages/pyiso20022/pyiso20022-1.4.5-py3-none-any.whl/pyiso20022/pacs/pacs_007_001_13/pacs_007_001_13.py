...
class OriginalGroupHeader20:
    ...
    rvsl_rsn_inf: List[PaymentReversalReason10] = field(
        default_factory=list,
        metadata={
            "name": "RvslRsnInf",
            "type": "Element",
...
@dataclass
class FitoFipaymentReversalV13:
    class Meta:
        name = "FIToFIPaymentReversalV13"

    grp_hdr: Optional[GroupHeader127] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    orgnl_grp_inf: Optional[OriginalGroupHeader20] = field(
        default=None,
        metadata={
            "name": "OrgnlGrpInf",
            "type": "Element",
    ...
    tx_inf: List[PaymentTransaction149] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_rvsl: Optional[FitoFipaymentReversalV13] = field(
        default=None,
        metadata={
            "name": "FIToFIPmtRvsl",
            "type": "Element",
