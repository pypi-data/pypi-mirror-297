...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.02"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.02",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class FitoFipaymentReversalV02:
    class Meta:
        name = "FIToFIPaymentReversalV02"

    grp_hdr: Optional[GroupHeader41] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    tx_inf: List[PaymentTransactionInformation29] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_rvsl: Optional[FitoFipaymentReversalV02] = field(
        default=None,
        metadata={
            "name": "FIToFIPmtRvsl",
            "type": "Element",
