...
@dataclass
class BankToCustomerAccountReportV12:
    ...
    rpt: List[AccountReport33] = field(
        default_factory=list,
        metadata={
            "name": "Rpt",
            "type": "Element",
...
class Document:
    ...
    bk_to_cstmr_acct_rpt: Optional[BankToCustomerAccountReportV12] = field(
        default=None,
        metadata={
