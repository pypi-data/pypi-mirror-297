...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.06"
...
@dataclass
class BankToCustomerAccountReportV06:
    ...
    rpt: List[AccountReport19] = field(
        default_factory=list,
        metadata={
            "name": "Rpt",
            "type": "Element",
...
class Document:
    ...
    bk_to_cstmr_acct_rpt: Optional[BankToCustomerAccountReportV06] = field(
        default=None,
        metadata={
