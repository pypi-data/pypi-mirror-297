...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02"
...
class BankToCustomerAccountReportV02:
    ...
    rpt: List[AccountReport11] = field(
        default_factory=list,
        metadata={
            "name": "Rpt",
            "type": "Element",
...
class Document:
    ...
    bk_to_cstmr_acct_rpt: Optional[BankToCustomerAccountReportV02] = field(
        default=None,
        metadata={
