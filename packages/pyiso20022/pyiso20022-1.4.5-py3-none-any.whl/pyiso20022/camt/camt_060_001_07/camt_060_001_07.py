...
class GroupHeader117:
    ...
    msg_sndr: Optional[Party50Choice] = field(
        default=None,
        metadata={
            "name": "MsgSndr",
            "type": "Element",
...
class ReportingRequest7:
    ...
    acct_ownr: Optional[Party50Choice] = field(
        default=None,
        metadata={
            "name": "AcctOwnr",
            "type": "Element",
    ...
    acct_svcr: Optional[BranchAndFinancialInstitutionIdentification8] = field(
        default=None,
        metadata={
            "name": "AcctSvcr",
            "type": "Element",
...
@dataclass
class AccountReportingRequestV07:
    grp_hdr: Optional[GroupHeader117] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    rptg_req: List[ReportingRequest7] = field(
        default_factory=list,
        metadata={
            "name": "RptgReq",
            "type": "Element",
...
class Document:
    ...
    acct_rptg_req: Optional[AccountReportingRequestV07] = field(
        default=None,
        metadata={
            "name": "AcctRptgReq",
            "type": "Element",
