...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
class AccountStatement6:
    ...
    txs_summry: Optional[TotalTransactions5] = field(
        default=None,
        metadata={
            "name": "TxsSummry",
            "type": "Element",
...
@dataclass
class BankToCustomerStatementV06:
    ...
    stmt: List[AccountStatement6] = field(
        default_factory=list,
        metadata={
            "name": "Stmt",
            "type": "Element",
...
class Document:
    ...
    bk_to_cstmr_stmt: Optional[BankToCustomerStatementV06] = field(
        default=None,
        metadata={
            "name": "BkToCstmrStmt",
            "type": "Element",
