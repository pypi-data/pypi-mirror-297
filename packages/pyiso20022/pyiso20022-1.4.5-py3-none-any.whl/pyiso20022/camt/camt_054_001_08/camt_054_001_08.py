...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.08"
...
@dataclass
class BankToCustomerDebitCreditNotificationV08:
    ...
    ntfctn: List[AccountNotification17] = field(
        default_factory=list,
        metadata={
            "name": "Ntfctn",
            "type": "Element",
