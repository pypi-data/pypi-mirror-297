...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.08"
...
@dataclass
class OriginalPaymentInstruction34:
    ...
    tx_inf: List[PaymentTransaction109] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class UnderlyingTransaction24:
    ...
    orgnl_pmt_inf_and_cxl: List[OriginalPaymentInstruction34] = field(
        default_factory=list,
        metadata={
...
@dataclass
class CustomerPaymentCancellationRequestV08:
    ...
    undrlyg: List[UnderlyingTransaction24] = field(
        default_factory=list,
        metadata={
            "name": "Undrlyg",
            "type": "Element",
...
class Document:
    ...
    cstmr_pmt_cxl_req: Optional[CustomerPaymentCancellationRequestV08] = field(
        default=None,
        metadata={
            "name": "CstmrPmtCxlReq",
            "type": "Element",
