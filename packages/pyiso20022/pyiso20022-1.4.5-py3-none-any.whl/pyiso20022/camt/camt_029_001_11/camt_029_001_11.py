...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.11"
...
class PaymentTransaction132:
    ...
    rsltn_rltd_inf: Optional[ResolutionData3] = field(
        default=None,
        metadata={
            "name": "RsltnRltdInf",
            "type": "Element",
...
class UnderlyingTransaction29:
    ...
    tx_inf_and_sts: List[PaymentTransaction138] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
class ResolutionOfInvestigationV11:
    ...
    cxl_dtls: List[UnderlyingTransaction29] = field(
        default_factory=list,
        metadata={
            "name": "CxlDtls",
            "type": "Element",
    ...
    mod_dtls: Optional[PaymentTransaction132] = field(
        default=None,
        metadata={
            "name": "ModDtls",
            "type": "Element",
...
class Document:
    ...
    rsltn_of_invstgtn: Optional[ResolutionOfInvestigationV11] = field(
        default=None,
        metadata={
