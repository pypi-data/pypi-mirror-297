...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.09"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.055.001.09",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class OriginalPaymentInstruction36:
    ...
    tx_inf: List[PaymentTransaction124] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class UnderlyingTransaction27:
    ...
    orgnl_pmt_inf_and_cxl: List[OriginalPaymentInstruction36] = field(
        default_factory=list,
        metadata={
...
@dataclass
class CustomerPaymentCancellationRequestV09:
    ...
    undrlyg: List[UnderlyingTransaction27] = field(
        default_factory=list,
        metadata={
            "name": "Undrlyg",
            "type": "Element",
...
class Document:
    ...
    cstmr_pmt_cxl_req: Optional[CustomerPaymentCancellationRequestV09] = field(
        default=None,
        metadata={
            "name": "CstmrPmtCxlReq",
            "type": "Element",
