...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.028.001.11"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.028.001.11",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class PaymentComplementaryInformation10:
...
@dataclass
class AdditionalPaymentInformationV11:
    ...
    inf: Optional[PaymentComplementaryInformation10] = field(
        default=None,
        metadata={
            "name": "Inf",
            "type": "Element",
...
class Document:
    ...
    addtl_pmt_inf: Optional[AdditionalPaymentInformationV11] = field(
        default=None,
        metadata={
            "name": "AddtlPmtInf",
            "type": "Element",
