...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.056.001.06"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.056.001.06",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
class PaymentTransaction75:
    ...
    assgnr: Optional[BranchAndFinancialInstitutionIdentification5] = field(
        default=None,
        metadata={
            "name": "Assgnr",
            "type": "Element",
    ...
    assgne: Optional[BranchAndFinancialInstitutionIdentification5] = field(
        default=None,
        metadata={
            "name": "Assgne",
            "type": "Element",
...
class UnderlyingTransaction16:
    ...
    tx_inf: List[PaymentTransaction75] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
@dataclass
class FitoFipaymentCancellationRequestV06:
    class Meta:
    ...
    undrlyg: List[UnderlyingTransaction16] = field(
        default_factory=list,
        metadata={
            "name": "Undrlyg",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_cxl_req: Optional[FitoFipaymentCancellationRequestV06] = field(
        default=None,
        metadata={
