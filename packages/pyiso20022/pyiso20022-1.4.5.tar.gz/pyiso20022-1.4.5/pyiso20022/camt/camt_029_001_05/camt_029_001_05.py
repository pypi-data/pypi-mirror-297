...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.05"
...
@dataclass
class OriginalPaymentInstruction10:
    ...
    tx_inf_and_sts: List[PaymentTransaction54] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
class UnderlyingTransaction9:
    ...
    orgnl_pmt_inf_and_sts: List[OriginalPaymentInstruction10] = field(
        default_factory=list,
        metadata={
    ...
    tx_inf_and_sts: List[PaymentTransaction53] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
@dataclass
class ResolutionOfInvestigationV05:
    ...
    cxl_dtls: List[UnderlyingTransaction9] = field(
        default_factory=list,
        metadata={
            "name": "CxlDtls",
            "type": "Element",
...
class Document:
    ...
    rsltn_of_invstgtn: Optional[ResolutionOfInvestigationV05] = field(
        default=None,
        metadata={
