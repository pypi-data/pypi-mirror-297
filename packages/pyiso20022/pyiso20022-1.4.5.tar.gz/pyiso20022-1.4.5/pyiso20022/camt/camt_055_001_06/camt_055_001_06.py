...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.06"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.055.001.06",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class PaymentCancellationReason3:
...
class OriginalGroupHeader6:
    ...
    cxl_rsn_inf: List[PaymentCancellationReason3] = field(
        default_factory=list,
        metadata={
            "name": "CxlRsnInf",
            "type": "Element",
...
@dataclass
class OriginalPaymentInstruction20:
    ...
    tx_inf: List[PaymentTransaction74] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
@dataclass
class UnderlyingTransaction15:
    orgnl_grp_inf_and_cxl: Optional[OriginalGroupHeader6] = field(
        default=None,
        metadata={
    ...
    orgnl_pmt_inf_and_cxl: List[OriginalPaymentInstruction20] = field(
        default_factory=list,
        metadata={
...
@dataclass
class CustomerPaymentCancellationRequestV06:
    ...
    undrlyg: List[UnderlyingTransaction15] = field(
        default_factory=list,
        metadata={
            "name": "Undrlyg",
            "type": "Element",
...
class Document:
    ...
    cstmr_pmt_cxl_req: Optional[CustomerPaymentCancellationRequestV06] = field(
        default=None,
        metadata={
            "name": "CstmrPmtCxlReq",
            "type": "Element",
