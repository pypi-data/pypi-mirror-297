...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.028.001.09"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.028.001.09",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class PaymentComplementaryInformation8:
...
@dataclass
class AdditionalPaymentInformationV09:
    ...
    inf: Optional[PaymentComplementaryInformation8] = field(
        default=None,
        metadata={
            "name": "Inf",
            "type": "Element",
...
class Document:
    ...
    addtl_pmt_inf: Optional[AdditionalPaymentInformationV09] = field(
        default=None,
        metadata={
            "name": "AddtlPmtInf",
            "type": "Element",
