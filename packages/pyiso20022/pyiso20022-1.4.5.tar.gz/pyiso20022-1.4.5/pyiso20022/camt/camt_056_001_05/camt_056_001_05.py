...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.056.001.05"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.056.001.05",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
class PaymentTransaction62:
    ...
    orgnl_tx_ref: Optional[OriginalTransactionReference22] = field(
        default=None,
        metadata={
            "name": "OrgnlTxRef",
            "type": "Element",
...
class UnderlyingTransaction13:
    ...
    tx_inf: List[PaymentTransaction62] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
@dataclass
class FitoFipaymentCancellationRequestV05:
    class Meta:
    ...
    undrlyg: List[UnderlyingTransaction13] = field(
        default_factory=list,
        metadata={
            "name": "Undrlyg",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_cxl_req: Optional[FitoFipaymentCancellationRequestV05] = field(
        default=None,
        metadata={
