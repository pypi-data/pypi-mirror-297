...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.028.001.08"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.028.001.08",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class UnderlyingStatementEntry2:
...
class PaymentComplementaryInformation7:
    ...
    ultmt_dbtr: Optional[PartyIdentification125] = field(
        default=None,
        metadata={
            "name": "UltmtDbtr",
            "type": "Element",
    ...
    dbtr: Optional[PartyIdentification125] = field(
        default=None,
        metadata={
            "name": "Dbtr",
            "type": "Element",
    ...
    cdtr: Optional[PartyIdentification125] = field(
        default=None,
        metadata={
            "name": "Cdtr",
            "type": "Element",
    ...
    ultmt_cdtr: Optional[PartyIdentification125] = field(
        default=None,
        metadata={
            "name": "UltmtCdtr",
            "type": "Element",
    ...
    prvs_instg_agt1: Optional[BranchAndFinancialInstitutionIdentification5] = (
        field(
            default=None,
            metadata={
                "name": "PrvsInstgAgt1",
    ...
    prvs_instg_agt1_acct: Optional[CashAccount24] = field(
        default=None,
        metadata={
    ...
    prvs_instg_agt2: Optional[BranchAndFinancialInstitutionIdentification5] = (
        field(
            default=None,
            metadata={
                "name": "PrvsInstgAgt2",
    ...
    prvs_instg_agt2_acct: Optional[CashAccount24] = field(
        default=None,
        metadata={
    ...
    prvs_instg_agt3: Optional[BranchAndFinancialInstitutionIdentification5] = (
        field(
            default=None,
            metadata={
                "name": "PrvsInstgAgt3",
    ...
    prvs_instg_agt3_acct: Optional[CashAccount24] = field(
        default=None,
        metadata={
...
@dataclass
class UnderlyingPaymentInstruction4:
...
@dataclass
class UnderlyingPaymentTransaction3:
    orgnl_grp_inf: Optional[UnderlyingGroupInformation1] = field(
        default=None,
        metadata={
            "name": "OrgnlGrpInf",
...
@dataclass
class UnderlyingTransaction4Choice:
    initn: Optional[UnderlyingPaymentInstruction4] = field(
        default=None,
        metadata={
            "name": "Initn",
            "type": "Element",
    ...
    intr_bk: Optional[UnderlyingPaymentTransaction3] = field(
        default=None,
        metadata={
            "name": "IntrBk",
            "type": "Element",
    ...
    stmt_ntry: Optional[UnderlyingStatementEntry2] = field(
        default=None,
        metadata={
            "name": "StmtNtry",
            "type": "Element",
...
@dataclass
class AdditionalPaymentInformationV08:
    ...
    undrlyg: Optional[UnderlyingTransaction4Choice] = field(
        default=None,
        metadata={
            "name": "Undrlyg",
            "type": "Element",
    ...
    inf: Optional[PaymentComplementaryInformation7] = field(
        default=None,
        metadata={
            "name": "Inf",
            "type": "Element",
...
class Document:
    ...
    addtl_pmt_inf: Optional[AdditionalPaymentInformationV08] = field(
        default=None,
        metadata={
            "name": "AddtlPmtInf",
            "type": "Element",
