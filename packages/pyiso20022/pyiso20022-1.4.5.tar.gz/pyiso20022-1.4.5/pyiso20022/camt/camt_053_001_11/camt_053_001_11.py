...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.11"
...
@dataclass
class BankToCustomerStatementV11:
    ...
    stmt: List[AccountStatement12] = field(
        default_factory=list,
        metadata={
            "name": "Stmt",
            "type": "Element",
...
class Document:
    ...
    bk_to_cstmr_stmt: Optional[BankToCustomerStatementV11] = field(
        default=None,
        metadata={
            "name": "BkToCstmrStmt",
            "type": "Element",
