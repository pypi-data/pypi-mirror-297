...
@dataclass
class PaymentCancellationReason6:
...
class OriginalGroupHeader21:
    ...
    cxl_rsn_inf: List[PaymentCancellationReason6] = field(
        default_factory=list,
        metadata={
            "name": "CxlRsnInf",
            "type": "Element",
...
@dataclass
class OriginalPaymentInstruction49:
    ...
    tx_inf: List[PaymentTransaction154] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
@dataclass
class UnderlyingTransaction33:
    orgnl_grp_inf_and_cxl: Optional[OriginalGroupHeader21] = field(
        default=None,
        metadata={
    ...
    orgnl_pmt_inf_and_cxl: List[OriginalPaymentInstruction49] = field(
        default_factory=list,
        metadata={
...
@dataclass
class CustomerPaymentCancellationRequestV12:
    ...
    undrlyg: List[UnderlyingTransaction33] = field(
        default_factory=list,
        metadata={
            "name": "Undrlyg",
            "type": "Element",
...
class Document:
    ...
    cstmr_pmt_cxl_req: Optional[CustomerPaymentCancellationRequestV12] = field(
        default=None,
        metadata={
            "name": "CstmrPmtCxlReq",
            "type": "Element",
