...
@dataclass
class DebitAuthorisation3:
    cxl_rsn: Optional[CancellationReason33Choice] = field(
        default=None,
        metadata={
            "name": "CxlRsn",
            "type": "Element",
    ...
    amt_to_dbt: Optional[ActiveOrHistoricCurrencyAndAmount] = field(
        default=None,
        metadata={
            "name": "AmtToDbt",
            "type": "Element",
...
class AdditionalRequestData1Choice:
    reqd_dbt_authstn: Optional[DebitAuthorisation3] = field(
        default=None,
        metadata={
            "name": "ReqdDbtAuthstn",
            "type": "Element",
    ...
    reqd_compstn: Optional[CompensationRequest1] = field(
        default=None,
        metadata={
            "name": "ReqdCompstn",
            "type": "Element",
    ...
    reqd_valtn: Optional[AdjustmentRequest1] = field(
        default=None,
        metadata={
            "name": "ReqdValtn",
            "type": "Element",
...
class InvestigationReason2:
    ...
    rsn: Optional[InvestigationReason1Choice] = field(
        default=None,
        metadata={
            "name": "Rsn",
            "type": "Element",
    ...
    rsn_sub_tp: Optional[InvestigationReasonSubType1Choice] = field(
        default=None,
        metadata={
            "name": "RsnSubTp",
            "type": "Element",
    ...
    addtl_req_data: Optional[AdditionalRequestData1Choice] = field(
        default=None,
        metadata={
            "name": "AddtlReqData",
            "type": "Element",
...
class InvestigationRequestV01:
    invstgtn_req: Optional[InvestigationRequest2] = field(
        default=None,
        metadata={
            "name": "InvstgtnReq",
            "type": "Element",
    ...
    invstgtn_data: List[InvestigationReason2] = field(
        default_factory=list,
        metadata={
            "name": "InvstgtnData",
            "type": "Element",
...
class Document:
    ...
    invstgtn_req: Optional[InvestigationRequestV01] = field(
        default=None,
        metadata={
            "name": "InvstgtnReq",
            "type": "Element",
