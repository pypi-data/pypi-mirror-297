...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.02"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.055.001.02",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class OriginalPaymentInstruction4:
    ...
    tx_inf: List[PaymentTransaction37] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class UnderlyingTransaction6:
    ...
    orgnl_pmt_inf_and_cxl: List[OriginalPaymentInstruction4] = field(
        default_factory=list,
        metadata={
...
@dataclass
class CustomerPaymentCancellationRequestV02:
    ...
    undrlyg: List[UnderlyingTransaction6] = field(
        default_factory=list,
        metadata={
            "name": "Undrlyg",
            "type": "Element",
...
class Document:
    ...
    cstmr_pmt_cxl_req: Optional[CustomerPaymentCancellationRequestV02] = field(
        default=None,
        metadata={
            "name": "CstmrPmtCxlReq",
            "type": "Element",
