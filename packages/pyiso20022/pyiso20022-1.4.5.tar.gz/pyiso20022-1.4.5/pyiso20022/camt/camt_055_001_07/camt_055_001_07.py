...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.07"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.055.001.07",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class OriginalPaymentInstruction29:
    ...
    tx_inf: List[PaymentTransaction95] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class UnderlyingTransaction21:
    ...
    orgnl_pmt_inf_and_cxl: List[OriginalPaymentInstruction29] = field(
        default_factory=list,
        metadata={
...
@dataclass
class CustomerPaymentCancellationRequestV07:
    ...
    undrlyg: List[UnderlyingTransaction21] = field(
        default_factory=list,
        metadata={
            "name": "Undrlyg",
            "type": "Element",
...
class Document:
    ...
    cstmr_pmt_cxl_req: Optional[CustomerPaymentCancellationRequestV07] = field(
        default=None,
        metadata={
            "name": "CstmrPmtCxlReq",
            "type": "Element",
