...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.05"
...
@dataclass
class BankToCustomerAccountReportV05:
    ...
    rpt: List[AccountReport18] = field(
        default_factory=list,
        metadata={
            "name": "Rpt",
            "type": "Element",
...
class Document:
    ...
    bk_to_cstmr_acct_rpt: Optional[BankToCustomerAccountReportV05] = field(
        default=None,
        metadata={
