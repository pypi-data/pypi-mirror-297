...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.056.001.03"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.056.001.03",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
class UnderlyingTransaction8:
    ...
    tx_inf: List[PaymentTransaction48] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
@dataclass
class FitoFipaymentCancellationRequestV03:
    class Meta:
        name = "FIToFIPaymentCancellationRequestV03"
    ...
    undrlyg: List[UnderlyingTransaction8] = field(
        default_factory=list,
        metadata={
            "name": "Undrlyg",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_cxl_req: Optional[FitoFipaymentCancellationRequestV03] = field(
        default=None,
        metadata={
