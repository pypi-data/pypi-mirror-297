...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.026.001.06"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:camt.026.001.06",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
class Document:
    ...
    ubl_to_apply: Optional[UnableToApplyV06] = field(
        default=None,
        metadata={
            "name": "UblToApply",
            "type": "Element",
