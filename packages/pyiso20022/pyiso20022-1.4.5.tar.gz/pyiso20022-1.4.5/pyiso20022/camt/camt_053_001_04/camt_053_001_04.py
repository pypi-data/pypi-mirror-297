...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04"
...
@dataclass
class BankToCustomerStatementV04:
    ...
    stmt: List[AccountStatement4] = field(
        default_factory=list,
        metadata={
            "name": "Stmt",
            "type": "Element",
...
class Document:
    ...
    bk_to_cstmr_stmt: Optional[BankToCustomerStatementV04] = field(
        default=None,
        metadata={
            "name": "BkToCstmrStmt",
            "type": "Element",
