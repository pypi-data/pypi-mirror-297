...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.11"
...
@dataclass
class BankToCustomerDebitCreditNotificationV11:
    ...
    ntfctn: List[AccountNotification21] = field(
        default_factory=list,
        metadata={
            "name": "Ntfctn",
            "type": "Element",
...
class Document:
    ...
    bk_to_cstmr_dbt_cdt_ntfctn: Optional[
        BankToCustomerDebitCreditNotificationV11
    ] = field(
        default=None,
        metadata={
