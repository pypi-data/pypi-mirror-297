...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.07"
...
@dataclass
class BankToCustomerAccountReportV07:
    ...
    rpt: List[AccountReport22] = field(
        default_factory=list,
        metadata={
            "name": "Rpt",
            "type": "Element",
...
class Document:
    ...
    bk_to_cstmr_acct_rpt: Optional[BankToCustomerAccountReportV07] = field(
        default=None,
        metadata={
