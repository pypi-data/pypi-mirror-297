...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.004.001.06"
...
@dataclass
class PaymentReturnV06:
    grp_hdr: Optional[GroupHeader72] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    tx_inf: List[PaymentTransaction65] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class Document:
    ...
    pmt_rtr: Optional[PaymentReturnV06] = field(
        default=None,
        metadata={
            "name": "PmtRtr",
            "type": "Element",
