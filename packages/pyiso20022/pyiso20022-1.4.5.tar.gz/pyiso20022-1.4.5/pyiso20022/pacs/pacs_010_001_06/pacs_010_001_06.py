...
@dataclass
class DirectDebitTransactionInformation33:
...
@dataclass
class CreditTransferTransaction66:
    ...
    drct_dbt_tx_inf: List[DirectDebitTransactionInformation33] = field(
        default_factory=list,
        metadata={
            "name": "DrctDbtTxInf",
            "type": "Element",
...
@dataclass
class FinancialInstitutionDirectDebitV06:
    grp_hdr: Optional[GroupHeader119] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    cdt_instr: List[CreditTransferTransaction66] = field(
        default_factory=list,
        metadata={
            "name": "CdtInstr",
            "type": "Element",
...
class Document:
    ...
    fidrct_dbt: Optional[FinancialInstitutionDirectDebitV06] = field(
        default=None,
        metadata={
            "name": "FIDrctDbt",
            "type": "Element",
