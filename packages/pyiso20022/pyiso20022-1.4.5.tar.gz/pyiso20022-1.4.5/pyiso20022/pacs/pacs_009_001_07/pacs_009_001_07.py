...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.009.001.07"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pacs.009.001.07",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class CreditTransferTransaction32:
    ...
    initg_pty: Optional[PartyIdentification125] = field(
        default=None,
        metadata={
            "name": "InitgPty",
            "type": "Element",
...
@dataclass
class CreditTransferTransaction31:
    ...
    undrlyg_cstmr_cdt_trf: Optional[CreditTransferTransaction32] = field(
        default=None,
        metadata={
...
@dataclass
class FinancialInstitutionCreditTransferV07:
    grp_hdr: Optional[GroupHeader70] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    cdt_trf_tx_inf: List[CreditTransferTransaction31] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTxInf",
            "type": "Element",
...
class Document:
    ...
    ficdt_trf: Optional[FinancialInstitutionCreditTransferV07] = field(
        default=None,
        metadata={
            "name": "FICdtTrf",
            "type": "Element",
