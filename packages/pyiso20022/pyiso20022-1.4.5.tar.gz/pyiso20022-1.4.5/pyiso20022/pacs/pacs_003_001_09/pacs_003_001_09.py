...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.003.001.09"
...
@dataclass
class DirectDebitTransactionInformation29:
...
class FitoFicustomerDirectDebitV09:
    ...
    drct_dbt_tx_inf: List[DirectDebitTransactionInformation29] = field(
        default_factory=list,
        metadata={
            "name": "DrctDbtTxInf",
            "type": "Element",
...
class Document:
    ...
    fito_ficstmr_drct_dbt: Optional[FitoFicustomerDirectDebitV09] = field(
        default=None,
        metadata={
