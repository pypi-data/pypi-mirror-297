...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.028.001.05"
...
class FitoFipaymentStatusRequestV05:
    class Meta:
        name = "FIToFIPaymentStatusRequestV05"
    ...
    tx_inf: List[PaymentTransaction131] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_sts_req: Optional[FitoFipaymentStatusRequestV05] = field(
        default=None,
        metadata={
