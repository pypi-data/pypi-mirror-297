...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.13"
...
@dataclass
class FitoFipaymentStatusReportV13:
    class Meta:
        name = "FIToFIPaymentStatusReportV13"

    grp_hdr: Optional[GroupHeader101] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    tx_inf_and_sts: List[PaymentTransaction142] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_sts_rpt: Optional[FitoFipaymentStatusReportV13] = field(
        default=None,
        metadata={
