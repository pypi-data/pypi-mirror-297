...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.003.001.10"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pacs.003.001.10",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class DirectDebitTransaction11:
    mndt_rltd_inf: Optional[MandateRelatedInformation15] = field(
        default=None,
        metadata={
            "name": "MndtRltdInf",
            "type": "Element",
...
@dataclass
class DirectDebitTransactionInformation30:
    ...
    drct_dbt_tx: Optional[DirectDebitTransaction11] = field(
        default=None,
        metadata={
            "name": "DrctDbtTx",
            "type": "Element",
...
@dataclass
class FitoFicustomerDirectDebitV10:
    class Meta:
        name = "FIToFICustomerDirectDebitV10"

    grp_hdr: Optional[GroupHeader98] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    drct_dbt_tx_inf: List[DirectDebitTransactionInformation30] = field(
        default_factory=list,
        metadata={
            "name": "DrctDbtTxInf",
            "type": "Element",
...
class Document:
    ...
    fito_ficstmr_drct_dbt: Optional[FitoFicustomerDirectDebitV10] = field(
        default=None,
        metadata={
