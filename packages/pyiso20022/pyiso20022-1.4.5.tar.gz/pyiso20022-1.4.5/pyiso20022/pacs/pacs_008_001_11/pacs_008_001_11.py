...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.008.001.11"
...
@dataclass
class FitoFicustomerCreditTransferV11:
    class Meta:
    ...
    cdt_trf_tx_inf: List[CreditTransferTransaction58] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTxInf",
            "type": "Element",
...
class Document:
    ...
    fito_ficstmr_cdt_trf: Optional[FitoFicustomerCreditTransferV11] = field(
        default=None,
        metadata={
