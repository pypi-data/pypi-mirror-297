...
@dataclass
class CreditTransferTransaction64:
...
@dataclass
class FitoFicustomerCreditTransferV12:
    class Meta:
        name = "FIToFICustomerCreditTransferV12"

    grp_hdr: Optional[GroupHeader113] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    cdt_trf_tx_inf: List[CreditTransferTransaction64] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTxInf",
            "type": "Element",
...
class Document:
    ...
    fito_ficstmr_cdt_trf: Optional[FitoFicustomerCreditTransferV12] = field(
        default=None,
        metadata={
