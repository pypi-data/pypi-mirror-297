...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.08"
...
@dataclass
class FitoFipaymentStatusReportV08:
    class Meta:
        name = "FIToFIPaymentStatusReportV08"

    grp_hdr: Optional[GroupHeader53] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    orgnl_grp_inf_and_sts: List[OriginalGroupHeader7] = field(
        default_factory=list,
        metadata={
    ...
    tx_inf_and_sts: List[PaymentTransaction80] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_sts_rpt: Optional[FitoFipaymentStatusReportV08] = field(
        default=None,
        metadata={
