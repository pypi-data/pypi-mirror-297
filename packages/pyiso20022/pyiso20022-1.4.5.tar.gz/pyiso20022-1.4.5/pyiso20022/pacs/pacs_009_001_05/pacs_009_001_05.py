...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.009.001.05"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pacs.009.001.05",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class CreditTransferTransaction18:
...
@dataclass
class CreditTransferTransaction17:
    ...
    undrlyg_cstmr_cdt_trf: Optional[CreditTransferTransaction18] = field(
        default=None,
        metadata={
...
@dataclass
class FinancialInstitutionCreditTransferV05:
    grp_hdr: Optional[GroupHeader49] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    cdt_trf_tx_inf: List[CreditTransferTransaction17] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTxInf",
            "type": "Element",
...
class Document:
    ...
    ficdt_trf: Optional[FinancialInstitutionCreditTransferV05] = field(
        default=None,
        metadata={
            "name": "FICdtTrf",
            "type": "Element",
