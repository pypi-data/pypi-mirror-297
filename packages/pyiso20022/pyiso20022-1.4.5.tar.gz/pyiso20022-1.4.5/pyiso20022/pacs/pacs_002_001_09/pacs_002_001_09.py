...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.09"
...
@dataclass
class FitoFipaymentStatusReportV09:
    class Meta:
    ...
    orgnl_grp_inf_and_sts: List[OriginalGroupHeader13] = field(
        default_factory=list,
        metadata={
    ...
    tx_inf_and_sts: List[PaymentTransaction91] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
class Document:
    ...
    fito_fipmt_sts_rpt: Optional[FitoFipaymentStatusReportV09] = field(
        default=None,
        metadata={
