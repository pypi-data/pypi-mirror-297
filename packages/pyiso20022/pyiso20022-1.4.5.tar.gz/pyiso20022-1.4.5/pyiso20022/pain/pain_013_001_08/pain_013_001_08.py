...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.013.001.08"
...
class PaymentInstruction35:
    ...
    cdt_trf_tx: List[CreditTransferTransaction42] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTx",
            "type": "Element",
...
@dataclass
class CreditorPaymentActivationRequestV08:
    ...
    pmt_inf: List[PaymentInstruction35] = field(
        default_factory=list,
        metadata={
            "name": "PmtInf",
            "type": "Element",
...
class Document:
    ...
    cdtr_pmt_actvtn_req: Optional[CreditorPaymentActivationRequestV08] = field(
        default=None,
        metadata={
