...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.014.001.01"
...
class NumberOfTransactionsPerStatus3:
    ...
    dtld_sts: Optional[TransactionIndividualStatus3Code] = field(
        default=None,
        metadata={
            "name": "DtldSts",
            "type": "Element",
...
class ChargesInformation7:
    ...
    pty: Optional[BranchAndFinancialInstitutionIdentification5] = field(
        default=None,
        metadata={
            "name": "Pty",
            "type": "Element",
...
@dataclass
class AmendmentInformationDetails7:
...
@dataclass
class StructuredRemittanceInformation8:
...
@dataclass
class MandateRelatedInformation7:
    ...
    amdmnt_inf_dtls: Optional[AmendmentInformationDetails7] = field(
        default=None,
        metadata={
            "name": "AmdmntInfDtls",
            "type": "Element",
...
class OriginalGroupInformation25:
    ...
    grp_sts: Optional[TransactionGroupStatus3Code] = field(
        default=None,
        metadata={
            "name": "GrpSts",
            "type": "Element",
...
class RemittanceInformation6:
    ...
    strd: List[StructuredRemittanceInformation8] = field(
        default_factory=list,
        metadata={
            "name": "Strd",
            "type": "Element",
...
@dataclass
class OriginalTransactionReference15:
    ...
    sttlm_inf: Optional[SettlementInformation16] = field(
        default=None,
        metadata={
            "name": "SttlmInf",
            "type": "Element",
    ...
    mndt_rltd_inf: Optional[MandateRelatedInformation7] = field(
        default=None,
        metadata={
            "name": "MndtRltdInf",
            "type": "Element",
    ...
    rmt_inf: Optional[RemittanceInformation6] = field(
        default=None,
        metadata={
            "name": "RmtInf",
            "type": "Element",
...
class PaymentTransactionInformation34:
    ...
    tx_sts: Optional[TransactionIndividualStatus3Code] = field(
        default=None,
        metadata={
            "name": "TxSts",
            "type": "Element",
    ...
    chrgs_inf: List[ChargesInformation7] = field(
        default_factory=list,
        metadata={
            "name": "ChrgsInf",
            "type": "Element",
    ...
    orgnl_tx_ref: Optional[OriginalTransactionReference15] = field(
        default=None,
        metadata={
            "name": "OrgnlTxRef",
            "type": "Element",
...
class OriginalPaymentInformation5:
    ...
    pmt_inf_sts: Optional[TransactionGroupStatus3Code] = field(
        default=None,
        metadata={
            "name": "PmtInfSts",
            "type": "Element",
    ...
    tx_inf_and_sts: List[PaymentTransactionInformation34] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
@dataclass
class CreditorPaymentActivationRequestStatusReportV01:
    grp_hdr: Optional[GroupHeader46] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    orgnl_grp_inf_and_sts: Optional[OriginalGroupInformation25] = field(
        default=None,
        metadata={
    ...
    orgnl_pmt_inf_and_sts: List[OriginalPaymentInformation5] = field(
        default_factory=list,
        metadata={
