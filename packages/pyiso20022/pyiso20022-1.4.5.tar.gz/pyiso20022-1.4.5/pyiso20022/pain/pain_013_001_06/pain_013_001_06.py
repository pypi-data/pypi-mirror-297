...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.013.001.06"
...
@dataclass
class CreditTransferTransaction22:
...
class PaymentInstruction23:
    ...
    cdt_trf_tx: List[CreditTransferTransaction22] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTx",
            "type": "Element",
...
@dataclass
class CreditorPaymentActivationRequestV06:
    ...
    pmt_inf: List[PaymentInstruction23] = field(
        default_factory=list,
        metadata={
            "name": "PmtInf",
            "type": "Element",
...
class Document:
    ...
    cdtr_pmt_actvtn_req: Optional[CreditorPaymentActivationRequestV06] = field(
        default=None,
        metadata={
