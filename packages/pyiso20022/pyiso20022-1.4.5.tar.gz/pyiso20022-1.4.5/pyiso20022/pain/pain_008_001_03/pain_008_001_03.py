...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.03"
...
@dataclass
class DirectDebitTransactionInformation11:
...
class PaymentInstruction7:
    ...
    drct_dbt_tx_inf: List[DirectDebitTransactionInformation11] = field(
        default_factory=list,
        metadata={
            "name": "DrctDbtTxInf",
            "type": "Element",
...
@dataclass
class CustomerDirectDebitInitiationV03:
    ...
    pmt_inf: List[PaymentInstruction7] = field(
        default_factory=list,
        metadata={
            "name": "PmtInf",
            "type": "Element",
...
class Document:
    ...
    cstmr_drct_dbt_initn: Optional[CustomerDirectDebitInitiationV03] = field(
        default=None,
        metadata={
