...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.007.001.03"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pain.007.001.03",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class OriginalPaymentInstruction2:
    ...
    tx_inf: List[PaymentTransaction35] = field(
        default_factory=list,
        metadata={
            "name": "TxInf",
            "type": "Element",
...
@dataclass
class CustomerPaymentReversalV03:
    ...
    orgnl_pmt_inf_and_rvsl: List[OriginalPaymentInstruction2] = field(
        default_factory=list,
        metadata={
...
class Document:
    ...
    cstmr_pmt_rvsl: Optional[CustomerPaymentReversalV03] = field(
        default=None,
        metadata={
            "name": "CstmrPmtRvsl",
            "type": "Element",
