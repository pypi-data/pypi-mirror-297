...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.014.001.06"
...
@dataclass
class OriginalGroupInformation28:
...
@dataclass
class OriginalTransactionReference26:
...
class PaymentTransaction83:
    ...
    orgnl_tx_ref: Optional[OriginalTransactionReference26] = field(
        default=None,
        metadata={
            "name": "OrgnlTxRef",
            "type": "Element",
...
@dataclass
class OriginalPaymentInstruction24:
    ...
    tx_inf_and_sts: List[PaymentTransaction83] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
@dataclass
class CreditorPaymentActivationRequestStatusReportV06:
    ...
    orgnl_grp_inf_and_sts: Optional[OriginalGroupInformation28] = field(
        default=None,
        metadata={
    ...
    orgnl_pmt_inf_and_sts: List[OriginalPaymentInstruction24] = field(
        default_factory=list,
        metadata={
