...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
class PaymentInstruction16:
    ...
    cdt_trf_tx_inf: List[CreditTransferTransaction20] = field(
        default_factory=list,
        metadata={
            "name": "CdtTrfTxInf",
            "type": "Element",
...
@dataclass
class CustomerCreditTransferInitiationV06:
    ...
    pmt_inf: List[PaymentInstruction16] = field(
        default_factory=list,
        metadata={
            "name": "PmtInf",
            "type": "Element",
...
class Document:
    ...
    cstmr_cdt_trf_initn: Optional[CustomerCreditTransferInitiationV06] = field(
        default=None,
        metadata={
