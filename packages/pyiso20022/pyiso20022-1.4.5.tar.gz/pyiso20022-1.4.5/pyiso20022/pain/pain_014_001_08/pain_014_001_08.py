...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.014.001.08"
...
@dataclass
class OriginalTransactionReference33:
...
class PaymentTransaction128:
    ...
    orgnl_tx_ref: Optional[OriginalTransactionReference33] = field(
        default=None,
        metadata={
            "name": "OrgnlTxRef",
            "type": "Element",
...
@dataclass
class OriginalPaymentInstruction39:
    ...
    tx_inf_and_sts: List[PaymentTransaction128] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
@dataclass
class CreditorPaymentActivationRequestStatusReportV08:
    ...
    orgnl_pmt_inf_and_sts: List[OriginalPaymentInstruction39] = field(
        default_factory=list,
        metadata={
