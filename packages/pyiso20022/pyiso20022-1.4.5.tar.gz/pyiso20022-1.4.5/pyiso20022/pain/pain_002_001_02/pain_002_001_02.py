...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.02"
...
class ClearingSystemMemberIdentification3Choice:
    id: Optional[str] = field(
        ...
        metadata={
            "name": "Id",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pain.002.001.02",
            "min_length": 1,
            "max_length": 35,
        },
    )
...
class Document:
    ...
    pain_002_001_02: Optional[Pain00200102] = field(
        default=None,
        metadata={
            "name": "pain.002.001.02",
            "type": "Element",
