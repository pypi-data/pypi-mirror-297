...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.11"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:pain.002.001.11",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
class TrackerRecord1:
    ...
    chrgs_amt: Optional[ActiveCurrencyAndAmount] = field(
        default=None,
        metadata={
            "name": "ChrgsAmt",
            "type": "Element",
    ...
    xchg_rate_data: Optional[CurrencyExchange13] = field(
        default=None,
        metadata={
            "name": "XchgRateData",
            "type": "Element",
...
@dataclass
class TrackerData1:
    confd_dt: Optional[DateAndDateTime2Choice] = field(
        default=None,
        metadata={
            "name": "ConfdDt",
            "type": "Element",
    ...
    confd_amt: Optional[ActiveCurrencyAndAmount] = field(
        default=None,
        metadata={
            "name": "ConfdAmt",
            "type": "Element",
...
class PaymentTransaction126:
    ...
    trckr_data: Optional[TrackerData1] = field(
        default=None,
        metadata={
            "name": "TrckrData",
            "type": "Element",
...
class OriginalPaymentInstruction38:
    ...
    tx_inf_and_sts: List[PaymentTransaction126] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
@dataclass
class CustomerPaymentStatusReportV11:
    grp_hdr: Optional[GroupHeader86] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    orgnl_grp_inf_and_sts: Optional[OriginalGroupHeader17] = field(
        default=None,
        metadata={
    ...
    orgnl_pmt_inf_and_sts: List[OriginalPaymentInstruction38] = field(
        default_factory=list,
        metadata={
...
class Document:
    ...
    cstmr_pmt_sts_rpt: Optional[CustomerPaymentStatusReportV11] = field(
        default=None,
        metadata={
            "name": "CstmrPmtStsRpt",
            "type": "Element",
