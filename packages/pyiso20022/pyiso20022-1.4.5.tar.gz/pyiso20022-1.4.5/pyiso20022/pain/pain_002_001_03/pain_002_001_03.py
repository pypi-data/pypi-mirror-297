...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.002.001.03"
...
class OriginalGroupInformation20:
    ...
    sts_rsn_inf: List[StatusReasonInformation8] = field(
        default_factory=list,
        metadata={
            "name": "StsRsnInf",
            "type": "Element",
...
class PaymentTransactionInformation25:
    ...
    chrgs_inf: List[ChargesInformation5] = field(
        default_factory=list,
        metadata={
            "name": "ChrgsInf",
            "type": "Element",
...
class OriginalPaymentInformation1:
    ...
    tx_inf_and_sts: List[PaymentTransactionInformation25] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
class CustomerPaymentStatusReportV03:
    grp_hdr: Optional[GroupHeader36] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    orgnl_grp_inf_and_sts: Optional[OriginalGroupInformation20] = field(
        default=None,
        metadata={
    ...
    orgnl_pmt_inf_and_sts: List[OriginalPaymentInformation1] = field(
        default_factory=list,
        metadata={
...
class Document:
    ...
    cstmr_pmt_sts_rpt: Optional[CustomerPaymentStatusReportV03] = field(
        default=None,
        metadata={
            "name": "CstmrPmtStsRpt",
            "type": "Element",
