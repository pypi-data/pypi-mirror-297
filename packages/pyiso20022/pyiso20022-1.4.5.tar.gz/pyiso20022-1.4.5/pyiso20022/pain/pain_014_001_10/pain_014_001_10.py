...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:pain.014.001.10"
...
@dataclass
class OriginalTransactionReference38:
...
class PaymentTransaction145:
    ...
    orgnl_tx_ref: Optional[OriginalTransactionReference38] = field(
        default=None,
        metadata={
            "name": "OrgnlTxRef",
            "type": "Element",
...
@dataclass
class OriginalPaymentInstruction46:
    ...
    tx_inf_and_sts: List[PaymentTransaction145] = field(
        default_factory=list,
        metadata={
            "name": "TxInfAndSts",
            "type": "Element",
...
@dataclass
class CreditorPaymentActivationRequestStatusReportV10:
    grp_hdr: Optional[GroupHeader106] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    orgnl_pmt_inf_and_sts: List[OriginalPaymentInstruction46] = field(
        default_factory=list,
        metadata={
