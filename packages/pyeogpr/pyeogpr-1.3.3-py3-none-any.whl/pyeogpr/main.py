...
class Datacube:
    ...
    ----------
        ...
        bands : default is None
            If you use your own model, you will ned to provide a list of bands that are used by your model-sensor
            e.g.: bands = ['B02', 'B03', 'B04', 'B05', 'B06', 'B07']
        
    """
    def __init__(self,sensor:str, biovar: str, bounding_box: list, temporal_extent: list, cloudmask = False, bands = None):
    ...
    def construct_datacube(self, composite=None):
        ...
        if self.bands:
            ...
            scale_factor = self.sensors_dict[self.sensor]["scale_factor"]

        data = self.connection.load_collection(self.sensor,
                                       self.spatial_extent,
                                       self.temporal_extent,
                                       self.bands) * scale_factor
    ...
    def process_map(self, gapfill = False, own_model = None):
        ...
        own_model : Default is None
            If you have developed your own ARTMO GPR vegetation trait model, provide the the file
            directory. For example: "own_model = C:\Users\Username\custom_artmo_model.py"
            Furthermore, you need to define the bands that are used by your model-sensor
            For example, bands = ['B02', 'B03', 'B04', 'B05', 'B06', 'B07']
