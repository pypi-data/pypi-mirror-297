...
def initialize_db():
    ...
    # If the database file was newly created, set the permissions to allow all users to write
    if not db_exists:
        # Allow read and write for all users (user, group, and others)
        os.chmod(DB_FILE, stat.S_IRWXU | stat.S_IRWXG | stat.S_IRWXO)  # rwxrwxrwx (777)
