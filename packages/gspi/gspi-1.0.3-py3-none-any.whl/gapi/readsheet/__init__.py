...
def getsheets(sheetid,creds_file,token_file):
    creds = None
...
def get_all_data(sheetid,sheetname,creds_file,token_file):
    creds = None
    SCOPES = ['https://www.googleapis.com/auth/spreadsheets.readonly']
    if os.path.isfile(token_file):
        creds = Credentials.from_authorized_user_file(token_file, SCOPES)
...
def get_specific_data(sheetid,sheetname,header_name,creds_file,token_file):
    creds = None
    SCOPES = ['https://www.googleapis.com/auth/spreadsheets.readonly']
    if os.path.isfile(token_file):
        creds = Credentials.from_authorized_user_file(token_file, SCOPES)
