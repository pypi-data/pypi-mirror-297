...
class TestPlaystorescraperAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = PlaystorescraperAPIClient(self.api_key)

    @patch('apiverve_playstorescraper.apiClient.requests.get')
