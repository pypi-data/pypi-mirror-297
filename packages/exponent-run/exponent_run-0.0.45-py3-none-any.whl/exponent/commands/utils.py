...
def check_exponent_version(force: bool = False) -> None:
    """
    ...
    upgrade_exponent(new_version, show_rerun_message=False)


def upgrade_exponent(new_version: str, show_rerun_message: bool = True) -> None:
    """
