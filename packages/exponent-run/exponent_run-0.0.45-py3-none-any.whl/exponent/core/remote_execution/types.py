...
class HeartbeatInfo(BaseModel):
    exponent_version: str = get_version()
...
class RemoteFile(BaseModel):
    ...
    def resolve(self, client_working_directory: str) -> str:
        working_directory = Path(self.working_directory, self.file_path)

        if not working_directory.is_absolute():
            working_directory = Path(client_working_directory, working_directory)
