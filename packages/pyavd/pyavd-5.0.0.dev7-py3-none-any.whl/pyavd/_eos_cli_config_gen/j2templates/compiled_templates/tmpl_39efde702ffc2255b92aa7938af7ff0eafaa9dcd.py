            ...
            for l_2_subnet, l_2_loop in LoopContext(t_2(environment.getattr(l_1_dhcp_server, 'subnets')), undefined):
                ...
                if t_5(environment.getattr(l_2_subnet, 'reservations')):
                    ...
                    for l_3_reservation, l_3_loop in LoopContext(t_2(environment.getattr(l_2_subnet, 'reservations'), 'mac_address'), undefined):
                        _loop_vars = {}
                        pass
                        if t_5(environment.getattr(l_3_reservation, 'mac_address')):
                            pass
                            yield '         mac-address '
...
blocks = {}
debug_info = '7=48&8=51&9=55&10=57&11=59&14=62&15=64&18=67&20=73&21=76&23=78&26=81&28=87&29=90&31=92&32=95&34=97&35=100&37=102&38=105&40=107&41=110&43=113&45=117&46=119&48=123&49=126&50=129&51=131&52=134&54=136&55=139&57=141&58=144&61=146&66=150&68=154&70=159&71=162&73=164&74=167&76=169&79=172&81=178&82=181&85=184&88=187&90=191&91=193&92=196&93=199&94=203&95=206&96=210&97=213&101=219&102=222'