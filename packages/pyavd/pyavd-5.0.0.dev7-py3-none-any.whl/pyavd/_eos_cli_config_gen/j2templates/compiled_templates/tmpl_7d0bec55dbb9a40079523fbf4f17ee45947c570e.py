...
def root(context, missing=missing):
    ...
    for l_1_ethernet_interface in t_3((undefined(name='ethernet_interfaces') if l_0_ethernet_interfaces is missing else l_0_ethernet_interfaces), 'name'):
        ...
        if t_10(environment.getattr(environment.getattr(l_1_ethernet_interface, 'encapsulation_dot1q'), 'vlan')):
            ...
            yield '\n'
        elif t_10(environment.getattr(environment.getattr(environment.getattr(l_1_ethernet_interface, 'encapsulation_vlan'), 'client'), 'protocol')):
            pass
            ...
            if ((undefined(name='client_protocol') if l_1_client_protocol is missing else l_1_client_protocol) in ['dot1q', 'dot1ad']):
                ...
                if t_10(environment.getattr(environment.getattr(environment.getattr(l_1_ethernet_interface, 'encapsulation_vlan'), 'client'), 'vlan')):
                    ...
                    pass
                    if t_10(environment.getattr(environment.getattr(environment.getattr(l_1_ethernet_interface, 'encapsulation_vlan'), 'client'), 'inner_protocol')):
                        pass
                ...
                if ((((undefined(name='client_protocol') if l_1_client_protocol is missing else l_1_client_protocol) in ['dot1q', 'dot1ad', 'untagged']) and t_10(environment.getattr(environment.getattr(environment.getattr(l_1_ethernet_interface, 'encapsulation_vlan'), 'network'), 'protocol'))) and (not (undefined(name='network_flag') if l_1_network_flag is missing else l_1_network_flag))):
                    ...
                    if ((undefined(name='network_protocol') if l_1_network_protocol is missing else l_1_network_protocol) in ['dot1q', 'dot1ad']):
                        ...
                        if t_10(environment.getattr(environment.getattr(environment.getattr(l_1_ethernet_interface, 'encapsulation_vlan'), 'network'), 'vlan')):
                            ...
                            pass
                            if t_10(environment.getattr(environment.getattr(environment.getattr(l_1_ethernet_interface, 'encapsulation_vlan'), 'network'), 'inner_protocol')):
                                pass
        ...
        if t_10(environment.getattr(l_1_ethernet_interface, 'eos_cli')):
            ...
            yield '\n'
    l_1_ethernet_interface = l_1_encapsulation_cli = l_1_encapsulation_dot1q_cli = l_1_client_protocol = l_1_network_flag = l_1_network_protocol = l_1_dfe_algo_cli = l_1_dfe_hold_time_cli = l_1_aaa_config = l_1_actions = l_1_host_mode_cli = l_1_auth_cli = l_1_auth_failure_fallback_mba = l_1_address_locking_cli = l_1_backup_link_cli = l_1_host_proxy_cli = l_1_tcp_mss_ceiling_cli = l_1_interface_ip_nat = l_1_hide_passwords = l_1_poe_link_down_action_cli = l_1_poe_limit_cli = l_1_frequency_cli = missing
