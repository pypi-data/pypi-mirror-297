...
def root(context, missing=missing):
    ...
    if t_12((undefined(name='ethernet_interfaces') if l_0_ethernet_interfaces is missing else l_0_ethernet_interfaces)):
        ...
        for l_1_ethernet_interface in t_3((undefined(name='ethernet_interfaces') if l_0_ethernet_interfaces is missing else l_0_ethernet_interfaces), 'name'):
            ...
            elif t_12(environment.getattr(environment.getattr(environment.getattr(l_1_ethernet_interface, 'encapsulation_vlan'), 'client'), 'protocol')):
                pass
        ...
        if (t_9((undefined(name='flexencap_interfaces') if l_0_flexencap_interfaces is missing else l_0_flexencap_interfaces)) > 0):
            ...
            for l_1_ethernet_interface in (undefined(name='flexencap_interfaces') if l_0_flexencap_interfaces is missing else l_0_flexencap_interfaces):
                ...
                l_1_vlan_id = t_1(environment.getattr(l_1_ethernet_interface, 'vlan_id'), '-')
                _loop_vars['vlan_id'] = l_1_vlan_id
                l_1_client_protocol = t_1(environment.getattr(environment.getattr(environment.getattr(l_1_ethernet_interface, 'encapsulation_vlan'), 'client'), 'protocol'), '-')
                ...
                if ((undefined(name='client_protocol') if l_1_client_protocol is missing else l_1_client_protocol) in ['dot1q', 'dot1ad']):
                    pass
                    l_1_client_inner_protocol = t_1(environment.getattr(environment.getattr(environment.getattr(l_1_ethernet_interface, 'encapsulation_vlan'), 'client'), 'inner_protocol'), '-')
                ...
                l_1_network_protocol = t_1(environment.getattr(environment.getattr(environment.getattr(l_1_ethernet_interface, 'encapsulation_vlan'), 'network'), 'protocol'), '-')
                ...
                if ((undefined(name='network_protocol') if l_1_network_protocol is missing else l_1_network_protocol) in ['dot1q', 'dot1ad']):
                    pass
                    l_1_network_inner_protocol = t_1(environment.getattr(environment.getattr(environment.getattr(l_1_ethernet_interface, 'encapsulation_vlan'), 'network'), 'inner_protocol'), '-')
                ...
                yield ' |\n'
            l_1_ethernet_interface = l_1_description = l_1_vlan_id = l_1_client_protocol = l_1_client_inner_protocol = l_1_client_vlan = l_1_client_outer_vlan = l_1_client_inner_vlan = l_1_network_protocol = l_1_network_inner_protocol = l_1_network_vlan = l_1_network_outer_vlan = l_1_network_inner_vlan = missing
