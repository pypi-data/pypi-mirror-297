...
from botrun_ask_folder.models.reference import Reference
...
def query_qdrant_knowledge_base(
    ...
    qdrant_client_instance = QdrantClient(
        qdrant_host, port=qdrant_port, api_key=qdrant_api_key, https=False
    )
...
def get_reference_content_from_messages(messages: List[Dict]) -> List[Reference]:
...
def rag_plus_completion_call(
    ...
    try:
        ...
        lst_references = get_reference_content_from_messages(messages)
        reference_content = ""
