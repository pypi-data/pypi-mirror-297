...
class TestMoonrisemoonsetAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = MoonrisemoonsetAPIClient(self.api_key)

    @patch('apiverve_moonrisemoonset.apiClient.requests.get')
