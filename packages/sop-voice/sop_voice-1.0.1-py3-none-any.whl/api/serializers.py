...
class SDA_ListSerializer(NetBoxModelSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name='plugins-api:sop_voice-api:sda_list-detail'
    )
...
class NestedSDA_ListSerializer(WritableNestedSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name='plugins-api:sop_voice-api:sda_list-detail'
    )
