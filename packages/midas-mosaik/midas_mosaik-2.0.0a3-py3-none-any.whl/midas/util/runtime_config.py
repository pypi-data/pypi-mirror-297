...
CONFIG_FILE_PATHS = [
    f"{appdirs.site_config_dir('midas2', 'OFFIS')}/{CONFIG_FILE_NAME}",
    f"{appdirs.user_config_dir('midas2', 'OFFIS')}/{CONFIG_FILE_NAME}",
...
DEFAULT_BASE_CONFIG = {
    ...
    "paths": {
        "data_path": (
            f"{appdirs.user_config_dir('midas2', 'OFFIS')}/{DATA_DIR_NAME}"
        ),
        # "output_path": f"{getcwd()}/_outputs",
        "output_path": OUTPUT_DIR_NAME,
        "scenario_path": (
            f"{appdirs.user_config_dir('midas2', 'OFFIS')}/{SCENARIO_DIR_NAME}"
        ),
    },
    "data": {
        "commercials": {
