...
def get_voxelcity(rectangle_vertices, building_source, land_cover_source, dem_source, meshsize, cancel_dem=False, remove_perimeter_object=None, mapvis=False, voxelvis=False):
