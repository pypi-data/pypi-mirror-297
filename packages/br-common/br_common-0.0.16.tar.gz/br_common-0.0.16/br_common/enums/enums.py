...
class ErrorMessages(Enum):
    ...
    AWS_S3_EXCEPTION = "Something went wrong. Please try again later."
    AWS_S3_BUCKET_REGION_ERROR = "Failed to retrieve bucket region from S3."
    AWS_S3_FOLDER_CREATE_ERROR = "Failed to create the folder on S3."
    AWS_S3_FOLDER_DELETE_ERROR = "Failed to create the folder on S3."
    AWS_S3_FILE_UPLOAD_ERROR = "Unable to upload files at this time. Please try again later."
    AWS_S3_PRESIGNED_URL_ERROR = "Failed to generate pre-signed URL. Please try again later."
    ...
    PASSWORD_RESET_FAILED = "You can't use any of your last 3 passwords."
