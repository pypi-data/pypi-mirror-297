...
from KAFY.models_loader import (
...
def add_model(model_family, source, config_path, save_as_name):
    ...
    model.config.training_args_path = "/speakingTrajectories/KAFYGitHubRepo/KAFY/Let'sSpeakTrajectories/KAFY/KAFY/assets/training_args.json"
    ...
    print("Model architecture inially saved to transformersPlugin")
...
def parse_command(command=None):
    ...
    start_new_project_match = re.match(
