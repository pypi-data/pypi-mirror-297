...
class TestUseragentgeneratorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = UseragentgeneratorAPIClient(self.api_key)

    @patch('apiverve_useragentgenerator.apiClient.requests.get')
