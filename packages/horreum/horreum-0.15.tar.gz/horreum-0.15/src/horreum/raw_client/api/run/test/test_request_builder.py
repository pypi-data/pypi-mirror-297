...
class TestRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Run, request_configuration: Optional[RequestConfiguration[TestRequestBuilderPostQueryParameters]] = None) -> bytes:
        """
        Upload a new Run
    ...
    def to_post_request_information(self,body: Run, request_configuration: Optional[RequestConfiguration[TestRequestBuilderPostQueryParameters]] = None) -> RequestInformation:
        """
        Upload a new Run
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class TestRequestBuilderPostRequestConfiguration(RequestConfiguration[TestRequestBuilderPostQueryParameters]):
        """
