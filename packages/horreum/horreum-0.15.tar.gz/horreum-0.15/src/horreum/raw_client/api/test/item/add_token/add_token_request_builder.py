...
class AddTokenRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: TestToken, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[int]:
        """
    ...
    def to_post_request_information(self,body: TestToken, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Add a Test API Token for access to provide access to a test data for integrated tooling, e.g. reporting services
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> AddTokenRequestBuilder:
        """
    ...
    @dataclass
    class AddTokenRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
