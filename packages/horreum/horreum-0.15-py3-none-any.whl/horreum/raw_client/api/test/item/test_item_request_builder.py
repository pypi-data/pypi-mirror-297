...
class TestItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[TestItemRequestBuilderGetQueryParameters]] = None) -> Optional[Test]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[TestItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Retrieve a test by id
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
    ...
    @dataclass
    class TestItemRequestBuilderGetRequestConfiguration(RequestConfiguration[TestItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
