...
# This function is to get built-in file location in legacy old way
# There is a new way in using new way along with pyproject.toml
...
def main():
    ...
    parser.add_argument('--version', action='version', version='8.3.0'),
