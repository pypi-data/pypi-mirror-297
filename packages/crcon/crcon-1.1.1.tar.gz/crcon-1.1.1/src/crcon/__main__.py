...
def print_help():
    ...
    {Style.bold()}Commands:{Style.reset()}
        ...
        style <style>        {Color.text("#6c0")}# Apply a style (italic, bold, doubleunderlined, faint, hidden, normalintensity, overlined, propspacing, reverse, strikethrough, underline){Color.default_text()}
