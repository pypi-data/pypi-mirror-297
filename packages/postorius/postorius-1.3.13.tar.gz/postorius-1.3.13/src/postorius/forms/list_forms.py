...
class MessageAcceptanceForm(ListSettingsForm):
    ...
    accept_these_nonmembers = ListOfStringsField(
        ...
        help_text=_(
            ...
            'addresses or other lists on this server whose members'
            ' are allowed to post to this mailing list without'
            ' subscribing to the list.'
            " Entries beginning with `^' are regexps and are matched against"
            ' the sender addresses in the message.'
            " Entries beginning with `@' are other mailman lists on this"
            ' server whose members will be matched.'
