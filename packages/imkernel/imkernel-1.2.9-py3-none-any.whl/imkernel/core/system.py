...
class Method(IndustryModel):
    ...
    def get_group_name_df(self):
        ...
        :return:
        """
        return pd.DataFrame(self.tree.get_no_tag_nodes(), columns=["method type"])
    ...
    def add_input_parameter_data(self, id: str, data_list):
        """
        增加参数输入数据
        :param id:唯一标识符
        :param data_list: 需要增加的参数数据列表
    ...
    def add_output_parameter_data(self, id: str, data_list):
        """
        增加参数输出数据
        :param id:唯一标识符
        :param data_list: 需要增加的参数数据列表
    ...
    input_parameter_data = add_input_parameter_data
    output_parameter_data = add_output_parameter_data
