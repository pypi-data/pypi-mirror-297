...
class GitHubDatabase:
    ...
    def write_data(self, path: str, data: str, message: str = "Updated data") -> int:
        ...
        try:
            ...
            return 500  # Indicate an error occurred
    ...
    def generate_example() -> None:
        """Generates an example script with base code on how to use our database."""
...
class PlayerDataSystem:
    ...
    def save_player_data(self, username: str, player_instance: Any, attributes: Optional[List[str]] = None) -> None:
        ...
        try:
            ...
            print(colored_text("RED", f"Error: {e}"))
            print(colored_text("GREEN", "Attempting to save to offline backup version [this will not affect online saves]"))
    ...
    def save_offline_data(self, username: str, player_instance: Any, attributes: Optional[List[str]] = None) -> None:
        ...
        # Grab the file name
        name: str = player_instance.username if player_instance.username else player_instance.first_name if player_instance.first_name else "example_username"
    ...
    def delete_account(self, username: str) -> int:
        ...
        try:
            ...
            print(colored_text("RED", f"Error: {e}"))
            print(colored_text("GREEN", "Attempting to delete offline backup version [this will not affect online saves]"))
