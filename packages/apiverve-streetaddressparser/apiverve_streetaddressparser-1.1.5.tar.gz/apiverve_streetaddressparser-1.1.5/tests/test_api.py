...
class TestStreetaddressparserAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = StreetaddressparserAPIClient(self.api_key)

    @patch('apiverve_streetaddressparser.apiClient.requests.get')
