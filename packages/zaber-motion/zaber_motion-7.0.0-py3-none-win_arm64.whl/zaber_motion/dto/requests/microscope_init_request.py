...
class MicroscopeInitRequest:
    ...
    third_party: ThirdPartyComponents = field(default_factory=ThirdPartyComponents.zero_values)
    ...
    def zero_values() -> 'MicroscopeInitRequest':
        return MicroscopeInitRequest(
            ...
            force=False,
            third_party=ThirdPartyComponents.zero_values(),
        )
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            'thirdParty': self.third_party.to_dict(),
        }
    ...
    def from_dict(data: Dict[str, Any]) -> 'MicroscopeInitRequest':
        return MicroscopeInitRequest(
            ...
            third_party=ThirdPartyComponents.from_dict(data.get('thirdParty')),  # type: ignore
        )
    ...
    def validate(self) -> None:
        ...
        if self.third_party is None:
            raise ValueError(f'Property "ThirdParty" of "MicroscopeInitRequest" is None.')

        if not isinstance(self.third_party, ThirdPartyComponents):
            raise ValueError(f'Property "ThirdParty" of "MicroscopeInitRequest" is not an instance of "ThirdPartyComponents".')
