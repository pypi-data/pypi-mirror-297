...
__all__ = (
    ...
    "PublicAccessBlockConfigTypeDef",
...
GetPublicAccessBlockConfigRequestRequestTypeDef = TypedDict(
    "GetPublicAccessBlockConfigRequestRequestTypeDef",
    {
        "ResourceArn": str,
    },
)
PublicAccessBlockConfigTypeDef = TypedDict(
    "PublicAccessBlockConfigTypeDef",
    {
        "BlockPublicPolicy": NotRequired[bool],
        "RestrictPublicResource": NotRequired[bool],
    },
)
...
GetPublicAccessBlockConfigResponseTypeDef = TypedDict(
    "GetPublicAccessBlockConfigResponseTypeDef",
    {
        "PublicAccessBlockConfig": PublicAccessBlockConfigTypeDef,
        "ResponseMetadata": ResponseMetadataTypeDef,
    },
)
PutPublicAccessBlockConfigRequestRequestTypeDef = TypedDict(
    "PutPublicAccessBlockConfigRequestRequestTypeDef",
    {
        "ResourceArn": str,
        "PublicAccessBlockConfig": PublicAccessBlockConfigTypeDef,
...
PutPublicAccessBlockConfigResponseTypeDef = TypedDict(
    "PutPublicAccessBlockConfigResponseTypeDef",
    {
        "PublicAccessBlockConfig": PublicAccessBlockConfigTypeDef,
        "ResponseMetadata": ResponseMetadataTypeDef,
