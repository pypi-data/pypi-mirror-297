...
class Model:
    ...
    def add_constraint_from_expression(self, equation: Equation, inequality_tolerance: float=0):
        """
        ℹ️ **This feature is experimental and may change.**
        ...
        mask, bounds = equation.generate_constraint(self._variables, inequality_tolerance)
