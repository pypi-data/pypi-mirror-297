...
from ..db import QueryManager, get_scoped_session
...
class ModelRestApi(BaseApi):
    ...
    def get_api_session(self):
        ...
        """
        return get_scoped_session(getattr(self.datamodel.obj, "__bind_key__", None))
    ...
    async def get_list_headless(
        ...
        count_task = asyncio.create_task(
            smart_run(query.count, session, q.filters, filter_classes)
        )
    ...
    async def get_headless(
        ...
        """
        try:
            id = self.datamodel.obj_id(id=id).id
