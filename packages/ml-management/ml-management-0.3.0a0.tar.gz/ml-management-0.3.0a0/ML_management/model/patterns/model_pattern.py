...
from ML_management.mlmanagement.utils import INIT_FUNCTION_NAME
    ...
    def __init__(self):
        ...
        for frame in inspect.stack():
            if frame.function != "__init__":
                if frame.function == INIT_FUNCTION_NAME:
                    self.artifacts = os.path.dirname(frame.filename) + "/artifacts"
                else:
                    warnings.warn("Cannot setup self.artifacts path automatically.")
                break
