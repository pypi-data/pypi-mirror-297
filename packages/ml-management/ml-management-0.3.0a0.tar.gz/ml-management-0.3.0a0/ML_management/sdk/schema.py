...
class DatasetLoaderVersion(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('creation_timestamp', 'data_json_schema', 'dataset_loader', 'dataset_loader_method_schema_names', 'dataset_loader_method_schemas', 'description', 'last_updated_timestamp', 'list_deployed_jobs', 'name', 'pagination_deployed_jobs', 'run', 'source_path', 'tags', 'version')
    creation_timestamp = sgqlc.types.Field(sgqlc.types.non_null(LONG), graphql_name='creationTimestamp')
...
class ExecutorVersion(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('available_collectors', 'available_dataset_loader_versions', 'available_dataset_loaders', 'available_model_versions', 'available_models', 'build_job', 'creation_timestamp', 'description', 'desired_dataset_loader_methods', 'desired_model_methods', 'desired_model_patterns', 'executor', 'executor_method_schema', 'executor_method_schema_name', 'job_json_schema', 'job_json_schema_for_dataset_loaders', 'job_json_schema_for_models', 'job_json_schema_for_role_dataset_loader', 'job_json_schema_for_role_model', 'last_updated_timestamp', 'list_deployed_jobs', 'name', 'pagination_available_collectors', 'pagination_available_dataset_loader_versions', 'pagination_available_dataset_loaders', 'pagination_available_model_versions', 'pagination_available_models', 'pagination_deployed_jobs', 'run', 'source_path', 'tags', 'upload_model_modes', 'version')
...
class ModelVersion(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('available_collectors', 'available_dataset_loader_versions', 'available_dataset_loaders', 'available_executor_versions', 'available_executors', 'build_job', 'creation_timestamp', 'description', 'group_job_run', 'group_job_run_id', 'last_updated_timestamp', 'list_deployed_jobs', 'list_eval_run', 'list_lineage_model_version', 'list_new_model_from_version', 'list_new_version_from_version', 'list_next_graph_nodes', 'list_next_model_version', 'model', 'model_method_schemas', 'name', 'pagination_available_collectors', 'pagination_available_dataset_loader_versions', 'pagination_available_dataset_loaders', 'pagination_available_executor_versions', 'pagination_available_executors', 'pagination_deployed_jobs', 'pagination_eval_run', 'pagination_lineage_model_version', 'pagination_new_model_from_version', 'pagination_new_version_from_version', 'pagination_next_model_version', 'root_model_version', 'root_run', 'run', 'source_executor_version', 'source_model_version', 'source_path', 'source_run', 'tags', 'upload_model_type', 'venv_build_job', 'version')
    available_collectors = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(InlineObject))), graphql_name='availableCollectors')
...
class Run(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('artifact_uri', 'end_time', 'experiment', 'experiment_id', 'get_conda_env', 'lifecycle_stage', 'list_artifacts', 'list_mlflow_artifacts', 'list_requirements', 'params', 'parent_job', 'run_id', 'start_time', 'status', 'tags')
