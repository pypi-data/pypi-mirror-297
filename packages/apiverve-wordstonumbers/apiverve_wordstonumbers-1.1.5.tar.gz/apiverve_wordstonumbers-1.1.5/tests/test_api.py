...
class TestWordstonumbersAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = WordstonumbersAPIClient(self.api_key)

    @patch('apiverve_wordstonumbers.apiClient.requests.get')
