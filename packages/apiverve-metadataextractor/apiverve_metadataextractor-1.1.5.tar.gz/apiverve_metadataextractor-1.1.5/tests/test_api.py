...
class TestMetadataextractorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = MetadataextractorAPIClient(self.api_key)

    @patch('apiverve_metadataextractor.apiClient.requests.get')
