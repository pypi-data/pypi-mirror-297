...
from .type_defs import (
    ...
    GetPublicAccessBlockConfigRequestRequestTypeDef,
    GetPublicAccessBlockConfigResponseTypeDef,
    ...
    PutPublicAccessBlockConfigRequestRequestTypeDef,
    PutPublicAccessBlockConfigResponseTypeDef,
...
class LambdaClient(AioBaseClient):
    ...
    async def delete_resource_policy(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/lambda.html#Lambda.Client.delete_resource_policy)
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_lambda/client/#delete_resource_policy)
        """
    ...
    async def get_public_access_block_config(
        self, **kwargs: Unpack[GetPublicAccessBlockConfigRequestRequestTypeDef]
    ) -> GetPublicAccessBlockConfigResponseTypeDef:
        """
        .

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/lambda.html#Lambda.Client.get_public_access_block_config)
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_lambda/client/#get_public_access_block_config)
        """
    ...
    async def get_resource_policy(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/lambda.html#Lambda.Client.get_resource_policy)
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_lambda/client/#get_resource_policy)
        """
    ...
    async def put_public_access_block_config(
        self, **kwargs: Unpack[PutPublicAccessBlockConfigRequestRequestTypeDef]
    ) -> PutPublicAccessBlockConfigResponseTypeDef:
        """
        .

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/lambda.html#Lambda.Client.put_public_access_block_config)
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_lambda/client/#put_public_access_block_config)
        """
    ...
    async def put_resource_policy(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/lambda.html#Lambda.Client.put_resource_policy)
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_lambda/client/#put_resource_policy)
        """
