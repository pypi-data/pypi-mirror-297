...
class TestTenseconverterAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = TenseconverterAPIClient(self.api_key)

    @patch('apiverve_tenseconverter.apiClient.requests.get')
