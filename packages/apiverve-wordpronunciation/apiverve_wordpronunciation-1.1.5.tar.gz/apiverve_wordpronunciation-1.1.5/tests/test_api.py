...
class TestWordpronunciationAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = WordpronunciationAPIClient(self.api_key)

    @patch('apiverve_wordpronunciation.apiClient.requests.get')
