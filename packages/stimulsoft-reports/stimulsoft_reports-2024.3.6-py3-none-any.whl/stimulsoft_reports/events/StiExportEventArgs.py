...
### Properties
    ...
    def format(self, value: StiExportFormat):
        ...
        if not isinstance(self.__settings, StiExportSettings):
    ...
    def settings(self, value):
        ...
        if self.__format != None and isinstance(value, dict):
            self.__settings = StiExportFormat.getExportSettings(self.format)
