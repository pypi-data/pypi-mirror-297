...
### HTML
    ...
    def _getComponentHtml(self) -> str:
        ...
        processPrepareVariables = self.onPrepareVariables.hasServerCallbacks()
        result += self.onPrepareVariables.getHtml(processPrepareVariables, False, processPrepareVariables)
