...
class Api(object):
    ...
    def api_version(self):
        ...
        :rtype: str
        """
        if "syspass_api_version" in os.environ:
            return os.environ["syspass_api_version"]
        else:
    ...
    def api_url(self):
        if (
            ...
            return os.environ["syspass_api_url"]
    ...
    def api_directory(self, directory=None):
        ...
        if directory is None:
            if self.__api_directory != os.path.join(
                os.path.dirname(os.path.abspath(__file__)), "api_definition"
            ):
                self.__api_directory = os.path.join(
                    os.path.dirname(os.path.abspath(__file__)), "api_definition"
                )
