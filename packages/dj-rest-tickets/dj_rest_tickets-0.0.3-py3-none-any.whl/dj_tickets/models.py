...
SupportTeam : type[AbstractSupportTeam] = apps.get_model(settings.DJ_REST_TICKETS['SupportTeam'],require_ready=False)
...
SupportTeamMember : type[AbstractSupportTeamMember] = apps.get_model(settings.DJ_REST_TICKETS['SupportTeamMember'],require_ready=False)
...
Ticket : type[AbstractTicket] = apps.get_model(settings.DJ_REST_TICKETS['Ticket'],require_ready=False)
...
TicketMessage : type[AbstractTicketMessage] = apps.get_model(settings.DJ_REST_TICKETS['TicketMessage'],require_ready=False)
