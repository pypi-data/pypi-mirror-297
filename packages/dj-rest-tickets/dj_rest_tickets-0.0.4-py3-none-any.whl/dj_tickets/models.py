...
SupportTeam : type[AbstractSupportTeam] = apps.get_model(get_settings().get('SupportTeam','dj_tickets.DefaultSupportTeam'),require_ready=False)
...
SupportTeamMember : type[AbstractSupportTeamMember] = apps.get_model(get_settings().get('SupportTeamMember','dj_tickets.DefaultSupportTeamMember'),require_ready=False)
...
Ticket : type[AbstractTicket] = apps.get_model(get_settings().get('Ticket','dj_tickets.DefaultTicket'),require_ready=False)
...
TicketMessage : type[AbstractTicketMessage] = apps.get_model(get_settings().get('TicketMessage','dj_tickets.DefaultTicketMessage'),require_ready=False)
