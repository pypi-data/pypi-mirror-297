...
from .settings import open_config_file, config
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('-w', '--wait-for-enter', action='store_true', help="Wait for Enter key press before executing console command")
...
def handle_command(args: argparse.Namespace):
    ...
    config.is_wait_for_enter = args.wait_for_enter
