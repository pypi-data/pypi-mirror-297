...
from .helpers import analize_message, get_string_size_kb, style, tokens_from_messages
...
def conversation(work_folder: str, full_scan: bool = False, structure_only: bool = False, initial_message: str = None) -> None:
    try:
        ...
        while True:
            ...
            if not is_skip_user_question:
                handle_user_interaction(messages)

            # analize_message(messages)
            chat_response = chat_completion_request(messages, config.functions)
