...
- radius (number; required)"""
    ...
    def __init__(self, children=None, id=Component.UNDEFINED, key=Component.UNDEFINED, className=Component.UNDEFINED, center=Component.REQUIRED, radius=Component.REQUIRED, pathOptions=Component.UNDEFINED, editable=Component.UNDEFINED, nClicks=Component.UNDEFINED, mouseOverCount=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'center', 'className', 'editable', 'key', 'loading_state', 'mouseOverCount', 'nClicks', 'pathOptions', 'radius']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'center', 'className', 'editable', 'key', 'loading_state', 'mouseOverCount', 'nClicks', 'pathOptions', 'radius']
