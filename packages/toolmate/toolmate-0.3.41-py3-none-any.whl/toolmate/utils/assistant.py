...
{code}```'''
    ...
    def setToolSelectionConfigs_old(self):
        self.configureToolSelectionAgent()
...
{writing}""")
    ...
    def processSingleAction(self, action: str, description: str, gui: bool=False) -> Optional[bool]:
        ...
        if action == "chat":
            ...
            Plugins.checkAvailableTools(display=False)
...
{description}"""
            ...
            if config.tool_selection_agent:
                ...
                if selectedTool:
                    ...
                    return self.runSingleAction(action, description, gui)
                else:
                    return None
            else:
                return None
...
{files if files else "Not found!"}'''
    ...
    def runSingleAction(self, action: str, description: str, gui: bool=False) -> bool:
        chatOnly = self.processSingleAction(action, description, gui)
