...
{files if files else "Not found!"}'''
    ...
    def streamResponseGui(self, response: str):
        ...
    ...
    def runMultipleActions(self, content: str):
        ...
        if not actions:
            if content.strip():
                ...
                complete = self.runSingleAction("", content)
                if not complete:
                    return False
        else:
            separator = "＊@＊@＊"
            ...
            for index, action in enumerate(actions):
                ...
                if description.strip():
                    ...
                    if action == "deep_reflection":
                        ...
                        complete = self.runSingleAction("context", description)
                        if not complete:
                            return False
                        # review
                        ...
                        complete = self.runSingleAction("chat", description)
                        if not complete:
                            return False
                        # refine
                        message = '''\n@chat: Refine ...\n'''
                        ...
                        message = f'''\n@{action}: {description}'''
                        displayActionMessage(message)
                        complete = self.runSingleAction(action, description)
                        if not complete:
                            return False
        return True
