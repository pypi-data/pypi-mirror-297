...
from toolmate import print1, print2, print3, getPythonFunctionResponse, extractPythonCode, encode_image, selectEnabledTool
...
Remember, output the new copy of python code ONLY, without additional notes or explanation."""
    ...
    def runGeniusCall(messages: dict, chatOnly: bool = False):
        user_request = messages[-1]["content"]
        if not config.selectedTool and chatOnly:
