...
from .tools import get_tool_defs, maybe_execute_tools
...
def converse(
    ...
    (name_to_tool, tool_defs) = get_tool_defs(tools)
    tool_config: ToolConfigurationTypeDef = {"tools": tool_defs}
    ...
    tool_results = maybe_execute_tools(response["output"]["message"], name_to_tool)
