...
def main():
    ...
    prod_dm._checkemptydir(output_pattern)
    #if not result["OK"]:
    #    return result
    ...
    if update_ts:
        ...
        for out_lfn in out_lfn_list:
            ...
            for in_lfn in in_lfn_list:
                ...
                elif out_run_number in in_file_name:
                    map_lfn[out_lfn] = in_lfn
                else:
                    unprocessed_lfn_list.append(in_lfn)
        ...
        for lfn in unprocessed_lfn_list:
