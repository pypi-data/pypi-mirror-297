...
class Operation(google.protobuf.message.Message):
    ...
    IS_COMBINABLE_FIELD_NUMBER: builtins.int
    ...
    is_combinable: builtins.bool
    """Is this a "combinable setup"
    if this part of the price needs to be filled in later
    for example setups will be combined at the bottom of
    the invoice rather than listed as a subcomponent here
    if true: price represents ceil( sum(utilization) ) * price
    """
    duration: builtins.float
    """how long did this operation take in seconds
    if `combine=True` this is the length of 1.0 utilization
    """
    utilization: builtins.float
    """how much of this setup does ONE part consume
    ...
    def ClearField(self, field_name: typing_extensions.Literal["duration", b"duration", "is_combinable", b"is_combinable", "note", b"note", "operation_id", b"operation_id", "price", b"price", "utilization", b"utilization"]) -> None: ...
...
class LinePrice(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["outcome", b"outcome", "stock", b"stock", "total", b"total", "unit", b"unit"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["address_id", b"address_id", "description", b"description", "extents", b"extents", "mass", b"mass", "method_id", b"method_id", "operations", b"operations", "outcome", b"outcome", "part_id", b"part_id", "quantity", b"quantity", "shop_id", b"shop_id", "stock", b"stock", "total", b"total", "unit", b"unit"]) -> None: ...
...
class OrderPrice(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["discount", b"discount", "lines", b"lines", "setups", b"setups", "shipping", b"shipping", "taxes", b"taxes", "total", b"total"]) -> None: ...
...
class PriceMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["addresses", b"addresses", "machines", b"machines", "stock", b"stock"]) -> None: ...
