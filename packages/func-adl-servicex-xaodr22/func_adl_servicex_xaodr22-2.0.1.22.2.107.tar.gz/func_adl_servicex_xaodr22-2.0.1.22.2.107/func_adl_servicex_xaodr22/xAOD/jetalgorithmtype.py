...
class JetAlgorithmType:
    ...
    def algName(self, id: func_adl_servicex_xaodr22.xAOD.jetalgorithmtype.JetAlgorithmType.ID) -> func_adl_servicex_xaodr22.str.str:
        "A method"
        ...

    def algId(self, n: func_adl_servicex_xaodr22.str.str) -> func_adl_servicex_xaodr22.xAOD.jetalgorithmtype.JetAlgorithmType.ID:
        "A method"
        ...
