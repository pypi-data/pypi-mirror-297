...
class DevicesApi(object):
    ...
    def get_rotary_turntable_calibration_data(self, device_id, **kwargs):  # noqa: E501
        """GET Rotary Turntable Calibration  # noqa: E501

        Get the calibration data for the device  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_rotary_turntable_calibration_data(device_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_rotary_turntable_calibration_data_with_http_info(device_id, **kwargs)  # noqa: E501

    def get_rotary_turntable_calibration_data_with_http_info(self, device_id, **kwargs):  # noqa: E501
        """GET Rotary Turntable Calibration  # noqa: E501
        ...
        >>> thread = api.get_rotary_turntable_calibration_data_with_http_info(device_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_rotary_turntable_calibration_data" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'device_id' is set
        if self.api_client.client_side_validation and local_var_params.get('device_id') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `device_id` when calling `get_rotary_turntable_calibration_data`")  # noqa: E501

        if self.api_client.client_side_validation and ('device_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['device_id']) > 36):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `device_id` when calling `get_rotary_turntable_calibration_data`, length must be less than or equal to `36`")  # noqa: E501
        if self.api_client.client_side_validation and ('device_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['device_id']) < 36):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `device_id` when calling `get_rotary_turntable_calibration_data`, length must be greater than or equal to `36`")  # noqa: E501
        if self.api_client.client_side_validation and 'device_id' in local_var_params and not re.search(r'[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}', local_var_params['device_id']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `device_id` when calling `get_rotary_turntable_calibration_data`, must conform to the pattern `/[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}/`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/Devices/{device_id}/RotaryTurntableCalibration', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def put_rotary_turntable_calibration_data(self, device_id, **kwargs):  # noqa: E501
        """PUT RotaryTurntableCalibration  # noqa: E501

        Acticate calibration process for Turntable  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.put_rotary_turntable_calibration_data(device_id, async_req=True)
        >>> result = thread.get()

        :param device_id: (required)
        :type device_id: str
        :param position_offset: Position offset 
        :type position_offset: float
        :param barcode_lowest_value: Barcode lowest value
        :type barcode_lowest_value: int
        :param barcode_highest_value: Barcode highest value
        :type barcode_highest_value: int
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.put_rotary_turntable_calibration_data_with_http_info(device_id, **kwargs)  # noqa: E501

    def put_rotary_turntable_calibration_data_with_http_info(self, device_id, **kwargs):  # noqa: E501
        """PUT RotaryTurntableCalibration  # noqa: E501
        ...
        >>> thread = api.put_rotary_turntable_calibration_data_with_http_info(device_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = [
            'device_id',
            'position_offset',
            'barcode_lowest_value',
            'barcode_highest_value'
        ]
        all_params.extend(
            [
                'async_req',
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method put_rotary_turntable_calibration_data" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'device_id' is set
        if self.api_client.client_side_validation and local_var_params.get('device_id') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `device_id` when calling `put_rotary_turntable_calibration_data`")  # noqa: E501

        if self.api_client.client_side_validation and ('device_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['device_id']) > 36):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `device_id` when calling `put_rotary_turntable_calibration_data`, length must be less than or equal to `36`")  # noqa: E501
        if self.api_client.client_side_validation and ('device_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['device_id']) < 36):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `device_id` when calling `put_rotary_turntable_calibration_data`, length must be greater than or equal to `36`")  # noqa: E501
        if self.api_client.client_side_validation and 'device_id' in local_var_params and not re.search(r'[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}', local_var_params['device_id']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `device_id` when calling `put_rotary_turntable_calibration_data`, must conform to the pattern `/[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}/`")  # noqa: E501
        if self.api_client.client_side_validation and 'position_offset' in local_var_params and local_var_params['position_offset'] > 800:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `position_offset` when calling `put_rotary_turntable_calibration_data`, must be a value less than or equal to `800`")  # noqa: E501
        if self.api_client.client_side_validation and 'position_offset' in local_var_params and local_var_params['position_offset'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `position_offset` when calling `put_rotary_turntable_calibration_data`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and 'barcode_lowest_value' in local_var_params and local_var_params['barcode_lowest_value'] > 50:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `barcode_lowest_value` when calling `put_rotary_turntable_calibration_data`, must be a value less than or equal to `50`")  # noqa: E501
        if self.api_client.client_side_validation and 'barcode_lowest_value' in local_var_params and local_var_params['barcode_lowest_value'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `barcode_lowest_value` when calling `put_rotary_turntable_calibration_data`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and 'barcode_highest_value' in local_var_params and local_var_params['barcode_highest_value'] > 800:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `barcode_highest_value` when calling `put_rotary_turntable_calibration_data`, must be a value less than or equal to `800`")  # noqa: E501
        if self.api_client.client_side_validation and 'barcode_highest_value' in local_var_params and local_var_params['barcode_highest_value'] < 750:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `barcode_highest_value` when calling `put_rotary_turntable_calibration_data`, must be a value greater than or equal to `750`")  # noqa: E501
        collection_formats = {}
        ...
        query_params = []
        if local_var_params.get('position_offset') is not None:  # noqa: E501
            query_params.append(('position_offset', local_var_params['position_offset']))  # noqa: E501
        if local_var_params.get('barcode_lowest_value') is not None:  # noqa: E501
            query_params.append(('barcode_lowest_value', local_var_params['barcode_lowest_value']))  # noqa: E501
        if local_var_params.get('barcode_highest_value') is not None:  # noqa: E501
            query_params.append(('barcode_highest_value', local_var_params['barcode_highest_value']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/Devices/{device_id}/RotaryTurntableCalibration', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
