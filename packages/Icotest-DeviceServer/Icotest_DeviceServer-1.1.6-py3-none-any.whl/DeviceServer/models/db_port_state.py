...
class DbPortState(object):
    ...
    def port_state_id(self, port_state_id):
        ...
        if (self.local_vars_configuration.client_side_validation and
                port_state_id is not None and len(port_state_id) > 100):
            raise ValueError("Invalid value for `port_state_id`, length must be less than or equal to `100`")  # noqa: E501
