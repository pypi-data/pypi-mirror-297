...
*DevicesApi* | [**get_rotary_turntable_calibration_data**](docs/DevicesApi.md#get_rotary_turntable_calibration_data) | **GET** /Devices/{device_id}/RotaryTurntableCalibration | GET Rotary Turntable Calibration
...
*DevicesApi* | [**put_rotary_turntable_calibration_data**](docs/DevicesApi.md#put_rotary_turntable_calibration_data) | **PUT** /Devices/{device_id}/RotaryTurntableCalibration | PUT RotaryTurntableCalibration
...
## Documentation For Models
 ...
 - [GetDockerContainerNames200Response](docs/GetDockerContainerNames200Response.md)
