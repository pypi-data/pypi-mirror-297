...
setup(
    ...
    packages=[
        ...
        "WasiPollWorld.wit.imports.wasi.clocks.v0_2_1",
        "WasiPollWorld.wit.imports.wasi.io",
        "WasiPollWorld.wit.imports.wasi.io.v0_2_1"
    ],
    package_data={
        ...
        "WasiPollWorld.wit.imports.wasi.clocks.v0_2_1": ["*.py", "*.pyi", "py.typed"],
        "WasiPollWorld.wit.imports.wasi.io": ["*.py", "*.pyi", "py.typed"],
        "WasiPollWorld.wit.imports.wasi.io.v0_2_1": ["*.py", "*.pyi", "py.typed"]
    }
)
