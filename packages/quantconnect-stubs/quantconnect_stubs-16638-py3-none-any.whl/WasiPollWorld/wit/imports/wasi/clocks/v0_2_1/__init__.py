...
del sys.modules["WasiPollWorld.wit.imports.wasi.clocks.v0_2_1"]
from clr import AddReference
AddReference("WasiPollWorld.wit.imports.wasi.clocks.v0_2_1")
from WasiPollWorld.wit.imports.wasi.clocks.v0_2_1 import *
