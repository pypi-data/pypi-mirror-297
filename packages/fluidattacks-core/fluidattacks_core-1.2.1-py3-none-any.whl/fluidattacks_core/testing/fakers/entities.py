...
def fake_vulnerability(
    *,  # NOSONAR
    ...
    creation_date: str = FIXED_DATE,
    reported_date: str = FIXED_DATE,
) -> dict[str, Any]:
    created_at = datetime.fromisoformat(creation_date).isoformat()
    reported_at = datetime.fromisoformat(reported_date).isoformat()
    ...
    return {
        ...
        "pk_hash": f"HASH#{vuln_hash}",
        "sk_hash": f"ROOT#{root_id}",
        ...
        "unreliable_indicators": {
            ...
            "unreliable_report_date": reported_at,
