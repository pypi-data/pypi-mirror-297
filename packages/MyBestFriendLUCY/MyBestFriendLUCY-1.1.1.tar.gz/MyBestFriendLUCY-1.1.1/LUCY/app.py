...
model = tf.keras.models.load_model('LUCY/eth_lstm_model-30m.h5')  # Adjust the path if necessary
scaler = joblib.load('LUCY/scaler-h.pkl')  # Adjust the path if necessary
