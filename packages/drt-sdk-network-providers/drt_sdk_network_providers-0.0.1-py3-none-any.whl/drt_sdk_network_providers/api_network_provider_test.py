import pytest
from drt_sdk_core import Address, Transaction

from drt_sdk_network_providers.api_network_provider import \
    ApiNetworkProvider
from drt_sdk_network_providers.errors import GenericError
from drt_sdk_network_providers.interface import IPagination
...
class TestApi:
    api = ApiNetworkProvider('https://devnet-api.dharitri.com')
    ...
    def test_get_account(self):
        address = Address.new_from_bech32('moa1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qs67hy0')
        result = self.api.get_account(address)

        assert result.address.to_bech32() == 'moa1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qs67hy0'
        assert result.username == ''

    def test_get_generic_with_bad_address(self):
        with pytest.raises(GenericError, match='a bech32 address is expected'):
            url = 'accounts/moa1bad'
    ...
    def test_get_meta_dcdt(self):
        adr = Address.new_from_bech32('moa1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qs67hy0')
    ...
    def test_get_transaction(self):
        ...
        assert result.sender.to_bech32() == 'moa18s6a06ktr2v6fgxv4ffhauxvptssnaqlds45qgsrucemlwc8rawqevhvh6'
        assert result.receiver.to_bech32() == 'moa1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qs67hy0'
    ...
    def test_get_transactions_in_mempool_for_account(self):
        address = Address.new_from_bech32("moa18s6a06ktr2v6fgxv4ffhauxvptssnaqlds45qgsrucemlwc8rawqevhvh6")
    ...
    def test_query_contract(self):
        query = ContractQuery(Address.new_from_bech32('moa1qqqqqqqqqqqqqpgqqy34h7he2ya6qcagqre7ur7cc65vt0mxrc8q7ytel9'),
                              'getSum', 0, [])
    ...
    def test_get_definition_of_fungible_token(self):
        ...
        assert result.identifier == 'TEST-ff155e'
        assert result.owner.to_bech32() == 'moa1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qs67hy0'
    ...
    def test_get_non_fungible_token(self):
        ...
        assert result.identifier == 'NFTEST-ec88b8-01'
        assert result.collection == 'NFTEST-ec88b8'
        assert result.creator.to_bech32() == 'moa1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qs67hy0'
        assert result.balance == 0
        assert result.royalties == 25
    ...
    def test_send_transaction(self):
        transaction = Transaction(
            sender="moa1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qs67hy0",
            receiver="moa1487vz5m4zpxjyqw4flwa3xhnkzg4yrr3mkzf5sf0zgt94hjprc8qs67hy0",
            gas_limit=50000,
            chain_id="D",
