...
from drt_sdk_network_providers.interface import IAddress, IContractQuery
...
from drt_sdk_network_providers.resources import (GenericResponse,
                                                        SimulateResponse)
...
class ProxyNetworkProvider:
    ...
    def __get_token_properties(self, identifier: str) -> List[bytes]:
        ...
        query = ContractQuery(DCDT_CONTRACT_ADDRESS, 'getTokenProperties', 0, [encoded_identifier])
