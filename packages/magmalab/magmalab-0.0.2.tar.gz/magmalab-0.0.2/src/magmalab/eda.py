...
def boxplots(df, cols, hue, nrows, ncols, figsize, wspace = 0.4, hspace = 0.4, title = '', y_title = 1, palette = 'tab10', fontsize_title = 16, fontsize_label = 12, fontsize_count = 10):
    # Creating Figure
    ...
    for x, ax in zip(cols, axs.ravel()):
        ...
        ax.set_ylabel(hue, fontsize = fontsize_label)
        ...
        ax2.set_yticklabels(x_data[hue].value_counts().sort_index(), fontsize = fontsize_count)
