...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('_lin_solver_args', '_lin_solver_cls', 'c', 'bfmstar', 'time', 'dt', 'gfu_old')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('_lin_solver_args', '_lin_solver_cls', 'c', 'bfmstar', 'time', 'gfa_old', 'gfu_old', 'gfv_old', 'dt')
