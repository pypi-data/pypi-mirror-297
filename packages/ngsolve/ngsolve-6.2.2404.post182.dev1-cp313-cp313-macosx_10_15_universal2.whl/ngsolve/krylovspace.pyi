...
class GMResSolver(LinearSolver):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('iterations', 'innerproduct', 'restart', 'norm')
...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('its', 'plt', '_final_residual', 'iterations', 'tol', 'plotrates', 'atol', 'pre', 'residuals', 'ress', 'ax', 'fig', 'clear_output', 'mat', 'sol', 'maxiter', 'callback_sol', 'display', 'callback', 'printrates')
