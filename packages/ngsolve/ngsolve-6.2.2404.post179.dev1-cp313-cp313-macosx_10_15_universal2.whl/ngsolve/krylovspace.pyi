...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('callback', 'clear_output', 'tol', 'mat', 'printrates', 'pre', 'plotrates', '_final_residual', 'its', 'callback_sol', 'maxiter', 'fig', 'display', 'residuals', 'sol', 'iterations', 'ax', 'atol', 'plt', 'ress')
