...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('dt', 'time', '_lin_solver_args', 'gfu_old', '_lin_solver_cls', 'bfmstar', 'c')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('gfv_old', 'gfa_old', 'dt', 'time', '_lin_solver_args', 'gfu_old', '_lin_solver_cls', 'bfmstar', 'c')
