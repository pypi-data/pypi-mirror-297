...
from Orange.widgets.gui import checkBox
from AnyQt.QtWidgets import QVBoxLayout, QCheckBox, QLabel, QRadioButton, QButtonGroup
...
class OWOptimisationSelection(widget.OWWidget):
    ...
    class Inputs:
        ...
        in_pointer = Input("Get study for the loop", str)  # sended as the widget is created
