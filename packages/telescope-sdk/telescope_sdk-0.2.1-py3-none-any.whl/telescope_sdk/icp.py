...
class IdealCustomerProfile(TelescopeBaseType):
    ...
    job_titles: List[str]
    excluded_job_titles: List[str] = Field(default_factory=list)
    ...
    require_email: bool = Field(default=False)
    company_revenue_range: Optional[RevenueRange] = Field(default=None)
    only_show_verified_emails: bool = Field(default=False)
    hide_companies_in_another_campaign: bool = Field(default=False)
    hide_leads_in_another_campaign: bool = Field(default=False)
