...
def example_pymca() -> Generator[str, None, None]:
    with resources.resource_path("workflows", "example_pymca.ows") as path:
        yield str(path)


@pytest.fixture()
def example_larch() -> Generator[str, None, None]:
    with resources.resource_path("workflows", "example_larch.ows") as path:
        yield str(path)


@pytest.fixture()
def example_bm23() -> Generator[str, None, None]:
    with resources.resource_path("workflows", "example_bm23.ows") as path:
        yield str(path)
