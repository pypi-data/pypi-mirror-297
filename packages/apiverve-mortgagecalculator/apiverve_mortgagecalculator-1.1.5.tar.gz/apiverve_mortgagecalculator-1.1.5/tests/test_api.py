...
class TestMortgagecalculatorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = MortgagecalculatorAPIClient(self.api_key)

    @patch('apiverve_mortgagecalculator.apiClient.requests.get')
