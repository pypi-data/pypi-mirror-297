...
class _SDKSettings(_BaseSDKConfiguration):
    ...
    client_application_language: str = "en"  # ["en", "sp"]
    ...
    azure_insights_instrumentation_key: str = "" # Application Insights key (for logging into Azure)
    azure_insights_avoid_404_log: bool = False # Avoid to log requests from endpoints not found
