...
class BoolColumn(BaseColumn):
    column_type: Literal["BoolColumn"] = "BoolColumn"
    data_type: Literal["bool"] = "bool"


class Column(BaseColumn):
    column_type: Literal["Column"] = "Column"
    data_type: Literal["str", "int", "float", "datetime", "date", "time"] = "str"
    # index: bool = False
...
class MultiSelectColumn(BaseColumn):
    column_type: Literal["MultiSelectColumn"] = "MultiSelectColumn"
...
class Page(BaseModel):
    ...
    blocks: tuple[
        Union[Text, Boolean, Input, Select, Button, Table, Chart],
        ...,
    ]


AvailablePageBlock = [Text, Boolean, Input, Select, Button, Table, Chart]
