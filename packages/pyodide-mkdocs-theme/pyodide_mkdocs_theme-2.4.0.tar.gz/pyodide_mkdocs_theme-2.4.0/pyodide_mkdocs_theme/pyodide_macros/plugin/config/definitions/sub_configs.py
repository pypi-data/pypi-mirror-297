...
IDES_CONFIG = SubConfigSrc(
    ...
    ConfigOptionSrc(
        ...
        docs="""
            ...
            |:-:|:-:|
            | {{ pmt_note("Option à `false`",0) }} ![AssertionError: message
            normal](!!show_assertions_msg_only__assert_full_png) | {{ pmt_note("Option à `false`",0)
            }} ![Autres erreurs: message normal](!!show_assertions_msg_only__error_full_png) |
...
TESTING_CONFIG = SubConfigSrc(
    ...
    ConfigOptionSrc(
        ...
        docs="""
            ...
            * Pour `#!yaml {{config_validator("testing.include")}}: serve`, le bouton est présent par défaut.
            * Pour `#!yaml {{config_validator("testing.include")}}: site`, le bouton est absent par défaut.
        """,
        yaml_desc = "Name of the IDEs testing page. Generated only if given."
    ),
