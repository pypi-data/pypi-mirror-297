...
#
def create_table(schema, layer, table_name, yml=None, partition_fields=[], anonimized_fields=[], comment={}, comment_squad={}, fields={}, tbl_properties={}, replace=False):
...
#       yml[yml object, string or None] = yml file path (it is not required to create a bronze table). Default is none.
#
def create_table_bronze(schema, table_name, yml=None, partition_fields=[], tbl_properties={}, replace=False):
...
#       yml[yml object, string or None] = yml file path (it is not required to create a bronze table). Default is none.
#
def create_table_silver(schema, table_name, yml=None, partition_fields=[], anonimized_fields=[], comment={}, comment_squad={}, fields={}, tbl_properties={}, replace=False):
