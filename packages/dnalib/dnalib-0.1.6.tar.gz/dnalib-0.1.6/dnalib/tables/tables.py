...
class LayerTable:    
    ...
    def load(self):        
        ...
        """
        # create inicial query
        self.load_source_df_data()

        # cast fields from bronze layer
        ...
        log(__name__).info(f"Sucessfully loaded {self.source_df.count()} rows from {self.table_name}.") 
        return self
