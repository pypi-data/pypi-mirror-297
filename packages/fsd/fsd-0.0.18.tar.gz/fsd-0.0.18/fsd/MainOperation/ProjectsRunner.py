...
class ProjectsRunner:
    ...
    async def run_project(self, basename, role, max_retries=20):
        ...
        if pipeline == "1":
            ...
            return await self.compile.start_CLI_compile_process("Run and open this project in the fastest way. Proceed directly to running the project as quickly as possible, assuming all dependencies are installed.", basename)
        else:
