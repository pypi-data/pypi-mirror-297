...
class DependencyProjectAnalysAgent:
    ...
    def initial_setup(self, dependency_files, OS_architecture):
        ...
        system_prompt = (
            ...
            "4. List ALL required dependencies. Unless specified by the user, use the latest stable versions without explicitly mentioning version numbers.\n"
            ...
            f"12. ALWAYS mention the step to navigate back to the right working directory before each major operation.\n"
            ...
            f"CRITICAL: DO NOT include ANY extra guides on how to use/open/update/download/git the project. STRICTLY LIMIT your response to dependency installation commands ONLY, always starting with 'cd {self.repo.get_repo_path()}'. Any deviation from this will be considered a critical error.\n\n"
