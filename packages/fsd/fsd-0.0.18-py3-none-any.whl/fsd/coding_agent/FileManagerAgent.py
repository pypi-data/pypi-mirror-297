...
class FileManagerAgent:
    ...
    async def get_file_planning(self, idea):
        ...
        prompt = (
                ...
                "Adding_new_files must include all new files that need to be created. For image files, only include files with the .svg extension and exclude all other image types. "
