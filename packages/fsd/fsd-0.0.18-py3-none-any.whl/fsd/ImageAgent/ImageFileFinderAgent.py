...
class ImageFileFinderAgent:
    ...
    async def get_style_file_planning(self, tree):
        ...
        prompt = (
            "Analyze the provided project structure and identify ALL main files related to color and style of the current project. Your task:\n\n"
            "1. INCLUDE:\n"
            ...
            "{\n"
            "    \"style_files\": [\"file1.extension\", \"file2.extension\", ...]\n"
            "}\n\n"
            "CRITICAL: Return ONLY the valid JSON object. Do NOT include any explanatory text, markdown formatting, or extraneous characters. Ensure the JSON is parseable and contains only the file names (not full paths) of relevant files."
        )
