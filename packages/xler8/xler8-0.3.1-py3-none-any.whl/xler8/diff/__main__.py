...
def diff_xlsx(in1_filename, in2_filename, out1_filename):
...
print("Trying to generate Diff [%s] <-> [%s] into [%s]" % (arg_in1, arg_in2, arg_out1))
diff_xlsx(arg_in1, arg_in2, arg_out1)
