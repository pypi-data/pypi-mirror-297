...
class EasyDF:
    ...
    def from_lh_table(self, lh_name: str, table_name: str, limit: int = None) -> 'EasyDF':
        sql_builder = EasySQLSelectBuilder.new().select(["*"]).from_lh_table(lh_name, table_name).limit(limit)
