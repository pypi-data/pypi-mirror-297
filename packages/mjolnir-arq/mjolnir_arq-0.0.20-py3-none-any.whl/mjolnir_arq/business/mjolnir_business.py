...
class MjolnirBusiness:
    ...
    def create_project(self) -> None:
        try:
            # Obtener la ruta relativa al paquete actual
            origen = os.path.join(os.path.dirname(os.path.dirname(__file__)), "backend_hexagonal")
            ...
            print(
                colored(
                    f"ERROR: Puede que la carpeta ya esté presente en tu directorio.\n {e}",
                    "light_red",
                )
            )
