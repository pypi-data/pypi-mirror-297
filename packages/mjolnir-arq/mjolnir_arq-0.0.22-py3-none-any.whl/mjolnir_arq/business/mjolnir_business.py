...
class MjolnirBusiness:
    ...
    def copy_contents(self, origen, destino):
        for item in os.listdir(origen):
            src_path = os.path.join(origen, item)
            dest_path = os.path.join(destino, item)
            ...
            if os.path.isdir(src_path):
                if not os.path.exists(dest_path):
                    ...
                    self.copy_contents(src_path, dest_path)
            # Copiar archivos, incluyendo los archivos ocultos
            else:
    ...
    def create_project(self) -> None:
        try:
            ...
            self.copy_contents(origen, destino)
