...
class MjolnirBusiness:
    ...
    def create_project(self) -> None:
        ...
        origen = "../backend-hexagonal"
        # TODO: current_directory - local
        """ destino = f"{self.current_directory}/project" """
        # TODO: current_directory - production
        destino = f"{self.current_directory}"
        ...
        try:
            ...
            print(colored(f"SUCCESS: Librerias instaladas.", "cyan"))
        except Exception as e:
            print(
                colored(
                    f"ERROR: 1. puede que la carpeta src ya esta presente en tu directorio.\n",
                    "light_red",
                )
            )
