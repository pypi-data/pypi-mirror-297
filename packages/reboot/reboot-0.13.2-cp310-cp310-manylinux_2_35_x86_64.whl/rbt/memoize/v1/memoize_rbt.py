...
import rbt.memoize.v1.memoize_pb2
import rbt.memoize.v1.memoize_pb2_grpc
import rbt.v1alpha1.options_pb2
# Additionally re-export all messages and enums from the pb2 module.
from rbt.memoize.v1.memoize_pb2 import (
    ResetRequest,
    ResetResponse,
    StartRequest,
    StartResponse,
...
class MemoizeServicerMiddleware(rbt.aio.internals.middleware.Middleware):
    ...
    def __init__(
        ...
        *,
        ...
        self.request_type_by_method_name: dict[str, type[google.protobuf.message.Message]] = {
            'Reset': rbt.memoize.v1.memoize_pb2.ResetRequest,
            'Start': rbt.memoize.v1.memoize_pb2.StartRequest,
            'Store': rbt.memoize.v1.memoize_pb2.StoreRequest,
            'Status': rbt.memoize.v1.memoize_pb2.StatusRequest,
        }
        ...
        if self._token_verifier is not None and self._authorizer is None:
            raise RuntimeError(
                ...
                f"'rbt.memoize.v1.Memoize'"
            )


    def add_to_server(self, server: grpc.aio.Server) -> None:
        rbt.memoize.v1.memoize_pb2_grpc.add_MemoizeInterfaceServicer_to_server(
            self, server
        )
    ...
    async def react_query(
        ...
        if method == 'Reset':
            ...
            try:
                ...
                request = rbt.memoize.v1.memoize_pb2.StatusRequest()
    ...
    async def react_mutate(
        ...
        if method == 'Reset':
            request = rbt.memoize.v1.memoize_pb2.ResetRequest()
            request.ParseFromString(request_bytes)
            ...
            while True:
                ...
                stub = rbt.memoize.v1.memoize_pb2_grpc.MemoizeInterfaceStub(
            ...
            request = rbt.memoize.v1.memoize_pb2.StartRequest()
            request.ParseFromString(request_bytes)
            ...
            request = rbt.memoize.v1.memoize_pb2.StoreRequest()
            request.ParseFromString(request_bytes)
        ...
        *,
        ...
        if 'Reset' == task.method_name:
            if only_validate:
                ...
                return rbt.memoize.v1.memoize_pb2.ResetResponse()
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (MemoizeWorkflowStub(
                            ...
                            typing.cast(rbt.memoize.v1.memoize_pb2.ResetRequest, task.request),
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return rbt.memoize.v1.memoize_pb2.StartResponse()
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (MemoizeWorkflowStub(
                            ...
                            typing.cast(rbt.memoize.v1.memoize_pb2.StartRequest, task.request),
                            bearer_token=__internal_magic_token__,
                            idempotency=rbt.aio.idempotency.Idempotency(
                                alias=f'Task {task.task_id.task_uuid}',
                            ),
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return rbt.memoize.v1.memoize_pb2.StoreResponse()
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (MemoizeWorkflowStub(
                            ...
                            typing.cast(rbt.memoize.v1.memoize_pb2.StoreRequest, task.request),
                            bearer_token=__internal_magic_token__,
                            idempotency=rbt.aio.idempotency.Idempotency(
                                alias=f'Task {task.task_id.task_uuid}',
                            ),
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return rbt.memoize.v1.memoize_pb2.StatusResponse()
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (MemoizeWorkflowStub(
                            ...
                            typing.cast(rbt.memoize.v1.memoize_pb2.StatusRequest, task.request),
                            bearer_token=__internal_magic_token__,
                        ))
    ...
    async def __Reset(
        ...
        state: rbt.memoize.v1.memoize_pb2.Memoize,
        request: rbt.memoize.v1.memoize_pb2.ResetRequest,
        *,
        validating_effects: bool,
        ...
        try:
            ...
            assert_type(
                response,
                [
                    rbt.memoize.v1.memoize_pb2.ResetResponse,
                ],
            )
            ...
            if isinstance(aborted, rbt.aio.aborted.SystemAborted):
                ...
                if not NODEJS:
                    logger.warning(
                        f"Unhandled (in 'rbt.memoize.v1.Memoize.Reset') {aborted}; propagating as 'Unknown'\n" +
                ...
                raise rbt.aio.aborted.SystemAborted(
                    ...
                    # information.
                    message=f"unhandled (in 'rbt.memoize.v1.Memoize.Reset') {aborted}"
                )
            else:
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'rbt.memoize.v1.Memoize.Reset') {aborted}"
                        )
                elif (
            ...
            if not NODEJS:
                logger.warning(
                    f"Unhandled (in 'rbt.memoize.v1.Memoize.Reset') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
            ...
            raise rbt.aio.aborted.SystemAborted(
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'rbt.memoize.v1.Memoize.Reset') {type(exception).__name__}: {exception}"
            )
    ...
    async def _Reset(
        ...
        *,
        ...
        if idempotent_mutation is not None:
            response = rbt.memoize.v1.memoize_pb2.ResetResponse()
    ...
    async def _schedule_Reset(
        ...
        *,
        ...
        headers: rbt.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[rbt.aio.contexts.WriterContext, rbt.memoize.v1.memoize_pb2.ResetResponse]:
    ...
    async def Reset(
        ...
        if authoritative_consensus != self.consensus_id:
            ...
            stub = rbt.memoize.v1.memoize_pb2_grpc.MemoizeInterfaceStub(channel)
            call = stub.Reset(
                request=request,
        ...
        *,
        ...
        try:
            ...
            assert_type(
                response,
                [
                    rbt.memoize.v1.memoize_pb2.StartResponse,
                ],
            )
            # TODO: retrying a control loop might cause an effect
            # validation retry to either "hang" or "do more
            ...
            if isinstance(aborted, rbt.aio.aborted.SystemAborted):
                ...
                if not NODEJS:
                    logger.warning(
                        f"Unhandled (in 'rbt.memoize.v1.Memoize.Start') {aborted}; propagating as 'Unknown'\n" +
                        ''.join(traceback.format_exception(aborted))
                    )
                raise rbt.aio.aborted.SystemAborted(
                    rbt.v1alpha1.errors_pb2.Unknown(),
                    ...
                    # debugging, it does expose implementation
                    # information.
                    message=f"unhandled (in 'rbt.memoize.v1.Memoize.Start') {aborted}"
                )
            else:
                if (
                    aborted_type is not None and
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'rbt.memoize.v1.Memoize.Start') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if not NODEJS:
                logger.warning(
                    f"Unhandled (in 'rbt.memoize.v1.Memoize.Start') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
                    ''.join(traceback.format_exception(exception))
                )
            raise rbt.aio.aborted.SystemAborted(
                rbt.v1alpha1.errors_pb2.Unknown(),
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'rbt.memoize.v1.Memoize.Start') {type(exception).__name__}: {exception}"
            )
    ...
    async def _Start(
        ...
        *,
        ...
        if idempotent_mutation is not None:
            response = rbt.memoize.v1.memoize_pb2.StartResponse()
            response.ParseFromString(idempotent_mutation.response)
            return response
    ...
    async def _schedule_Start(
        ...
        *,
        ...
        headers: rbt.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[rbt.aio.contexts.WriterContext, rbt.memoize.v1.memoize_pb2.StartResponse]:
        context: rbt.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            context_type=rbt.aio.contexts.WriterContext,
        )
        ...
        *,
        ...
        try:
            ...
            assert_type(
                response,
                [
                    rbt.memoize.v1.memoize_pb2.StoreResponse,
                ],
            )
            # TODO: retrying a control loop might cause an effect
            # validation retry to either "hang" or "do more
            ...
            if isinstance(aborted, rbt.aio.aborted.SystemAborted):
                ...
                if not NODEJS:
                    logger.warning(
                        f"Unhandled (in 'rbt.memoize.v1.Memoize.Store') {aborted}; propagating as 'Unknown'\n" +
                        ''.join(traceback.format_exception(aborted))
                    )
                raise rbt.aio.aborted.SystemAborted(
                    rbt.v1alpha1.errors_pb2.Unknown(),
                    ...
                    # debugging, it does expose implementation
                    # information.
                    message=f"unhandled (in 'rbt.memoize.v1.Memoize.Store') {aborted}"
                )
            else:
                if (
                    aborted_type is not None and
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'rbt.memoize.v1.Memoize.Store') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if not NODEJS:
                logger.warning(
                    f"Unhandled (in 'rbt.memoize.v1.Memoize.Store') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
                    ''.join(traceback.format_exception(exception))
                )
            raise rbt.aio.aborted.SystemAborted(
                rbt.v1alpha1.errors_pb2.Unknown(),
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'rbt.memoize.v1.Memoize.Store') {type(exception).__name__}: {exception}"
            )
    ...
    async def _Store(
        ...
        *,
        ...
        if idempotent_mutation is not None:
            response = rbt.memoize.v1.memoize_pb2.StoreResponse()
            response.ParseFromString(idempotent_mutation.response)
            return response
    ...
    async def _schedule_Store(
        ...
        *,
        ...
        headers: rbt.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[rbt.aio.contexts.WriterContext, rbt.memoize.v1.memoize_pb2.StoreResponse]:
        context: rbt.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            context_type=rbt.aio.contexts.WriterContext,
        )
    ...
    async def __Status(
        ...
        *,
        validating_effects: bool,
    ) -> rbt.memoize.v1.memoize_pb2.StatusResponse:
        try:
            response = (
            ...
            if isinstance(aborted, rbt.aio.aborted.SystemAborted):
                ...
                if not NODEJS:
                    logger.warning(
                        f"Unhandled (in 'rbt.memoize.v1.Memoize.Status') {aborted}; propagating as 'Unknown'\n" +
                        ''.join(traceback.format_exception(aborted))
                    )
                raise rbt.aio.aborted.SystemAborted(
                    rbt.v1alpha1.errors_pb2.Unknown(),
                    ...
                    # debugging, it does expose implementation
                    # information.
                    message=f"unhandled (in 'rbt.memoize.v1.Memoize.Status') {aborted}"
                )
            else:
                if (
                    aborted_type is not None and
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'rbt.memoize.v1.Memoize.Status') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if not NODEJS:
                logger.warning(
                    f"Unhandled (in 'rbt.memoize.v1.Memoize.Status') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
                    ''.join(traceback.format_exception(exception))
                )
            raise rbt.aio.aborted.SystemAborted(
                rbt.v1alpha1.errors_pb2.Unknown(),
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'rbt.memoize.v1.Memoize.Status') {type(exception).__name__}: {exception}"
            )
    ...
    async def _schedule_Status(
        ...
        *,
        ...
        headers: rbt.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[rbt.aio.contexts.WriterContext, rbt.memoize.v1.memoize_pb2.StatusResponse]:
        context: rbt.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            context_type=rbt.aio.contexts.WriterContext,
        )
        response = rbt.memoize.v1.memoize_pb2.StatusResponse()
...
class _MemoizeStub(rbt.aio.stubs.Stub):

    __service_name__ = rbt.aio.types.ServiceName('rbt.memoize.v1.MemoizeInterface')
    ...
    def __init__(
        ...
        *,
        ...
        self._stub = rbt.memoize.v1.memoize_pb2_grpc.MemoizeInterfaceStub(channel)
    ...
    async def Status(
        ...
        *,
        ...
        async with self._call(
            ...
            unary=True,
            reader=True,
            response_type=rbt.memoize.v1.memoize_pb2.StatusResponse,
            aborted_type=Memoize.StatusAborted,
            metadata=metadata,
            bearer_token=bearer_token,
        ) as call:
        ...
        *,
        ...
        with self._idempotency_manager.idempotently(
            ...
            async with self._call(
                ...
                unary=True,
                reader=False,
                response_type=rbt.memoize.v1.memoize_pb2.ResetResponse,
                aborted_type=Memoize.ResetAborted,
                metadata=metadata,
        ...
        *,
        ...
        with self._idempotency_manager.idempotently(
            ...
            async with self._call(
                ...
                unary=True,
                reader=False,
                response_type=rbt.memoize.v1.memoize_pb2.StartResponse,
                aborted_type=Memoize.StartAborted,
                metadata=metadata,
                idempotency_key=idempotency_key,
                bearer_token=bearer_token,
        ...
        *,
        ...
        with self._idempotency_manager.idempotently(
            ...
            async with self._call(
                ...
                unary=True,
                reader=False,
                response_type=rbt.memoize.v1.memoize_pb2.StoreResponse,
                aborted_type=Memoize.StoreAborted,
                metadata=metadata,
                idempotency_key=idempotency_key,
                bearer_token=bearer_token,
...
MemoizeStateType: typing.TypeAlias = rbt.memoize.v1.memoize_pb2.Memoize
MemoizeRequestTypes: typing.TypeAlias = \
        rbt.memoize.v1.memoize_pb2.ResetRequest \
        | rbt.memoize.v1.memoize_pb2.StartRequest \
        | rbt.memoize.v1.memoize_pb2.StoreRequest \
        | rbt.memoize.v1.memoize_pb2.StatusRequest


class MemoizeAuthorizer(
    MemoizeAuthorizerMixin,
    rbt.aio.auth.authorizers.Authorizer[MemoizeStateType, MemoizeRequestTypes],
):
    ...
    async def authorize(
        ...
        *,
        ...
        if method_name == 'rbt.memoize.v1.Memoize.Reset':
            return await self.Reset(
                context,
                typing.cast(rbt.memoize.v1.memoize_pb2.Memoize, state),
                typing.cast(rbt.memoize.v1.memoize_pb2.ResetRequest, request),
            )
        elif method_name == 'rbt.memoize.v1.Memoize.Start':
            return await self.Start(
                context,
                typing.cast(rbt.memoize.v1.memoize_pb2.Memoize, state),
                typing.cast(rbt.memoize.v1.memoize_pb2.StartRequest, request),
            )
        elif method_name == 'rbt.memoize.v1.Memoize.Store':
            return await self.Store(
                context,
                typing.cast(rbt.memoize.v1.memoize_pb2.Memoize, state),
                typing.cast(rbt.memoize.v1.memoize_pb2.StoreRequest, request),
            )
        elif method_name == 'rbt.memoize.v1.Memoize.Status':
            return await self.Status(
                context,
                typing.cast(rbt.memoize.v1.memoize_pb2.Memoize, state),
                typing.cast(rbt.memoize.v1.memoize_pb2.StatusRequest, request),
            )
        else:
...
class MemoizeServicer(rbt.aio.servicers.Servicer):
    Authorizer: typing.TypeAlias = MemoizeAuthorizer

    __service_name__ = rbt.aio.types.ServiceName('rbt.memoize.v1.MemoizeInterface')
    __state_type_name__ = rbt.aio.types.StateTypeName('rbt.memoize.v1.Memoize')
    __state_type__ = rbt.memoize.v1.memoize_pb2.Memoize
    __file_descriptor__ = rbt.memoize.v1.memoize_pb2.DESCRIPTOR
    ...
    class Effects(rbt.aio.state_managers.Effects):
        def __init__(
            ...
            *,
            ...
            assert_type(state, [rbt.memoize.v1.memoize_pb2.Memoize])
    ...
    class ResetEffects(Effects):
        def __init__(
            ...
            *,
            ...
            assert_type(state, [rbt.memoize.v1.memoize_pb2.Memoize])
            assert_type(response, [rbt.memoize.v1.memoize_pb2.ResetResponse])
    ...
    class StartEffects(Effects):
        def __init__(
            ...
            *,
            ...
            assert_type(state, [rbt.memoize.v1.memoize_pb2.Memoize])
            assert_type(response, [rbt.memoize.v1.memoize_pb2.StartResponse])
    ...
    class StoreEffects(Effects):
        def __init__(
            ...
            *,
            ...
            assert_type(state, [rbt.memoize.v1.memoize_pb2.Memoize])
            assert_type(response, [rbt.memoize.v1.memoize_pb2.StoreResponse])
    ...
    ) -> rbt.memoize.v1.memoize_pb2.Memoize:
...
class Memoize:
    ...
    State: typing.TypeAlias = rbt.memoize.v1.memoize_pb2.Memoize
    ...
    class ResetFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, rbt.memoize.v1.memoize_pb2.ResetResponse]:
            """Awaits for task to finish and returns it's response."""

            async def wait_for_task() -> rbt.memoize.v1.memoize_pb2.ResetResponse:
                ...
                try:
                    ...
                    if (
                        ...
                        raise rbt.aio.aborted.SystemAborted(
                            ...
                            "but expecting type 'rbt.memoize.v1.memoize_pb2.ResetResponse'; "
    ...
    class ResetAborted(rbt.aio.aborted.Aborted):
    ...
    class StartFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, rbt.memoize.v1.memoize_pb2.StartResponse]:
            """Awaits for task to finish and returns it's response."""

            async def wait_for_task() -> rbt.memoize.v1.memoize_pb2.StartResponse:
                channel = self._channel_manager.get_channel_from_state_type_name(
                    self._task_id.state_type,
                    rbt.aio.types.StateRef(self._task_id.state_ref),
                )
                ...
                try:
                    ...
                    if (
                        ...
                        raise rbt.aio.aborted.SystemAborted(
                            ...
                            f"task with UUID {str(uuid.UUID(bytes=self._task_id.task_uuid))} "
                            f"has a response of type '{response_or_error.TypeName()}' "
                            "but expecting type 'rbt.memoize.v1.memoize_pb2.StartResponse'; "
                            "are you waiting on a task of the correct method?",
                        ) from None
    ...
    class StartAborted(rbt.aio.aborted.Aborted):
    ...
    class StoreFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, rbt.memoize.v1.memoize_pb2.StoreResponse]:
            """Awaits for task to finish and returns it's response."""

            async def wait_for_task() -> rbt.memoize.v1.memoize_pb2.StoreResponse:
                channel = self._channel_manager.get_channel_from_state_type_name(
                    self._task_id.state_type,
                    rbt.aio.types.StateRef(self._task_id.state_ref),
                )
                ...
                try:
                    ...
                    if (
                        ...
                        raise rbt.aio.aborted.SystemAborted(
                            ...
                            f"task with UUID {str(uuid.UUID(bytes=self._task_id.task_uuid))} "
                            f"has a response of type '{response_or_error.TypeName()}' "
                            "but expecting type 'rbt.memoize.v1.memoize_pb2.StoreResponse'; "
                            "are you waiting on a task of the correct method?",
                        ) from None
    ...
    class StoreAborted(rbt.aio.aborted.Aborted):
    ...
    class StatusFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, rbt.memoize.v1.memoize_pb2.StatusResponse]:
            """Awaits for task to finish and returns it's response."""

            async def wait_for_task() -> rbt.memoize.v1.memoize_pb2.StatusResponse:
                channel = self._channel_manager.get_channel_from_state_type_name(
                    self._task_id.state_type,
                    rbt.aio.types.StateRef(self._task_id.state_ref),
                )
                ...
                try:
                    ...
                    if (
                        ...
                        raise rbt.aio.aborted.SystemAborted(
                            ...
                            f"task with UUID {str(uuid.UUID(bytes=self._task_id.task_uuid))} "
                            f"has a response of type '{response_or_error.TypeName()}' "
                            "but expecting type 'rbt.memoize.v1.memoize_pb2.StatusResponse'; "
                            "are you waiting on a task of the correct method?",
                        ) from None
    ...
    class StatusAborted(rbt.aio.aborted.Aborted):
    ...
    class WeakReference(typing.Generic[Memoize_ScheduleTypeVar]):
        ...
        class _Reactively:
            ...
            async def Status(
                ...
                __options__: typing.Optional[rbt.aio.call.Options] = None,
            ) -> typing.AsyncIterator[rbt.memoize.v1.memoize_pb2.StatusResponse]:
        ...
        def reactively(self):
            return Memoize.WeakReference._Reactively(
                service_name=rbt.aio.types.ServiceName('rbt.memoize.v1.MemoizeInterface'),
                state_ref=self._state_ref,
                bearer_token=self._bearer_token,
            )
        ...
        class _Schedule:
            ...
            def __init__(
                self,
                tasks: typing.Callable[[rbt.aio.contexts.TransactionContext | rbt.aio.contexts.WorkflowContext | rbt.aio.external.ExternalContext], MemoizeTasksStub],
                *,
                when: typing.Optional[datetime | timedelta] = None,
                idempotency: typing.Optional[rbt.aio.idempotency.Idempotency] = None,
            ) -> None:
            ...
            async def Reset(
                ...
                __context__: rbt.aio.contexts.TransactionContext | rbt.aio.contexts.WorkflowContext | rbt.aio.external.ExternalContext,
                __options__: typing.Optional[rbt.aio.call.Options] = None,
            ) -> rbt.aio.tasks.TaskEffect | Memoize.ResetFuture:
                # TODO: mypy-protobuf declares that
                # `google.protobuf.message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                request = rbt.memoize.v1.memoize_pb2.ResetRequest(
                ...
                if isinstance(__context__, rbt.aio.contexts.TransactionContext):
                    return rbt.aio.tasks.TaskEffect(
                        service_name=rbt.aio.types.ServiceName(
                            'rbt.memoize.v1.MemoizeInterface'
                        ),
            ...
            async def Start(
                ...
                __context__: rbt.aio.contexts.TransactionContext | rbt.aio.contexts.WorkflowContext | rbt.aio.external.ExternalContext,
                __options__: typing.Optional[rbt.aio.call.Options] = None,
            ) -> rbt.aio.tasks.TaskEffect | Memoize.StartFuture:
                # TODO: mypy-protobuf declares that
                # `google.protobuf.message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                request = rbt.memoize.v1.memoize_pb2.StartRequest(
            ...
            async def Store(
                ...
                *,
                data: typing.Optional[bytes] = None,
            ) -> rbt.aio.tasks.TaskEffect | Memoize.StoreFuture:
                if data is not None and not isinstance(
                    ...
                    raise TypeError(
                        ...
                        f"'rbt.memoize.v1.memoize_pb2.StoreRequest': field 'data' is not "
            ...
            async def Status(
                ...
                __context__: rbt.aio.contexts.TransactionContext | rbt.aio.contexts.WorkflowContext | rbt.aio.external.ExternalContext,
                __options__: typing.Optional[rbt.aio.call.Options] = None,
            ) -> rbt.aio.tasks.TaskEffect | Memoize.StatusFuture:
                # TODO: mypy-protobuf declares that
                # `google.protobuf.message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                request = rbt.memoize.v1.memoize_pb2.StatusRequest(
    ...
    ) -> tuple[Memoize.WeakReference, rbt.memoize.v1.memoize_pb2.ResetResponse]:
        # TODO: mypy-protobuf declares that
        # `google.protobuf.message.Message` constructor arguments are
        # always non-None, when in reality they are optional.
        request = rbt.memoize.v1.memoize_pb2.ResetRequest(
    ...
    async def _Start(
        ...
        *,
        ...
        __state_id__: typing.Optional[rbt.aio.types.StateId] = None,
        __idempotency__: typing.Optional[rbt.aio.idempotency.Idempotency] = None,
    ) -> tuple[Memoize.WeakReference, rbt.memoize.v1.memoize_pb2.StartResponse]:
        # TODO: mypy-protobuf declares that
        # `google.protobuf.message.Message` constructor arguments are
        # always non-None, when in reality they are optional.
        request = rbt.memoize.v1.memoize_pb2.StartRequest(
    ...
    async def _Store(
        ...
        *,
        ...
        __idempotency__: typing.Optional[rbt.aio.idempotency.Idempotency] = None,
        data: typing.Optional[bytes] = None,
    ) -> tuple[Memoize.WeakReference, rbt.memoize.v1.memoize_pb2.StoreResponse]:
        if data is not None and not isinstance(
            data,
            bytes,
        ):
