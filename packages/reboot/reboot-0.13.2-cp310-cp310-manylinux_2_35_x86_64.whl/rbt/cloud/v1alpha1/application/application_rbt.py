...
class ApplicationServicerMiddleware(rbt.aio.internals.middleware.Middleware):
    ...
    async def _schedule_Create(
        ...
        *,
        ...
        headers: rbt.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[rbt.aio.contexts.WriterContext, rbt.cloud.v1alpha1.application.application_pb2.CreateResponse]:
    ...
    async def _schedule_Up(
        ...
        *,
        ...
        headers: rbt.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[rbt.aio.contexts.WriterContext, rbt.cloud.v1alpha1.application.application_pb2.UpResponse]:
        context: rbt.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            context_type=rbt.aio.contexts.WriterContext,
        )
    ...
    async def _schedule_UpTask(
        ...
        *,
        ...
        headers: rbt.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[rbt.aio.contexts.WriterContext, rbt.cloud.v1alpha1.application.application_pb2.UpTaskResponse]:
        context: rbt.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            context_type=rbt.aio.contexts.WriterContext,
        )
    ...
    async def _schedule_Down(
        ...
        *,
        ...
        headers: rbt.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[rbt.aio.contexts.WriterContext, rbt.cloud.v1alpha1.application.application_pb2.DownResponse]:
        context: rbt.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            context_type=rbt.aio.contexts.WriterContext,
        )
    ...
    async def _schedule_DownTask(
        ...
        *,
        ...
        headers: rbt.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[rbt.aio.contexts.WriterContext, rbt.cloud.v1alpha1.application.application_pb2.DownTaskResponse]:
        context: rbt.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            context_type=rbt.aio.contexts.WriterContext,
        )
...
class _ApplicationStub(rbt.aio.stubs.Stub):

    __service_name__ = rbt.aio.types.ServiceName('rbt.cloud.v1alpha1.application.ApplicationInterface')
...
class ApplicationAuthorizer(
    ...
    rbt.aio.auth.authorizers.Authorizer[ApplicationStateType, ApplicationRequestTypes],
):
...
class ApplicationServicer(rbt.aio.servicers.Servicer):
    Authorizer: typing.TypeAlias = ApplicationAuthorizer

    __service_name__ = rbt.aio.types.ServiceName('rbt.cloud.v1alpha1.application.ApplicationInterface')
    __state_type_name__ = rbt.aio.types.StateTypeName('rbt.cloud.v1alpha1.application.Application')
...
class Application:
    ...
    class CreateAborted(rbt.aio.aborted.Aborted):
    ...
    class UpAborted(rbt.aio.aborted.Aborted):
        ...
        def __init__(
            self,
            error: MethodError |  rbt.aio.aborted.GrpcError,
            *,
            message: typing.Optional[str] = None,
            # Do not set this value when constructing in order to
            # raise. This is only used internally when constructing
    ...
    class UpTaskAborted(rbt.aio.aborted.Aborted):
    ...
    class DownAborted(rbt.aio.aborted.Aborted):
    ...
    class DownTaskAborted(rbt.aio.aborted.Aborted):
    ...
    class WeakReference(typing.Generic[Application_ScheduleTypeVar]):
        ...
        def reactively(self):
            return Application.WeakReference._Reactively(
                service_name=rbt.aio.types.ServiceName('rbt.cloud.v1alpha1.application.ApplicationInterface'),
                state_ref=self._state_ref,
                bearer_token=self._bearer_token,
            )
        ...
        class _Schedule:
            ...
            def __init__(
                self,
                tasks: typing.Callable[[rbt.aio.contexts.TransactionContext | rbt.aio.contexts.WorkflowContext | rbt.aio.external.ExternalContext], ApplicationTasksStub],
                *,
                when: typing.Optional[datetime | timedelta] = None,
                idempotency: typing.Optional[rbt.aio.idempotency.Idempotency] = None,
            ) -> None:
            ...
            async def Up(
                ...
                *,
                container_image_name: typing.Optional[str] = None,
            ) -> rbt.aio.tasks.TaskEffect | Application.UpFuture:
            ...
            async def UpTask(
                ...
                *,
                container_image_name: typing.Optional[str] = None,
            ) -> rbt.aio.tasks.TaskEffect | Application.UpTaskFuture:
                if container_image_name is not None and not isinstance(
                    container_image_name,
                    str,
                ):
            ...
            async def Down(
                ...
                __context__: rbt.aio.contexts.TransactionContext | rbt.aio.contexts.WorkflowContext | rbt.aio.external.ExternalContext,
                __options__: typing.Optional[rbt.aio.call.Options] = None,
            ) -> rbt.aio.tasks.TaskEffect | Application.DownFuture:
                # TODO: mypy-protobuf declares that
                # `google.protobuf.message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                request = rbt.cloud.v1alpha1.application.application_pb2.DownRequest(
            ...
            async def DownTask(
                ...
                __context__: rbt.aio.contexts.TransactionContext | rbt.aio.contexts.WorkflowContext | rbt.aio.external.ExternalContext,
                __options__: typing.Optional[rbt.aio.call.Options] = None,
            ) -> rbt.aio.tasks.TaskEffect | Application.DownTaskFuture:
                # TODO: mypy-protobuf declares that
                # `google.protobuf.message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                request = rbt.cloud.v1alpha1.application.application_pb2.DownTaskRequest(
