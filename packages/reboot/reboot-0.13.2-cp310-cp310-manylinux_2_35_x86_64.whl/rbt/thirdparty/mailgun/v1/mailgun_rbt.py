...
class MessageServicerMiddleware(rbt.aio.internals.middleware.Middleware):
    ...
    async def _schedule_Send(
        ...
        *,
        ...
        headers: rbt.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[rbt.aio.contexts.WriterContext, rbt.thirdparty.mailgun.v1.mailgun_pb2.SendResponse]:
    ...
    async def _schedule_SendTask(
        ...
        *,
        ...
        headers: rbt.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[rbt.aio.contexts.WriterContext, rbt.thirdparty.mailgun.v1.mailgun_pb2.SendTaskResponse]:
        context: rbt.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            context_type=rbt.aio.contexts.WriterContext,
        )
...
class _MessageStub(rbt.aio.stubs.Stub):

    __service_name__ = rbt.aio.types.ServiceName('rbt.thirdparty.mailgun.v1.MessageInterface')
...
class MessageAuthorizer(
    ...
    rbt.aio.auth.authorizers.Authorizer[MessageStateType, MessageRequestTypes],
):
...
class MessageServicer(rbt.aio.servicers.Servicer):
    Authorizer: typing.TypeAlias = MessageAuthorizer

    __service_name__ = rbt.aio.types.ServiceName('rbt.thirdparty.mailgun.v1.MessageInterface')
    __state_type_name__ = rbt.aio.types.StateTypeName('rbt.thirdparty.mailgun.v1.Message')
...
class Message:
    ...
    class SendAborted(rbt.aio.aborted.Aborted):
    ...
    class SendTaskAborted(rbt.aio.aborted.Aborted):
    ...
    class WeakReference(typing.Generic[Message_ScheduleTypeVar]):
        ...
        def reactively(self):
            return Message.WeakReference._Reactively(
                service_name=rbt.aio.types.ServiceName('rbt.thirdparty.mailgun.v1.MessageInterface'),
                state_ref=self._state_ref,
                bearer_token=self._bearer_token,
            )
        ...
        class _Schedule:
            ...
            def __init__(
                self,
                tasks: typing.Callable[[rbt.aio.contexts.TransactionContext | rbt.aio.contexts.WorkflowContext | rbt.aio.external.ExternalContext], MessageTasksStub],
                *,
                when: typing.Optional[datetime | timedelta] = None,
                idempotency: typing.Optional[rbt.aio.idempotency.Idempotency] = None,
            ) -> None:
            ...
            async def SendTask(
                ...
                *,
                send_request: typing.Optional[rbt.thirdparty.mailgun.v1.mailgun_pb2.SendRequest] = None,
            ) -> rbt.aio.tasks.TaskEffect | Message.SendTaskFuture:
