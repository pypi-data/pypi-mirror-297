...
from rbt.aio.aborted import Aborted
from rbt.aio.contexts import Context, Participants
from rbt.aio.headers import IDEMPOTENCY_KEY_HEADER, Headers
...
from rbt.aio.types import ApplicationId, GrpcMetadata, ServiceName, StateRef
from typing import (
    AsyncIterable,
    AsyncIterator,
    Awaitable,
...
class Stub:
    ...
    def __init__(
        ...
        *,
        ...
        # NOTE: when running tests via `rbt.aio.tests.Resemble`
