...
from rbt.aio.resolvers import StaticResolver
from rbt.aio.types import RoutableAddress
...
class ExternalContext(IdempotencyManager):
    """Abstraction for making RPCs to one or more resemble states from
    _outside_ of Resemble.
    """
