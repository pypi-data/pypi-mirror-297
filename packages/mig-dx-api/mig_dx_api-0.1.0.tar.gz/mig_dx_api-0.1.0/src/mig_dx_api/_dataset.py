...
from ._models import Dataset, Field, create_model
...
class DatasetManager:
    ...
    def create(self, name: str, description: str, schema: dict) -> "DatasetOperations":
...
class AsyncDatasetManager:
    ...
    async def create(
        self, name: str, description: str, schema: dict
    ) -> "AsyncDatasetOperations":
...
class DatasetOperations(ABCDatasetOperations):
    ...
    def load(self, data: list[dict]):
        ...
        r = self.upload_data_to_url(upload_url, data)
