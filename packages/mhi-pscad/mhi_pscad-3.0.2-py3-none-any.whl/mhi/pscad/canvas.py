...
class Canvas(Remotable):               # pylint: disable=too-many-public-methods
    ...
    def _find(self, *names: Optional[str], **params) -> List[Component]:
        ...
        if namespace and defn_name and params:
            try:
    ...
    def select_components(self,             # pylint: disable=too-many-arguments
                          x1: int, y1: int,
    ...
    def add_component(self,                 # pylint: disable=too-many-arguments
...
class UserCanvas(Canvas):              # pylint: disable=too-many-public-methods
