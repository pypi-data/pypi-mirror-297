...
class Project(Remotable):              # pylint: disable=too-many-public-methods
    """
    PSCAD Project
    """
    ...
    def _forget(self):
        ...
        del self._pscad._project_cache[self.name] # pylint: disable=protected-access
        super()._forget()
    ...
    def _param_values(self, param_name, namespace, defn, named, **params):
        ...
        for defn_name in self.definitions():
            ...
            if prj_defn.is_module():
                ...
                canvas_values = canvas._param_values(param_name, # pylint: disable=protected-access
