...
class Ai:
    ...
    def upload(self, file_path):
        ...
        print(f"Uploaded {file_path}. Please re-use this URL for future computer.ai.cloud operations involving that file:", url)
        return url
    ...
    def chat(
        ...
        if self.openai_client == None:
            openai_client = OpenAI(base_url=self.computer.api_base, api_key=self.computer.api_key)
