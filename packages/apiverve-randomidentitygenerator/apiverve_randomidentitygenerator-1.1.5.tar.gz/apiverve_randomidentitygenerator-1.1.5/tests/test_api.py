...
class TestRandomidentitygeneratorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = RandomidentitygeneratorAPIClient(self.api_key)

    @patch('apiverve_randomidentitygenerator.apiClient.requests.get')
