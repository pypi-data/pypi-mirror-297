...
def _create_experiment(experiment_name: Optional[str] = None) -> BaseExperiment:
    ...
    exp._log_other("Created from", FRAMEWORK, include_context=False)

    return exp


def _get_or_create_experiment(experiment: Optional[BaseExperiment]) -> BaseExperiment:
    if experiment:
        return experiment
