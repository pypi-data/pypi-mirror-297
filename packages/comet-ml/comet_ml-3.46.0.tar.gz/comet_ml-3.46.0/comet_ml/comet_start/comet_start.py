...
def start(
    ...
    Returns:
        The initialized Comet Experiment object. Returns a [comet_ml.Experiment][] object when online is `True` and a
            [comet_ml.OfflineExperiment][] object when online is `False`.
