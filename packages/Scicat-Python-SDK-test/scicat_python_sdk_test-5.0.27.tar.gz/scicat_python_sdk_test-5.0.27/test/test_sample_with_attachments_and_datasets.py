    ...
    def make_instance(self, include_optional) -> SampleWithAttachmentsAndDatasets:
        ...
        if include_optional:
            return SampleWithAttachmentsAndDatasets(
                ...
                datasets = [
                    Scicat-Python-SDK-test.models.dataset_class.DatasetClass(
                        created_by = '', 
                        updated_by = '', 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        ...
                        version = '', 
                        history = [
                            Scicat-Python-SDK-test.models.history_class.HistoryClass(
                                id = '8f00b243-6dfe-4d1f-9096-fdb2f6983434', 
                                updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                                updated_by = '', )
                            ], 
