...
import Scicat-Python-SDK-test
from Scicat-Python-SDK-test.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to http://localhost
# See configuration.py for a list of all supported configuration parameters.
configuration = Scicat-Python-SDK-test.Configuration(
    host = "http://localhost"
)
...
with Scicat-Python-SDK-test.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = Scicat-Python-SDK-test.AdminApi(api_client)
