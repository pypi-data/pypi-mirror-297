...
def create_bronze_table_definition(spark, table_name: str, files_path: str, file_format: str, partitions: dict, schema_exclude_columns: list):
    @dlt.table(
...
def silver_streaming_process(spark, table_name: str, keys: list, partitions: dict, exclude_columns: list):
