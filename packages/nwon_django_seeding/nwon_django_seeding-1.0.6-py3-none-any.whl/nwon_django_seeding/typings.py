...
class NWONDjangoSeedingSettings(BaseModel):
    ...
    custom_seed_map: Dict[Type[Model], Dict[str, str]] = Field(
        description="This map configures our custom seeding logic for specific models. It maps a model class to a dictionary that contains the field names in the database and maps them to the field names in the seed file."
    )
