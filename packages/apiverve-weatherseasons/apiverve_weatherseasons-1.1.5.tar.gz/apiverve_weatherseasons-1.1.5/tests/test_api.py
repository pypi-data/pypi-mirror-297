...
class TestWeatherseasonsAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = WeatherseasonsAPIClient(self.api_key)

    @patch('apiverve_weatherseasons.apiClient.requests.get')
