from youtube_autonomous.segments.enums import SegmentStatus, SegmentBuildingField, ProjectStatus, ProjectField
...
class DatabaseHandler:
    ...
    def update_project_segment_status(self, db_project_id: Union[ObjectId, str], segment_index: int, status: SegmentStatus):
        """
        ...
        self.__update_project_segment_field(db_project_id, segment_index, ProjectField.STATUS.value, status.value)
