from youtube_autonomous.segments.enums import SegmentStatus, SegmentBuildingField, ProjectStatus
...
class DatabaseHandler:
    ...
    def __update_project_segment_field(self, db_project_id: Union[ObjectId, str], segment_index: int, field, value):
        """
    ...
    def __update_project_segment_status(self, db_project_id: Union[ObjectId, str], segment_index: int, status: SegmentStatus):
        """
        ...
        if not isinstance(status, SegmentStatus):
            raise Exception('The "status" parameter provided is not a SegmentStatus.')
    ...
    def set_project_segment_as_in_progress(self, db_project_id: Union[ObjectId, str], segment_index: int):
        ...
        self.__update_project_segment_status(db_project_id, segment_index, SegmentStatus.IN_PROGRESS.value)
    ...
    def set_project_segment_as_finished(self, db_project_id: Union[ObjectId, str], segment_index: int):
        ...
        self.__update_project_segment_status(db_project_id, segment_index, SegmentStatus.FINISHED)
    ...
    def set_project_segment_transcription(self, db_project_id: Union[ObjectId, str], segment_index: int, transcription):
        ...
        self.__update_project_segment_field(db_project_id, segment_index, SegmentBuildingField.TRANSCRIPTION.value, transcription)
    ...
    def set_project_segment_audio_filename(self, db_project_id: Union[ObjectId, str], segment_index: int, audio_filename):
        ...
        self.__update_project_segment_field(db_project_id, segment_index, SegmentBuildingField.AUDIO_FILENAME.value, audio_filename)
    ...
    def set_project_segment_video_filename(self, db_project_id: Union[ObjectId, str], segment_index: int, video_filename):
        ...
        self.__update_project_segment_field(db_project_id, segment_index, SegmentBuildingField.VIDEO_FILENAME.value, video_filename)
    ...
    def set_project_segment_full_filename(self, db_project_id: Union[ObjectId, str], segment_index: int, full_filename):
        ...
        self.__update_project_segment_field(db_project_id, segment_index, SegmentBuildingField.FULL_FILENAME.value, full_filename)

    def __update_project_field(self, db_project_id: Union[ObjectId, str], field, value):
        if not db_project_id:
            raise Exception('No "db_project_id" provided.')
    ...
    def set_project_as_in_progress(self, db_project_id: Union[ObjectId, str]):
        ...
        self.__update_project_field(db_project_id, 'status', ProjectStatus.IN_PROGRESS.value)
    ...
    def set_project_as_finished(self, db_project_id: Union[ObjectId, str]):
        ...
        self.__update_project_field(db_project_id, 'status', ProjectStatus.FINISHED.value)
