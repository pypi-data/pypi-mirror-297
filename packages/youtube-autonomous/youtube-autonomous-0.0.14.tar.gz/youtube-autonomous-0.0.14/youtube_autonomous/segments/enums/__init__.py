...
class SegmentType(Enum):
    ...
    @classmethod
    def is_valid(cls, type: str):
        """
        Returns True if the provided 'type' is a valid SegmentType enum
        or False if not.
        """
        if not type:
        ...
        if not isinstance(type, str):
            raise Exception('The "type" parameter provided is not a string.')
...
class SegmentStatus(Enum):
    ...
    def is_valid(cls, status: str):
        """
        Returns True if the provided 'status' is a valid SegmentStatus enum
        or False if not.
        """
        if not status:
        ...
        if not isinstance(status, str):
            raise Exception('The "status" parameter provided is not a string.')
...
class ProjectStatus(Enum):
    ...
    def is_valid(cls, status: str):
        """
        Returns True if the provided 'status' is a valid ProjectStatus enum
        or False if not.
        """
        if not status:
            raise Exception('No "status" provided.')
