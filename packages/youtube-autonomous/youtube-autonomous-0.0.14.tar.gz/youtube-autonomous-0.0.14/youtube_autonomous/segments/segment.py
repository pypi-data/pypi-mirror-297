...
class Segment:
    ...
    def text(self, text: Union[str, None]):
        if not self._do_use_setter:
            ...
            self._text_sanitized = self._shortcode_parser.text_sanitized
            self._text_sanitized_without_shortcodes = self._shortcode_parser.text_sanitized_without_shortcodes
            self._text_sanitized_with_simplified_shortcodes = self._shortcode_parser.text_sanitized_with_simplified_shortcodes
