...
class TestUseragentparserAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = UseragentparserAPIClient(self.api_key)

    @patch('apiverve_useragentparser.apiClient.requests.get')
