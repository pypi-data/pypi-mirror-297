...
async def async_getParsedTransaction(tx_sig=None,txnData=None,,maxSupportedTransactionVersion=None):
    maxSupportedTransactionVersion=maxSupportedTransactionVersion or 0
    method = "getParsedTransaction"
    params = await makeParams(tx_sig=tx_sig,txnData=txnData, maxSupportedTransactionVersion=maxSupportedTransactionVersion)
    return await makeLimitedDbCall(method, params)

def getParsedTransaction(tx_sig=None,txnData=None,maxSupportedTransactionVersion=None):
    return get_async_response(tx_sig=tx_sig,txnData=txnData, maxSupportedTransactionVersion=maxSupportedTransactionVersion)
