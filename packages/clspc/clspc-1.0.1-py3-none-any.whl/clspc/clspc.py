...
class CL_SPC:
    ...
    def __init__(self, past_window: int, future_window: int, forgetting_factor: float, error_cost: npt.NDArray[np.float64], input_cost: npt.NDArray[np.float64], input_delta_cost: npt.NDArray[np.float64]):
        """
    ...
    def step(self, uk: float, yk: float, rf: npt.NDArray[np.float64]) -> float:
        ...
        4. Contruct :math:`\\tilde{\mathcal{H}}`
