.. container:: document
   ...
   IDE) <https://github.com/robotframework/RIDE/>`__ v2.1dev73 is a new
   ...
   *Linux users are advised to install first wxPython from .whl package
   ...
   .. code:: literal-block
      ...
      pip install --upgrade --pre robotframework-ride==v2.1dev73
   ...
   RIDE v2.1dev73 was released on 03/September/2024.
