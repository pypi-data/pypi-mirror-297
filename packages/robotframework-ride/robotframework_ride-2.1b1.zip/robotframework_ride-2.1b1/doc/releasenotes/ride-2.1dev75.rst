.. container:: document
   ...
   IDE) <https://github.com/robotframework/RIDE/>`__ v2.1dev75 is a new
   ...
   *Linux users are advised to install first wxPython from .whl package
   ...
   .. code:: literal-block
      ...
      pip install --upgrade --pre robotframework-ride==v2.1dev75
   ...
   RIDE v2.1dev75 was released on 04/September/2024.
