...
class LayoutApp(App):
    ...
    def __init__(self, driver_class: Type[Driver] | None = None, css_path: CSSPathType | None = None,
                 ...
                 review_steps: list[Tuple[str, str, str]] = None) -> None:
...
class UI:
    ...
    def __init__(self, fcommit: FlashCommitAdapter, review_steps: list[Tuple[str, str, str]]):
        super().__init__()
        self.app = LayoutApp(fcommit=fcommit, review_steps=review_steps)
