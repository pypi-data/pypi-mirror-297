...
class GithubIntergration:
    ...
    def __init__(self, token, expiration_time) -> None:
    ...
    def refresh_access_token(self):
        ...
        if response.status_code == 201:
            ...
            print(f"Access token refreshed. Expires at: {expires_at_str}")
        else:
    ...
    def should_throttle(self):
        ...
        if rate_limit.core.remaining < 100:
            ...
            print(f"Warning: Approaching rate limit. {rate_limit.core.remaining} calls remaining.")
            print(f"Rate limit will reset in {reset_time:.2f} seconds.")
