...
class basic_data:
	...
	def __init__(self):
		...
		self.vars["line_style"] = {"-.": 5, "-..": 6, "." : 2, "=": 7, "-" : 1}
		self.vars["line_width"] = {"yel": 7,"25": 2,"50": 4,"75": 6,"100": 8,"150": 12,"225": 18,"300": 24,"450": 36,"600": 48,"---": 2,"--": 4
								   ,"-": 6,"basic": 8,"": 8,"+": 12,"++": 18,"+++": 24,"++++": 36,"+++++": 48}
		...
		self.vars["num_th_vs_num"] = {'1st': 1, '2nd': 2, '3rd': 3, '4th': 4, '5th': 5, '6th': 6, '7th': 7, '8th': 8, '9th': 9, '10th': 10,
		...
		self.vars["month_vs_num"] = {'january': 1, 'february': 2, 'march': 3, 'april': 4, 'may': 5, 'june': 6, 'july': 7, 'august': 8, 'september': 9, 'october': 10, 'november': 11, 'december': 12}
		self.vars["num_vs_month"] = self.vars["dic_no_mon"] = {1:'january', 2:'february', 3:'march', 4:'april', 5:'may', 6:'june', 7:'july', 8:'august',  9:'september', 10:'october', 11:'november', 12:'december'}
		self.vars["mon_vs_num"] = {'jan': 1, 'feb': 2, 'mar': 3, 'apr': 4, 'jun': 6, 'jul': 7, 'aug': 8, 'sep': 9, 'oct': 10, 'nov': 11, 'dec': 12}
		self.vars["week_vs_num"] = self.vars["week_vs_enum"] = {'monday': 1, 'tuesday': 2, 'wendsday': 3, 'thursday': 4, 'friday': 5, 'saturday': 6, 'sunday': 7}
		self.vars["dic_mon_no"] = {'january': 1, 'february': 2, 'march': 3, 'april': 4, 'may': 5, 'june': 6, 'july': 7,
		...
		self.vars["check_week_vs_num"] = {'monday': 1, 'tuesday': 2, 'wendsday': 3, 'thursday': 4, 'friday': 5, 'saturday': 6, 'sunday': 7,
										  'mon': 1, 'tue': 2, 'wen': 3, 'thu': 4, 'fri': 5,  'sat': 6, 'sun': 7,
										  '월요일': 1, '화요일': 2, '수요일': 3, '목요일': 4, '금요일': 5,  '토요일': 6, '일요일': 7,
										  '월': 1, '화': 2, '수': 3, '목': 4, '금': 5,  '토': 6, '일': 7
										  }
		self.vars["check_font_para"] = {"bold": "bold", "진하게": "bold",
		...
		self.vars["check_line_para"] = {
					"실선": ["thi", 1], "점선": ["thi", 2], "가는점선": ["thi", 1],
					"굵은실선": ["thi", 6], "hairline": ["thi", 1],
					"thick": ["thi", 4], "thin": ["thi", 2], "t-2": ["thi", 1],
					"to": ["thi", -4138], "t1": ["thi", 4], "t-1": ["thi", 2], "매우가는": ["thi", 1],
					"일반": ["thi", -4138], "굵은": ["thi", 4], "가는": ["thi", 2],
					"-": ["sty", 1], ".": ["sty", -4118], "-.": ["sty", 4], "-..": ["sty", 5], "..": ["sty", -4115], "=": ["sty", 4119],
					"no": ["sty", -4142], "/..": ["sty", 13], "/.": ["sty", 13],
					"\\": ["pos", [5]], "대각선왼쪽": ["pos", [5]],
					"/": ["pos", [6]], "대각선오른쪽": ["pos", [6]],
					"|": ["pos", [7]], "left": ["pos", [7]], "왼쪽": ["pos",[7]],
					"t": ["pos", [8]], "top": ["pos", [8]], "위쪽": ["pos", [8]],
					"b": ["pos", [9]], "bottom": ["pos", [9]],	"아래쪽": ["pos", [9]],
					"r": ["pos", [10]], "right": ["pos", [10]], "오른쪽": ["pos", [10]],
					"h": ["pos", [11]], "inside-h": ["pos", [11]], "inh": ["pos", [11]], "안쪽세로": ["pos", [11]], "hor": ["pos", [11]],
					"v": ["pos", [12]], "inside-v": ["pos", [12]], "inv": ["pos", [12]], "안쪽가로": ["pos", [12]], "ver": ["pos", [12]],
					"in": ["pos", [11, 12]],
					"o": ["pos", [7, 8, 9, 10]], "테두리": ["pos", [7, 8, 9, 10]], "": ["pos", [7, 8, 9, 10]], "out": ["pos", [7, 8, 9, 10]], "outside": ["pos", [7, 8, 9, 10]],
					"a": ["pos", [7, 8, 9, 10, 11, 12]], "al!": ["pos", [7, 8, 9, 10, 11, 12]],	"전부": ["pos", [7, 8, 9, 10, 11, 12]],
					"total": ["pos", [5, 6, 7, 8, 9, 10, 11, 12]]}
		...
		self.vars["check_color_step"] = {
			...
			10: "10", "10": "10", "l-5": "10", "-----": "10", "dark_grayish": "10", "dkg": "10", "어두운회색": "10",
			"d-5": "10",
		...
		self.vars["check_color_name"] ={
			...
			"청록": "blu_cya", "청록색": "blu_cya", "청녹": "blu_cya", "청": "blu_cya", "군청": "blu_cya", "군청색": "blu_cya", "청색": "blu_cya", "blu_cya": "blu_cya", "bluecyan": "blu_cya", "blue_cyan": "blu_cya", "blue cyan": "blu_cya", "cb": "blu_cya", "bg": "blu_cya", "bluegreen": "blu_cya", "bc": "blu_cya",7: "blu_cya", 210: "blu_cya",
		...
		self.vars["check_line_style"] = {"실선": 1, "일반": 1,"_": 1,"": 1,"-": -4115, "-.": 4, "-..": 5,".": -4118, "점선": -4118,"=": -4119,"no": -4142, "/": 13,}
		self.vars["check_line_position"] = {
			"l": [7], "left": [7], "왼쪽": [7],
			"t": [8], "top": [8], "위쪽": [8],
			"b": [9], "bottom": [9], "아래쪽": [9],
			...
			"o": [7, 8, 9, 10], "테두리": [7, 8, 9, 10], "": [7, 8, 9, 10],	"basic": [7, 8, 9, 10],
			"out": [7, 8, 9, 10],"사각": [7, 8, 9, 10],"외곽": [7, 8, 9, 10],"outside": [7, 8, 9, 10],
			"/": [6], "대각선오른쪽": [6],
			"\\": [5], "대각선왼쪽": [5],
			"in": [11, 12],
			"total": [5, 6, 7, 8, 9, 10, 11, 12],
		}
		self.vars["check_line_thickness"] = {
			'굵은': 4, '굵은선': 4, 'thick': 4, 't1': 4,
			"": -4138, "기본굵기": -4138, "기본두께": -4138,"기본선": -4138, 't0': -4138, 'thick_basic': -4138,
			'가는선': 2, '가는': 2, 'thin': 2, 't-1': 2,'매우가는': 1, '매우가는선': 1,'hairline': 1, 't-2': 1, 1:1, 2:2}
		self.vars["check_font_type"] = {"진하게": "bold", "bold": "bold",
										   "이탈릭": "italic", "이탤릭": "italic", "이태릭": "italic", "italic": "italic",
										   "밑줄": "underline", "underline": "underline", "line": "underline",
										   "취소선": "strikethrough", "strikethrough": "strikethrough", "취소": "strikethrough", "strike": "strikethrough",
											"중간": 1, "middle": 1, "왼쪽": 0, "left": 0, "오른쪽": 2, "right": 2, "l": 0, "m": 1, "r": 2,
										}


		self.vars["basic_12color_h"] = [0, 30, 60, 90, 120, 150, 180, 210, 240, 270, 300, 330]
		self.vars["basic_9color_sl_big_step"] = [[100, 80], [100, 77], [100, 68], [100, 59], [100, 50], [90, 41], [80, 32], [70, 23], [60, 14]]
		self.vars["basic_10color_sl_small_step"] = [[0, 12], [0, 9], [0, 6], [0, 3], [0, 0], [0, -3], [0, -6], [0, -9], [0, -12], [0, -14]]
		self.vars["basic_10color_sl"] = [[100, 0], [90, 10], [80, 20], [70, 30], [60, 40], [50, 50], [40, 60], [30, 70], [10, 80], [10, 90], [0, 100]]
		self.vars["basic_11color_sl"] = [[100, 0], [100, 10], [100, 20], [100, 30], [100, 40], [100, 50],[100, 60], [100, 70], [100, 80], [100, 90], [100, 100]]
		self.vars["basic_12color_sl"] = [[90, 50], [80, 30], [80, 50], [80, 70], [50, 20], [50, 40],  [50, 60], [50, 80], [20, 20], [20, 40], [20, 60], [20, 80]]
		self.vars["basic_12color_rgb"] = self.vars["color12_rgb"] = [[255, 0, 0], [255, 128, 0], [255, 255, 0], [128, 255, 0],[0, 255, 0], [0, 255, 128], [0, 255, 255], [0, 128, 255],[0, 0, 255], [128, 0, 255], [255, 0, 255], [255, 0, 128], ]
		self.vars["basic_12color_hsl"] = [[0, 100, 50], [30, 100, 50], [60, 100, 50], [90, 100, 50],  [120, 100, 50], [150, 100, 50], [180, 100, 50],  [210, 100, 50], [240, 100, 50], [270, 100, 50], [300, 100, 50], [330, 100, 50]]
		self.vars["basic_18color_hsl"] = [[0, 100, 50],[20, 100, 50],[40, 100, 50], [60, 100, 50], [80, 100, 50],[100, 100, 50],
		...
		self.vars["basic_15tone_eng_vs_sl"] = {"p": [25, 85], "ltg": [25, 65],"g": [25, 35],"dkg": [25, 15],"lt": [50, 80],"sf": [50, 60], "d": [50, 40],"dk": [50, 20],"s": [70, 50],	"b": [75, 75],"dp": [75, 25],"v": [90, 50],	"bla": [100, 0],"whi": [0, 100],"pas": [100, 80]}
		self.vars["basic_12color_name_kor"] = ["빨강", "오렌지", "노랑", "연두", "초록", "연초록", "하늘","군청색", "파랑", "남색", "핑크", "자주"]
		self.vars["basic_12color_name_eng"] = ['red', 'ora', 'yel', 'gre_yel', 'gre', 'gre_cya',  'cya', 'blu_cya', 'blu', 'blu_mag', 'pin',  'red_mag']
		self.vars["basic_12color_name_eng_vs_h"] = {"red": 0, "ora": 30, "yel": 60, "gre_yel": 90, "gre": 120, "gre_cya": 150, "cya": 180,  "blu_cya": 210, "blu": 240, "blu_mag": 270,  "mag": 300, "red_mag": 330, "gra": 0, "whi": 0,  "bla": 0, }
		self.vars["basic_15tone_eng"] = ["p","ltg","g","dkg","lt","sf","d","dk","s","b","dp","v", "bla", "whi", "pas"]
		self.vars["basic_12tone_eng"] = ["p","ltg","g","dkg","lt","sf","d","dk","s","b","dp","v"]
		self.vars["basic_15tone_kor"] = ["연한", "밝은회색", "회색", "어두운회색","옅은", "부드러운","탁한", "어두운", "기본", "밝은", "짙은", "선명한", "검은", "하얀", "파스텔"]
		self.vars["basic_20color_name_eng_vs_hsl"] = self.vars["color_vs_hsl"] = {
			"gra": [180, 0, 50], 	"whi": [0, 0, 100], "bla": [0, 0, 0], 	"red": [0, 100, 50],
			...
			"bro": [30, 100, 40], "sca": [350, 100, 38],	"pal_pin": [348, 95, 84],	"sul_yel": [54, 87, 58],
		}
		self.vars["basic_20color_name_eng_vs_rgb"] = self.vars["color_vs_rgb"] = {
		...
		self.vars["excel46_rgb"] = [[255, 0, 0], [0, 255, 0], [0, 0, 255], [255, 255, 0], [255, 0, 255],
					 [0, 255, 255], [153, 51, 102], [255, 255, 204], [204, 255, 255], [102, 0, 102],
					 [255, 128, 128], [0, 102, 204], [204, 204, 255], [0, 204, 255], [204, 255, 204],
					 [255, 255, 153], [153, 204, 255], [255, 153, 204], [204, 153, 255], [255, 204, 153],
					 [51, 102, 255], [51, 204, 204], [153, 204, 0], [255, 204, 0], [255, 153, 0],
					 ...
					 [128, 0, 0], [0, 128, 0], [0, 0, 128], [128, 128, 0], [128, 0, 128],
					 [0, 128, 128], [192, 192, 192], [128, 128, 128], [153, 153, 255], [0, 0, 0],]
		self.vars["excel56_vs_color_kor"] = {
		...
		self.vars["color_kor_vs_excel56"] = {
		...
		self.vars["faber_to_sl"] = [[[100, 0], [100, 50], [0, 0]],
					[[0, 0], [0, 75], [0, 100]],
					[[100, 0], [25, 75], [0, 100]],
					[[25, 0], [10, 50], [0, 75]],
					[[100, 0], [0, 0], [0, 100]],
		...
		self.vars["ganada"] = {}  # 워드용으로 공통으로 사용되는 변수들
		self.vars["ganada"]["line"] = {}
		self.vars["ganada"]["line"]["-."] = 5
		self.vars["ganada"]["line"]["-.."] = 6
		self.vars["ganada"]["line"]["."] = 2
		self.vars["ganada"]["line"]["="] = 7
		self.vars["ganada"]["line"]["-"] = 1

		self.vars["ganada"]["color_index"] = {}
		self.vars["ganada"]["color_index"]["red"] = 6
		self.vars["ganada"]["color_index"]["bla"] = 1
		self.vars["ganada"]["color_index"]["blu"] = 2
		self.vars["ganada"]["color_index"]["basic"] = 0
		self.vars["ganada"]["color_index"][""] = 0
		self.vars["ganada"]["color_index"]["gra"] = 16
		self.vars["ganada"]["color_index"]["gre"] = 11
		self.vars["ganada"]["color_index"]["pin"] = 5
		self.vars["ganada"]["color_index"]["vio"] = 12
		self.vars["ganada"]["color_index"]["whi"] = 8
		self.vars["ganada"]["color_index"]["yel"] = 7

		self.vars["ganada"]["color_24bit"] = {}
		self.vars["ganada"]["color_24bit"]["aqu"] = 13421619
		self.vars["ganada"]["color_24bit"][""] = -16777216
		self.vars["ganada"]["color_24bit"]["bla"] = 0
		self.vars["ganada"]["color_24bit"]["blu"] = 16711680
		self.vars["ganada"]["color_24bit"]["bro"] = 13209
		self.vars["ganada"]["color_24bit"]["gre"] = 32768
		self.vars["ganada"]["color_24bit"]["ind"] = 10040115
		self.vars["ganada"]["color_24bit"]["ora"] = 26367
		self.vars["ganada"]["color_24bit"]["pin"] = 16711935
		self.vars["ganada"]["color_24bit"]["red"] = 255
		self.vars["ganada"]["color_24bit"]["vio"] = 8388736
		self.vars["ganada"]["color_24bit"]["whi"] = 16777215
		self.vars["ganada"]["color_24bit"]["yel"] = 65535

		self.vars["ganada"]["line_width"] = {}
		self.vars["ganada"]["line_width"]["yel"] = 7
		self.vars["ganada"]["line_width"]["25"] = 2
		self.vars["ganada"]["line_width"]["50"] = 4
		self.vars["ganada"]["line_width"]["75"] = 6
		self.vars["ganada"]["line_width"]["100"] = 8
		self.vars["ganada"]["line_width"]["150"] = 12
		self.vars["ganada"]["line_width"]["225"] = 18
		self.vars["ganada"]["line_width"]["300"] = 24
		self.vars["ganada"]["line_width"]["450"] = 36
		self.vars["ganada"]["line_width"]["600"] = 48

		self.vars["ganada"]["line_width"]["---"] = 2
		self.vars["ganada"]["line_width"]["--"] = 4
		self.vars["ganada"]["line_width"]["-"] = 6
		self.vars["ganada"]["line_width"]["basic"] = 8
		self.vars["ganada"]["line_width"][""] = 8
		self.vars["ganada"]["line_width"]["+"] = 12
		self.vars["ganada"]["line_width"]["++"] = 18
		self.vars["ganada"]["line_width"]["+++"] = 24
		self.vars["ganada"]["line_width"]["++++"] = 36
		self.vars["ganada"]["line_width"]["+++++"] = 48

		#self.vars["ganada"]["current_page_begin_no"] = self.word_application.Selection.Range.Information(1)
		#self.vars["ganada"]["current_page_end_no"] = self.word_application.Selection.Range.Information(3)
		#self.vars["ganada"]["page_total"] = self.word_application.Selection.Range.Information(4)
		#self.vars["ganada"]["cap_on_off"] = self.word_application.Selection.Range.Information(21)
		#self.vars["ganada"]["num_on_off"] = self.word_application.Selection.Range.Information(22)
		#self.vars["ganada"]["current_line_index"] = self.word_application.Selection.Range.Information(10)
		#self.vars["ganada"]["zoom"] = self.word_application.Selection.Range.Information(19)
		#self.vars["ganada"]["file_name"] = self.active_word_file.Name
		#self.vars["ganada"]["file_fullname"] = self.active_word_file.FullName
		#self.vars["ganada"]["file_path"] = self.active_word_file.Path
		#self.vars["ganada"]["paragraph_nos"] = self.active_word_file.Paragraphs.Count
		#self.vars["ganada"]["file_nos"] = self.word_application.Documents.Count
		#self.vars["ganada"]["table_nos"] = self.active_word_file.Tables.Count


		self.vars["wdCell"] = 12, # 보통 워드나 엑셀의 이름은 고유하므로 딱히 분리하지 않아도 된다
		self.vars["wdColumn"] = 9,
		self.vars["wdRow"] = 10,
		self.vars["wdTable"] = 15,
		self.vars["wdCharacte"] = 1
		self.vars["wdWord"] = 2
		self.vars["wdCharacterFormatting"] = 13
		self.vars["wdItem"] = 16
		self.vars["wdLine"] = 5  # 라인
		self.vars["wdSentence"] = 3  # 글을쓰다가 .까지의 영역
		self.vars["wdParagraph"] = 4  # 문단
		self.vars["wdParagraphFormatting"] = 14
		self.vars["wdScreen"] = 7
		self.vars["wdSection"] = 8  # 임의적으로 구역을 나누는것
		self.vars["wdStory"] = 6
		self.vars["wdWindow"] = 11

		self.vars["wdGoToAbsolute"] = 1  # An absolute position.
		self.vars["wdGoToFirst"] = 1  # The first instance of the specified object.
		self.vars["wdGoToLast"] = -1  # The last instance of the specified object.
		self.vars["wdGoToNext"] = 2  # The next instance of the specified object.
		self.vars["wdGoToPrevious"] = 3  # The previous instance of the specified object.
		self.vars["wdGoToRelative"] = 2  # A position relative to the current position.
		self.vars["wdGoToBookmark"] = -1  # A bookmark.
		self.vars["wdGoToComment"] = 6  # A comment.
		self.vars["wdGoToEndnote"] = 5  # An endnote.
		self.vars["wdGoToEquation"] = 10  # An equation.
		self.vars["wdGoToField"] = 7  # A field.
		self.vars["wdGoToFootnote"] = 4  # A footnote.
		self.vars["wdGoToGrammaticalError"] = 14  # A grammatical error.
		self.vars["wdGoToGraphic"] = 8  # A graphic.
		self.vars["wdGoToHeading"] = 11  # A heading.
		self.vars["wdGoToLine"] = 3  # A line.
		self.vars["wdGoToObject"] = 9  # An object.
		self.vars["wdGoToPage"] = 1  # A page.
		self.vars["wdGoToPercent"] = 12  # A percent.
		self.vars["wdGoToProofreadingError"] = 15  # A proofreading error.
		self.vars["wdGoToSection"] = 0  # A section.
		self.vars["wdGoToSpellingError"] = 13  # A spelling error.
		self.vars["wdGoToTable"] = 2  # A table.
		...
		self.vars["han"]["basic_italic"] = False
...
class han_basic_data:
	def zzz_sample_001(self):
		"""
		#1 : 새로운 아래아한글용 문서를 open합니다
		#2 : 문자열을 3번 반복하는데, 줄바꿈을 합니다
		#3 : 새로운 줄을 2번 만듭니다
		#4 : 문자열을 3번 반복하는데, 줄바꿈을 하지 않읍니다
		"""

		hwp = han("new") #1

		for no in range(3): #2
			hwp.write_text_at_cursor("현재 커서 위치에 글을 쓰고 다음줄로 옮깁니다", True)

		hwp.insert_new_line(2)# 3

		for no in range(3): #4
			hwp.write_text_at_cursor("현재 커서 위치에 글을 쓰고 다음줄로 이동하지 않읍니다", False)

	def zzz_sample_002(self):

		hwp = han("new")

		# 모든 줄을 삭제하여, 빈 문서를 만든다
		hwp.delete_all_in_document()

		# 현재커서에 님의 침묵을 쓴다
		hwp.write_text_at_cursor(self.vars["sample"]["nim"], True)

		line_nos = hwp.count_line_in_doc()
		print("줄의 수는 => ", line_nos)

		hwp.move_cursor_to_begin_of_doc() #문서의 시작지점으로 커서를 옮긴다
		hwp.move_cursor_to_nth_next_char(3) #3번째 문자로 커서이동
		hwp.move_cursor_to_nth_next_line(3) #3번째 줄로 커서이동

		for one in range(4):
			hwp.move_cursor_to_next_line()

		hwp.paint_highlight_for_selection() #선택한 영역을 하이라이트(노란색)합니다

		aaa = hwp.get_information_for_statusbar() #스테이터스바에 나타나는 기본 정보를 갖고온다
		print(aaa)

	def zzz_sample_003(self):
		hwp = han("new")
		...
		#3번째줄을 선택한다
		hwp.select_line_by_no_from_begin_of_doc(3)

		hwp.set_font_bold_in_selection() #선택한 영역을 진하게 만든다
		hwp.paint_highlight_for_selection() #선택한 영역을 하이라이트(노란색)합니다

		#7번째줄을 선택한다
		hwp.select_line_by_no_from_begin_of_doc(7)
		hwp.paint_highlight_for_selection()

		hwp.select_from_cursor_to_nth_word(5)
		hwp.set_font_bold_in_selection()
		hwp.select_from_cursor_to_nth_word(2)
		hwp.set_font_color_in_selection_by_scolor("blu")

		hwp.move_cursor_to_nth_line(2)
		hwp.select_current_line()
		hwp.paint_highlight_for_selection()

		hwp.select_from_cursor_to_nth_word(6)
		hwp.set_font_bold_in_selection()
		hwp.set_font_color_in_selection_by_scolor("red")
		hwp.move_cursor_to_end_of_selection()

	def zzz_sample_004(self):
		#새로운 문서를 만든다
		hwp = han("new")
		...
		for x in range(1, 3+1):
			for y in range(1, 5+1):
				hwp.write_text_in_table_by_xy(1, x,y,str(x*y), False)

		# 문서의 마지막으로 커서를 옮긴다
		hwp.move_cursor_to_end_of_doc()
		hwp.insert_next_line_at_cusor(1)
		hwp.write_text_at_cursor("값을 씁니다2", False)
		hwp.insert_next_line_at_cusor(3)
		...
		for x in range(1, 3+1):
			for y in range(1, 5+1):
				hwp.write_text_in_table_by_xy(2, x,y,str(x*y), True)
