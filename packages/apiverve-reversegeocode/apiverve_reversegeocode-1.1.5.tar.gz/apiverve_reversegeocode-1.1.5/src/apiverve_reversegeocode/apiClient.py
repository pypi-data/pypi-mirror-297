...
class ReversegeocodeAPIClient:
    def __init__(self, api_key, secure=True):
        """
        Initialize the ReversegeocodeAPIClient with the API key and secure flag
        ...
        self.secure = secure
        self.base_url = 'https://api.apiverve.com/v1/reversegeocode'
        self.headers = {
