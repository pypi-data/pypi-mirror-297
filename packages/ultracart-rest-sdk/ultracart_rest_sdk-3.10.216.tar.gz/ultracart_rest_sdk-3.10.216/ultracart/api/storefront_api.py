...
class StorefrontApi(object):
    ...
    def sunset_email_segment(self, storefront_oid, email_segment_uuid, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.sunset_email_segment_with_http_info(storefront_oid, email_segment_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.sunset_email_segment_with_http_info(storefront_oid, email_segment_uuid, **kwargs)  # noqa: E501
            return data

    def sunset_email_segment_with_http_info(self, storefront_oid, email_segment_uuid, **kwargs):  # noqa: E501
        """Sunset email segment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sunset_email_segment_with_http_info(storefront_oid, email_segment_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method sunset_email_segment" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'storefront_oid' is set
        if ('storefront_oid' not in params or
                params['storefront_oid'] is None):
            raise ValueError("Missing the required parameter `storefront_oid` when calling `sunset_email_segment`")  # noqa: E501
        # verify the required parameter 'email_segment_uuid' is set
        if ('email_segment_uuid' not in params or
                params['email_segment_uuid'] is None):
            raise ValueError("Missing the required parameter `email_segment_uuid` when calling `sunset_email_segment`")  # noqa: E501
