class TooOldPyroherdVersion(Exception):
    def __init__(
            self,
            version_needed: str,
            pyroherd_version: str,
    ):
        super().__init__(
            f'Needed pyroherd {version_needed}+, '
...
class HerdCallsAlreadyRunning(Exception):
    def __init__(self):
        super().__init__(
            'HerdCalls client is already running',
        )
