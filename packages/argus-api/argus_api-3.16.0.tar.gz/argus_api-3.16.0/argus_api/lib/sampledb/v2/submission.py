...
def submission_statistics(
    ...
    indexEndTimestamp: str = None,
    groupBy: dict = None,
    statisticsMetrics: dict = None,
    statistics: dict = None,
    rangeMetrics: dict = None,
    timeline: dict = None,
    json: bool = True,
    verify: Optional[bool] = None,
    proxies: Optional[dict] = None,
    ...
    :param list statisticsMetrics: The numerical fields for which to generate metrics. Deprecated\, use statistics instead
    :param list statistics: The numerical fields for which to generate metrics
    :param list rangeMetrics: The timestamp fields for which to generate statistics. Deprecated\, use timeline instead
    ...
    # Only send statisticsMetrics if the argument was provided, don't send null values
    if statisticsMetrics is not None:
        body.update({"statisticsMetrics": statisticsMetrics})
    # Only send statistics if the argument was provided, don't send null values
    if statistics is not None:
        body.update({"statistics": statistics})
    # Only send rangeMetrics if the argument was provided, don't send null values
    if rangeMetrics is not None:
        body.update({"rangeMetrics": rangeMetrics})
