...
def submit(
    ...
    # Only send enableSandboxAnalysis if the argument was provided, don't send null values
    if enableSandboxAnalysis is not None:
        body.update({"enableSandboxAnalysis": enableSandboxAnalysis})
    # Only send allowSandboxInternetAccess if the argument was provided, don't send null values
    if allowSandboxInternetAccess is not None:
        body.update({"allowSandboxInternetAccess": allowSandboxInternetAccess})
    # Only send enableAntivirusScan if the argument was provided, don't send null values
    if enableAntivirusScan is not None:
        body.update({"enableAntivirusScan": enableAntivirusScan})
    # Only send clientName if the argument was provided, don't send null values
