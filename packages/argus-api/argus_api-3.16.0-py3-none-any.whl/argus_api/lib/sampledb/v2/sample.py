...
def add_evidence(
    ...
    :param str name: The name given to the evidence. Deprecated and will be replaced with fileName
    :param str fileName: The file name given to the evidence
    :param bool internal: Whether the Evidence should be available to external users or not
    :param bool potentiallyMalicious: Whether the Evidence is malicious or not
    :param list flags: Flags for the evidence. Deprecated and will be replaced with booleans internal and potentiallyMalicious
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
      default. If set to false, the raw ``requests.Response`` object will be returned.
    :param verify: path to a certificate bundle or boolean indicating whether SSL
      verification should be performed.
