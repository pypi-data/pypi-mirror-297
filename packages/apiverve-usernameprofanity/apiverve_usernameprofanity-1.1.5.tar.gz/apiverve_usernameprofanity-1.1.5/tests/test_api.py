...
class TestUsernameprofanityAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = UsernameprofanityAPIClient(self.api_key)

    @patch('apiverve_usernameprofanity.apiClient.requests.get')
