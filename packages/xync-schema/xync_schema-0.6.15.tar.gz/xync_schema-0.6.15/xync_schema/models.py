...
class Fiat(Model):
    ...
    @classmethod
    def pyd(
        cls, max_rcs=1, bck_rel=False, exclude=("user",), include=(), excl_raw_flds=True, force=False
    ) -> type[PydanticModel]:
        return super().pyd(bck_rel=bck_rel, exclude=exclude, excl_raw_flds=excl_raw_flds)
