...
class Agent(TsModel):
    ...
    def pydListItem(
        ...
        return super().pydListItem(max_recursion, backward_relations, exclude=("user",))
...
class Fiat(Model):
    ...
    def pydListItem(
        ...
        return super().pydListItem(2, False, ("user", "pmcur__exs"))
    ...
    def pyd(
        ...
        return super().pyd(
            backward_relations=backward_relations, exclude=exclude, exclude_raw_fields=exclude_raw_fields
        )
