...
from cloudx.logutils import CxLogging


logging = CxLogging.get_logger('CxMail')
...
class CxMailClient(object):
  ...
  def new_mail(self) -> CxMail:
    self._mails.append(CxMail().set_from_addr(self._username))
