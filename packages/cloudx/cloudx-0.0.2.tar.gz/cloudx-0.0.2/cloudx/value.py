...
from cloudx.limits import *
from cloudx.patterns import *
from cloudx import jsonutils as json
from cloudx.urlutils import CxUrl
...
class CxValueUtils(object):
  ...
  def base_encode(s: Union[bytes, str], base: Optional[int] = None, encoding: Optional[str] = None, with_meta: bool = False) -> str:
    encoding = CxValueUtils.auto_choose_encoding(encoding)

    s = CxValueUtils.str_to_bytes(s, encoding=encoding)

    base = CxValueUtils.auto_choose_base(base)

    enc = getattr(base64, f'b{base}encode')
    assert callable(enc)

    ret = CxValueUtils.bytes_to_str(enc(s), encoding=encoding)
  ...
  def base_decode(s: Union[bytes, str], base: Optional[int] = None, encoding: Optional[str] = None) -> Union[bytes, str]:
    ...
    s = CxValueUtils.bytes_to_str(s)

    if PATTERN_BASE_ENC.fullmatch(s):
      s_t = s.split(',', maxsplit=1)
      base = CxValueUtils.auto_choose_base(s_t[0][4:])
      s = s[1]
    else:
      base = CxValueUtils.auto_choose_base(base)
  ...
  def base_encode_v(v: Any, base: Optional[int] = None, encoding: str = None, encoder: str = 'json') -> str:
    ...
    s = enc(v)
    s = CxValueUtils.str_to_bytes(s)

    ret = CxValueUtils.base_encode(s, base=base, encoding=encoding, with_meta=True)
  ...
  def base_decode_v(v: Any, encoding: str = None) -> Any:
    ...
    if isinstance(v, str):
      ...
      v = CxValueUtils.base_decode(v, encoding=encoding)
  ...
  def is_none(v: Any, strict: bool = False) -> bool:
    ...
    if v is None:
      ...
      v = CxValueUtils.base_decode_v(v)
      if v is None:
        ret = True
  ...
  def is_not_true(v: Any, strict: bool = False) -> bool:
    return not CxValueUtils.is_true(v, strict=strict)

  @staticmethod
  def is_not_false(v: Any, strict: bool = False) -> bool:
    return not CxValueUtils.is_false(v, strict=strict)
  ...
  def to_list(v: Any, default: Optional[List] = None, strict: bool = False, deep_clone: Optional[bool] = None) -> Union[None, List]:
    ...
    ret = CxValueUtils.clone(ret, deep=deep_clone)
...
class CxValue(object):
  def __init__(self, v: Any, vfn: Optional[Callable] = None):
    v = v.raw_value if isinstance(v, CxValue) else v
    v = vfn(v) if callable(vfn) else v
    self._raw_value = v

  @staticmethod
  def create(v: Any):
    return v if isinstance(v, CxValue) else CxValue(v)
  ...
  def is_callable(self) -> bool:
    return CxValueUtils.is_callable(self.raw_value)

  def is_function(self) -> bool:
    return CxValueUtils.is_function(self.raw_value)

  def is_method(self) -> bool:
    return CxValueUtils.is_method(self.raw_value)

  def is_none(self, strict: bool = False) -> bool:
    return CxValueUtils.is_none(self.raw_value, strict=strict)

  def is_bool(self, strict: bool = False) -> bool:
    return CxValueUtils.is_bool(self.raw_value, strict=strict)

  def is_true(self, strict: bool = False) -> bool:
    return CxValueUtils.is_true(self.raw_value, strict=strict)

  def is_false(self, strict: bool = False) -> bool:
    return CxValueUtils.is_false(self.raw_value, strict=strict)

  def is_not_true(self, strict: bool = False) -> bool:
    return CxValueUtils.is_not_true(self.raw_value, strict=strict)

  def is_not_false(self, strict: bool = False) -> bool:
    return CxValueUtils.is_not_false(self.raw_value, strict=strict)

  def is_int(self, strict: bool = False) -> bool:
    return CxValueUtils.is_int(self.raw_value, strict=strict)

  def is_float(self, strict: bool = False) -> bool:
    return CxValueUtils.is_float(self.raw_value, strict=strict)
  ...
  def is_str(self, strict: bool = False) -> bool:
    return CxValueUtils.is_str(self.raw_value, strict=strict)

  def is_list(self, strict: bool = False) -> bool:
    return CxValueUtils.is_list(self.raw_value, strict=strict)

  def is_dict(self, strict: bool = False) -> bool:
    return CxValueUtils.is_dict(self.raw_value, strict=strict)

  def to_bool(self, default: Optional[bool] = None, strict: bool = False) -> Union[None, bool]:
    return CxValueUtils.to_bool(self.raw_value, default=default, strict=strict)

  def to_int(self, default: Optional[int] = None, strict: bool = False) -> Union[None, int]:
    return CxValueUtils.to_int(self.raw_value, default=default, strict=strict)

  def to_float(self, default: Optional[float] = None, strict: bool = False) -> Union[None, float]:
    return CxValueUtils.to_float(self.raw_value, default=default, strict=strict)

  def to_str(self, default: Optional[str] = None, strict: bool = False) -> Union[None, str]:
    return CxValueUtils.to_str(self.raw_value, default=default, strict=strict)

  def to_list(self, default: Optional[list] = None, strict: bool = False) -> Union[None, list]:
    return CxValueUtils.to_list(self.raw_value, default=default, strict=strict)

  def to_dict(self, default: Optional[dict] = None, strict: bool = False) -> Union[None, dict]:
    return CxValueUtils.to_dict(self.raw_value, default=default, strict=strict)

  def __eq__(self, other: Any) -> bool:
    v = other.raw_value if isinstance(other, CxValue) else other
  ...
  def __copy__(self):
    return CxValue(copy.copy(self.raw_value))
