...
def _update_existing_control(
    ...
    update_existing_control(
        ...
        control_dict.get("statement"),
        control_dict.get("responsibility"),
        primary_role.get("id") if primary_role else None,
    )
    if params := control_dict.get("parameters"):
        handle_params(
            params,
...
def get_or_create_system_role(role: str, ssp_id: int) -> Dict:
    """
...
def update_existing_control(
    control: ControlImplementation, status: str, statement: str, responsibility: str, primary_role: Dict
):
    """
    ...
    control.systemRoleId = primary_role.get("id") if primary_role else None
    control.save()
