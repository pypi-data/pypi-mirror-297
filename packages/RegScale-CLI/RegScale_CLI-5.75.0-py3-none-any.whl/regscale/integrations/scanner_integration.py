...
def issue_due_date(severity: regscale_models.IssueSeverity, created_date: str) -> str:
    """
    ...
    due_date_map = {
        ...
        regscale_models.IssueSeverity.Moderate: 210,
        regscale_models.IssueSeverity.Low: 364,
    }
    days = due_date_map.get(severity, 394)
