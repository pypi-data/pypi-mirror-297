...
def label_propagate_continuous(embeddings, positive_seeds, negative_seeds,words, **kwargs):
    """
...
def densify(embeddings, positive_seeds, negative_seeds,words, 
    ...
    """
    embeddings= Embedding(embeddings, words, normalize=True)
    positive_seeds = [element.lower() for element in positive_seeds]
    negative_seeds = [element.lower() for element in negative_seeds]
