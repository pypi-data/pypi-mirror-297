...
__version__ = "1.0"
__description__ = "Module for reading the Chromium leveldbase LocalStorage format"
        ...
        for item in self._flat_items:  # pre-sorted
            if isinstance(item, LocalStorageRecord):
                if current_meta is None:
                    ...
                    self._batches[current_meta.leveldbase_seq_number] = LocalStorageBatch(current_meta, current_end)
                    current_meta = None
                    current_end = 0
                else:
