...
ext_modules = [
    Extension(
        'matrix_library',
        sources=['src/package_FUNNY/c_code/matrix_library.c'],
    ),
]
setup(
    name="package_FUNNY",
    ...
    cmdclass={
        'build_ext': build_ext, # il dizionario deve mappare stringhe (nomi dei comandi) a classi che estendono setuptools.Command
    },
