...
def make_thematic(root_directory, dataset_name, test_case_number, nnvvppp_algoname, thematic_function, *thematic_args,
                  **thematic_kwargs):
    """
    ...
    **thematic_kwargs : Arguments nommés supplémentaires à passer à la fonction thématique.
    ...
    None
    """
    print(f"Arguments positionnels : {thematic_args}")
    print(f"Arguments nommés : {thematic_kwargs}")
...
def make_generic(root_directory, dataset_name, test_case_number, nnvvppp_algoname, verbose=False) -> None:
    """
