...
setup(
    ...
    install_requires=['pandas==2.1.1', 'click==8.1.7', 'pyyaml', 'mkdocs==1.6.0', 'stdlib-list', 'nbformat', 'packaging', 'attrs>=22.2.0', 'fastapi', 'numpy==1.26.0', 'pip_audit==2.7.3', 'nbconvert==7.16.4', 'requests', 'uvicorn'],
    ...
    package_data = {'package_auto_assembler': ['mkdocs/**/*', 'version_logs.csv', 'release_notes.md', 'lsts_package_versions.yml', 'notebook.ipynb', 'package_mapping.json', 'package_licenses.json', '.paa.config']} ,
