...
def application(prompt: Dict[str, Any], test_case: TestCase) -> ExternalApplicationOutputCompletion:
    ...
    trace_spans = [  # whatever traces you want to track, such as what the output of each node inside the application was
        {
            "node_id": "completion",
...
question_id_to_annotation_config_dict = {
    question_ids[1]: {
        "annotation_config": "flexible",  # NOTE: this has to be a flexible annotation config
        "components": [
            [
                {
                    "data_loc": ["test_case_data", "input"],
