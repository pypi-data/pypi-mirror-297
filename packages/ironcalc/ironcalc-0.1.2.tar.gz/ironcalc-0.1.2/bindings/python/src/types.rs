use pyo3::prelude::*;
use xlsx::base::types::{Alignment, Border, BorderItem, BorderStyle, Fill, Font, FontScheme, HorizontalAlignment, Style, VerticalAlignment};
...
//     fn from(py_fill: PyFill) -> Self {
//         Fill {
//             pattern_type: py_fill.pattern_type,
//             fg_color: py_fill.fg_color,
//             bg_color: py_fill.bg_color,
//         }
//     }
// }
...
//             diagonal_up: py_border.diagonal_up,
//             diagonal_down: py_border.diagonal_down,
//             left: py_border.left.map(|item| item.into()),
//             right: py_border.right.map(|item| item.into()),
//             top: py_border.top.map(|item| item.into()),
//             bottom: py_border.bottom.map(|item| item.into()),
//             diagonal: py_border.diagonal.map(|item| item.into()),
//         }
//     }
// }
...
//     fn from(py_align: PyAlignment) -> Self {
//         Alignment {
//             horizontal: py_align.horizontal.into(),
//             vertical: py_align.vertical.into(),
//             wrap_text: py_align.wrap_text,
//         }
//     }
// }
...
//     fn from(py_style: PyStyle) -> Self {
//         Style {
//             alignment: py_style.alignment.map(|a| a.into()),
//             num_fmt: py_style.num_fmt,
//             fill: py_style.fill.into(),
//             font: py_style.font.into(),
//             border: py_style.border.into(),
//             quote_prefix: py_style.quote_prefix,
