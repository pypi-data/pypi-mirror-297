...
class Scatterer(PropertiesReport):
    ...
    def print_properties(self) -> None:
        ...
        Returns:
            None
        """
        super(Scatterer, self).print_properties(
        ...
        # print(min_delta_position, mean_delta_position)


    def add_population(self, name: str, size: BaseDistribution, refractive_index: BaseDistribution, concentration: Quantity) -> None:
        """
