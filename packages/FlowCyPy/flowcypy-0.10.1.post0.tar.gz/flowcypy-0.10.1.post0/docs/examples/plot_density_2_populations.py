...
from FlowCyPy.units import (
    microsecond, micrometer, meter, refractive_index_unit, milliliter, second, millivolt, kelvin,
    millisecond, nanometer, milliwatt, degree, volt, watt, megahertz, particle, ampere, ohm, milliampere
)
...
algorithm = peak_finder.MovingAverage(
    threshold=0.03 * millivolt,
    window_size=1 * microsecond,
    min_peak_distance=0.2 * microsecond
