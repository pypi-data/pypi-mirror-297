...
class TestProfanityfilterAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = ProfanityfilterAPIClient(self.api_key)

    @patch('apiverve_profanityfilter.apiClient.requests.get')
