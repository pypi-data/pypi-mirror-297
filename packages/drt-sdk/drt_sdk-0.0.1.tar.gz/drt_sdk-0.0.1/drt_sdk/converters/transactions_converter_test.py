...
from drt_sdk.network_providers.contract_results import \
    ContractResultItem as ContractResultItemOnNetwork
from drt_sdk.network_providers.contract_results import \
    ContractResults as ContractResultOnNetwork
from drt_sdk.network_providers.transaction_events import \
...
from drt_sdk.network_providers.transaction_logs import \
...
def test_transaction_from_dictionary_with_inner_transaction():
    ...
    inner_transaction = Transaction(
        ...
        data=b"hello",
        chain_id="localnet",
        relayer="moa1k2s324ww2g0yj38qn2ch2jwctdy8mnfxep94q9arncc6xecg3xaqhr5l9h"
    )

    relayed_transaction = Transaction(
        nonce=77,
        sender="moa1k2s324ww2g0yj38qn2ch2jwctdy8mnfxep94q9arncc6xecg3xaqhr5l9h",
        receiver="moa1k2s324ww2g0yj38qn2ch2jwctdy8mnfxep94q9arncc6xecg3xaqhr5l9h",
        gas_limit=180000,
        chain_id="localnet",
...
def test_convert_tx_on_network_to_outcome():
    ...
    logs.address = Address.new_from_bech32("moa1k2s324ww2g0yj38qn2ch2jwctdy8mnfxep94q9arncc6xecg3xaqhr5l9h")
    logs.events = [event]
    ...
    expected_tx_outcome = TransactionOutcome(
        transaction_results=[SmartContractResult(
            ...
            logs=TransactionLogs(
                address="moa1k2s324ww2g0yj38qn2ch2jwctdy8mnfxep94q9arncc6xecg3xaqhr5l9h",
...
def test_convert_tx_on_network_to_outcome_with_signal_error():
    ...
    event.address = Address.new_from_bech32("moa1qqqqqqqqqqqqqpgqj8k976l59n7fyth8ujl4as5uyn3twn0ha0ws9pjvgk")
    ...
    logs = TxLogsOnNetwork()
    logs.address = Address.new_from_bech32("moa1qqqqqqqqqqqqqpgqj8k976l59n7fyth8ujl4as5uyn3twn0ha0ws9pjvgk")
    logs.events = [event]
    ...
    expected_tx_outcome = TransactionOutcome(
        transaction_results=[SmartContractResult(
            ...
            logs=TransactionLogs(
                address="moa1qqqqqqqqqqqqqpgqj8k976l59n7fyth8ujl4as5uyn3twn0ha0ws9pjvgk",
                events=[TransactionEvent(
                    address="moa1qqqqqqqqqqqqqpgqj8k976l59n7fyth8ujl4as5uyn3twn0ha0ws9pjvgk",
                    identifier="signalError",
                    topics=[
                        Address.new_from_bech32("moa1testnlersh4z0wsv8kjx39me4rmnvjkwu8dsaea7ukdvvc9z396qfw237w").get_public_key(),
