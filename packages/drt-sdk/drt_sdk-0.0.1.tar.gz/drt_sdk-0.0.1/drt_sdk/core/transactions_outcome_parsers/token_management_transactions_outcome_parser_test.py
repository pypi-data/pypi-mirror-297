...
from drt_sdk.core.errors import ParseTransactionOutcomeError
...
from drt_sdk.testutils.utils import base64_topics_to_bytes
...
class TestTokenManagementTransactionsOutcomeParser:
    ...
    def test_parse_issue_fungible(self):
        ...
        tx_log = TransactionLogs("moa18s6a06ktr2v6fgxv4ffhauxvptssnaqlds45qgsrucemlwc8rawqevhvh6", [event])
    ...
    def test_parse_issue_non_fungible(self):
        ...
        empty_result = SmartContractResult()
        tx_log = TransactionLogs("moa18s6a06ktr2v6fgxv4ffhauxvptssnaqlds45qgsrucemlwc8rawqevhvh6", [first_event, second_event, third_event])
        tx_results_and_logs = TransactionOutcome(transaction_results=[empty_result], transaction_logs=tx_log)
    ...
    def test_parse_register_and_set_all_roles(self):
        ...
        tx_log = TransactionLogs("moa18s6a06ktr2v6fgxv4ffhauxvptssnaqlds45qgsrucemlwc8rawqevhvh6", [first_event, second_event])
        ...
        result_logs = TransactionLogs("moa18s6a06ktr2v6fgxv4ffhauxvptssnaqlds45qgsrucemlwc8rawqevhvh6", [first_result_event, second_result_event])
        sc_result = SmartContractResult(
    ...
    def test_parse_set_special_role(self):
        ...
        assert len(outcome) == 1
        assert outcome[0].user_address == "moa18s6a06ktr2v6fgxv4ffhauxvptssnaqlds45qgsrucemlwc8rawqevhvh6"
        assert outcome[0].token_identifier == identifier
        assert outcome[0].roles == roles
    ...
    def test_parse_freeze(self):
        ...
        nonce = 0
        balance = 10000000
        address = "moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8"
        ...
        tx_log = TransactionLogs("moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8", [event])
        sc_result = SmartContractResult(
            sender="moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqzllls29jpxv",
