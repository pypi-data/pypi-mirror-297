...
from drt_sdk.testutils.mock_network_provider import (
    MockNetworkProvider, TimelinePointMarkCompleted, TimelinePointWait)
from drt_sdk.testutils.wallets import load_wallets
...
class TestTransactionAwaiter:
    ...
    def test_on_network(self):
        ...
        proxy = ProxyNetworkProvider("https://devnet-api.dharitri.com")
