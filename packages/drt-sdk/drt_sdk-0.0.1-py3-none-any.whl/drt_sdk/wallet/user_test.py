...
from drt_sdk.core import (Address, Message, MessageComputer,
                                 Transaction, TransactionComputer)
from drt_sdk.wallet.crypto.randomness import Randomness
from drt_sdk.wallet.user_keys import UserSecretKey
...
def test_load_signers_from_pem():
    ...
    assert Address(signers[0].get_pubkey().buffer, "moa").to_bech32() == "moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8"
    assert Address(signers[1].get_pubkey().buffer, "moa").to_bech32() == "moa1spyavw0956vq68xj8y4tenjpq2wd5a9p2c6j8gsz7ztyrnpxrruq0yu4wk"
    assert Address(signers[2].get_pubkey().buffer, "moa").to_bech32() == "moa1k2s324ww2g0yj38qn2ch2jwctdy8mnfxep94q9arncc6xecg3xaqhr5l9h"
...
def test_sign_message():
    message = Message("hello".encode(), address=Address.new_from_bech32("moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8"))
