...
from drt_sdk.testutils.mock_network_provider import MockNetworkProvider
...
class TestSmartContractQueriesController:
    ...
    def test_create_query_without_arguments(self):
        ...
        contract = "moa1qqqqqqqqqqqqqpgqsnwuj85zv7t0wnxfetyqqyjvvg444lpk7uast5pehk"
        function = "getSum"
    ...
    def test_run_query_with_mock_provider(self):
        ...
        query = SmartContractQuery(
            contract="moa1qqqqqqqqqqqqqpgqvc7gdl0p4s97guh498wgz75k8sav6sjfjlwq6zc2w5",
            function="bar",
            arguments=[]
        )
    ...
    def test_run_query_on_network(self):
        provider = ProxyNetworkProvider("https://devnet-api.dharitri.com")
