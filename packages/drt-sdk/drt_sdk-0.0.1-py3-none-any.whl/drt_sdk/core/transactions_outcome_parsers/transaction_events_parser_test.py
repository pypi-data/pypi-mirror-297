...
from drt_sdk.converters import TransactionsConverter
from drt_sdk.core.address import Address
from drt_sdk.core.codec import encode_unsigned_number
...
from drt_sdk.network_providers import ApiNetworkProvider
...
def test_parse_dcdt_safe_deposit_event():
    ...
    assert parsed[0] == SimpleNamespace(
        dest_address=Address.new_from_bech32("moa1wfkv9495dhtt6a9yepxsyu2mlpw2ua333j4cr0qfulpxr4q5nfns6sz0qr").get_public_key(),
...
def test_parse_multisig_start_perform_action():
    ...
    assert data == SimpleNamespace(
        ...
        action_data=SimpleNamespace(
            **{
                "0": SimpleNamespace(
                    to=Address.new_from_bech32("moa1qqqqqqqqqqqqqpgq6qr0w0zzyysklfneh32eqp2cf383zc89d8ssxtssxl").get_public_key(),
                    rewa_amount=0,
                    opt_gas_limit=None,
                    endpoint_name=b'add',
        ...
        signers=[Address.new_from_bech32("moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8").get_public_key()]
    )
...
def test_multisig_start_perform_action():
    api = ApiNetworkProvider("https://testnet-api.dharitri.com")
    ...
    assert parsed_event.data == SimpleNamespace(
        ...
        action_data=SimpleNamespace(
            **{
                "0": Address.new_from_bech32("moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8").get_public_key(),
                '__discriminant__': 1
            },
        ),
        signers=[Address.new_from_bech32("moa18s6a06ktr2v6fgxv4ffhauxvptssnaqlds45qgsrucemlwc8rawqevhvh6").get_public_key()]
    )
