...
class TestSmartContractTransactionsOutcomeParser:
    ...
    def test_parse_minimalistic_deploy_outcome(self):
        contract = Address.new_from_bech32("moa1qqqqqqqqqqqqqpgqqacl85rd0gl2q8wggl8pwcyzcr4fflc5d8ssppnmyz")
        deployer = Address.new_from_bech32("moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8")
        code_hash = b"abba"
    ...
    def test_parse_successful_deploy(self):
        ...
        proxy = ProxyNetworkProvider("https://devnet-gateway.dharitri.com")
        ...
        parsed = self.parser.parse_deploy(tx_outcome)
        assert parsed.contracts[0].address == "moa1qqqqqqqqqqqqqpgq29deu3uhcvuk7jhxd5cxrvh23xulkcewd8ssf3hg9g"
        assert parsed.contracts[0].owner_address == "moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8"
