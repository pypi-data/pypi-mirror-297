...
from drt_sdk.core.constants import (DEFAULT_MESSAGE_VERSION,
                                           SDK_PY_SIGNER, UNKNOWN_SIGNER)
from drt_sdk.core.interfaces import IAddress, IMessage
...
class MessageComputer:
    """
    Also see:
     - https://github.com/DharitriOne/drt-sdk-js-core/blob/v11.2.0/src/signableMessage.ts
