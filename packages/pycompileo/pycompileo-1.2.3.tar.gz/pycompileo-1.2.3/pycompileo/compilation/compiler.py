...
def scaffold_copy(filepath, output_path, global_variables):
    shutil.copy(filepath, output_path)

    with open(output_path, 'wr') as f:
        f.write(CodeProcessor.process_code(f.read(), global_variables))
    ...
    for root, dirs, files in os.walk(path):
        for file in files:
            ...
            if file.endswith('.py'):
                ...
                scaffold_copy(file_path, output_file, global_variables)
