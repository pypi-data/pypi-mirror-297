...
def quicklook_xarray(
    ...
    try:
        ...
        norm, bounds = get_norm(rcs, scale_bounds, lidar_name=lidar_name, channel=channel)
...
def quicklook_from_date(
    ...
    **kwargs,
    ...
    xlims = (parse_datetime(target_date), parse_datetime(target_date + timedelta(days=1)))
