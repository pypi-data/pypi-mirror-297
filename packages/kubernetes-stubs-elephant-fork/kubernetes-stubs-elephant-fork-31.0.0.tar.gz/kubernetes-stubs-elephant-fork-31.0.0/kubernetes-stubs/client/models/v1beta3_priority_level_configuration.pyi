...
class V1beta3PriorityLevelConfiguration:
    ...
    def __init__(self, *, api_version: typing.Optional[str] = ..., kind: typing.Optional[str] = ..., metadata: typing.Optional[kubernetes.client.V1ObjectMeta] = ..., spec: typing.Optional[kubernetes.client.V1beta3PriorityLevelConfigurationSpec] = ..., status: typing.Optional[kubernetes.client.V1beta3PriorityLevelConfigurationStatus] = ...) -> None:
        ...
...
class V1beta3PriorityLevelConfigurationDict(typing.TypedDict, total=False):
    ...
    status: typing.Optional[kubernetes.client.V1beta3PriorityLevelConfigurationStatusDict]
