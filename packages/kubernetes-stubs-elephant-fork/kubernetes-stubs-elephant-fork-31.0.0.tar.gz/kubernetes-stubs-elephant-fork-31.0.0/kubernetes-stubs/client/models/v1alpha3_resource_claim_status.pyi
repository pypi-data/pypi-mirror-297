...
class V1alpha3ResourceClaimStatus:
    ...
    def __init__(self, *, allocation: typing.Optional[kubernetes.client.V1alpha3AllocationResult] = ..., deallocation_requested: typing.Optional[bool] = ..., reserved_for: typing.Optional[list[kubernetes.client.V1alpha3ResourceClaimConsumerReference]] = ...) -> None:
        ...
