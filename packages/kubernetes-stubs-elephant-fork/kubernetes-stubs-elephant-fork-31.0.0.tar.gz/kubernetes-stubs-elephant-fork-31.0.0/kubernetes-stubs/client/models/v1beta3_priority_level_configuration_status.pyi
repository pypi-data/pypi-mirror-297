...
class V1beta3PriorityLevelConfigurationStatus:
    ...
    def __init__(self, *, conditions: typing.Optional[list[kubernetes.client.V1beta3PriorityLevelConfigurationCondition]] = ...) -> None:
        ...
...
class V1beta3PriorityLevelConfigurationStatusDict(typing.TypedDict, total=False):
    conditions: typing.Optional[list[kubernetes.client.V1beta3PriorityLevelConfigurationConditionDict]]
