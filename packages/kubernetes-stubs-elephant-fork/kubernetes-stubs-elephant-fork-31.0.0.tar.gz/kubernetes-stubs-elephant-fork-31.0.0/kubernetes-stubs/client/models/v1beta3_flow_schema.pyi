...
class V1beta3FlowSchema:
    ...
    def __init__(self, *, api_version: typing.Optional[str] = ..., kind: typing.Optional[str] = ..., metadata: typing.Optional[kubernetes.client.V1ObjectMeta] = ..., spec: typing.Optional[kubernetes.client.V1beta3FlowSchemaSpec] = ..., status: typing.Optional[kubernetes.client.V1beta3FlowSchemaStatus] = ...) -> None:
        ...
