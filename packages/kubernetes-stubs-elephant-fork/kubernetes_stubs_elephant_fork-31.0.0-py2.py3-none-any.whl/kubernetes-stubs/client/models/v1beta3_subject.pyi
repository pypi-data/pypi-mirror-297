...
class V1beta3Subject:
    ...
    def __init__(self, *, group: typing.Optional[kubernetes.client.V1beta3GroupSubject] = ..., kind: str, service_account: typing.Optional[kubernetes.client.V1beta3ServiceAccountSubject] = ..., user: typing.Optional[kubernetes.client.V1beta3UserSubject] = ...) -> None:
        ...
