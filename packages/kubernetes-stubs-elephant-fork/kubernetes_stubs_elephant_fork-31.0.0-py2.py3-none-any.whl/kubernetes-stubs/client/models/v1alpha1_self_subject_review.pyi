...
class V1alpha1SelfSubjectReview:
    ...
    def __init__(self, *, api_version: typing.Optional[str] = ..., kind: typing.Optional[str] = ..., metadata: typing.Optional[kubernetes.client.V1ObjectMeta] = ..., status: typing.Optional[kubernetes.client.V1alpha1SelfSubjectReviewStatus] = ...) -> None:
        ...
