...
class QShadowLabel(QLabel):
    def __init__(self, text, text_color:QColor, shadow_color:QColor, shadow_radius:int=3, reversed:bool=False, parent=None):
        super(QShadowLabel, self).__init__(parent)
        self._txt_color = text_color
        self._shd_color = shadow_color
...
# 创建一个QShadowLabel对象
shadow_label = QShadowLabel(QColor(65, 105, 225, 200), QColor(13, 21, 45, 200), 4, reversed=False)
shadow_label.setFont(QFont("Consolas", 14, QFont.Bold))
shadow_label.show()
