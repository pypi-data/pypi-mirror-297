...
class TestWebsitereadabilityAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = WebsitereadabilityAPIClient(self.api_key)

    @patch('apiverve_websitereadability.apiClient.requests.get')
