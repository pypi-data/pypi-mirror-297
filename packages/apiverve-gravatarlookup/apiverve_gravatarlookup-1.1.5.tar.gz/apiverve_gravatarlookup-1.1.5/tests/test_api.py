...
class TestGravatarlookupAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = GravatarlookupAPIClient(self.api_key)

    @patch('apiverve_gravatarlookup.apiClient.requests.get')
