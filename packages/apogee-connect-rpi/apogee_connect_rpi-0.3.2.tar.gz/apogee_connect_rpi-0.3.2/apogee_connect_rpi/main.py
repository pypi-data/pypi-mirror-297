...
class ApogeeConnect:
    ...
    async def collect(self, *args, **kwargs):
        ...
        try:
            ...
            if manual_collection:
                await self.commandImplement.collect_manual(address, interval, start, end, file, append, auto_overwrite)
            else:
                await self.commandImplement.collect_auto(address, interval, start, end, file, append, auto_overwrite)
        except Exception as e:
            print(e)
    ...
    async def config(self, *args, **kwargs) -> dict:
        ...
        try:
            ...
            if config_args['collection_frequency'] is not None and (config_args['collection_frequency'] < 5 or config_args['collection_frequency'] > 60):
    ...
    async def stop(self, *args, **kwargs):
        ...
        try:
            ...
            if all is not None and end is not None:
    ...
    async def transfer(self, *args, **kwargs):
        ...
        try:
            ...
            await self.commandImplement.transfer(address, start, end, file, append, auto_overwrite)    
