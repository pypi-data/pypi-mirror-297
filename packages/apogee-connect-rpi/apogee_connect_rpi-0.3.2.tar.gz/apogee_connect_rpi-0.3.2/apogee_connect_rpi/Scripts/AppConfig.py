...
class AppConfig:    
    ...
    def update_config(self, config_args):
        ...
        if config_args.get('precision') is not None:
            self.set_precision(config, config_args.get('precision'))
        
        if config_args.get('temp') is not None:
            self.set_temp_units(config, config_args.get('temp'))

        if config_args.get('par_filtering') is not None:
            self.set_par_filtering(config, config_args.get('par_filtering'))

        if config_args.get('filepath') is not None:
            self.set_default_filepath(config, config_args.get('filepath'))
        
        if config_args.get('collection_frequency') is not None:
            self.set_collection_frequency(config, config_args.get('collection_frequency'))
