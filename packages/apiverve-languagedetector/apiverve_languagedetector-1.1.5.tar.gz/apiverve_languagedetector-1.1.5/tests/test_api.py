...
class TestLanguagedetectorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = LanguagedetectorAPIClient(self.api_key)

    @patch('apiverve_languagedetector.apiClient.requests.get')
