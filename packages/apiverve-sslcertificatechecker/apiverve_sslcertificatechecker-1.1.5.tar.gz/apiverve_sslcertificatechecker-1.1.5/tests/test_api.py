...
class TestSslcheckerAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = SslcheckerAPIClient(self.api_key)

    @patch('apiverve_sslcertificatechecker.apiClient.requests.get')
