...
Refer to the Terraform Registry for docs: [`data_aws_securityhub_standards_control_associations`](https://registry.terraform.io/providers/hashicorp/aws/5.68.0/docs/data-sources/securityhub_standards_control_associations).
'''
...
class DataAwsSecurityhubStandardsControlAssociations(
    ...
    def __init__(
        ...
        *,
        ...
        standards_control_associations: typing.Optional[typing.Union[_cdktf_9a9027ec.IResolvable, typing.Sequence[typing.Union["DataAwsSecurityhubStandardsControlAssociationsStandardsControlAssociations", typing.Dict[builtins.str, typing.Any]]]]] = None,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.68.0/docs/data-sources/securityhub_standards_control_associations aws_securityhub_standards_control_associations} Data Source.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param security_control_id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.68.0/docs/data-sources/securityhub_standards_control_associations#security_control_id DataAwsSecurityhubStandardsControlAssociations#security_control_id}.
        :param standards_control_associations: standards_control_associations block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.68.0/docs/data-sources/securityhub_standards_control_associations#standards_control_associations DataAwsSecurityhubStandardsControlAssociations#standards_control_associations}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
        ...
        config = DataAwsSecurityhubStandardsControlAssociationsConfig(
            ...
            standards_control_associations=standards_control_associations,
    ...
    @jsii.member(jsii_name="putStandardsControlAssociations")
    def put_standards_control_associations(
        self,
        value: typing.Union[_cdktf_9a9027ec.IResolvable, typing.Sequence[typing.Union["DataAwsSecurityhubStandardsControlAssociationsStandardsControlAssociations", typing.Dict[builtins.str, typing.Any]]]],
    ) -> None:
        '''
        :param value: -
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__beb230ae7c146f818093fdc501559d98a508dc5579bad5bf7348b3f091fed0a9)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        return typing.cast(None, jsii.invoke(self, "putStandardsControlAssociations", [value]))

    @jsii.member(jsii_name="resetStandardsControlAssociations")
    def reset_standards_control_associations(self) -> None:
        return typing.cast(None, jsii.invoke(self, "resetStandardsControlAssociations", []))
    ...
    @builtins.property
    @jsii.member(jsii_name="standardsControlAssociationsInput")
    def standards_control_associations_input(
        self,
    ) -> typing.Optional[typing.Union[_cdktf_9a9027ec.IResolvable, typing.List["DataAwsSecurityhubStandardsControlAssociationsStandardsControlAssociations"]]]:
        return typing.cast(typing.Optional[typing.Union[_cdktf_9a9027ec.IResolvable, typing.List["DataAwsSecurityhubStandardsControlAssociationsStandardsControlAssociations"]]], jsii.get(self, "standardsControlAssociationsInput"))
...
@jsii.data_type(
    ...
    name_mapping={
        ...
        "standards_control_associations": "standardsControlAssociations",
    },
)
class DataAwsSecurityhubStandardsControlAssociationsConfig(
    ...
    def __init__(
        ...
        *,
        ...
        if __debug__:
            ...
            check_type(argname="argument standards_control_associations", value=standards_control_associations, expected_type=type_hints["standards_control_associations"])
        ...
        if standards_control_associations is not None:
            self._values["standards_control_associations"] = standards_control_associations
    ...
    def standards_control_associations(
        ...
        '''
        result = self._values.get("standards_control_associations")
        return typing.cast(typing.Optional[typing.Union[_cdktf_9a9027ec.IResolvable, typing.List["DataAwsSecurityhubStandardsControlAssociationsStandardsControlAssociations"]]], result)
...
class DataAwsSecurityhubStandardsControlAssociationsStandardsControlAssociationsList(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[_cdktf_9a9027ec.IResolvable, typing.List[DataAwsSecurityhubStandardsControlAssociationsStandardsControlAssociations]]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[_cdktf_9a9027ec.IResolvable, typing.List[DataAwsSecurityhubStandardsControlAssociationsStandardsControlAssociations]]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8bb050d68f60ccc27540a5620da5bd1add05807137a26c3c4f2531cbaa5b6c24)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataAwsSecurityhubStandardsControlAssociationsStandardsControlAssociationsOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[_cdktf_9a9027ec.IResolvable, DataAwsSecurityhubStandardsControlAssociationsStandardsControlAssociations]]:
        return typing.cast(typing.Optional[typing.Union[_cdktf_9a9027ec.IResolvable, DataAwsSecurityhubStandardsControlAssociationsStandardsControlAssociations]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[_cdktf_9a9027ec.IResolvable, DataAwsSecurityhubStandardsControlAssociationsStandardsControlAssociations]],
    ) -> None:
        if __debug__:
...
def _typecheckingstub__beb230ae7c146f818093fdc501559d98a508dc5579bad5bf7348b3f091fed0a9(
    value: typing.Union[_cdktf_9a9027ec.IResolvable, typing.Sequence[typing.Union[DataAwsSecurityhubStandardsControlAssociationsStandardsControlAssociations, typing.Dict[builtins.str, typing.Any]]]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__8bb050d68f60ccc27540a5620da5bd1add05807137a26c3c4f2531cbaa5b6c24(
    value: typing.Optional[typing.Union[_cdktf_9a9027ec.IResolvable, typing.List[DataAwsSecurityhubStandardsControlAssociationsStandardsControlAssociations]]],
) -> None:
    """Type checking stubs"""
    pass
