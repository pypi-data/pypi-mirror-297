...
Refer to the Terraform Registry for docs: [`data_aws_ssoadmin_application_assignments`](https://registry.terraform.io/providers/hashicorp/aws/5.68.0/docs/data-sources/ssoadmin_application_assignments).
'''
...
class DataAwsSsoadminApplicationAssignments(
    ...
    def __init__(
        ...
        *,
        ...
        :param application_arn: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.68.0/docs/data-sources/ssoadmin_application_assignments#application_arn DataAwsSsoadminApplicationAssignments#application_arn}.
        :param application_assignments: application_assignments block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.68.0/docs/data-sources/ssoadmin_application_assignments#application_assignments DataAwsSsoadminApplicationAssignments#application_assignments}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
