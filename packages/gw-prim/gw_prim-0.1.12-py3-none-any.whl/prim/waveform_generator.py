...
def generate_waveform(
    ...
    S1z: int | float = 0,
    S2z: int | float = 0,
    approximant: int | str = lalsim.SpinTaylorT1,
    deltaT: int | float = 1 / 4096,
    phiRef: int | float = 0,
    ...
    approximant: int | str, default lalsim.SpinTaylorT1
        If an int given then this is the lalsimulation enum of the approximant.
        If a str given then this is either "SEOBNRv5HM" or "SEOBNRv5PHM" and is generated using
        pyseobnr.
    deltaT: int | float, default 1 / 4096
