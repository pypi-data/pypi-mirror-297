...
class TransactionEventsParser:
    def __init__(self, abi: IAbi, first_topic_as_identifier: bool = True) -> None:
        ...
        # https://github.com/DharitriOne/drt-chain-vm-go/blob/v1.5.27/vmhost/contexts/output.go#L270
        # https://github.com/DharitriOne/drt-chain-vm-go/blob/v1.5.27/vmhost/contexts/output.go#L283
