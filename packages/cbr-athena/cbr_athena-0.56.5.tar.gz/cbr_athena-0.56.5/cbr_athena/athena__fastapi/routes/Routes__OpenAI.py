...
class Routes__OpenAI(Fast_API__Routes):
    ...
    async def prompt_with_system__stream(self, gpt_prompt_with_system_and_history: GPT_Prompt_With_System_And_History, request: Request):
        ...
        self.cbr_chats_storage_s3.save_user_request(gpt_prompt_with_system_and_history, request_id)
        ...
        async def streamer():
            ...
            llm_chat_completion = LLMs__Chat_Completion(llm_answer=gpt_response, **gpt_prompt_with_system_and_history.model_dump())
