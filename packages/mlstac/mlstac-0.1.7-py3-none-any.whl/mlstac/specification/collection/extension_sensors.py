...
def add_landsat1(mlstac_object, bands: Union[str, list] = "all"):
    landsat1_mss_bands = {
        "B04": {
            "index": 0,
            "common_name": "Green",
...
def add_landsat2(mlstac_object, bands: Union[str, list] = "all"):
    landsat2_mss_bands = {
        "B04": {
            "index": 0,
            "common_name": "Green",
...
def add_landsat3(mlstac_object, bands: Union[str, list] = "all"):
    landsat3_mss_bands = {
        "B04": {
            "index": 0,
            "common_name": "Green",
...
def add_landsat4_mss(mlstac_object, bands: Union[str, list] = "all"):
    landsat4_mss_bands = {
        "B01": {
            "index": 0,
            "common_name": "Green",
...
def add_landsat4_tm(mlstac_object, bands: Union[str, list] = "all"):
    landsat4_tm_bands = {
        "B01": {
            "index": 0,
            "common_name": "Blue",
...
def add_landsat5_mss(mlstac_object, bands: Union[str, list] = "all"):
    landsat5_mss_bands = {
        "B01": {
            "index": 0,
            "common_name": "Green",
...
def add_landsat5_tm(mlstac_object, bands: Union[str, list] = "all"):
    landsat5_tm_bands = {
        "B01": {
            "index": 0,
            "common_name": "Blue",
...
def add_landsat7(mlstac_object, bands: Union[str, list] = "all"):
    landsat7_bands = {
        "B01": {
            "index": 0,
            "common_name": "Blue",
...
def add_landsat8(mlstac_object, bands: Union[str, list] = "all"):
    landsat8_bands = {
        "B01": {
            "index": 0,
...
def add_landsat9(mlstac_object, bands: Union[str, list] = "all"):
    landsat9_bands = {
        "B01": {
            "index": 0,
            "common_name": "coastal aerosol",
...
def add_sentinel2(mlstac_object, bands: Union[str, list] = "all"):
    sentinel2_bands = {
        "B01": {
            "index": 0,
            "common_name": "coastal aerosol",
...
def add_eo1_ali(mlstac_object, bands: Union[str, list] = "all"):
    eo1_ali_bands = {
        "B01": {
            "index": 0,
            "common_name": "Pan",
...
def add_aster(mlstac_object, bands: str = "all"):
...
def add_modis(mlstac_object, bands: str = "all"):
