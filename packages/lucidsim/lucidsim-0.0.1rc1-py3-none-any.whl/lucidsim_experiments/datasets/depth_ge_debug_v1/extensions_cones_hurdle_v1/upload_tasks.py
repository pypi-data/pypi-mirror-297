...
def upload():
    ...
    sweep_paths = """
    hurdle_one_intermediate_0.jsonl
    hurdle_one_intermediate_1.jsonl
    hurdle_one_intermediate_2.jsonl
    hurdle_one_intermediate_3.jsonl
    hurdle_one_expert_0.jsonl
    hurdle_one_expert_1.jsonl
    hurdle_one_expert_2.jsonl
    hurdle_one_expert_3.jsonl
    hurdle_many_intermediate_0.jsonl
    hurdle_many_intermediate_1.jsonl
    hurdle_many_intermediate_2.jsonl
    hurdle_many_intermediate_3.jsonl
    hurdle_many_expert_0.jsonl
    hurdle_many_expert_1.jsonl
    hurdle_many_expert_2.jsonl
    hurdle_many_expert_3.jsonl
    """.split("\n")
