    ...
    with doc:
        ...
        for i in range(4):
            ...
            last = sweep_maker(
                ...
                file_name=f"gaps_many_intermediate_{i}.jsonl",
            )
        ...
        for i in range(4):
            last = sweep_maker(
                ...
                start=last,
                teacher_type=f"intermediate/collection-{i:02d}",
                file_name=f"gaps_one_intermediate_{i}.jsonl",
            )
        ...
        for i in range(4):
            ...
            last = sweep_maker(
                ...
                file_name=f"gaps_many_expert_{i}.jsonl",
            )
        ...
        for i in range(4):
            ...
            last = sweep_maker(
                ...
                start=last,
                teacher_type=f"expert/collection-{i:02d}",
                file_name=f"gaps_one_expert_{i}.jsonl",
            )
