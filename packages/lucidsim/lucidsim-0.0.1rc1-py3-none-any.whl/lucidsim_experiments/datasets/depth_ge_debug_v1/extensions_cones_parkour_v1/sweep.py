...
if __name__ == "__main__":
    ...
    with doc:
        ...
        expert = "/lucid-sim/lucid-sim/baselines/launch_gains/2024-03-20/04.03.35/go1/300/20/0.5/checkpoints/model_last.pt"
    ...
    with doc:
        ...
        checkpoint_paths += [expert] * (len(checkpoint_paths))
    ...
    with doc:
        ...
        def sweep_maker(short_name, checkpoint_paths, *, start=0, teacher_type, file_name):
            ...
            with Sweep(RUN, Unroll_s, DepthTeacherNode) as sweep:
                ...
                DepthTeacherNode.data_prefix = f"/lucidsim/lucidsim/datasets/unrolls/depth_ge_debug_v1/extensions_cones_{short_name}/{teacher_type}"
        ...
        for i in range(4):
            ...
            last = sweep_maker(
                ...
                file_name=f"parkour_spread_intermediate_{i}.jsonl",
            )
        ...
        for i in range(4):
            last = sweep_maker(
                ...
                start=last,
                teacher_type=f"intermediate/collection-{i:02d}",
                file_name=f"parkour_close_intermediate_{i}.jsonl",
            )
        ...
        for i in range(4):
            ...
            last = sweep_maker(
                ...
                file_name=f"parkour_spread_expert_{i}.jsonl",
            )

        for i in range(4):
            # here are the experts for one gap
            last = sweep_maker(
                "parkour_close",
                [expert] * 500,
                start=last,
                teacher_type=f"expert/collection-{i:02d}",
                file_name=f"parkour_close_expert_{i}.jsonl",
            )
