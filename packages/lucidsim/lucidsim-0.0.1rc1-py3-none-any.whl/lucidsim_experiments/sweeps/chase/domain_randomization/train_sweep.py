...
with Sweep(RUN, TrainCfg) as sweep:
    ...
    with sweep.product:
        TrainCfg.dataset_prefix = [
            "scenes/domain_randomization/chase_basketball_v1",
            "scenes/domain_randomization/chase_soccer_v1",
            "scenes/domain_randomization/chase_cones_v1",
        ]
...
def tail(RUN, TrainCfg, *_):
    RUN.prefix, RUN.job_name, _ = RUN(
        ...
        job_name=f"{TrainCfg.dataset_prefix}/{TrainCfg.stack_size}/{TrainCfg.seed}",
    )
