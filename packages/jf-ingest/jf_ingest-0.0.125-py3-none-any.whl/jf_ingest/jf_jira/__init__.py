...
from jf_ingest.telemetry import jelly_trace, record_span
...
def pull_issues_new_sync_path(
    ...
    with record_span('write_jira_issue_by_date_batch_to_local_or_s3'):
    ...
    with record_span('write_jira_issue_by_ids_batch_to_local_or_s3'):
...
def load_and_push_jira_to_s3(ingest_config: IngestionConfig) -> bool:
    ...
    with emit_event_to_jellyfish_context_manager(
        ...
        _run_load_and_push_to_s3(ingest_config=ingest_config)
