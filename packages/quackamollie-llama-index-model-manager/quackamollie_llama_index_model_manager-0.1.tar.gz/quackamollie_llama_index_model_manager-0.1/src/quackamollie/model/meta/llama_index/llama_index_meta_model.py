# -*- coding: utf-8 -*-
__all__ = ["MetaLlamaIndexQuackamollieModel"]
...
class MetaLlamaIndexQuackamollieModel(MetaQuackamollieModel, metaclass=ABCMeta):
    """ Metaclass for models managed by `LlamaIndexQuackamollieModelManager` """
