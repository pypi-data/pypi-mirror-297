    ...
    try:
        ...
        for filename in os.listdir(local_storage_path):
            if filename.endswith(".docx"):
                ...
                # Check if the file modification time is within the threshold range
                if threshold_start <= file_mod_time <= threshold_end:
                    ...
                    MediLink_ConfigLoader.log("Skipping DOCX file (modification time outside threshold): {}".format(filepath), level="INFO")
