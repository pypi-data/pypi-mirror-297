...
class TestPasswordstrengthAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = PasswordstrengthAPIClient(self.api_key)

    @patch('apiverve_passwordstrength.apiClient.requests.get')
