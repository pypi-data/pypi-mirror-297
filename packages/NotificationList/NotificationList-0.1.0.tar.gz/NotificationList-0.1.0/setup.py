...
setup(
    ...
    keywords='breach response, breach notification, notification lists, data consolidation, unique identifiers, affected parties, data merging, efficiency tools, duplicate notifications'
