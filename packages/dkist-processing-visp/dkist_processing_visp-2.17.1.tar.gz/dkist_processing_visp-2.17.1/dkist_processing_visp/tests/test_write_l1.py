...
from dkist_processing_visp.tests.conftest import make_random_data
from dkist_processing_visp.tests.conftest import tag_on_map_raster_stokes
...
def write_calibrated_frames_to_task(
    task, pol_mode: str, data_shape: tuple[int, int], wcs_axis_names: tuple[str, str]
):
