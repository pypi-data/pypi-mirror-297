...
class OpenSDKError(Exception):
    pass


class APIError(OpenSDKError):
    message: str
...
class AccessKeyError(APIError):
    def __init__(self, *, message: str = "Access key error.", request: httpx.Request) -> None:
