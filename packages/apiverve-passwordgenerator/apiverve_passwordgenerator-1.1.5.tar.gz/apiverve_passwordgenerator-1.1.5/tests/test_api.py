...
class TestPasswordgeneratorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = PasswordgeneratorAPIClient(self.api_key)

    @patch('apiverve_passwordgenerator.apiClient.requests.get')
