...
def download_model(model_id, exclude=None, download_subdir='yes'):
...
def download_model_cmd():
    ...
    download_model(model_id=args.model_id, exclude=exclude, download_subdir=args.download_subdir)
