...
class Isilon:
    ...
    def __init__(self, username, password, clusters, platform_api_version='15', dns_resolve=False):
    ...
    def get_all_quotas(self, clusters=None):
        ...
        Args:
            clusters (list, optional): A list containing the cluster names.
                Defaults to None.
