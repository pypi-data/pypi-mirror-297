...
class MessageViewsTestCase(TestCase):
    ...
    def test_message_page(self):
        url = reverse('hk_message_index', args=("list@example.com",
                      get_message_id_hash("msg")))
        with self.settings(USE_L10N=True, DATETIME_FORMAT='Y-m-d H:i:s',
                           TIME_FORMAT="H:i:s"):
            with timezone.override(tz.utc):
        ...
        sender_time = '<span title="Sender\'s time: Feb. 2, 2015, 1 p.m.">10 a.m.</span>'  # noqa: E501
