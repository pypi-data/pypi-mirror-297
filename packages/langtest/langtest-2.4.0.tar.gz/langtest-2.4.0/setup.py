...
extras_require = \
{':extra == "openai"': ['openai>=1.40.6,<2.0.0'],
 ':extra == "transformers"': ['transformers>=4.44.2,<5.0.0'],
 'ai21': ['ai21>=1.1.0,<2.0.0', 'langchain>=0.1.11,<0.2.0'],
 'cohere': ['cohere>=4.10.0,<5.0.0', 'langchain>=0.1.11,<0.2.0'],
 'datasets': ['datasets>=2.14.0'],
 'evaluate': ['rouge-score>=0.1.2,<0.2.0',
              'evaluate>=0.4.0,<0.5.0',
              'seqeval>=1.2.0,<2.0.0'],
 'huggingface-hub': ['huggingface_hub>0.16.0', 'langchain>=0.1.11,<0.2.0'],
 'johnsnowlabs': ['johnsnowlabs==4.3.5'],
 'langchain': ['langchain>=0.1.11,<0.2.0', 'langchain-openai>=0.1.4,<0.2.0'],
 'matplotlib': ['matplotlib>=3.7.2,<4.0.0'],
 'metaflow': ['metaflow>=2.9.0'],
 'mlflow': ['mlflow>=2.16.2,<3.0.0'],
 'openai': ['langchain>=0.1.11,<0.2.0', 'langchain-openai>=0.1.4,<0.2.0'],
 'spacy': ['spacy>=3.0.0'],
