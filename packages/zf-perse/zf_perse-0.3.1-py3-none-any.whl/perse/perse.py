...
def reduce_html_content(content: Union[str, BeautifulSoup], exclude_tags: Set[str] = None) -> BeautifulSoup:
    """
...
def extract_json_fields(content: Union[str, BeautifulSoup], PydanticModel: BaseModel, model: str = default_model) -> Dict[str, Any]:
    """
...
def perse(content: str, exclude_tags: Set[str] = None) -> Dict[str, Any]:
    """
...
def perses(content: str, exclude_tags: Set[str] = None, indent: int = 2) -> str:
    """
