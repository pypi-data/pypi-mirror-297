...
def test_create_oauth_default_endpoints(
    ...
    oauth_client = super_admin_oauth_client_client.create_oauth_client(
        issuer="https://dev-41714738.okta.com",
        client_id="0oah7v0o13gI1Peec5d7",
        client_secret="5rDBGiMbEHE1YN-nFzWAxiGAKf9Jmg5M1VLofcOAdHIyBJn2wgkvy1rxDoM4GhRU",
    )

    assert oauth_client.issuer == "https://dev-41714738.okta.com"
    assert oauth_client.client_id == "0oah7v0o13gI1Peec5d7"
    assert oauth_client.client_secret == ""
    assert oauth_client.client_secret_set is True
    assert oauth_client.authorization_endpoint == 'https://dev-41714738.okta.com/oauth2/v1/authorize'
    assert oauth_client.token_endpoint == 'https://dev-41714738.okta.com/oauth2/v1/token'
