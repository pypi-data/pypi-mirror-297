...
class OAuthClient(_message.Message):
    __slots__ = ("name", "display_name", "issuer", "client_id", "client_secret", "client_secret_set", "authorization_endpoint", "token_endpoint", "extra_scopes", "refresh_disabled", "login_principal_claim", "callback_uri", "creator", "updater", "create_time", "update_time")
