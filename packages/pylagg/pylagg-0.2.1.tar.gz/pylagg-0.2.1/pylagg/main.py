...
import pylagg.cgr_py.kmer_input as kmer_input
from pylagg.cgr import generate_cgr_png
    ...
    if input:
        ...
        if(input.rfind(".txt") != -1):
            if scale_size != 100:
                ...
                input = input.replace(".txt", ".png")
                generate_cgr_png(counts_file_path, output_path + "/" + input.split('/')[-1])
