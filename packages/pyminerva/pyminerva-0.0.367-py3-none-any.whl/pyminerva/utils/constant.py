...
TECH_LIST = {
            'Trend':['sma','ema','macd','adx','psar','ichmoku',],
            'Momentum':['rsi','stoch','roc','cci','willr','ao','stochrsi','ppo',],
            'Volume':['obv','pvt','pvi','cmf','vwap','adosc','mfi','kvo','nvi',],
            'Volatility':['atr','bbands','donchian','kc','rvi',]
}