...
class BasicAuth(object):
  ...
  def __init__(self, username = 'trovares', password = ''):
    """
...
class Connection(object):
  ...
  auth : BasicAuth or KerberosAuth or PKIAuth
    Instance of the authentication mechanism to use.  Can be BasicAuth,
    KerberosAuth or PKIAuth.  Default is BasicAuth with no parameters.
  ...
  def __init__(self, host : str ='127.0.0.1', port : int = 4367,
               ...
               Union[BasicAuth, KerberosAuth, PKIAuth] = BasicAuth()):
    """
  ...
  def get_schema_from_data(
      ...
      row_label_columns : Optional[Seq[str]] = None) -> List[List]:
    """
