...
class AdminService(object):
    ...
    def PKIAuthenticate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/xgt.AdminService/PKIAuthenticate',
            AdminService__pb2.AuthenticateRequest.SerializeToString,
            AdminService__pb2.AuthenticateResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def KerberosAuthenticate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/xgt.AdminService/KerberosAuthenticate',
    ...
    def KeepAliveSession(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/xgt.AdminService/KeepAliveSession',
    ...
    def SetDefaultNamespace(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/xgt.AdminService/SetDefaultNamespace',
    ...
    def GetDefaultNamespace(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/xgt.AdminService/GetDefaultNamespace',
