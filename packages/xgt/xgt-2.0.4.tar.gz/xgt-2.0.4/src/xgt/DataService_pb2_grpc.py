...
class DataService(object):
    ...
    def InferSchema(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/xgt.DataService/InferSchema',
    ...
    def TransferFrameArrowClient(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/xgt.DataService/TransferFrameArrowClient',
