...
__all__ = ["SharableResource", "AsyncSharableResource"]
...
class SharableResourceWithRawResponse:
    def __init__(self, sharable: SharableResource) -> None:
...
class AsyncSharableResourceWithRawResponse:
    def __init__(self, sharable: AsyncSharableResource) -> None:
        self._sharable = sharable
...
class SharableResourceWithStreamingResponse:
    def __init__(self, sharable: SharableResource) -> None:
        self._sharable = sharable
...
class AsyncSharableResourceWithStreamingResponse:
    def __init__(self, sharable: AsyncSharableResource) -> None:
        self._sharable = sharable
