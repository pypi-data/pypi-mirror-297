...
from ....types.banks.attribute_definitions import transaction_update_params
...
class TransactionResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/obp/v5.1.0/banks/{bank_id}/attribute-definitions/transaction",
    ...
    def update(
        ...
        *,
        ...
        return self._put(
            f"/obp/v5.1.0/banks/{bank_id}/attribute-definitions/transaction",
            body=maybe_transform(body, transaction_update_params.TransactionUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BinaryAPIResponse,
    ...
    async def update(
        ...
        *,
        ...
        return await self._put(
            f"/obp/v5.1.0/banks/{bank_id}/attribute-definitions/transaction",
            body=await async_maybe_transform(body, transaction_update_params.TransactionUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=AsyncBinaryAPIResponse,
