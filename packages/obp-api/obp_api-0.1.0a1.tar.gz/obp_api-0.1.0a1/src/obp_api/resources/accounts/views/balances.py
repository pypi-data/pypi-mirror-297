...
class BalancesResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        <p>Get the Balances for the Account specified by BANK_ID and ACCOUNT_ID through the VIEW_ID.</p><p>Authentication is Mandatory</p>
        ...
        return self._get(
            f"/obp/v5.1.0/banks/{bank_id}/accounts/{account_id}/views/{view_id}/balances",
