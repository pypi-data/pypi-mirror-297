...
class TestRedirectURL:
    ...
    def test_method_update(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.put("/obp/v5.1.0/management/consumers/CONSUMER_ID/consumer/redirect_url").mock(
        ...
        assert cast(Any, redirect_url.is_closed) is True
        assert isinstance(redirect_url, BinaryAPIResponse)
    ...
    def test_streaming_response_update(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        with client.consumers.redirect_url.with_streaming_response.update(
            ...
            assert redirect_url.json() == {"foo": "bar"}
            assert cast(Any, redirect_url.is_closed) is True
            assert isinstance(redirect_url, StreamedBinaryAPIResponse)
...
class TestAsyncRedirectURL:
    ...
    async def test_method_update(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        assert cast(Any, redirect_url.is_closed) is True
        assert isinstance(redirect_url, AsyncBinaryAPIResponse)
    ...
    async def test_streaming_response_update(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        async with async_client.consumers.redirect_url.with_streaming_response.update(
            ...
            assert await redirect_url.json() == {"foo": "bar"}
            assert cast(Any, redirect_url.is_closed) is True
            assert isinstance(redirect_url, AsyncStreamedBinaryAPIResponse)
