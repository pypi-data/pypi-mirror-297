...
class TestAttributes:
    ...
    def test_method_update(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.put("/obp/v5.1.0/my/user/attributes/USER_ATTRIBUTE_ID").mock(
    ...
    def test_method_list(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.get("/obp/v5.1.0/my/user/attributes").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
        attribute = client.user.attributes.list()
        assert attribute.is_closed
        assert attribute.json() == {"foo": "bar"}
        assert cast(Any, attribute.is_closed) is True
        assert isinstance(attribute, BinaryAPIResponse)
    ...
    def test_raw_response_list(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        attribute = client.user.attributes.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.get("/obp/v5.1.0/my/user/attributes").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
        with client.user.attributes.with_streaming_response.list() as attribute:
            assert not attribute.is_closed
            assert attribute.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncAttributes:
    ...
    async def test_method_list(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.get("/obp/v5.1.0/my/user/attributes").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
        attribute = await async_client.user.attributes.list()
        assert attribute.is_closed
        assert await attribute.json() == {"foo": "bar"}
        assert cast(Any, attribute.is_closed) is True
        assert isinstance(attribute, AsyncBinaryAPIResponse)
    ...
    async def test_raw_response_list(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        attribute = await async_client.user.attributes.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.get("/obp/v5.1.0/my/user/attributes").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
        async with async_client.user.attributes.with_streaming_response.list() as attribute:
            assert not attribute.is_closed
            assert attribute.http_request.headers.get("X-Stainless-Lang") == "python"
