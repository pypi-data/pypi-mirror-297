...
class TestImages:
    ...
    def test_method_create(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        image = client.transactions.metadata.images.create(
    ...
    def test_raw_response_create(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        image = client.transactions.metadata.images.with_raw_response.create(
            transaction_id="TRANSACTION_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            view_id="VIEW_ID",
    ...
    def test_streaming_response_create(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        with client.transactions.metadata.images.with_streaming_response.create(
            transaction_id="TRANSACTION_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            view_id="VIEW_ID",
    ...
    def test_path_params_create(self, client: ObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            client.transactions.metadata.images.with_raw_response.create(
                transaction_id="TRANSACTION_ID",
                bank_id="",
                account_id="ACCOUNT_ID",
                view_id="VIEW_ID",
    ...
    def test_method_list(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        image = client.transactions.metadata.images.list(
            transaction_id="TRANSACTION_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            view_id="VIEW_ID",
    ...
    def test_raw_response_list(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        image = client.transactions.metadata.images.with_raw_response.list(
            transaction_id="TRANSACTION_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            view_id="VIEW_ID",
    ...
    def test_streaming_response_list(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        with client.transactions.metadata.images.with_streaming_response.list(
            transaction_id="TRANSACTION_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            view_id="VIEW_ID",
    ...
    def test_path_params_list(self, client: ObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            client.transactions.metadata.images.with_raw_response.list(
                transaction_id="TRANSACTION_ID",
                bank_id="",
                account_id="ACCOUNT_ID",
                view_id="VIEW_ID",
    ...
    def test_method_delete(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        image = client.transactions.metadata.images.delete(
            image_id="IMAGE_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            view_id="VIEW_ID",
    ...
    def test_raw_response_delete(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        image = client.transactions.metadata.images.with_raw_response.delete(
            image_id="IMAGE_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            view_id="VIEW_ID",
    ...
    def test_streaming_response_delete(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        with client.transactions.metadata.images.with_streaming_response.delete(
            image_id="IMAGE_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            view_id="VIEW_ID",
    ...
    def test_path_params_delete(self, client: ObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            client.transactions.metadata.images.with_raw_response.delete(
                image_id="IMAGE_ID",
                bank_id="",
                account_id="ACCOUNT_ID",
                view_id="VIEW_ID",
...
class TestAsyncImages:
    ...
    async def test_method_create(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        image = await async_client.transactions.metadata.images.create(
            transaction_id="TRANSACTION_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            view_id="VIEW_ID",
    ...
    async def test_raw_response_create(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        image = await async_client.transactions.metadata.images.with_raw_response.create(
            transaction_id="TRANSACTION_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            view_id="VIEW_ID",
    ...
    async def test_streaming_response_create(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        async with async_client.transactions.metadata.images.with_streaming_response.create(
            transaction_id="TRANSACTION_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            view_id="VIEW_ID",
    ...
    async def test_path_params_create(self, async_client: AsyncObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            await async_client.transactions.metadata.images.with_raw_response.create(
                transaction_id="TRANSACTION_ID",
                bank_id="",
                account_id="ACCOUNT_ID",
                view_id="VIEW_ID",
    ...
    async def test_method_list(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        image = await async_client.transactions.metadata.images.list(
            transaction_id="TRANSACTION_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            view_id="VIEW_ID",
    ...
    async def test_raw_response_list(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        image = await async_client.transactions.metadata.images.with_raw_response.list(
            transaction_id="TRANSACTION_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            view_id="VIEW_ID",
    ...
    async def test_streaming_response_list(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        async with async_client.transactions.metadata.images.with_streaming_response.list(
            transaction_id="TRANSACTION_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            view_id="VIEW_ID",
    ...
    async def test_path_params_list(self, async_client: AsyncObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            await async_client.transactions.metadata.images.with_raw_response.list(
                transaction_id="TRANSACTION_ID",
                bank_id="",
                account_id="ACCOUNT_ID",
                view_id="VIEW_ID",
    ...
    async def test_method_delete(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        image = await async_client.transactions.metadata.images.delete(
            image_id="IMAGE_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            view_id="VIEW_ID",
    ...
    async def test_raw_response_delete(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        image = await async_client.transactions.metadata.images.with_raw_response.delete(
            image_id="IMAGE_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            view_id="VIEW_ID",
    ...
    async def test_streaming_response_delete(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        async with async_client.transactions.metadata.images.with_streaming_response.delete(
            image_id="IMAGE_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            view_id="VIEW_ID",
    ...
    async def test_path_params_delete(self, async_client: AsyncObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            await async_client.transactions.metadata.images.with_raw_response.delete(
                image_id="IMAGE_ID",
                bank_id="",
                account_id="ACCOUNT_ID",
                view_id="VIEW_ID",
