...
class TestBalances:
    ...
    def test_method_list(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.get("/obp/v5.1.0/banks/BANK_ID/views/VIEW_ID/balances").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )
        balance = client.views.balances.list(
            view_id="VIEW_ID",
            bank_id="BANK_ID",
        )
    ...
    def test_raw_response_list(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        balance = client.views.balances.with_raw_response.list(
            view_id="VIEW_ID",
            bank_id="BANK_ID",
        )
    ...
    def test_streaming_response_list(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        with client.views.balances.with_streaming_response.list(
            view_id="VIEW_ID",
            bank_id="BANK_ID",
        ) as balance:
    ...
    def test_path_params_list(self, client: ObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            client.views.balances.with_raw_response.list(
                view_id="VIEW_ID",
                bank_id="",
            )
...
class TestAsyncBalances:
    ...
    async def test_method_list(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        balance = await async_client.views.balances.list(
            view_id="VIEW_ID",
            bank_id="BANK_ID",
        )
        assert balance.is_closed
    ...
    async def test_raw_response_list(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        balance = await async_client.views.balances.with_raw_response.list(
            view_id="VIEW_ID",
            bank_id="BANK_ID",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        async with async_client.views.balances.with_streaming_response.list(
            view_id="VIEW_ID",
            bank_id="BANK_ID",
        ) as balance:
            assert not balance.is_closed
    ...
    async def test_path_params_list(self, async_client: AsyncObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            await async_client.views.balances.with_raw_response.list(
                view_id="VIEW_ID",
                bank_id="",
            )
