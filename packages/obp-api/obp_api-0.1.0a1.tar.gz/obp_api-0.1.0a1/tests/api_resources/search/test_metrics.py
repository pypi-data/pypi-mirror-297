...
class TestMetrics:
    ...
    def test_method_list(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.get("/obp/v5.1.0/search/metrics").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
        metric = client.search.metrics.list()
    ...
    def test_raw_response_list(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        metric = client.search.metrics.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.get("/obp/v5.1.0/search/metrics").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
        with client.search.metrics.with_streaming_response.list() as metric:
...
class TestAsyncMetrics:
    ...
    async def test_method_list(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.get("/obp/v5.1.0/search/metrics").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
        metric = await async_client.search.metrics.list()
        assert metric.is_closed
    ...
    async def test_raw_response_list(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        metric = await async_client.search.metrics.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.get("/obp/v5.1.0/search/metrics").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
        async with async_client.search.metrics.with_streaming_response.list() as metric:
            assert not metric.is_closed
            assert metric.http_request.headers.get("X-Stainless-Lang") == "python"
