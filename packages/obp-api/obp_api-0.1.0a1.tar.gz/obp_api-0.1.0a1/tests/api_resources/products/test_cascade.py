...
class TestCascade:
    ...
    def test_method_delete(self, client: ObpAPI) -> None:
        cascade = client.products.cascade.delete(
    ...
    def test_raw_response_delete(self, client: ObpAPI) -> None:
        response = client.products.cascade.with_raw_response.delete(
            product_code="PRODUCT_CODE",
            bank_id="BANK_ID",
        )
    ...
    def test_streaming_response_delete(self, client: ObpAPI) -> None:
        with client.products.cascade.with_streaming_response.delete(
            product_code="PRODUCT_CODE",
            bank_id="BANK_ID",
        ) as response:
    ...
    def test_path_params_delete(self, client: ObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            client.products.cascade.with_raw_response.delete(
                product_code="PRODUCT_CODE",
                bank_id="",
            )
...
class TestAsyncCascade:
    ...
    async def test_method_delete(self, async_client: AsyncObpAPI) -> None:
        cascade = await async_client.products.cascade.delete(
            product_code="PRODUCT_CODE",
            bank_id="BANK_ID",
        )
        assert cascade is None
    ...
    async def test_raw_response_delete(self, async_client: AsyncObpAPI) -> None:
        response = await async_client.products.cascade.with_raw_response.delete(
            product_code="PRODUCT_CODE",
            bank_id="BANK_ID",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncObpAPI) -> None:
        async with async_client.products.cascade.with_streaming_response.delete(
            product_code="PRODUCT_CODE",
            bank_id="BANK_ID",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_delete(self, async_client: AsyncObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            await async_client.products.cascade.with_raw_response.delete(
                product_code="PRODUCT_CODE",
                bank_id="",
            )
