...
class TestCustomer:
    ...
    def test_method_retrieve(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.get("/obp/v5.1.0/banks/BANK_ID/attribute-definitions/customer").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )
        customer = client.banks.attribute_definitions.customer.retrieve(
            "BANK_ID",
        )
    ...
    def test_raw_response_retrieve(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        customer = client.banks.attribute_definitions.customer.with_raw_response.retrieve(
            "BANK_ID",
        )
    ...
    def test_streaming_response_retrieve(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        with client.banks.attribute_definitions.customer.with_streaming_response.retrieve(
            "BANK_ID",
        ) as customer:
    ...
    def test_path_params_retrieve(self, client: ObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            client.banks.attribute_definitions.customer.with_raw_response.retrieve(
                "",
            )
    ...
    def test_method_update(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.put("/obp/v5.1.0/banks/BANK_ID/attribute-definitions/customer").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )
...
class TestAsyncCustomer:
    ...
    async def test_method_retrieve(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        customer = await async_client.banks.attribute_definitions.customer.retrieve(
            "BANK_ID",
        )
        assert customer.is_closed
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        customer = await async_client.banks.attribute_definitions.customer.with_raw_response.retrieve(
            "BANK_ID",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        async with async_client.banks.attribute_definitions.customer.with_streaming_response.retrieve(
            "BANK_ID",
        ) as customer:
            assert not customer.is_closed
            assert customer.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            await async_client.banks.attribute_definitions.customer.with_raw_response.retrieve(
                "",
            )
