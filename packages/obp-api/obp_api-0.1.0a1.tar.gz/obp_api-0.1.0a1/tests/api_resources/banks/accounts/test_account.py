...
class TestAccount:
    ...
    def test_method_retrieve(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.get("/obp/v5.1.0/my/banks/BANK_ID/accounts/ACCOUNT_ID/account").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )
        account = client.banks.accounts.account.retrieve(
    ...
    def test_raw_response_retrieve(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        account = client.banks.accounts.account.with_raw_response.retrieve(
            account_id="ACCOUNT_ID",
            bank_id="BANK_ID",
        )
    ...
    def test_streaming_response_retrieve(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        with client.banks.accounts.account.with_streaming_response.retrieve(
            account_id="ACCOUNT_ID",
            bank_id="BANK_ID",
        ) as account:
    ...
    def test_path_params_retrieve(self, client: ObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            client.banks.accounts.account.with_raw_response.retrieve(
                account_id="ACCOUNT_ID",
                bank_id="",
            )
...
class TestAsyncAccount:
    ...
    async def test_method_retrieve(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        account = await async_client.banks.accounts.account.retrieve(
            account_id="ACCOUNT_ID",
            bank_id="BANK_ID",
        )
        assert account.is_closed
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        account = await async_client.banks.accounts.account.with_raw_response.retrieve(
            account_id="ACCOUNT_ID",
            bank_id="BANK_ID",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        async with async_client.banks.accounts.account.with_streaming_response.retrieve(
            account_id="ACCOUNT_ID",
            bank_id="BANK_ID",
        ) as account:
            assert not account.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            await async_client.banks.accounts.account.with_raw_response.retrieve(
                account_id="ACCOUNT_ID",
                bank_id="",
            )
