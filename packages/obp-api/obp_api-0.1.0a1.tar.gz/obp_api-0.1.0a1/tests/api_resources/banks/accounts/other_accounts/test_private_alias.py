...
class TestPrivateAlias:
    ...
    def test_method_delete(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        private_alias = client.banks.accounts.other_accounts.private_alias.delete(
    ...
    def test_raw_response_delete(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        private_alias = client.banks.accounts.other_accounts.private_alias.with_raw_response.delete(
            other_account_id="OTHER_ACCOUNT_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            view_id="VIEW_ID",
    ...
    def test_streaming_response_delete(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        with client.banks.accounts.other_accounts.private_alias.with_streaming_response.delete(
            other_account_id="OTHER_ACCOUNT_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            view_id="VIEW_ID",
    ...
    def test_path_params_delete(self, client: ObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            client.banks.accounts.other_accounts.private_alias.with_raw_response.delete(
                other_account_id="OTHER_ACCOUNT_ID",
                bank_id="",
                account_id="ACCOUNT_ID",
                view_id="VIEW_ID",
...
class TestAsyncPrivateAlias:
    ...
    async def test_method_delete(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        private_alias = await async_client.banks.accounts.other_accounts.private_alias.delete(
            other_account_id="OTHER_ACCOUNT_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            view_id="VIEW_ID",
    ...
    async def test_raw_response_delete(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        private_alias = await async_client.banks.accounts.other_accounts.private_alias.with_raw_response.delete(
            other_account_id="OTHER_ACCOUNT_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            view_id="VIEW_ID",
    ...
    async def test_streaming_response_delete(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        async with async_client.banks.accounts.other_accounts.private_alias.with_streaming_response.delete(
            other_account_id="OTHER_ACCOUNT_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            view_id="VIEW_ID",
    ...
    async def test_path_params_delete(self, async_client: AsyncObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            await async_client.banks.accounts.other_accounts.private_alias.with_raw_response.delete(
                other_account_id="OTHER_ACCOUNT_ID",
                bank_id="",
                account_id="ACCOUNT_ID",
                view_id="VIEW_ID",
