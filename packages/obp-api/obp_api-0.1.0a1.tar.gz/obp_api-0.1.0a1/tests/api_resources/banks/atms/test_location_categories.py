...
class TestLocationCategories:
    ...
    def test_method_update(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.put("/obp/v5.1.0/banks/BANK_ID/atms/ATM_ID/location-categories").mock(
        ...
        assert cast(Any, location_category.is_closed) is True
        assert isinstance(location_category, BinaryAPIResponse)
    ...
    def test_streaming_response_update(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        with client.banks.atms.location_categories.with_streaming_response.update(
            ...
            assert location_category.json() == {"foo": "bar"}
            assert cast(Any, location_category.is_closed) is True
            assert isinstance(location_category, StreamedBinaryAPIResponse)
...
class TestAsyncLocationCategories:
    ...
    async def test_method_update(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        assert cast(Any, location_category.is_closed) is True
        assert isinstance(location_category, AsyncBinaryAPIResponse)
    ...
    async def test_streaming_response_update(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        async with async_client.banks.atms.location_categories.with_streaming_response.update(
            ...
            assert await location_category.json() == {"foo": "bar"}
            assert cast(Any, location_category.is_closed) is True
            assert isinstance(location_category, AsyncStreamedBinaryAPIResponse)
