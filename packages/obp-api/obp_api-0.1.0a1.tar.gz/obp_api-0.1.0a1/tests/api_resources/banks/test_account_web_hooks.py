...
class TestAccountWebHooks:
    ...
    def test_method_create(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.post("/obp/v5.1.0/banks/BANK_ID/account-web-hooks").mock(
        ...
        assert cast(Any, account_web_hook.is_closed) is True
        assert isinstance(account_web_hook, BinaryAPIResponse)
    ...
    def test_streaming_response_create(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        with client.banks.account_web_hooks.with_streaming_response.create(
            ...
            assert account_web_hook.json() == {"foo": "bar"}
            assert cast(Any, account_web_hook.is_closed) is True
            assert isinstance(account_web_hook, StreamedBinaryAPIResponse)
    ...
    def test_method_update(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.put("/obp/v5.1.0/banks/BANK_ID/account-web-hooks").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )
...
class TestAsyncAccountWebHooks:
    ...
    async def test_method_create(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        assert cast(Any, account_web_hook.is_closed) is True
        assert isinstance(account_web_hook, AsyncBinaryAPIResponse)
    ...
    async def test_streaming_response_create(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        async with async_client.banks.account_web_hooks.with_streaming_response.create(
            ...
            assert await account_web_hook.json() == {"foo": "bar"}
            assert cast(Any, account_web_hook.is_closed) is True
            assert isinstance(account_web_hook, AsyncStreamedBinaryAPIResponse)
