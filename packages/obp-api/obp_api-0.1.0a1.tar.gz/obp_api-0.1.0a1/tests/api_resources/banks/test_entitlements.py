...
class TestEntitlements:
    ...
    def test_method_list(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.get("/obp/v5.1.0/banks/BANK_ID/entitlements").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )
        entitlement = client.banks.entitlements.list(
            "BANK_ID",
        )
    ...
    def test_raw_response_list(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        entitlement = client.banks.entitlements.with_raw_response.list(
            "BANK_ID",
        )
    ...
    def test_streaming_response_list(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        with client.banks.entitlements.with_streaming_response.list(
            "BANK_ID",
        ) as entitlement:
    ...
    def test_path_params_list(self, client: ObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            client.banks.entitlements.with_raw_response.list(
                "",
            )
...
class TestAsyncEntitlements:
    ...
    async def test_method_list(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        entitlement = await async_client.banks.entitlements.list(
            "BANK_ID",
        )
        assert entitlement.is_closed
    ...
    async def test_raw_response_list(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        entitlement = await async_client.banks.entitlements.with_raw_response.list(
            "BANK_ID",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        async with async_client.banks.entitlements.with_streaming_response.list(
            "BANK_ID",
        ) as entitlement:
            assert not entitlement.is_closed
            assert entitlement.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            await async_client.banks.entitlements.with_raw_response.list(
                "",
            )
