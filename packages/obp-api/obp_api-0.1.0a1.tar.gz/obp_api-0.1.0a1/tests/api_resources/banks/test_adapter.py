...
class TestAdapter:
    ...
    def test_method_retrieve(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.get("/obp/v5.1.0/banks/BANK_ID/adapter").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
        adapter = client.banks.adapter.retrieve(
            "BANK_ID",
        )
    ...
    def test_raw_response_retrieve(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        adapter = client.banks.adapter.with_raw_response.retrieve(
            "BANK_ID",
        )
    ...
    def test_streaming_response_retrieve(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.get("/obp/v5.1.0/banks/BANK_ID/adapter").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
        with client.banks.adapter.with_streaming_response.retrieve(
            "BANK_ID",
        ) as adapter:
    ...
    def test_path_params_retrieve(self, client: ObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            client.banks.adapter.with_raw_response.retrieve(
                "",
            )
...
class TestAsyncAdapter:
    ...
    async def test_method_retrieve(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.get("/obp/v5.1.0/banks/BANK_ID/adapter").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
        adapter = await async_client.banks.adapter.retrieve(
            "BANK_ID",
        )
        assert adapter.is_closed
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        adapter = await async_client.banks.adapter.with_raw_response.retrieve(
            "BANK_ID",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.get("/obp/v5.1.0/banks/BANK_ID/adapter").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
        async with async_client.banks.adapter.with_streaming_response.retrieve(
            "BANK_ID",
        ) as adapter:
            assert not adapter.is_closed
            assert adapter.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            await async_client.banks.adapter.with_raw_response.retrieve(
                "",
            )
