...
class TestEmail:
    ...
    def test_method_update(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.put("/obp/v5.1.0/banks/BANK_ID/customers/CUSTOMER_ID/email").mock(
    ...
    def test_streaming_response_update(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        with client.customers.email.with_streaming_response.update(
            ...
            assert email.json() == {"foo": "bar"}
            assert cast(Any, email.is_closed) is True
            assert isinstance(email, StreamedBinaryAPIResponse)
...
class TestAsyncEmail:
    ...
    async def test_streaming_response_update(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        async with async_client.customers.email.with_streaming_response.update(
            ...
            assert await email.json() == {"foo": "bar"}
            assert cast(Any, email.is_closed) is True
            assert isinstance(email, AsyncStreamedBinaryAPIResponse)
