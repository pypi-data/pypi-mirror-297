...
class TestOverviewFlat:
    parametrize = pytest.mark.parametrize("client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    @pytest.mark.respx(base_url=base_url)
    def test_method_retrieve(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.post("/obp/v5.1.0/banks/BANK_ID/customers/customer-number-query/overview-flat").mock(
        ...
        assert cast(Any, overview_flat.is_closed) is True
        assert isinstance(overview_flat, BinaryAPIResponse)
    ...
    def test_streaming_response_retrieve(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        with client.customers.customer_number_query.overview_flat.with_streaming_response.retrieve(
            ...
            assert overview_flat.json() == {"foo": "bar"}
            assert cast(Any, overview_flat.is_closed) is True
            assert isinstance(overview_flat, StreamedBinaryAPIResponse)
...
class TestAsyncOverviewFlat:
    ...
    async def test_method_retrieve(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        assert cast(Any, overview_flat.is_closed) is True
        assert isinstance(overview_flat, AsyncBinaryAPIResponse)
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        async with async_client.customers.customer_number_query.overview_flat.with_streaming_response.retrieve(
            ...
            assert await overview_flat.json() == {"foo": "bar"}
            assert cast(Any, overview_flat.is_closed) is True
            assert isinstance(overview_flat, AsyncStreamedBinaryAPIResponse)
