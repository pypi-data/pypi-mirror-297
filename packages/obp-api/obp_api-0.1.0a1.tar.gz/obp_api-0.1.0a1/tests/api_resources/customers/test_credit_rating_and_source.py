...
class TestCreditRatingAndSource:
    parametrize = pytest.mark.parametrize("client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    @pytest.mark.respx(base_url=base_url)
    def test_method_update(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.put("/obp/v5.1.0/banks/BANK_ID/customers/CUSTOMER_ID/credit-rating-and-source").mock(
        ...
        assert cast(Any, credit_rating_and_source.is_closed) is True
        assert isinstance(credit_rating_and_source, BinaryAPIResponse)
    ...
    def test_streaming_response_update(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        with client.customers.credit_rating_and_source.with_streaming_response.update(
            ...
            assert credit_rating_and_source.json() == {"foo": "bar"}
            assert cast(Any, credit_rating_and_source.is_closed) is True
            assert isinstance(credit_rating_and_source, StreamedBinaryAPIResponse)
...
class TestAsyncCreditRatingAndSource:
    ...
    async def test_method_update(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        assert cast(Any, credit_rating_and_source.is_closed) is True
        assert isinstance(credit_rating_and_source, AsyncBinaryAPIResponse)
    ...
    async def test_streaming_response_update(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        async with async_client.customers.credit_rating_and_source.with_streaming_response.update(
            ...
            assert await credit_rating_and_source.json() == {"foo": "bar"}
            assert cast(Any, credit_rating_and_source.is_closed) is True
            assert isinstance(credit_rating_and_source, AsyncStreamedBinaryAPIResponse)
