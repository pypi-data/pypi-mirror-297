...
class TestPrivate:
    ...
    def test_method_list(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.get("/obp/v5.1.0/banks/BANK_ID/accounts/private").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )
        private = client.bank_accounts.private.list(
            "BANK_ID",
        )
    ...
    def test_raw_response_list(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        private = client.bank_accounts.private.with_raw_response.list(
            "BANK_ID",
        )
    ...
    def test_streaming_response_list(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        with client.bank_accounts.private.with_streaming_response.list(
            "BANK_ID",
        ) as private:
    ...
    def test_path_params_list(self, client: ObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            client.bank_accounts.private.with_raw_response.list(
                "",
            )
...
class TestAsyncPrivate:
    ...
    async def test_method_list(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        private = await async_client.bank_accounts.private.list(
            "BANK_ID",
        )
        assert private.is_closed
    ...
    async def test_raw_response_list(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        private = await async_client.bank_accounts.private.with_raw_response.list(
            "BANK_ID",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        async with async_client.bank_accounts.private.with_streaming_response.list(
            "BANK_ID",
        ) as private:
            assert not private.is_closed
            assert private.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            await async_client.bank_accounts.private.with_raw_response.list(
                "",
            )
