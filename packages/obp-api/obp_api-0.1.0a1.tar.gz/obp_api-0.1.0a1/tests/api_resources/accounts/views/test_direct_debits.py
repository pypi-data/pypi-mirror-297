...
class TestDirectDebits:
    ...
    def test_raw_response_create(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        direct_debit = client.accounts.views.direct_debits.with_raw_response.create(
            view_id="VIEW_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            body={},
    ...
    def test_streaming_response_create(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        with client.accounts.views.direct_debits.with_streaming_response.create(
            view_id="VIEW_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            body={},
            ...
            assert direct_debit.json() == {"foo": "bar"}
            assert cast(Any, direct_debit.is_closed) is True
            assert isinstance(direct_debit, StreamedBinaryAPIResponse)
    ...
    def test_path_params_create(self, client: ObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            client.accounts.views.direct_debits.with_raw_response.create(
                view_id="VIEW_ID",
                bank_id="",
                account_id="ACCOUNT_ID",
                body={},
...
class TestAsyncDirectDebits:
    ...
    async def test_raw_response_create(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        direct_debit = await async_client.accounts.views.direct_debits.with_raw_response.create(
            view_id="VIEW_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            body={},
    ...
    async def test_streaming_response_create(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        async with async_client.accounts.views.direct_debits.with_streaming_response.create(
            view_id="VIEW_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
            body={},
            ...
            assert await direct_debit.json() == {"foo": "bar"}
            assert cast(Any, direct_debit.is_closed) is True
            assert isinstance(direct_debit, AsyncStreamedBinaryAPIResponse)
    ...
    async def test_path_params_create(self, async_client: AsyncObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            await async_client.accounts.views.direct_debits.with_raw_response.create(
                view_id="VIEW_ID",
                bank_id="",
                account_id="ACCOUNT_ID",
                body={},
