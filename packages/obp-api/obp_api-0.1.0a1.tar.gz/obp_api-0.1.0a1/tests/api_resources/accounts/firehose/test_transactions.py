...
class TestTransactions:
    ...
    def test_method_list(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        respx_mock.get("/obp/v5.1.0/banks/BANK_ID/firehose/accounts/ACCOUNT_ID/views/VIEW_ID/transactions").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )
        transaction = client.accounts.firehose.transactions.list(
            view_id="VIEW_ID",
            bank_id="BANK_ID",
    ...
    def test_raw_response_list(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        transaction = client.accounts.firehose.transactions.with_raw_response.list(
            view_id="VIEW_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
        )
    ...
    def test_streaming_response_list(self, client: ObpAPI, respx_mock: MockRouter) -> None:
        ...
        with client.accounts.firehose.transactions.with_streaming_response.list(
            view_id="VIEW_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
        ) as transaction:
    ...
    def test_path_params_list(self, client: ObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            client.accounts.firehose.transactions.with_raw_response.list(
                view_id="VIEW_ID",
                bank_id="",
                account_id="ACCOUNT_ID",
            )
...
class TestAsyncTransactions:
    ...
    async def test_method_list(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        transaction = await async_client.accounts.firehose.transactions.list(
            view_id="VIEW_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
        )
    ...
    async def test_raw_response_list(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        transaction = await async_client.accounts.firehose.transactions.with_raw_response.list(
            view_id="VIEW_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncObpAPI, respx_mock: MockRouter) -> None:
        ...
        async with async_client.accounts.firehose.transactions.with_streaming_response.list(
            view_id="VIEW_ID",
            bank_id="BANK_ID",
            account_id="ACCOUNT_ID",
        ) as transaction:
    ...
    async def test_path_params_list(self, async_client: AsyncObpAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bank_id` but received ''"):
            await async_client.accounts.firehose.transactions.with_raw_response.list(
                view_id="VIEW_ID",
                bank_id="",
                account_id="ACCOUNT_ID",
            )
