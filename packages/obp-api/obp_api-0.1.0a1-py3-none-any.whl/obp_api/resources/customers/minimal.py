...
__all__ = ["MinimalResource", "AsyncMinimalResource"]
...
class MinimalResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            f"/obp/v5.1.0/banks/{bank_id}/customers-minimal",
...
class MinimalResourceWithRawResponse:
    def __init__(self, minimal: MinimalResource) -> None:
...
class AsyncMinimalResourceWithRawResponse:
    def __init__(self, minimal: AsyncMinimalResource) -> None:
        self._minimal = minimal
...
class MinimalResourceWithStreamingResponse:
    def __init__(self, minimal: MinimalResource) -> None:
        self._minimal = minimal
...
class AsyncMinimalResourceWithStreamingResponse:
    def __init__(self, minimal: AsyncMinimalResource) -> None:
        self._minimal = minimal
