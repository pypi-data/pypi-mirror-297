...
from ....types.accounts.views import user_account_access_create_params

__all__ = ["UserAccountAccessResource", "AsyncUserAccountAccessResource"]


class UserAccountAccessResource(SyncAPIResource):
    @cached_property
    def with_raw_response(self) -> UserAccountAccessResourceWithRawResponse:
        """
        ...
        """
        return UserAccountAccessResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> UserAccountAccessResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/nemozak1/obp-api-python#with_streaming_response
        """
        return UserAccountAccessResourceWithStreamingResponse(self)
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            f"/obp/v5.1.0/banks/{bank_id}/accounts/{account_id}/views/{view_id}/user-account-access",
            body=maybe_transform(body, user_account_access_create_params.UserAccountAccessCreateParams),
...
class AsyncUserAccountAccessResource(AsyncAPIResource):
    @cached_property
    def with_raw_response(self) -> AsyncUserAccountAccessResourceWithRawResponse:
        """
        This property can be used as a prefix for any HTTP method call to return the
        the raw response object instead of the parsed content.
        ...
        For more information, see https://www.github.com/nemozak1/obp-api-python#accessing-raw-response-data-eg-headers
        """
        return AsyncUserAccountAccessResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncUserAccountAccessResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/nemozak1/obp-api-python#with_streaming_response
        """
        return AsyncUserAccountAccessResourceWithStreamingResponse(self)
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            f"/obp/v5.1.0/banks/{bank_id}/accounts/{account_id}/views/{view_id}/user-account-access",
            body=await async_maybe_transform(body, user_account_access_create_params.UserAccountAccessCreateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class UserAccountAccessResourceWithRawResponse:
    def __init__(self, user_account_access: UserAccountAccessResource) -> None:
        self._user_account_access = user_account_access

        self.create = to_custom_raw_response_wrapper(
            user_account_access.create,
            BinaryAPIResponse,
        )


class AsyncUserAccountAccessResourceWithRawResponse:
    def __init__(self, user_account_access: AsyncUserAccountAccessResource) -> None:
        self._user_account_access = user_account_access
...
class UserAccountAccessResourceWithStreamingResponse:
    def __init__(self, user_account_access: UserAccountAccessResource) -> None:
        self._user_account_access = user_account_access
...
class AsyncUserAccountAccessResourceWithStreamingResponse:
    def __init__(self, user_account_access: AsyncUserAccountAccessResource) -> None:
        self._user_account_access = user_account_access
