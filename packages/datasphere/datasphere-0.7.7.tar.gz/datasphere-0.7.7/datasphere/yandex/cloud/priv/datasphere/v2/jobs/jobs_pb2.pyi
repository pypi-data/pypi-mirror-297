...
class JobMetrics(google.protobuf.message.Message):
    ...
    CPUMETRIC_FIELD_NUMBER: builtins.int
    MEMMETRIC_FIELD_NUMBER: builtins.int
    GPUMETRIC_FIELD_NUMBER: builtins.int
    GPUMEMMETRIC_FIELD_NUMBER: builtins.int
    @property
    ...
    @property
    def cpuMetric(self) -> global___JobMetric: ...
    @property
    def memMetric(self) -> global___JobMetric: ...
    @property
    def gpuMetric(self) -> global___JobMetric: ...
    @property
    def gpuMemMetric(self) -> global___JobMetric: ...
    def __init__(
        self,
        *,
        timeline: collections.abc.Iterable[google.protobuf.timestamp_pb2.Timestamp] | None = ...,
        cpuMetric: global___JobMetric | None = ...,
        memMetric: global___JobMetric | None = ...,
        gpuMetric: global___JobMetric | None = ...,
        gpuMemMetric: global___JobMetric | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["cpuMetric", b"cpuMetric", "gpuMemMetric", b"gpuMemMetric", "gpuMetric", b"gpuMetric", "memMetric", b"memMetric"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["cpuMetric", b"cpuMetric", "gpuMemMetric", b"gpuMemMetric", "gpuMetric", b"gpuMetric", "memMetric", b"memMetric", "timeline", b"timeline"]) -> None: ...
