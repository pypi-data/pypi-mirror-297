...
class Project(google.protobuf.message.Message):
    ...
    class _StatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Project._Status.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        STATUS_UNSPECIFIED: Project._Status.ValueType  # 0
        ACTIVE: Project._Status.ValueType  # 1
        INACTIVE: Project._Status.ValueType  # 2

    class Status(_Status, metaclass=_StatusEnumTypeWrapper): ...
    STATUS_UNSPECIFIED: Project.Status.ValueType  # 0
    ACTIVE: Project.Status.ValueType  # 1
    INACTIVE: Project.Status.ValueType  # 2
    ...
    class Settings(google.protobuf.message.Message):
        ...
        IDE_EXEC_MODE_FIELD_NUMBER: builtins.int
        ...
        ide_exec_mode: global___Project.Settings.IdeExecutionMode.ValueType
        @property
        ...
        def ClearField(self, field_name: typing.Literal["data_proc_cluster_id", b"data_proc_cluster_id", "default_folder_id", b"default_folder_id", "early_access", b"early_access", "ide", b"ide", "ide_exec_mode", b"ide_exec_mode", "security_group_ids", b"security_group_ids", "service_account_id", b"service_account_id", "stale_exec_timeout_mode", b"stale_exec_timeout_mode", "subnet_id", b"subnet_id"]) -> None: ...
    ...
    name: builtins.str
    status: global___Project.Status.ValueType
    ...
    def HasField(self, field_name: typing.Literal["created_at", b"created_at", "settings", b"settings"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["created_at", b"created_at", "description", b"description", "disk_size_gb", b"disk_size_gb", "folder_id", b"folder_id", "id", b"id", "labels", b"labels", "name", b"name", "settings", b"settings", "status", b"status", "zone_id", b"zone_id"]) -> None: ...
