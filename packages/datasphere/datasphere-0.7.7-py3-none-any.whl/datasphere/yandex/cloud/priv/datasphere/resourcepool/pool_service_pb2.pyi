...
class ListPoolsRequest(google.protobuf.message.Message):
    ...
    INCLUDE_VMS_FIELD_NUMBER: builtins.int
    filter: builtins.str
    include_vms: builtins.bool
    def __init__(
        self,
        *,
        filter: builtins.str = ...,
    ...
    def ClearField(self, field_name: typing.Literal["filter", b"filter", "include_vms", b"include_vms"]) -> None: ...
...
class VmNetworkInterfaceSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["primary_v4_address", b"primary_v4_address", "primary_v6_address", b"primary_v6_address", "security_group_ids", b"security_group_ids", "subnet_id", b"subnet_id"]) -> None: ...
...
class AvailabilitySpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["default_subnet_id", b"default_subnet_id", "max_count", b"max_count", "min_count", b"min_count"]) -> None: ...
