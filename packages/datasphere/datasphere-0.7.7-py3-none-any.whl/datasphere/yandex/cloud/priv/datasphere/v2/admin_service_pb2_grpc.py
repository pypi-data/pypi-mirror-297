...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/priv/datasphere/v2/admin_service_pb2_grpc.py depends on'
...
def add_AdminServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.priv.datasphere.v2.AdminService', rpc_method_handlers)
