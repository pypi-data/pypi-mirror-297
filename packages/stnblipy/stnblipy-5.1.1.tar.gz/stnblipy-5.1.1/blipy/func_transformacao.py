...
class DeParaSN(DePara):
    ...
    def __init__(self, 
        ...
        if lingua == "pt" and val_int and not inverte:
            ...
            raise RuntimeError("Língua inválida: " + lingua)
...
class StrParaData():
    ...
    disponibilizados na forma de constantes via classe FmtDt, mas um formato
    específico pode ser passado, desde que seja reconhecível pelo método
