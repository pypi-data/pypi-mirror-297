...
from achatbot.common.interface import IBot, IConnector
from achatbot.common.types import DailyRoomBotArgs, SessionCtx
from achatbot.cmd.bots import BotInfo, import_bots, register_daily_room_bots
...
class BotTaskRunner:
    ...
    def run_daily_bot(self, bot_info: BotInfo):
        ...
        if len(bot_info.room_url.strip()) == 0:
            from achatbot.services.help.daily_rest import DailyRoomObject
            from achatbot.services.help.daily_room import DailyRoom
