...
class BlockchainParams:
    ...
    seed_difficulty = Difficulty(16, 8, 1, 16, HASH_LEN, COMPRESSION_LEVEL_LZ4, 0)
    low_diff_argon = Difficulty(1, 8, 1, 1, HASH_LEN, COMPRESSION_LEVEL_LZ4, 0)
    low_diff_sha256 = Difficulty(1, 8, 1, 1, HASH_LEN, COMPRESSION_LEVEL_LZ4, 1)
    max_hosts = 65536
