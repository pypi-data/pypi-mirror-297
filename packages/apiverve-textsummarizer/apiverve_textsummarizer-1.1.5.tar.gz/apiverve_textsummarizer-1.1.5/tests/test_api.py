...
class TestTextsummarizerAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = TextsummarizerAPIClient(self.api_key)

    @patch('apiverve_textsummarizer.apiClient.requests.get')
