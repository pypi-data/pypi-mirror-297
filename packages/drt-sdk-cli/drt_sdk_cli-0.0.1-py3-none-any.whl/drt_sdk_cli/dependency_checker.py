from drt_sdk_cli import config, errors, ux
from drt_sdk_cli.dependencies.modules import Rust
...
def check_if_rust_is_installed():
    ...
    if not rust_module.is_installed(""):
        ...
        ux.show_critical_error("Rust is not installed on your machine. Run `drtpy deps install rust --overwrite` and try again.")
