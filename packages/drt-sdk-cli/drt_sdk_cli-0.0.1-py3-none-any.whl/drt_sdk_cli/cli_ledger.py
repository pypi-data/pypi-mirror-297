...
from drt_sdk_cli import cli_shared
from drt_sdk_cli.ledger.ledger_app_handler import LedgerApp
...
def setup_parser(subparsers: Any) -> Any:
    ...
    sub = cli_shared.add_command_subparser(subparsers, "ledger", "version", "Get the version of the Dharitri App for Ledger")
