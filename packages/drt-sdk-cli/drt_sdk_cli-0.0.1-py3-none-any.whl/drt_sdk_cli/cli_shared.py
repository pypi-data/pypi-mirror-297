...
from drt_sdk_cli import config, errors, utils
from drt_sdk_cli.accounts import Account, LedgerAccount
from drt_sdk_cli.cli_output import CLIOutputBuilder
from drt_sdk_cli.cli_password import (load_guardian_password,
                                             load_password)
from drt_sdk_cli.constants import (DEFAULT_TX_VERSION,
                                          TRANSACTION_OPTIONS_TX_GUARDED)
from drt_sdk_cli.custom_network_provider import CustomNetworkProvider
from drt_sdk_cli.errors import ArgumentsNotProvidedError
from drt_sdk_cli.interfaces import ITransaction
from drt_sdk_cli.ledger.ledger_functions import do_get_ledger_address
from drt_sdk_cli.simulation import Simulator
from drt_sdk_cli.transactions import send_and_wait_for_result
from drt_sdk_cli.utils import log_explorer_transaction
...
def check_broadcast_args(args: Any):
    if hasattr(args, "relay") and args.relay and args.send:
        raise errors.BadUsage("Cannot directly send a relayed transaction. Use 'drtpy tx new --relay' first, then 'drtpy tx send --data-file'")
