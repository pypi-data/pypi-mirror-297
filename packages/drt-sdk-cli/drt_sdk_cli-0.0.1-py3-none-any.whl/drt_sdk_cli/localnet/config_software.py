...
from drt_sdk_cli.localnet.config_part import ConfigPart
...
class Software(ConfigPart):
    def __init__(
        ...
        self.drt_chain_go = drt_chain_go
        self.drt_chain_proxy_go = drt_chain_proxy_go

    def get_name(self) -> str:
        return "software"

    def _do_override(self, other: Dict[str, Any]):
        self.drt_chain_go.override(other.get("drt_chain_go", {}))
        self.drt_chain_proxy_go.override(other.get("drt_chain_proxy_go", {}))

    def to_dictionary(self) -> Dict[str, Any]:
        return {
            "drt_chain_go": self.drt_chain_go.to_dictionary(),
            "drt_chain_proxy_go": self.drt_chain_proxy_go.to_dictionary(),
        }
