...
from drt_sdk_cli import errors, utils
from drt_sdk_cli.ux import show_warning

SDK_PATH = Path("~/drt-sdk").expanduser().resolve()
...
def get_defaults() -> Dict[str, Any]:
    return {
        "dependencies.vmtools.tag": "v0.0.3",
        "dependencies.vmtools.urlTemplate.linux": "https://github.com/DharitriOne/drt-chain-vm-go/archive/{TAG}.tar.gz",
        "dependencies.vmtools.urlTemplate.osx": "https://github.com/DharitriOne/drt-chain-vm-go/archive/{TAG}.tar.gz",
        "dependencies.vmtools.urlTemplate.windows": "https://github.com/DharitriOne/drt-chain-vm-go/archive/{TAG}.tar.gz",
        ...
        "dependencies.testwallets.tag": "v0.0.1",
        "dependencies.testwallets.urlTemplate.linux": "https://github.com/DharitriOne/drt-sdk-testwallets/archive/{TAG}.tar.gz",
        "dependencies.testwallets.urlTemplate.osx": "https://github.com/DharitriOne/drt-sdk-testwallets/archive/{TAG}.tar.gz",
        "dependencies.testwallets.urlTemplate.windows": "https://github.com/DharitriOne/drt-sdk-testwallets/archive/{TAG}.tar.gz",
