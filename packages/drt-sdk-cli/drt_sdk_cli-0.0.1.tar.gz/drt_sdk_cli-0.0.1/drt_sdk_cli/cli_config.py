...
from drt_sdk_cli import cli_shared, config, utils
from drt_sdk_cli.ux import confirm_continuation

logger = logging.getLogger("cli.config")


def setup_parser(subparsers: Any) -> Any:
    parser = cli_shared.add_group_subparser(subparsers, "config", "Configure drt-sdk (default values etc.)")
