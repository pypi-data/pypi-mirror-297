...
def log_explorer(chain: str, name: str, path: str, details: str):
    networks = {
        "1": ("Dharitri Mainnet Explorer", "https://explorer.dharitri.com"),
        "T": ("Dharitri Testnet Explorer", "https://testnet-explorer.dharitri.com"),
        "D": ("Dharitri Devnet Explorer", "https://devnet-explorer.dharitri.com"),
    }
    try:
