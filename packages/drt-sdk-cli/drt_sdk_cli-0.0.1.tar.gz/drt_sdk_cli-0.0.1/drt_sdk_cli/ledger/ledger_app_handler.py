...
from drt_sdk_cli.errors import LedgerError
from drt_sdk_cli.ledger.config import (LedgerAppConfiguration,
...
# Also see: https://github.com/DharitriOne/drt-sdk-js-hw-provider/blob/main/src/ledgerApp.ts
CLA = 0xed
