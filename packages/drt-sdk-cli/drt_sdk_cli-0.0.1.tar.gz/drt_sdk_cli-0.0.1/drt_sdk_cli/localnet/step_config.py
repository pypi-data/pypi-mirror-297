...
import drt_sdk_cli.utils as utils
from drt_sdk_cli.errors import KnownError
from drt_sdk_cli.localnet import (genesis_json,
...
def copy_config_to_nodes(config: ConfigRoot):
    config_prototype = config.software.drt_chain_go.get_node_config_folder()
...
def copy_config_to_seednode(config: ConfigRoot):
    config_source = config.software.drt_chain_go.get_seednode_config_folder()
...
def copy_config_to_proxy(config: ConfigRoot):
    config_prototype = config.software.drt_chain_proxy_go.get_proxy_config_folder()
