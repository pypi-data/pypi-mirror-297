...
from drt_sdk_wallet.validator_pem import ValidatorPEM
...
from drt_sdk_cli.cli_password import load_password
from drt_sdk_cli.config import (GAS_PER_DATA_BYTE, MIN_GAS_LIMIT,
                                       MetaChainSystemSCsCost)
from drt_sdk_cli.contracts import prepare_execute_transaction_data
from drt_sdk_cli.errors import BadUsage
from drt_sdk_cli.validators.validators_file import ValidatorsFile

logger = logging.getLogger("validators")

VALIDATORS_SMART_CONTRACT_ADDRESS = "moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqplllsxxctf0"
