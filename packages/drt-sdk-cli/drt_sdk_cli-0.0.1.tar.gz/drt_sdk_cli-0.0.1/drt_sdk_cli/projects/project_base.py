...
from drt_sdk_cli import dependencies, errors, myprocess, utils
from drt_sdk_cli.dependencies.modules import StandaloneModule
from drt_sdk_cli.projects.constants import PROJECT_CONFIG_FILENAME
from drt_sdk_cli.projects.interfaces import IProject
from drt_sdk_cli.projects.migrations import migrate_project_config_file
