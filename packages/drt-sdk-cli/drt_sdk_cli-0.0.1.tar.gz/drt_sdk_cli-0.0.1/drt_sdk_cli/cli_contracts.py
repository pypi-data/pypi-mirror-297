...
from drt_sdk_core import Address, AddressComputer, Transaction
from drt_sdk_core.transaction_factories import TransactionsFactoryConfig
from drt_sdk_network_providers.proxy_network_provider import \
    ProxyNetworkProvider

from drt_sdk_cli import cli_shared, projects, utils
from drt_sdk_cli.cli_output import CLIOutputBuilder
from drt_sdk_cli.constants import NUMBER_OF_SHARDS
from drt_sdk_cli.contract_verification import \
    trigger_contract_verification
from drt_sdk_cli.contracts import SmartContract, query_contract
from drt_sdk_cli.cosign_transaction import cosign_transaction
from drt_sdk_cli.dependency_checker import check_if_rust_is_installed
from drt_sdk_cli.docker import is_docker_installed, run_docker
from drt_sdk_cli.errors import DockerMissingError, NoWalletProvided
from drt_sdk_cli.interfaces import IAddress
from drt_sdk_cli.projects.core import get_project_paths_recursively
from drt_sdk_cli.projects.templates import Contract
from drt_sdk_cli.ux import show_message
...
def _add_arguments_arg(sub: Any):
    sub.add_argument("--arguments", nargs='+',
                     ...
                     "boolean] or hex-encoded. E.g. --arguments 42 0x64 1000 0xabba str:TOK-a1c2ef true moa1[..]")
