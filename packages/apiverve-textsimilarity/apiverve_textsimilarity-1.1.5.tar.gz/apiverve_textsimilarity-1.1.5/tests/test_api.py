...
class TestTextsimilarityAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = TextsimilarityAPIClient(self.api_key)

    @patch('apiverve_textsimilarity.apiClient.requests.get')
