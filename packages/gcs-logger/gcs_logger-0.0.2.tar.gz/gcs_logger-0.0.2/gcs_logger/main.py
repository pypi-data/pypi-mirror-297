...
def get_gcs_logger(name: str, log_level: str) -> logging.Logger:
    """Returns a logger with the given name that writes messages with colors according to the log level."""
