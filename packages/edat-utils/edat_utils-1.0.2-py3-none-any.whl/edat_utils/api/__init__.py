...
from edat_utils.api.api_academico_service.service import ApiAcademicoService
from edat_utils.api.api_colegios_service.service import ApiColegiosTecnicosService
from edat_utils.api.api_funcionario_service.service import ApiFuncionarioService
