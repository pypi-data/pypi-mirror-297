...
class TestUrlunshortenerAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = UrlunshortenerAPIClient(self.api_key)

    @patch('apiverve_urlunshortener.apiClient.requests.get')
