...
from ttlinks.common.base_utils import BinaryClass, Creator, BinaryFlyWeightFactory
...
class OUIUnit:
    ...
    def __new__(
            cls,
            oui_id: List[BinaryClass],
            oui_mask: List[BinaryClass],
            oui_type: OUIType,
...
class OUIUnitCreator(Creator):
    def create_product(self, **kwargs):
        data = {
            'oui_id': [
                BinaryFlyWeightFactory.get_binary_class(NumeralConverter.hexadecimal_to_binary(binary))
