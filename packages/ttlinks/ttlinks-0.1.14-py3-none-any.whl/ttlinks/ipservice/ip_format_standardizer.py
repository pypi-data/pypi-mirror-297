...
if __name__ == '__main__':
    ...
    # print(IPStandardizer.ipv4_interface('192.168.1.1/24'))
    # print(IPStandardizer.ipv4_wildcard('192.168.1.1 0.0.1.255'))
    # print(IPStandardizer.ipv6_interface('fe00::1/64'))
    # print(IPStandardizer.ipv6_wildcard('fe00::1  FF00::'))

    # ipaddress = CIDRInterfaceIPv4StandardizerHandler()
    # print(ipaddress.handle('192.168.1.1/24'))
    #
    # ipaddress = DotInterfaceIPv4StandardizerHandler()
    # print(ipaddress.handle('192.168.1.1    255.255.255.0'))
    #
    # ipaddress = IPAddrInterfaceIPv4StandardizerHandler()
    # print(ipaddress.handle(IPv4Addr('192.168.1.1'), IPv4NetMask('255.255.255.0')))
    #
    # ipaddress = DotWildcardIPv4StandardizerHandler()
    # print(ipaddress.handle('192.168.1.1    255.255.255.0'))
    #
    # ipaddress = IPAddrWildcardIPv4StandardizerHandler()
    # print(ipaddress.handle(IPv4Addr('192.168.1.1'), IPv4WildCard('255.255.255.0')))

    # ipaddress = CIDRInterfaceIPv6StandardizerHandler()
    # print(ipaddress.handle('fe00::1/64'))
    #
    # ipaddress = DotInterfaceIPv6StandardizerHandler()
    # print(ipaddress.handle('fe00::1  FF00::'))
    #
    # ipaddress = IPAddrInterfaceIPv6StandardizerHandler()
    # print(ipaddress.handle(IPv6Addr('fe00::1'), IPv6NetMask('/64')))
    #
    # ipaddress = DotWildcardIPv6StandardizerHandler()
    # print(ipaddress.handle('fe00::1  ::FF'))
    #
    # ipaddress = IPAddrWildcardIPv6StandardizerHandler()
    # print(ipaddress.handle(IPv6Addr('fe00::1'), IPv6WildCard('::ffFF')))
