...
class TestLovecalculatorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = LovecalculatorAPIClient(self.api_key)

    @patch('apiverve_lovecalculator.apiClient.requests.get')
