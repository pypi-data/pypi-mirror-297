...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PartnerNext = channel.unary_unary(
                ...
                response_deserializer=user__pb2.CommonResponse.FromString,
                _registered_method=True)
        self.CreatePartnerVerification = channel.unary_unary(
                '/UserService/CreatePartnerVerification',
                request_serializer=user__pb2.CreatePartnerVerificationRequest.SerializeToString,
                response_deserializer=user__pb2.CommonResponse.FromString,
                _registered_method=True)
        self.EditPartnerVerification = channel.unary_unary(
                '/UserService/EditPartnerVerification',
                request_serializer=user__pb2.EditPartnerVerificationRequest.SerializeToString,
                response_deserializer=user__pb2.CommonResponse.FromString,
                _registered_method=True)
        self.VerificationCompleted = channel.unary_unary(
                '/UserService/VerificationCompleted',
                request_serializer=user__pb2.CommonRequest.SerializeToString,
                response_deserializer=user__pb2.CommonResponse.FromString,
                _registered_method=True)
...
class UserServiceServicer(object):
    ...
    def CreatePartnerVerification(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')

    def EditPartnerVerification(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')

    def VerificationCompleted(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CreatePartnerVerification': grpc.unary_unary_rpc_method_handler(
                    servicer.CreatePartnerVerification,
                    request_deserializer=user__pb2.CreatePartnerVerificationRequest.FromString,
                    response_serializer=user__pb2.CommonResponse.SerializeToString,
            ),
            'EditPartnerVerification': grpc.unary_unary_rpc_method_handler(
                    servicer.EditPartnerVerification,
                    request_deserializer=user__pb2.EditPartnerVerificationRequest.FromString,
                    response_serializer=user__pb2.CommonResponse.SerializeToString,
            ),
            'VerificationCompleted': grpc.unary_unary_rpc_method_handler(
                    servicer.VerificationCompleted,
                    request_deserializer=user__pb2.CommonRequest.FromString,
                    response_serializer=user__pb2.CommonResponse.SerializeToString,
            ),
    }
...
class UserService(object):
    ...
    @staticmethod
    def CreatePartnerVerification(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/UserService/CreatePartnerVerification',
            user__pb2.CreatePartnerVerificationRequest.SerializeToString,
            user__pb2.CommonResponse.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    @staticmethod
    def EditPartnerVerification(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/UserService/EditPartnerVerification',
            user__pb2.EditPartnerVerificationRequest.SerializeToString,
            user__pb2.CommonResponse.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    @staticmethod
    def VerificationCompleted(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
