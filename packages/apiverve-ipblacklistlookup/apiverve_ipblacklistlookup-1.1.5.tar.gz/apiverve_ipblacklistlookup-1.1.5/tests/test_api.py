...
class TestIpblacklistlookupAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = IpblacklistlookupAPIClient(self.api_key)

    @patch('apiverve_ipblacklistlookup.apiClient.requests.get')
