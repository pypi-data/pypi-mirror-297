...
@auto_schema
def report_aluminum_beam_column(matl: AluMaterial, sect: SteelSection, load: MemberForce, length: SteelLength, eff_len: EffectiveLength, factor: AluMomentModificationFactor) -> bytes:
    dll = load_dll()
    ...
    return read_file_as_binary(file_path)
