...
def set_platform(platform: str = None):
    if platform == "openmind" or platform == "openi":
...
class HubApi(BaseApi):
    ...
    def space_info(
        ...
        **kwargs,
        ...
        module = get_plugin(kwargs.pop("platform", None))
        return module.space_info(repo_id=repo_id, timeout=timeout, token=token)
    ...
    def list_repo_tree(
        ...
        **kwargs,
        ...
        return module.list_repo_tree(
            repo_id=repo_id, path_in_repo=path_in_repo, revision=revision, token=token, recursive=recursive
        )
