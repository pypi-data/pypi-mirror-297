...
def test_tag_parsing():
    print(r"(?:^|.*\s)(?:https://)*openlicense.ai/(n/|t/|\b)(\w+)(?:$|\s|" + '|'.join([re.escape(x) for x in '.,!?"\'@#$%^&*()']) + ")")
    
    t = BasePlugin.parse_tag_in_str('"Use of content under this domain in AI technologies is subject to the licensing terms defined in https://openlicense.ai/t/imageshack"')
