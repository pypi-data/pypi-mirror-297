...
```python
pip install data-and-reporting-sdk==1.1.0
```

You can also view the package at:
https://pypi.python.org/pypi/data-and-reporting-sdk/1.1.0
...
| `bearer_token_credentials` | [`BearerTokenCredentials`](__base_path/auth/oauth-2-client-credentials-grant.md) | The credential object for OAuth 2 Client Credentials Grant |
...
* [`BearerToken (OAuth 2 Client Credentials Grant)`](__base_path/auth/oauth-2-client-credentials-grant.md)
