...
from utils.webdriver.configurations import init_webdriver
from utils.webdriver.methods import (
    handle_open_url,
...
def main_flow(pbar: tqdm, driver: WebDriver):
    ...
    handle_open_menu_options(pbar, driver, '//*[contains(@class, "ng2-chart-menu-button")]', 3)
