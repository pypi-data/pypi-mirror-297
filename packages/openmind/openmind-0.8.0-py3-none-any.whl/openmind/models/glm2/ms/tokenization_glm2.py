# 2024.04.01 - Adapt to openmind.
#              Huawei Technologies Co., Ltd.
#
# This code is based on https://huggingface.co/THUDM/chatglm2-6b/blob/main/tokenization_chatglm.py.
# It was modified to fit the MindSpore framework.
#
...
class SPTokenizer:
    ...
    def __init__(self, model_path: str):
        ...
        if self.sp_model.vocab_size() != self.sp_model.get_piece_size():
            raise ValueError(
                "sp_model.vocab_size() should be equal to sp_model.get_piece_size()"
...
class ChatGLM2Tokenizer(PreTrainedTokenizer):
    ...
    def get_command(self, token):
        ...
        return self.tokenizer.special_tokens.get(token)
