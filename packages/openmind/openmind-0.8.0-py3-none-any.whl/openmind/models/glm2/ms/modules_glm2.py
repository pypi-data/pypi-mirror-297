...
class FreqsMgr(nn.Cell):
    ...
    def __init__(
        self, dim, seq_length=None, max_position_embedding=4096, rotary_dtype=mstype.float16, base=10000, rope_ratio=1.0
    ):
        super().__init__()
...
class ChatGLM2MLP(nn.Cell):
    ...
    def __init__(self, config: ChatGLM2Config):
        ...
        self.dense_h_to_4h.shard(
            ...
            strategy_bias=(
                (config.parallel_config.data_parallel, config.parallel_config.model_parallel),
