...
from .modules_glm2 import FreqsMgr
...
class ChatGLM2WithPtuning2(ChatGLM2ForConditionalGeneration):
    ...
    def kvcache(self, layer_idx):
        key_cache = self.transformer.encoder.layers[
            layer_idx
        ].self_attention.infer_attention.paged_attention_mgr.key_cache
        value_cache = self.transformer.encoder.layers[
            layer_idx
        ].self_attention.infer_attention.paged_attention_mgr.value_cache
