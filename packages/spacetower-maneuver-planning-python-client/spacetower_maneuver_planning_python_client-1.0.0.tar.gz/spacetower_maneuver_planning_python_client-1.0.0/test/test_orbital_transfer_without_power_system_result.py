        ...
        if include_optional:
            return OrbitalTransferWithoutPowerSystemResult(
                output_ephemeris = spacetower_maneuver_planning_python_client.models.output_ephemeris_without_power_system.OutputEphemerisWithoutPowerSystem(
                    ...
                    thrust_vector_ephemeris = null, 
                    mass_ephemeris = null, 
                    osculating_orbit_ephemeris = spacetower_maneuver_planning_python_client.models.osculating_orbit_ephemeris.OsculatingOrbitEphemeris(), 
