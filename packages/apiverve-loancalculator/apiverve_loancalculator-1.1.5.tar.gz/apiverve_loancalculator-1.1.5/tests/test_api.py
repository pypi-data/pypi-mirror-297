...
class TestLoanpaymentcalculatorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = LoanpaymentcalculatorAPIClient(self.api_key)

    @patch('apiverve_loancalculator.apiClient.requests.get')
