...
from pycamps.modules import Type4_2, ShortLine, InfBus
...
# Define base speed
wb = 377
SM1 = Type4_2('G1', BaseSpeed=wb)
TL1 = ShortLine('TL_1_2', BaseSpeed=wb)
L1 = InfBus('I1', BaseSpeed=wb)
