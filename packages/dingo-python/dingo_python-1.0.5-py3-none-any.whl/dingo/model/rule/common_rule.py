...
@Model.rule_register('QUALITY_INCOMPLETENESS', ['default','sft','pretrain','benchmark','llm_base'])
...
if __name__ == '__main__':
    content = """
    . Men's Shoulder Length Hair Is The Right Choice For Guys Who Want Medium To Long Hair But Don't Need The Hassle Of Constantly Styling Their Hair. If You Choose A Shoulder Length Hairstyle, You Can Leave Your Hair Natural And Unstyled Or Simply Part It To The Side For A Relaxed Yet Stylish Side-swept Look. So Whether You Have Thin Or Fine Hair, Straight Or Curly Locks, Or Just Thick Hair You Need To Cut And Style Easily, We've Got The Freshest Looks Of The Year. Your Hairstyle Is A Fashion Statement That Can Make Or Break Your Personal Style For The Year, So Check Out Our Guide For The Coolest Hairstyles For Men To Try. Specifically, Guys With Thick, Wavy And Curly Hair Won't Have Trouble Finding A Stylish Hairstyle To Wear. Now Let's Look At The Top Best Haircuts For Men To Try In 2018. Contents. 1 Popular Hairstyles For Men In 2018. 2 Best Fade Haircuts For Men 2.1 High Vs Low Fade. 2.2 Skin And Bald Fade. 3 Undercut Hairstyle..
    """
    data = MetaData(
        data_id = '',
        prompt = '',
