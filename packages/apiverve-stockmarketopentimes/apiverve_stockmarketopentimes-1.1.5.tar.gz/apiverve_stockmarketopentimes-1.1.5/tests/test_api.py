...
class TestStockmarketopentimesAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = StockmarketopentimesAPIClient(self.api_key)

    @patch('apiverve_stockmarketopentimes.apiClient.requests.get')
