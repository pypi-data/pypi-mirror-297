...
4. Output your evaluation as a single JSON object with the "score" key.
...
3. Select the winner (A or B) that best addresses the user's question.
4. Output your decision as a single JSON object with the "winner" key.
