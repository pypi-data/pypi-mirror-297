...
class PartialUpdateRawDatasetDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PartialUpdateRawDatasetDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PartialUpdateRawDatasetDto:
        """Create an instance of PartialUpdateRawDatasetDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PartialUpdateRawDatasetDto.parse_obj(obj)

        _obj = PartialUpdateRawDatasetDto.parse_obj({
