...
class PartialUpdateDerivedDatasetDto(BaseModel):
    ...
    attachments: Optional[conlist(Attachment)] = None
    origdatablocks: Optional[conlist(OrigDatablock)] = None
    datablocks: Optional[conlist(Datablock)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PartialUpdateDerivedDatasetDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PartialUpdateDerivedDatasetDto:
        """Create an instance of PartialUpdateDerivedDatasetDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PartialUpdateDerivedDatasetDto.parse_obj(obj)

        _obj = PartialUpdateDerivedDatasetDto.parse_obj({
