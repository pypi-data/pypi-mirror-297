...
class UpdateRawDatasetDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateRawDatasetDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateRawDatasetDto:
        """Create an instance of UpdateRawDatasetDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateRawDatasetDto.parse_obj(obj)

        _obj = UpdateRawDatasetDto.parse_obj({
