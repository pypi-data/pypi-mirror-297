...
class UpdateDerivedDatasetDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateDerivedDatasetDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateDerivedDatasetDto:
        """Create an instance of UpdateDerivedDatasetDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateDerivedDatasetDto.parse_obj(obj)

        _obj = UpdateDerivedDatasetDto.parse_obj({
