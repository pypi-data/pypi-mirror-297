...
class CreateDerivedDatasetDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateDerivedDatasetDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateDerivedDatasetDto:
        """Create an instance of CreateDerivedDatasetDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateDerivedDatasetDto.parse_obj(obj)

        _obj = CreateDerivedDatasetDto.parse_obj({
