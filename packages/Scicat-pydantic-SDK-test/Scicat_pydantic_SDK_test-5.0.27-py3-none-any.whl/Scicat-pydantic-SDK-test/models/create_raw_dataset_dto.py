...
class CreateRawDatasetDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateRawDatasetDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateRawDatasetDto:
        """Create an instance of CreateRawDatasetDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateRawDatasetDto.parse_obj(obj)

        _obj = CreateRawDatasetDto.parse_obj({
