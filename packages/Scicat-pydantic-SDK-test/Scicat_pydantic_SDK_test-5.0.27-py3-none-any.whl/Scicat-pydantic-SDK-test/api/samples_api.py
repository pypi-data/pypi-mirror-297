...
from Scicat-pydantic-SDK-test.exceptions import (  # noqa: F401
    ApiTypeError,
    ApiValueError
)
...
class SamplesApi:
    ...
    @validate_arguments
    def samples_controller_find_by_id_access(self, id : StrictStr, pid : Annotated[StrictStr, Field(..., description="ID of the sample to check access for")], **kwargs) -> bool:  # noqa: E501
        ...
        >>> thread = api.samples_controller_find_by_id_access(id, pid, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.samples_controller_find_by_id_access_with_http_info(id, pid, **kwargs)  # noqa: E501

    @validate_arguments
    def samples_controller_find_by_id_access_with_http_info(self, id : StrictStr, pid : Annotated[StrictStr, Field(..., description="ID of the sample to check access for")], **kwargs) -> ApiResponse:  # noqa: E501
        """Check user access to a specific sample.  # noqa: E501
        ...
        >>> thread = api.samples_controller_find_by_id_access_with_http_info(id, pid, async_req=True)
        >>> result = thread.get()
