...
class GoogleGeoCoding(DtComponent):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.semaphore = asyncio.Semaphore(20)  # Adjust the limit as needed
    ...
    async def get_coordinates(
        ...
        async with self.semaphore:
            ...
            if pd.notnull(row[street_address]):
                ...
                try:
                    await asyncio.sleep(0.1)  # Avoid overwhelming Google APIs
    ...
    async def run(self):
        ...
        if results_list:
            ...
            for column in results_df.columns:
                self.data.loc[results_df.index, column] = results_df[column]
