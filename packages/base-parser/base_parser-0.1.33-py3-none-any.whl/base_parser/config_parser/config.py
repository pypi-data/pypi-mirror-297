...
class Config:
    ...
    def get_source_send_limit(self):
        return self.config["source"]["send_limit"]
    ...
    def get_relation_field(self, curr_endpoint_template):
        return curr_endpoint_template.get('relation')
    ...
    def get_receiver_url(self):
        return self.config["receiver"]["url"]['value']

    def get_receiver_api_token(self):
        return self.config["receiver"]["auth"]["token"]['value']

    def get_receiver_auth_type(self):
        return self.config["receiver"]["auth"]["type"]['value']
