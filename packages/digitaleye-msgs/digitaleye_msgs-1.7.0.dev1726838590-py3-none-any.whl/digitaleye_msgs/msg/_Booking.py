...
class Booking(genpy.Message):
  _md5sum = "0eff80c35b5fcf36d5960eae5cc4caf8"
...
"""
  __slots__ = ['booking_id','status','start','end','agent_reg','actions','allocations_options']
  _slot_types = ['uint32','uint32','uint64','uint64','uint64','digitaleye_msgs/Action[]','digitaleye_msgs/BookingAllocations[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       booking_id,status,start,end,agent_reg,actions,allocations_options
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2I3Q().pack(_x.booking_id, _x.status, _x.start, _x.end, _x.agent_reg))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.booking_id, _x.status, _x.start, _x.end, _x.agent_reg,) = _get_struct_2I3Q().unpack(str[start:end])
      start = end
      end += 4
...
def _get_struct_2I():
    ...
    return _struct_2I
_struct_2I3Q = None
def _get_struct_2I3Q():
    global _struct_2I3Q
    if _struct_2I3Q is None:
        _struct_2I3Q = struct.Struct("<2I3Q")
    return _struct_2I3Q
_struct_2IQ = None
def _get_struct_2IQ():
    global _struct_2IQ
