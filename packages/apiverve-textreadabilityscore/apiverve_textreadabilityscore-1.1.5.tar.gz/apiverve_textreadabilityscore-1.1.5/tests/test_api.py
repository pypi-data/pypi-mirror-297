...
class TestReadabilityscoreAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = ReadabilityscoreAPIClient(self.api_key)

    @patch('apiverve_textreadabilityscore.apiClient.requests.get')
