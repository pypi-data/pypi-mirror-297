...
class TestQrcodegeneratorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = QrcodegeneratorAPIClient(self.api_key)

    @patch('apiverve_qrcodegenerator.apiClient.requests.get')
