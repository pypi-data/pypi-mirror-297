...
class ListWithSelectedItem_AcousticAnalysisSetup(
    _2683.AcousticAnalysisSetup, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_AcousticAnalysisSetup]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2683.AcousticAnalysisSetup.TYPE

    @property
    def selected_value(self: "Self") -> "_2683.AcousticAnalysisSetup":
    ...
    @property
    def available_values(self: "Self") -> "List[_2683.AcousticAnalysisSetup]":
