...
class ListWithSelectedItem_CylindricalGearSet(
    _2583.CylindricalGearSet, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_CylindricalGearSet]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2583.CylindricalGearSet.TYPE

    @property
    def selected_value(self: "Self") -> "_2583.CylindricalGearSet":
    ...
    @property
    def available_values(self: "Self") -> "List[_2583.CylindricalGearSet]":
