...
class ListWithSelectedItem_ShaftHubConnection(
    _2658.ShaftHubConnection, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_ShaftHubConnection]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2658.ShaftHubConnection.TYPE

    @property
    def selected_value(self: "Self") -> "_2658.ShaftHubConnection":
    ...
    @property
    def available_values(self: "Self") -> "List[_2658.ShaftHubConnection]":
