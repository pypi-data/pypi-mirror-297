...
class ListWithSelectedItem_CylindricalGear(
    _2582.CylindricalGear, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_CylindricalGear]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2582.CylindricalGear.TYPE

    @property
    def selected_value(self: "Self") -> "_2582.CylindricalGear":
    ...
    @property
    def available_values(self: "Self") -> "List[_2582.CylindricalGear]":
