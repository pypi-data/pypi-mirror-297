...
class ListWithSelectedItem_ActiveGearSetDesignSelectionGroup(
    _2569.ActiveGearSetDesignSelectionGroup, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2569.ActiveGearSetDesignSelectionGroup.TYPE

    @property
    def selected_value(self: "Self") -> "_2569.ActiveGearSetDesignSelectionGroup":
