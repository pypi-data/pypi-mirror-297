...
class Overridable_MeshStiffnessSource(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _7071.MeshStiffnessSource
        """
        return _7071.MeshStiffnessSource
    ...
    def implicit_type(cls: "Type[Overridable_MeshStiffnessSource]") -> "Any":
        ...
        Returns:
            Any
        """
        return _7071.MeshStiffnessSource.type_()

    @property
    def value(self: "Self") -> "_7071.MeshStiffnessSource":
    ...
    @property
    def override_value(self: "Self") -> "_7071.MeshStiffnessSource":
        """mastapy.system_model.analyses_and_results.static_loads.MeshStiffnessSource
    ...
    @property
    def calculated_value(self: "Self") -> "_7071.MeshStiffnessSource":
        """mastapy.system_model.analyses_and_results.static_loads.MeshStiffnessSource
