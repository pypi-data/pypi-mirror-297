...
class Overridable_NodeSelectionDepthOption(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
    ...
    ) -> "_2457.NodeSelectionDepthOption":
        ...
        Returns:
            _2457.NodeSelectionDepthOption
        """
        return _2457.NodeSelectionDepthOption
    ...
    def implicit_type(cls: "Type[Overridable_NodeSelectionDepthOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2457.NodeSelectionDepthOption.type_()

    @property
    def value(self: "Self") -> "_2457.NodeSelectionDepthOption":
    ...
    @property
    def override_value(self: "Self") -> "_2457.NodeSelectionDepthOption":
        """mastapy.system_model.fe.NodeSelectionDepthOption
    ...
    @property
    def calculated_value(self: "Self") -> "_2457.NodeSelectionDepthOption":
        """mastapy.system_model.fe.NodeSelectionDepthOption
