...
class EnumWithSelectedValue_RigidConnectorStiffnessType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RigidConnectorStiffnessType]",
    ) -> "_2651.RigidConnectorStiffnessType":
        ...
        Returns:
            _2651.RigidConnectorStiffnessType
        """
        return _2651.RigidConnectorStiffnessType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2651.RigidConnectorStiffnessType.type_()

    @property
    def selected_value(self: "Self") -> "_2651.RigidConnectorStiffnessType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2651.RigidConnectorStiffnessType]":
