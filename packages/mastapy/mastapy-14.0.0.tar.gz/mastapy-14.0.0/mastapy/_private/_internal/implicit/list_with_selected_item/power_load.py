...
class ListWithSelectedItem_PowerLoad(_2529.PowerLoad, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_PowerLoad]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2529.PowerLoad.TYPE

    @property
    def selected_value(self: "Self") -> "_2529.PowerLoad":
    ...
    @property
    def available_values(self: "Self") -> "List[_2529.PowerLoad]":
