...
class EnumWithSelectedValue_ThermalExpansionOption(
    ...
    def wrapped_type(
        ...
        Returns:
            _2466.ThermalExpansionOption
        """
        return _2466.ThermalExpansionOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2466.ThermalExpansionOption.type_()

    @property
    def selected_value(self: "Self") -> "_2466.ThermalExpansionOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2466.ThermalExpansionOption]":
