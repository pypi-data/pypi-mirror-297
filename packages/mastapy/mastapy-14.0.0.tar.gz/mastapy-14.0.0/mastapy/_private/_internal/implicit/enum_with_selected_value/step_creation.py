...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _5951
...
class EnumWithSelectedValue_StiffnessOptionsForHarmonicAnalysis_StepCreation(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_StiffnessOptionsForHarmonicAnalysis_StepCreation]",
    ) -> "_5951.StiffnessOptionsForHarmonicAnalysis.StepCreation":
        ...
        Returns:
            _5951.StiffnessOptionsForHarmonicAnalysis.StepCreation
        """
        return _5951.StiffnessOptionsForHarmonicAnalysis.StepCreation
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5951.StiffnessOptionsForHarmonicAnalysis.StepCreation.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_5951.StiffnessOptionsForHarmonicAnalysis.StepCreation]":
