...
class EnumWithSelectedValue_TorqueSpecificationForSystemDeflection(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_TorqueSpecificationForSystemDeflection]",
    ) -> "_7127.TorqueSpecificationForSystemDeflection":
        ...
        Returns:
            _7127.TorqueSpecificationForSystemDeflection
        """
        return _7127.TorqueSpecificationForSystemDeflection
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7127.TorqueSpecificationForSystemDeflection.type_()

    @property
    def selected_value(self: "Self") -> "_7127.TorqueSpecificationForSystemDeflection":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_7127.TorqueSpecificationForSystemDeflection]":
