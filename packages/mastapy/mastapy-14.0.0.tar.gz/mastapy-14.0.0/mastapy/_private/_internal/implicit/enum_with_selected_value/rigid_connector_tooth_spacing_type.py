...
class EnumWithSelectedValue_RigidConnectorToothSpacingType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RigidConnectorToothSpacingType]",
    ) -> "_2654.RigidConnectorToothSpacingType":
        ...
        Returns:
            _2654.RigidConnectorToothSpacingType
        """
        return _2654.RigidConnectorToothSpacingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2654.RigidConnectorToothSpacingType.type_()

    @property
    def selected_value(self: "Self") -> "_2654.RigidConnectorToothSpacingType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2654.RigidConnectorToothSpacingType]":
