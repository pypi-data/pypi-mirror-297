...
class EnumWithSelectedValue_ExcitationAnalysisViewOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ExcitationAnalysisViewOption]",
    ) -> "_2316.ExcitationAnalysisViewOption":
        ...
        Returns:
            _2316.ExcitationAnalysisViewOption
        """
        return _2316.ExcitationAnalysisViewOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2316.ExcitationAnalysisViewOption.type_()

    @property
    def selected_value(self: "Self") -> "_2316.ExcitationAnalysisViewOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2316.ExcitationAnalysisViewOption]":
