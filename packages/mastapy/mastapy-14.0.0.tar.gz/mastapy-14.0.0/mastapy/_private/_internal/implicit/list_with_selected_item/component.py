...
class ListWithSelectedItem_Component(_2499.Component, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_Component]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2499.Component.TYPE

    @property
    def selected_value(self: "Self") -> "_2499.Component":
    ...
    @property
    def available_values(self: "Self") -> "List[_2499.Component]":
