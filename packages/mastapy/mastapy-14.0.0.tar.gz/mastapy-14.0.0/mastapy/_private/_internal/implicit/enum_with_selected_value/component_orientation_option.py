...
class EnumWithSelectedValue_ComponentOrientationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ComponentOrientationOption]",
    ) -> "_2420.ComponentOrientationOption":
        ...
        Returns:
            _2420.ComponentOrientationOption
        """
        return _2420.ComponentOrientationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2420.ComponentOrientationOption.type_()

    @property
    def selected_value(self: "Self") -> "_2420.ComponentOrientationOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2420.ComponentOrientationOption]":
