...
from mastapy._private.system_model.part_model import _2528, _2529
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2261, _2264
...
class DutyCycleImporter(_0.APIBase):
    ...
    def design_state_destinations(
        self: "Self",
    ) -> "List[_2261.DutyCycleImporterDesignEntityMatch[_5794.DesignState]]":
    ...
    @property
    def duty_cycles_to_import(self: "Self") -> "List[_2264.IncludeDutyCycleOption]":
    ...
    def point_load_destinations(
        self: "Self",
    ) -> "List[_2261.DutyCycleImporterDesignEntityMatch[_2528.PointLoad]]":
    ...
    def power_load_destinations(
        self: "Self",
    ) -> "List[_2261.DutyCycleImporterDesignEntityMatch[_2529.PowerLoad]]":
