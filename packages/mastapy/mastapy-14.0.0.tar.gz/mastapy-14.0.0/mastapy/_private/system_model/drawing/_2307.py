...
from mastapy._private.utility.enums import _1875, _1876
...
class _Cast_PartAnalysisCaseWithContourViewable:
    ...
    def abstract_system_deflection_viewable(
        self: "CastSelf",
    ) -> "_2297.AbstractSystemDeflectionViewable":
        from mastapy._private.system_model.drawing import _2297

        return self.__parent__._cast(_2297.AbstractSystemDeflectionViewable)

    @property
    def advanced_system_deflection_viewable(
        self: "CastSelf",
    ) -> "_2298.AdvancedSystemDeflectionViewable":
        from mastapy._private.system_model.drawing import _2298

        return self.__parent__._cast(_2298.AdvancedSystemDeflectionViewable)

    @property
    def dynamic_analysis_viewable(self: "CastSelf") -> "_2302.DynamicAnalysisViewable":
        from mastapy._private.system_model.drawing import _2302

        return self.__parent__._cast(_2302.DynamicAnalysisViewable)

    @property
    def harmonic_analysis_viewable(
        self: "CastSelf",
    ) -> "_2303.HarmonicAnalysisViewable":
        from mastapy._private.system_model.drawing import _2303

        return self.__parent__._cast(_2303.HarmonicAnalysisViewable)

    @property
    def modal_analysis_viewable(self: "CastSelf") -> "_2305.ModalAnalysisViewable":
        from mastapy._private.system_model.drawing import _2305

        return self.__parent__._cast(_2305.ModalAnalysisViewable)

    @property
    def system_deflection_viewable(
        self: "CastSelf",
    ) -> "_2314.SystemDeflectionViewable":
        from mastapy._private.system_model.drawing import _2314

        return self.__parent__._cast(_2314.SystemDeflectionViewable)
...
class PartAnalysisCaseWithContourViewable(_0.APIBase):
    ...
    def contour(
        self: "Self", value: "_1875.ThreeDViewContourOptionFirstSelection"
    ) -> None:
    ...
    @enforce_parameter_types
    def contour_secondary(
        self: "Self", value: "_1876.ThreeDViewContourOptionSecondSelection"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def contour_draw_style(self: "Self") -> "_2300.ContourDrawStyle":
