...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.drawing import _2301, _2311, _2312
...
class _Cast_RotorDynamicsViewable:
    ...
    def critical_speed_analysis_viewable(
        self: "CastSelf",
    ) -> "_2301.CriticalSpeedAnalysisViewable":
        from mastapy._private.system_model.drawing import _2301

        return self.__parent__._cast(_2301.CriticalSpeedAnalysisViewable)

    @property
    def stability_analysis_viewable(
        self: "CastSelf",
    ) -> "_2311.StabilityAnalysisViewable":
        from mastapy._private.system_model.drawing import _2311

        return self.__parent__._cast(_2311.StabilityAnalysisViewable)

    @property
    def steady_state_synchronous_response_viewable(
        self: "CastSelf",
    ) -> "_2312.SteadyStateSynchronousResponseViewable":
        from mastapy._private.system_model.drawing import _2312

        return self.__parent__._cast(_2312.SteadyStateSynchronousResponseViewable)
...
class RotorDynamicsViewable(_0.APIBase):
    ...
    @property
    def rotor_dynamics(self: "Self") -> "_4130.RotorDynamicsDrawStyle":
