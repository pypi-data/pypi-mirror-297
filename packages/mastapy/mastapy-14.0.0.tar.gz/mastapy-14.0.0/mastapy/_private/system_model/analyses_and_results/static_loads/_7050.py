...
class _Cast_HarmonicLoadDataImportFromMotorPackages:
    ...
    def harmonic_load_data_import_base(
        self: "CastSelf",
    ) -> "_7049.HarmonicLoadDataImportBase":
        return self.__parent__._cast(_7049.HarmonicLoadDataImportBase)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HarmonicLoadDataImportFromMotorPackages(_7049.HarmonicLoadDataImportBase[T]):
    """HarmonicLoadDataImportFromMotorPackages
