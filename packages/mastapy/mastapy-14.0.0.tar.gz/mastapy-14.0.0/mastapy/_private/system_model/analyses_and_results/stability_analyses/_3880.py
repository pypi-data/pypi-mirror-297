...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelGearSetStabilityAnalysis(_3868.AGMAGleasonConicalGearSetStabilityAnalysis):
    """BevelGearSetStabilityAnalysis
    ...
    def agma_gleason_conical_gears_stability_analysis(
        self: "Self",
    ) -> "List[_3881.BevelGearStabilityAnalysis]":
    ...
    def agma_gleason_conical_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_3879.BevelGearMeshStabilityAnalysis]":
