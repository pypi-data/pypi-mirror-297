...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptCouplingConnectionDynamicAnalysis(_6453.CouplingConnectionDynamicAnalysis):
    """ConceptCouplingConnectionDynamicAnalysis
    ...
    @property
    def connection_load_case(self: "Self") -> "_6986.ConceptCouplingConnectionLoadCase":
