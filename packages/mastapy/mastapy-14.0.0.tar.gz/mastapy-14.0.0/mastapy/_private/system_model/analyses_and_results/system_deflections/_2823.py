...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearMeshSystemDeflection(_2843.GearMeshSystemDeflection):
    """CylindricalGearMeshSystemDeflection
    ...
    @property
    def gear_a(self: "Self") -> "_2829.CylindricalGearSystemDeflection":
    ...
    @property
    def gear_b(self: "Self") -> "_2829.CylindricalGearSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4184.CylindricalGearMeshPowerFlow":
    ...
    def cylindrical_meshed_gear_system_deflections(
        self: "Self",
    ) -> "List[_2833.CylindricalMeshedGearSystemDeflection]":
    ...
    def mesh_deflections_left_flank(
        self: "Self",
    ) -> "List[_2931.MeshDeflectionResults]":
    ...
    @property
    def gear_set(self: "Self") -> "_2826.CylindricalGearSetSystemDeflection":
