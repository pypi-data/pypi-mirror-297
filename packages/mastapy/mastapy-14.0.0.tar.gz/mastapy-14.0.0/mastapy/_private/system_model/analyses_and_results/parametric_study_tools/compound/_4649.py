...
class RootAssemblyCompoundParametricStudyTool(
    ...
    @property
    def compound_load_case(self: "Self") -> "_5790.AbstractLoadCaseGroup":
    ...
    def results_for_reporting(
        self: "Self",
    ) -> "_4500.ParametricStudyToolResultsForReporting":
    ...
    def root_assembly_duty_cycle_results(
        self: "Self",
    ) -> "_2989.DutyCycleEfficiencyResults":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4518.RootAssemblyParametricStudyTool]":
