...
class CylindricalGearSetPowerFlow(_4199.GearSetPowerFlow):
    ...
    @property
    def gears_power_flow(self: "Self") -> "List[_4185.CylindricalGearPowerFlow]":
    ...
    @property
    def meshes_power_flow(self: "Self") -> "List[_4184.CylindricalGearMeshPowerFlow]":
    ...
    def cylindrical_meshes_power_flow(
        self: "Self",
    ) -> "List[_4184.CylindricalGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CylindricalGearMeshPowerFlow]
