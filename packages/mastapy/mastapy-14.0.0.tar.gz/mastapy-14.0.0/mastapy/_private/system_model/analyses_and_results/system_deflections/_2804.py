...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearMeshSystemDeflection(_2843.GearMeshSystemDeflection):
    """ConceptGearMeshSystemDeflection
    ...
    @property
    def connection_load_case(self: "Self") -> "_6990.ConceptGearMeshLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4165.ConceptGearMeshPowerFlow":
