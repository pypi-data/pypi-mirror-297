...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DatumHarmonicAnalysis(_5836.ComponentHarmonicAnalysis):
    """DatumHarmonicAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_7017.DatumLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2835.DatumSystemDeflection":
