...
class _Cast_ClutchEngagementStatus:
    ...
    def generic_clutch_engagement_status(
        self: "CastSelf",
    ) -> "_5796.GenericClutchEngagementStatus":
        return self.__parent__._cast(_5796.GenericClutchEngagementStatus)
...
class ClutchEngagementStatus(
    _5796.GenericClutchEngagementStatus[_2396.ClutchConnection]
):
    """ClutchEngagementStatus
