...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetLoadCase(_7043.GearSetLoadCase):
    """WormGearSetLoadCase
    ...
    @property
    def gears_load_case(self: "Self") -> "List[_7132.WormGearLoadCase]":
    ...
    @property
    def worm_gears_load_case(self: "Self") -> "List[_7132.WormGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.WormGearLoadCase]
    ...
    @property
    def meshes_load_case(self: "Self") -> "List[_7133.WormGearMeshLoadCase]":
    ...
    @property
    def worm_meshes_load_case(self: "Self") -> "List[_7133.WormGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.WormGearMeshLoadCase]
