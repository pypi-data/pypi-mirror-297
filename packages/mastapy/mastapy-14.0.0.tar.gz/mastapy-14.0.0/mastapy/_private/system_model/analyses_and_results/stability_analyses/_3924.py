...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearSetStabilityAnalysis(_3965.SpecialisedAssemblyStabilityAnalysis):
    """GearSetStabilityAnalysis
    ...
    @property
    def gears_stability_analysis(self: "Self") -> "List[_3925.GearStabilityAnalysis]":
    ...
    def meshes_stability_analysis(
        self: "Self",
    ) -> "List[_3923.GearMeshStabilityAnalysis]":
