...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetSystemDeflection(_2844.GearSetSystemDeflection):
    """FaceGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4192.FaceGearSetPowerFlow":
    ...
    @property
    def gears_system_deflection(self: "Self") -> "List[_2840.FaceGearSystemDeflection]":
    ...
    def face_gears_system_deflection(
        self: "Self",
    ) -> "List[_2840.FaceGearSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.FaceGearSystemDeflection]
    ...
    def meshes_system_deflection(
        self: "Self",
    ) -> "List[_2838.FaceGearMeshSystemDeflection]":
