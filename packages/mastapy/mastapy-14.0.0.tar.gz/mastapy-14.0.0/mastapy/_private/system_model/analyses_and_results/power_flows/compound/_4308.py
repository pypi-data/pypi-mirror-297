...
class _Cast_ConnectionCompoundPowerFlow:
    ...
    def abstract_shaft_to_mountable_component_connection_compound_power_flow(
        self: "CastSelf",
    ) -> "_4276.AbstractShaftToMountableComponentConnectionCompoundPowerFlow":
        from mastapy._private.system_model.analyses_and_results.power_flows.compound import (
            _4276,
        )
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConnectionCompoundPowerFlow(_7708.ConnectionCompoundAnalysis):
    """ConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self: "Self") -> "List[_4171.ConnectionPowerFlow]":
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4171.ConnectionPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConnectionPowerFlow]
