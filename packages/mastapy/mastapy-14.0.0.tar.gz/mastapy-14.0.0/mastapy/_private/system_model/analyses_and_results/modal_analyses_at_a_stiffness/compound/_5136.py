...
class _Cast_ConceptGearMeshCompoundModalAnalysisAtAStiffness:
    ...
    def connection_compound_modal_analysis_at_a_stiffness(
        self: "CastSelf",
    ) -> "_5141.ConnectionCompoundModalAnalysisAtAStiffness":
        from mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import (
            _5141,
        )

        return self.__parent__._cast(_5141.ConnectionCompoundModalAnalysisAtAStiffness)
...
class ConceptGearMeshCompoundModalAnalysisAtAStiffness(
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5002.ConceptGearMeshModalAnalysisAtAStiffness]":
