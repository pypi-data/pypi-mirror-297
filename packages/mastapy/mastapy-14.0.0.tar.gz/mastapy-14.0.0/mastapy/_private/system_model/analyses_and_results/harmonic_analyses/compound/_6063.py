...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DatumCompoundHarmonicAnalysis(_6037.ComponentCompoundHarmonicAnalysis):
    """DatumCompoundHarmonicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5862.DatumHarmonicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_5862.DatumHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.DatumHarmonicAnalysis]
