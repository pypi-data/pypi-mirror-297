...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetModalAnalysis(_4749.GearSetModalAnalysis):
    """FaceGearSetModalAnalysis
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7034.FaceGearSetLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2839.FaceGearSetSystemDeflection":
    ...
    @property
    def gears_modal_analysis(self: "Self") -> "List[_4742.FaceGearModalAnalysis]":
    ...
    @property
    def face_gears_modal_analysis(self: "Self") -> "List[_4742.FaceGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearModalAnalysis]
    ...
    @property
    def meshes_modal_analysis(self: "Self") -> "List[_4741.FaceGearMeshModalAnalysis]":
    ...
    def face_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4741.FaceGearMeshModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearMeshModalAnalysis]
