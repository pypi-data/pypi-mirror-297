...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TorqueConverterCompoundPowerFlow(_4310.CouplingCompoundPowerFlow):
    """TorqueConverterCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4262.TorqueConverterPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4262.TorqueConverterPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.TorqueConverterPowerFlow]
