...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RollingRingCompoundPowerFlow(_4312.CouplingHalfCompoundPowerFlow):
    """RollingRingCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4236.RollingRingPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4236.RollingRingPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.RollingRingPowerFlow]
