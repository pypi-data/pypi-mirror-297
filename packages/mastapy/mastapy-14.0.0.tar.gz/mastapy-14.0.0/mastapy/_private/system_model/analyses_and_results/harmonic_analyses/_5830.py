...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltHarmonicAnalysis(_5836.ComponentHarmonicAnalysis):
    """BoltHarmonicAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_6979.BoltLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2794.BoltSystemDeflection":
