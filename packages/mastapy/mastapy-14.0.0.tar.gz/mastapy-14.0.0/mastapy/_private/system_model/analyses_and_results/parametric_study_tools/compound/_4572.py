...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltCompoundParametricStudyTool(_4578.ComponentCompoundParametricStudyTool):
    """BoltCompoundParametricStudyTool
    ...
    @property
    def component_design(self: "Self") -> "_2497.Bolt":
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_6979.BoltLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4424.BoltParametricStudyTool]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4424.BoltParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.BoltParametricStudyTool]
