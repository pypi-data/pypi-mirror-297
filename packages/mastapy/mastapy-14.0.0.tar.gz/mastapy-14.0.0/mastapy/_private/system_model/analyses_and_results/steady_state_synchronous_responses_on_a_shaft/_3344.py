...
class AssemblySteadyStateSynchronousResponseOnAShaft(
    ...
    @property
    def bolts(self: "Self") -> "List[_3357.BoltSteadyStateSynchronousResponseOnAShaft]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_3379.CVTSteadyStateSynchronousResponseOnAShaft]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_3365.ConceptCouplingSteadyStateSynchronousResponseOnAShaft]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_3400.HypoidGearSetSteadyStateSynchronousResponseOnAShaft]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3410.KlingelnbergCycloPalloidSpiralBevelGearSetSteadyStateSynchronousResponseOnAShaft]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3439.SpiralBevelGearSetSteadyStateSynchronousResponseOnAShaft]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_3443.SpringDamperSteadyStateSynchronousResponseOnAShaft]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_3464.WormGearSetSteadyStateSynchronousResponseOnAShaft]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3467.ZerolBevelGearSetSteadyStateSynchronousResponseOnAShaft]":
