...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CycloidalAssemblySystemDeflection(_2892.SpecialisedAssemblySystemDeflection):
    """CycloidalAssemblySystemDeflection
    ...
    @property
    def assembly_design(self: "Self") -> "_2625.CycloidalAssembly":
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7005.CycloidalAssemblyLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4179.CycloidalAssemblyPowerFlow":
