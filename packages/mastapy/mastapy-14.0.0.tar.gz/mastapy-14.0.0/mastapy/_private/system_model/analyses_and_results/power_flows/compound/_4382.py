...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelDiffGearSetCompoundPowerFlow(_4291.BevelGearSetCompoundPowerFlow):
    """StraightBevelDiffGearSetCompoundPowerFlow
    ...
    def straight_bevel_diff_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4380.StraightBevelDiffGearCompoundPowerFlow]":
    ...
    def straight_bevel_diff_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4381.StraightBevelDiffGearMeshCompoundPowerFlow]":
