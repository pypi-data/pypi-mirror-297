...
from mastapy._private.system_model.analyses_and_results.stability_analyses import _3984
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SynchroniserSleeveStabilityAnalysis(_3984.SynchroniserPartStabilityAnalysis):
    """SynchroniserSleeveStabilityAnalysis
