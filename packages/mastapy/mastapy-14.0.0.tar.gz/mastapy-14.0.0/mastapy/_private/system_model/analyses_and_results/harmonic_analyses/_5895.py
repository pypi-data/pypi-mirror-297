...
class _Cast_HarmonicAnalysisFEExportOptions:
    ...
    def harmonic_analysis_export_options(
        self: "CastSelf",
    ) -> "_5894.HarmonicAnalysisExportOptions":
        return self.__parent__._cast(_5894.HarmonicAnalysisExportOptions)
...
class HarmonicAnalysisFEExportOptions(
    _5894.HarmonicAnalysisExportOptions[
        _2738.IHaveFEPartHarmonicAnalysisResults, _2508.FEPart
    ]
):
    """HarmonicAnalysisFEExportOptions
