...
from mastapy._private.system_model.analyses_and_results.stability_analyses import _3992
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MeasurementComponentStabilityAnalysis(_3992.VirtualComponentStabilityAnalysis):
    """MeasurementComponentStabilityAnalysis
    ...
    @property
    def component_design(self: "Self") -> "_2518.MeasurementComponent":
    ...
    @property
    def component_load_case(self: "Self") -> "_7070.MeasurementComponentLoadCase":
