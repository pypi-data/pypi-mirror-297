...
TReal = TypeVar("TReal", bound="_2499.Component")
TComponentStaticLoad = TypeVar("TComponentStaticLoad", bound="_6985.ComponentLoadCase")
...
class ComponentStaticLoadCaseGroup(
    _5808.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]
):
    """ComponentStaticLoadCaseGroup
