...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearCompoundParametricStudyTool(_4611.GearCompoundParametricStudyTool):
    """FaceGearCompoundParametricStudyTool
    ...
    @property
    def component_design(self: "Self") -> "_2585.FaceGear":
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7032.FaceGearLoadCase":
