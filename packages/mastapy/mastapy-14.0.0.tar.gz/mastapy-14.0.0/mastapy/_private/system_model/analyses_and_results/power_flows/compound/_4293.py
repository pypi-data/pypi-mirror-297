...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltedJointCompoundPowerFlow(_4373.SpecialisedAssemblyCompoundPowerFlow):
    """BoltedJointCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4155.BoltedJointPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4155.BoltedJointPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BoltedJointPowerFlow]
