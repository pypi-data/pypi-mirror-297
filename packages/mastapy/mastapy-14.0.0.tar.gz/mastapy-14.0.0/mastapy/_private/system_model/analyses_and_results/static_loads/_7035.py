...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FEPartLoadCase(_6956.AbstractShaftOrHousingLoadCase):
    """FEPartLoadCase
    ...
    @property
    def angle_source(self: "Self") -> "_2413.AngleSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.fe._2413", "AngleSource"
        )(value)
    ...
    @enforce_parameter_types
    def fe_substructure(self: "Self", value: "_2438.FESubstructure") -> None:
        wrapper_type = (
    ...
    def surfaces_for_data_logging(
        self: "Self",
    ) -> "List[_6983.CMSElementFaceGroupWithSelectionOption]":
