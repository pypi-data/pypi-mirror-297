...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetCriticalSpeedAnalysis(_6749.GearSetCriticalSpeedAnalysis):
    """WormGearSetCriticalSpeedAnalysis
    ...
    def gears_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6814.WormGearCriticalSpeedAnalysis]":
    ...
    def meshes_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6815.WormGearMeshCriticalSpeedAnalysis]":
