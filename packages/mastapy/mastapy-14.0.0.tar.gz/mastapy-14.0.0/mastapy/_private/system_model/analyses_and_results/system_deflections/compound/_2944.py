...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AssemblyCompoundSystemDeflection(_2937.AbstractAssemblyCompoundSystemDeflection):
    """AssemblyCompoundSystemDeflection
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2776.AssemblySystemDeflection]":
    ...
    @property
    def bearings(self: "Self") -> "List[_2945.BearingCompoundSystemDeflection]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_2947.BeltDriveCompoundSystemDeflection]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_2950.BevelDifferentialGearSetCompoundSystemDeflection]":
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_2957.BoltedJointCompoundSystemDeflection]":
    ...
    @property
    def bolts(self: "Self") -> "List[_2956.BoltCompoundSystemDeflection]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_2978.CVTCompoundSystemDeflection]":
    ...
    @property
    def clutches(self: "Self") -> "List[_2958.ClutchCompoundSystemDeflection]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_2963.ConceptCouplingCompoundSystemDeflection]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_2968.ConceptGearSetCompoundSystemDeflection]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_2980.CycloidalAssemblyCompoundSystemDeflection]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_2982.CycloidalDiscCompoundSystemDeflection]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_2986.CylindricalGearSetCompoundSystemDeflection]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_2994.FEPartCompoundSystemDeflection]":
    ...
    def face_gear_sets(
        self: "Self",
    ) -> "List[_2993.FaceGearSetCompoundSystemDeflection]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_2995.FlexiblePinAssemblyCompoundSystemDeflection]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_3002.HypoidGearSetCompoundSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_3009.KlingelnbergCycloPalloidHypoidGearSetCompoundSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        ...
        "List[_3012.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSystemDeflection]"
    ):
    ...
    @property
    def mass_discs(self: "Self") -> "List[_3013.MassDiscCompoundSystemDeflection]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_3014.MeasurementComponentCompoundSystemDeflection]":
    ...
    @property
    def microphones(self: "Self") -> "List[_3016.MicrophoneCompoundSystemDeflection]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_3018.OilSealCompoundSystemDeflection]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_3020.PartToPartShearCouplingCompoundSystemDeflection]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_3025.PlanetCarrierCompoundSystemDeflection]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_3026.PointLoadCompoundSystemDeflection]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_3027.PowerLoadCompoundSystemDeflection]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_3029.RingPinsCompoundSystemDeflection]":
    ...
    @property
    def rolling_bearings(self: "Self") -> "List[_2945.BearingCompoundSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.compound.BearingCompoundSystemDeflection]
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_3031.RollingRingAssemblyCompoundSystemDeflection]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_3037.ShaftHubConnectionCompoundSystemDeflection]":
    ...
    @property
    def shafts(self: "Self") -> "List[_3035.ShaftCompoundSystemDeflection]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3042.SpiralBevelGearSetCompoundSystemDeflection]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_3043.SpringDamperCompoundSystemDeflection]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_3048.StraightBevelDiffGearSetCompoundSystemDeflection]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3051.StraightBevelGearSetCompoundSystemDeflection]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_3054.SynchroniserCompoundSystemDeflection]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_3058.TorqueConverterCompoundSystemDeflection]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_3062.UnbalancedMassCompoundSystemDeflection]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_3066.WormGearSetCompoundSystemDeflection]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3069.ZerolBevelGearSetCompoundSystemDeflection]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_2776.AssemblySystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.AssemblySystemDeflection]
