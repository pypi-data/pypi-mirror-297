...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearSetPowerFlow(_4142.AGMAGleasonConicalGearSetPowerFlow):
    """HypoidGearSetPowerFlow
    ...
    def agma_gleason_conical_gears_power_flow(
        self: "Self",
    ) -> "List[_4202.HypoidGearPowerFlow]":
    ...
    @property
    def hypoid_gears_power_flow(self: "Self") -> "List[_4202.HypoidGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.HypoidGearPowerFlow]
    ...
    def agma_gleason_conical_meshes_power_flow(
        self: "Self",
    ) -> "List[_4201.HypoidGearMeshPowerFlow]":
    ...
    @property
    def hypoid_meshes_power_flow(self: "Self") -> "List[_4201.HypoidGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.HypoidGearMeshPowerFlow]
