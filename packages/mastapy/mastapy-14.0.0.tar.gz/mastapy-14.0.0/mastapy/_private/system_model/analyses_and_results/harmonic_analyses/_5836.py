...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ComponentHarmonicAnalysis(_5921.PartHarmonicAnalysis):
    """ComponentHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self: "Self") -> "_4709.ComponentModalAnalysis":
    ...
    @property
    def results(self: "Self") -> "_5998.HarmonicAnalysisResultsPropertyAccessor":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2799.ComponentSystemDeflection":
