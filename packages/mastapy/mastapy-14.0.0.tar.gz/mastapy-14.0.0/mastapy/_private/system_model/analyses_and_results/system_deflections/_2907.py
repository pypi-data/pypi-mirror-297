...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2908
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SynchroniserHalfSystemDeflection(_2908.SynchroniserPartSystemDeflection):
    """SynchroniserHalfSystemDeflection
    ...
    @property
    def clutch_connection(self: "Self") -> "_2795.ClutchConnectionSystemDeflection":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4256.SynchroniserHalfPowerFlow":
