...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DatumCompoundPowerFlow(_4298.ComponentCompoundPowerFlow):
    """DatumCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4188.DatumPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4188.DatumPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.DatumPowerFlow]
