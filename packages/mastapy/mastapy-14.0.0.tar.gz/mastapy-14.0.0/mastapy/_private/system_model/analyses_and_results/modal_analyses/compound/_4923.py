...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PartCompoundModalAnalysis(_7715.PartCompoundAnalysis):
    """PartCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4776.PartModalAnalysis]":
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4776.PartModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.PartModalAnalysis]
