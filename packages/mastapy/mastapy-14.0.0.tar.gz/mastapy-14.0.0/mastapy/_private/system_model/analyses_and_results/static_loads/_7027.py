...
from mastapy._private.system_model.analyses_and_results.static_loads import _7028
...
class _Cast_ElectricMachineHarmonicLoadFluxImportOptions:
    ...
    def electric_machine_harmonic_load_import_options_base(
        self: "CastSelf",
    ) -> "_7028.ElectricMachineHarmonicLoadImportOptionsBase":
        return self.__parent__._cast(_7028.ElectricMachineHarmonicLoadImportOptionsBase)
