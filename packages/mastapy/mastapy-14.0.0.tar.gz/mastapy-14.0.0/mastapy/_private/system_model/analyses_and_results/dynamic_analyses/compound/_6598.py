...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearSetCompoundDynamicAnalysis(_6609.GearSetCompoundDynamicAnalysis):
    """CylindricalGearSetCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6465.CylindricalGearSetDynamicAnalysis]":
    ...
    def cylindrical_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6596.CylindricalGearCompoundDynamicAnalysis]":
    ...
    def cylindrical_meshes_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6597.CylindricalGearMeshCompoundDynamicAnalysis]":
