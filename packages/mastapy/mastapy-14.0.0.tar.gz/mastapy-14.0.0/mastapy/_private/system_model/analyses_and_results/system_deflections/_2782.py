...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2494, _2496
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BearingSystemDeflection(_2812.ConnectorSystemDeflection):
    """BearingSystemDeflection
    ...
    @property
    def component_load_case(self: "Self") -> "_6967.BearingLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4144.BearingPowerFlow":
    ...
    def race_mounting_options_for_analysis(
        self: "Self",
    ) -> "List[_2496.BearingRaceMountingOptions]":
