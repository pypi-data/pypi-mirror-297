...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BearingLoadCase(_6998.ConnectorLoadCase):
    """BearingLoadCase
    ...
    def bearing_element_orbit_model(
        self: "Self",
        value: "Union[_5509.BearingElementOrbitModel, Tuple[_5509.BearingElementOrbitModel, bool]]",
    ) -> None:
    ...
    @property
    def bearing_stiffness_model(self: "Self") -> "_5511.BearingStiffnessModel":
    ...
    def force_at_zero_displacement_input_method(
        self: "Self",
        value: "Union[_2495.BearingF0InputMethod, Tuple[_2495.BearingF0InputMethod, bool]]",
    ) -> None:
