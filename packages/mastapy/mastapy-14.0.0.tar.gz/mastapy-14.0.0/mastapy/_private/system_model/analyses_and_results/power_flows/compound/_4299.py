...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptCouplingCompoundPowerFlow(_4310.CouplingCompoundPowerFlow):
    """ConceptCouplingCompoundPowerFlow
    ...
    @property
    def component_design(self: "Self") -> "_2639.ConceptCoupling":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4164.ConceptCouplingPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4164.ConceptCouplingPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptCouplingPowerFlow]
