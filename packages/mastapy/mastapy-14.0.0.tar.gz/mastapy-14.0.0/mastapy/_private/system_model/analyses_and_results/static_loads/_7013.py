...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearSetLoadCase(_7043.GearSetLoadCase):
    """CylindricalGearSetLoadCase
    ...
    @property
    def reset_micro_geometry(self: "Self") -> "_7091.ResetMicroGeometryOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7091",
    ...
    def reset_micro_geometry(
        self: "Self", value: "_7091.ResetMicroGeometryOptions"
    ) -> None:
    ...
    @property
    def gears_load_case(self: "Self") -> "List[_7009.CylindricalGearLoadCase]":
    ...
    def cylindrical_gears_load_case(
        self: "Self",
    ) -> "List[_7009.CylindricalGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.CylindricalGearLoadCase]
    ...
    @property
    def meshes_load_case(self: "Self") -> "List[_7011.CylindricalGearMeshLoadCase]":
    ...
    def cylindrical_meshes_load_case(
        self: "Self",
    ) -> "List[_7011.CylindricalGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.CylindricalGearMeshLoadCase]
