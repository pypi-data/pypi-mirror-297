...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetHarmonicAnalysis(_5889.GearSetHarmonicAnalysis):
    """WormGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self: "Self") -> "List[_5971.WormGearHarmonicAnalysis]":
    ...
    def worm_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_5971.WormGearHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.WormGearHarmonicAnalysis]
    ...
    def meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_5972.WormGearMeshHarmonicAnalysis]":
