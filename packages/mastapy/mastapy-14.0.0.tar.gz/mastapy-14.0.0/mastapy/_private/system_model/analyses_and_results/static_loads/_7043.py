...
from mastapy._private.system_model.analyses_and_results.static_loads import _7071, _7102
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearSetLoadCase(_7102.SpecialisedAssemblyLoadCase):
    """GearSetLoadCase
    ...
    @property
    def gear_mesh_stiffness_model(self: "Self") -> "_5563.GearMeshStiffnessModel":
    ...
    def mesh_stiffness_source(
        self: "Self",
        value: "Union[_7071.MeshStiffnessSource, Tuple[_7071.MeshStiffnessSource, bool]]",
    ) -> None:
    ...
    def advanced_time_stepping_analysis_for_modulation_options(
        self: "Self",
    ) -> "_7162.AdvancedTimeSteppingAnalysisForModulationOptions":
    ...
    @property
    def gears_load_case(self: "Self") -> "List[_7038.GearLoadCase]":
    ...
    @property
    def gears_without_clones(self: "Self") -> "List[_7038.GearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.GearLoadCase]
    ...
    @property
    def meshes_load_case(self: "Self") -> "List[_7040.GearMeshLoadCase]":
