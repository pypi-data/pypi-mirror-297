...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PartSystemDeflection(_7716.PartFEAnalysis):
    """PartSystemDeflection
    ...
    @property
    def system_deflection(self: "Self") -> "_2911.SystemDeflection":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4220.PartPowerFlow":
    ...
    def create_viewable(self: "Self") -> "_2314.SystemDeflectionViewable":
