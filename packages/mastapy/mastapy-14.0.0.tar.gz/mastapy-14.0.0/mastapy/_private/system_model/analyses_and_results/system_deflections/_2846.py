...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GuideDxfModelSystemDeflection(_2799.ComponentSystemDeflection):
    """GuideDxfModelSystemDeflection
    ...
    @property
    def component_design(self: "Self") -> "_2510.GuideDxfModel":
    ...
    @property
    def component_load_case(self: "Self") -> "_7044.GuideDxfModelLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4200.GuideDxfModelPowerFlow":
