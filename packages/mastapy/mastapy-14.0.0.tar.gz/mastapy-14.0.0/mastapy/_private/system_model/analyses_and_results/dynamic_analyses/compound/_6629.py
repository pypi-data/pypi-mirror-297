...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OilSealCompoundDynamicAnalysis(_6585.ConnectorCompoundDynamicAnalysis):
    """OilSealCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6498.OilSealDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_6498.OilSealDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.OilSealDynamicAnalysis]
