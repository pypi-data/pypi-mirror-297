...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetModalAnalysis(_4749.GearSetModalAnalysis):
    """WormGearSetModalAnalysis
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7134.WormGearSetLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2923.WormGearSetSystemDeflection":
    ...
    @property
    def gears_modal_analysis(self: "Self") -> "List[_4825.WormGearModalAnalysis]":
    ...
    @property
    def worm_gears_modal_analysis(self: "Self") -> "List[_4825.WormGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.WormGearModalAnalysis]
    ...
    @property
    def meshes_modal_analysis(self: "Self") -> "List[_4824.WormGearMeshModalAnalysis]":
    ...
    def worm_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4824.WormGearMeshModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.WormGearMeshModalAnalysis]
