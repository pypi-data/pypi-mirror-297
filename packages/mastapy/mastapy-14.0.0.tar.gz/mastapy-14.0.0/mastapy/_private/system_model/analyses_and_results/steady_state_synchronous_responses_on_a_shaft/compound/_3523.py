...
class FaceGearMeshCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    @property
    def component_design(self: "Self") -> "_2365.FaceGearMesh":
    ...
    @property
    def connection_design(self: "Self") -> "_2365.FaceGearMesh":
        """mastapy.system_model.connections_and_sockets.gears.FaceGearMesh
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3390.FaceGearMeshSteadyStateSynchronousResponseOnAShaft]":
