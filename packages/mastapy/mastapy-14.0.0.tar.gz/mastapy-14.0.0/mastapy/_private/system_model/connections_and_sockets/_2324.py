...
class _Cast_ComponentConnection:
    ...
    @property
    def component_measurer(self: "CastSelf") -> "_2325.ComponentMeasurer":
        return self.__parent__._cast(_2325.ComponentMeasurer)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ComponentConnection(_2325.ComponentMeasurer):
    """ComponentConnection
    ...
    @property
    def connected_component(self: "Self") -> "_2499.Component":
