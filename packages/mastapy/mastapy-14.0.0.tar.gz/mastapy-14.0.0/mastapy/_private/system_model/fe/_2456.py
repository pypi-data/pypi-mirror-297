...
class _Cast_NodeGroupWithSelection:
    ...
    def fe_entity_group_with_selection(
        self: "CastSelf",
    ) -> "_2432.FEEntityGroupWithSelection":
        return self.__parent__._cast(_2432.FEEntityGroupWithSelection)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class NodeGroupWithSelection(_2432.FEEntityGroupWithSelection[_240.CMSNodeGroup, int]):
    """NodeGroupWithSelection
