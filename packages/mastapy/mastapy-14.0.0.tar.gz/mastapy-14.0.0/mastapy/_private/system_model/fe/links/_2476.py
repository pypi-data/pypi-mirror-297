...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe.links import _2473, _2480
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearMeshFELink(_2478.MultiAngleConnectionFELink):
    """GearMeshFELink
    ...
    def reference_fe_substructure_node_for_misalignments(
        self: "Self", value: "_2440.FESubstructureNode"
    ) -> None:
