...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2414, _2455
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FESubstructureWithSelectionForStaticAnalysis(_2445.FESubstructureWithSelection):
    """FESubstructureWithSelectionForStaticAnalysis
    ...
    @enforce_parameter_types
    def contour_option(self: "Self", value: "_1874.ThreeDViewContourOption") -> None:
    ...
    def boundary_conditions_all_nodes(
        self: "Self",
    ) -> "List[_2455.NodeBoundaryConditionStaticAnalysis]":
