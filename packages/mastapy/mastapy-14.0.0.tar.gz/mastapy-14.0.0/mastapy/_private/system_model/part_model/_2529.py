...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PowerLoad(_2536.VirtualComponent):
    """PowerLoad
    ...
    def electric_machine_search_region_specification_method(
        self: "Self",
    ) -> "_2504.ElectricMachineSearchRegionSpecificationMethod":
    ...
    @enforce_parameter_types
    def electric_machine_search_region_specification_method(
        self: "Self", value: "_2504.ElectricMachineSearchRegionSpecificationMethod"
    ) -> None:
    ...
    @property
    def engine_fuel_consumption_grid(self: "Self") -> "_1613.GriddedSurfaceAccessor":
    ...
    @property
    def engine_torque_grid(self: "Self") -> "_1613.GriddedSurfaceAccessor":
        """mastapy.math_utility.measured_data.GriddedSurfaceAccessor"""
    ...
    @enforce_parameter_types
    def engine_torque_grid(self: "Self", value: "_1613.GriddedSurfaceAccessor") -> None:
    ...
    @enforce_parameter_types
    def power_load_type(self: "Self", value: "_2273.PowerLoadType") -> None:
    ...
    @property
    def single_blade_details(self: "Self") -> "_2538.WindTurbineSingleBladeDetails":
