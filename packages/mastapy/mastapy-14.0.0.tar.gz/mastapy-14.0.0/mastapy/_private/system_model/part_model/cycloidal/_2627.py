...
if TYPE_CHECKING:
    ...
    from mastapy._private.cycloidal import _1510, _1511
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RingPins(_2521.MountableComponent):
    """RingPins
    ...
    @property
    def ring_pins_design(self: "Self") -> "_1510.RingPinsDesign":
    ...
    @property
    def ring_pins_material(self: "Self") -> "_1511.RingPinsMaterial":
