...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class Coupling(_2533.SpecialisedAssembly):
    """Coupling
    ...
    @property
    def halves(self: "Self") -> "List[_2643.CouplingHalf]":
    ...
    @property
    def half_a(self: "Self") -> "_2643.CouplingHalf":
    ...
    @property
    def half_b(self: "Self") -> "_2643.CouplingHalf":
        """mastapy.system_model.part_model.couplings.CouplingHalf
