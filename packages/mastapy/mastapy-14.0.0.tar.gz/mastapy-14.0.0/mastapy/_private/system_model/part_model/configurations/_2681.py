...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2567, _2568
...
TPart = TypeVar("TPart", bound="_2525.Part")
...
class _Cast_PartDetailSelection:
    ...
    def active_cylindrical_gear_set_design_selection(
        self: "CastSelf",
    ) -> "_2567.ActiveCylindricalGearSetDesignSelection":
        from mastapy._private.system_model.part_model.gears import _2567

        return self.__parent__._cast(_2567.ActiveCylindricalGearSetDesignSelection)

    @property
    def active_gear_set_design_selection(
        self: "CastSelf",
    ) -> "_2568.ActiveGearSetDesignSelection":
        from mastapy._private.system_model.part_model.gears import _2568

        return self.__parent__._cast(_2568.ActiveGearSetDesignSelection)

    @property
    def active_fe_substructure_selection(
        self: "CastSelf",
    ) -> "_2674.ActiveFESubstructureSelection":
        from mastapy._private.system_model.part_model.configurations import _2674

        return self.__parent__._cast(_2674.ActiveFESubstructureSelection)

    @property
    def active_shaft_design_selection(
        self: "CastSelf",
    ) -> "_2676.ActiveShaftDesignSelection":
        from mastapy._private.system_model.part_model.configurations import _2676

        return self.__parent__._cast(_2676.ActiveShaftDesignSelection)

    @property
    def bearing_detail_selection(self: "CastSelf") -> "_2679.BearingDetailSelection":
        from mastapy._private.system_model.part_model.configurations import _2679

        return self.__parent__._cast(_2679.BearingDetailSelection)
