...
class _Cast_PartDetailConfiguration:
    ...
    def active_gear_set_design_selection_group(
        ...
        return self.__parent__._cast(_2569.ActiveGearSetDesignSelectionGroup)

    @property
    def active_fe_substructure_selection_group(
        self: "CastSelf",
    ) -> "_2675.ActiveFESubstructureSelectionGroup":
        from mastapy._private.system_model.part_model.configurations import _2675

        return self.__parent__._cast(_2675.ActiveFESubstructureSelectionGroup)

    @property
    def active_shaft_design_selection_group(
        self: "CastSelf",
    ) -> "_2677.ActiveShaftDesignSelectionGroup":
        from mastapy._private.system_model.part_model.configurations import _2677

        return self.__parent__._cast(_2677.ActiveShaftDesignSelectionGroup)

    @property
    def bearing_detail_configuration(
        self: "CastSelf",
    ) -> "_2678.BearingDetailConfiguration":
        from mastapy._private.system_model.part_model.configurations import _2678

        return self.__parent__._cast(_2678.BearingDetailConfiguration)
