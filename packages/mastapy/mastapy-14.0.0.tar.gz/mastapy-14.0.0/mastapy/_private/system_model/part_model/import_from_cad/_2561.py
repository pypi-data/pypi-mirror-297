...
class _Cast_MountableComponentFromCAD:
    ...
    @property
    def component_from_cad(self: "CastSelf") -> "_2552.ComponentFromCAD":
        return self.__parent__._cast(_2552.ComponentFromCAD)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MountableComponentFromCAD(_2552.ComponentFromCAD):
    """MountableComponentFromCAD
