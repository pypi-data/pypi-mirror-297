...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.couplings import _2635, _2645, _2650
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BeltDrive(_2533.SpecialisedAssembly):
    """BeltDrive
    ...
    @property
    def type_of_belt(self: "Self") -> "_2635.BeltDriveType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model.couplings._2635", "BeltDriveType"
        )(value)

    @type_of_belt.setter
    @enforce_parameter_types
    def type_of_belt(self: "Self", value: "_2635.BeltDriveType") -> None:
    ...
    @property
    def belt_connections(self: "Self") -> "List[_2322.BeltConnection]":
    ...
    @property
    def pulleys(self: "Self") -> "List[_2650.Pulley]":
