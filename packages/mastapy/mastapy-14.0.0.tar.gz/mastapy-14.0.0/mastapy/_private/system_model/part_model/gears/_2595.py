...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2580, _2587
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class KlingelnbergCycloPalloidHypoidGear(_2593.KlingelnbergCycloPalloidConicalGear):
    """KlingelnbergCycloPalloidHypoidGear
