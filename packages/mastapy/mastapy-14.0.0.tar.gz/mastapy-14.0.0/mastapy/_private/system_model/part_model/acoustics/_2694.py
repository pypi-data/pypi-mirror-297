...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2691, _2692, _2693
...
class _Cast_MeshedResultSurfaceBase:
    ...
    @property
    def meshed_result_surface(self: "CastSelf") -> "_2693.MeshedResultSurface":
        from mastapy._private.system_model.part_model.acoustics import _2693

        return self.__parent__._cast(_2693.MeshedResultSurface)
