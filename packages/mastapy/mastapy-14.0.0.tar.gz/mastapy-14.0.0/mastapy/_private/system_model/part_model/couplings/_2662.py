...
class SplinePitchErrorOptions(_0.APIBase):
    ...
    def pitch_error_input_type(
        self: "Self",
        value: "Union[_2661.SplinePitchErrorInputType, Tuple[_2661.SplinePitchErrorInputType, bool]]",
    ) -> None:
    ...
    @property
    def pitch_error_options_left_flank(self: "Self") -> "_2649.PitchErrorFlankOptions":
    ...
    @property
    def pitch_error_options_right_flank(self: "Self") -> "_2649.PitchErrorFlankOptions":
        """mastapy.system_model.part_model.couplings.PitchErrorFlankOptions
    ...
    @property
    def pitch_error_flank_options(self: "Self") -> "List[_2649.PitchErrorFlankOptions]":
