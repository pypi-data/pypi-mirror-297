...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2583, _2589
...
class SystemOptimiser(_0.APIBase):
    ...
    def selected_duty_cycle_for_system_optimiser(
        self: "Self", value: "_5795.DutyCycle"
    ) -> None:
        wrapper_type = (
    ...
    @property
    def design(self: "Self") -> "_2254.Design":
    ...
    @property
    def details(self: "Self") -> "_2294.SystemOptimiserDetails":
    ...
    @property
    def tooth_number_finder(self: "Self") -> "_2295.ToothNumberFinder":
    ...
    def system_optimisation_gear_sets(
        self: "Self",
    ) -> "List[_5799.SystemOptimisationGearSet]":
    ...
    @property
    def target_ratios(self: "Self") -> "List[_2291.DesignStateTargetRatio]":
    ...
    @property
    def system_optimiser_duty_cycle(self: "Self") -> "_5795.DutyCycle":
    ...
    @enforce_parameter_types
    def system_optimiser_duty_cycle(self: "Self", value: "_5795.DutyCycle") -> None:
