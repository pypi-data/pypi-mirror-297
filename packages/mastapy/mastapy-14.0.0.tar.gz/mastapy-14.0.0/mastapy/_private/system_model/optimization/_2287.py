...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.optimization import _2281, _2284, _2286
...
class _Cast_OptimizationStep:
    ...
    def conical_gear_optimization_step(
        self: "CastSelf",
    ) -> "_2281.ConicalGearOptimizationStep":
        from mastapy._private.system_model.optimization import _2281

        return self.__parent__._cast(_2281.ConicalGearOptimizationStep)

    @property
    def cylindrical_gear_optimization_step(
        self: "CastSelf",
    ) -> "_2284.CylindricalGearOptimizationStep":
        from mastapy._private.system_model.optimization import _2284

        return self.__parent__._cast(_2284.CylindricalGearOptimizationStep)
...
class OptimizationStep(_0.APIBase):
    ...
    @property
    def optimisation_target(self: "Self") -> "_2286.MicroGeometryOptimisationTarget":
    ...
    def optimisation_target(
        self: "Self", value: "_2286.MicroGeometryOptimisationTarget"
    ) -> None:
