...
class _Cast_CylindricalGearOptimizationStep:
    ...
    @property
    def optimization_step(self: "CastSelf") -> "_2287.OptimizationStep":
        return self.__parent__._cast(_2287.OptimizationStep)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearOptimizationStep(_2287.OptimizationStep):
    """CylindricalGearOptimizationStep
