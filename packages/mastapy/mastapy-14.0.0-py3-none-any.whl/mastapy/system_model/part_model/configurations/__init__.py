...
if __tc:
    from mastapy._private.system_model.part_model.configurations._2674 import (
        ActiveFESubstructureSelection,
    )
    from mastapy._private.system_model.part_model.configurations._2675 import (
        ActiveFESubstructureSelectionGroup,
    )
    from mastapy._private.system_model.part_model.configurations._2676 import (
        ActiveShaftDesignSelection,
    )
    from mastapy._private.system_model.part_model.configurations._2677 import (
    ...
    __import_structure = {
        "_private.system_model.part_model.configurations._2674": [
            "ActiveFESubstructureSelection"
        ],
        "_private.system_model.part_model.configurations._2675": [
            "ActiveFESubstructureSelectionGroup"
        ],
        "_private.system_model.part_model.configurations._2676": [
            "ActiveShaftDesignSelection"
        ],
        "_private.system_model.part_model.configurations._2677": [
            "ActiveShaftDesignSelectionGroup"
        ],
