...
if TYPE_CHECKING:
    ...
    from mastapy._private.bolts import _1514, _1516, _1518
    from mastapy._private.cycloidal import _1504, _1511
    from mastapy._private.detailed_rigid_connectors.splines import _1464
    from mastapy._private.electric_machines import _1330, _1348, _1361
    ...
    from mastapy._private.system_model.optimization import _2280, _2283, _2288, _2289
...
class _Cast_NamedDatabaseItem:
    ...
    @property
    def winding_material(self: "CastSelf") -> "_1361.WindingMaterial":
        from mastapy._private.electric_machines import _1361

        return self.__parent__._cast(_1361.WindingMaterial)

    @property
    def spline_material(self: "CastSelf") -> "_1464.SplineMaterial":
        from mastapy._private.detailed_rigid_connectors.splines import _1464

        return self.__parent__._cast(_1464.SplineMaterial)

    @property
    def cycloidal_disc_material(self: "CastSelf") -> "_1504.CycloidalDiscMaterial":
        from mastapy._private.cycloidal import _1504

        return self.__parent__._cast(_1504.CycloidalDiscMaterial)

    @property
    def ring_pins_material(self: "CastSelf") -> "_1511.RingPinsMaterial":
        from mastapy._private.cycloidal import _1511

        return self.__parent__._cast(_1511.RingPinsMaterial)

    @property
    def bolted_joint_material(self: "CastSelf") -> "_1514.BoltedJointMaterial":
        from mastapy._private.bolts import _1514

        return self.__parent__._cast(_1514.BoltedJointMaterial)

    @property
    def bolt_geometry(self: "CastSelf") -> "_1516.BoltGeometry":
        from mastapy._private.bolts import _1516

        return self.__parent__._cast(_1516.BoltGeometry)

    @property
    def bolt_material(self: "CastSelf") -> "_1518.BoltMaterial":
        from mastapy._private.bolts import _1518

        return self.__parent__._cast(_1518.BoltMaterial)

    @property
    def pareto_optimisation_strategy(
        self: "CastSelf",
    ) -> "_1597.ParetoOptimisationStrategy":
        from mastapy._private.math_utility.optimisation import _1597

        return self.__parent__._cast(_1597.ParetoOptimisationStrategy)

    @property
    def bearing_settings_item(self: "CastSelf") -> "_1934.BearingSettingsItem":
        from mastapy._private.bearings import _1934

        return self.__parent__._cast(_1934.BearingSettingsItem)

    @property
    def iso14179_settings(self: "CastSelf") -> "_2028.ISO14179Settings":
        from mastapy._private.bearings.bearing_results.rolling import _2028

        return self.__parent__._cast(_2028.ISO14179Settings)

    @property
    def conical_gear_optimisation_strategy(
        self: "CastSelf",
    ) -> "_2280.ConicalGearOptimisationStrategy":
        from mastapy._private.system_model.optimization import _2280

        return self.__parent__._cast(_2280.ConicalGearOptimisationStrategy)

    @property
    def cylindrical_gear_optimisation_strategy(
        self: "CastSelf",
    ) -> "_2283.CylindricalGearOptimisationStrategy":
        from mastapy._private.system_model.optimization import _2283

        return self.__parent__._cast(_2283.CylindricalGearOptimisationStrategy)

    @property
    def optimization_strategy(self: "CastSelf") -> "_2288.OptimizationStrategy":
        from mastapy._private.system_model.optimization import _2288

        return self.__parent__._cast(_2288.OptimizationStrategy)

    @property
    def optimization_strategy_base(
        self: "CastSelf",
    ) -> "_2289.OptimizationStrategyBase":
        from mastapy._private.system_model.optimization import _2289

        return self.__parent__._cast(_2289.OptimizationStrategyBase)

    @property
    def supercharger_rotor_set(self: "CastSelf") -> "_2620.SuperchargerRotorSet":
        from mastapy._private.system_model.part_model.gears.supercharger_rotor_set import (
            _2620,
        )

        return self.__parent__._cast(_2620.SuperchargerRotorSet)
...
class NamedDatabaseItem(_0.APIBase):
    ...
    @property
    def database_key(self: "Self") -> "_1883.NamedKey":
    ...
    @database_key.setter
    @enforce_parameter_types
    def database_key(self: "Self", value: "_1883.NamedKey") -> None:
