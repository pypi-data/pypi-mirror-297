...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility import _1541, _1559
    from mastapy._private.nodal_analysis.geometry_modeller_link import _163, _170, _171
    from mastapy._private.system_model import _2254, _2257
    from mastapy._private.utility.operation_modes import _1841
...
class MASTAGUI(_0.APIBase):
    ...
    @property
    def active_design(self: "Self") -> "_2254.Design":
    ...
    @enforce_parameter_types
    def active_design(self: "Self", value: "_2254.Design") -> None:
    ...
    @property
    def open_designs(self: "Self") -> "List[_2254.Design]":
    ...
    @property
    def operation_mode(self: "Self") -> "_1841.OperationMode":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.operation_modes._1841", "OperationMode"
        )(value)

    @operation_mode.setter
    @enforce_parameter_types
    def operation_mode(self: "Self", value: "_1841.OperationMode") -> None:
    ...
    @property
    def selected_design_entity(self: "Self") -> "_2257.DesignEntity":
    ...
    @enforce_parameter_types
    def selected_design_entity(self: "Self", value: "_2257.DesignEntity") -> None:
    ...
    def add_fe_substructure_from_data(
        self: "Self",
        vertices_and_facets: "_1559.FacetedBody",
        geometry_modeller_design_information: "_163.GeometryModellerDesignInformation",
        dimensions: "Dict[str, _164.GeometryModellerDimension]",
        body_moniker: "str",
    ) -> None:
    ...
    def add_line_from_geometry_modeller(
        self: "Self", circles_on_axis: "_1541.CirclesOnAxis"
    ) -> None:
        """Method does not return.
    ...
    def circle_pairs_from_geometry_modeller(
        self: "Self",
        preselection_circles: "_1541.CirclesOnAxis",
        selected_circles: "List[_1541.CirclesOnAxis]",
    ) -> None:
        """Method does not return.
    ...
    def create_new_circles_on_axis(self: "Self") -> "_1541.CirclesOnAxis":
    ...
    def create_new_faceted_body(self: "Self") -> "_1559.FacetedBody":
    ...
    @enforce_parameter_types
    def open_design_in_new_tab(self: "Self", design: "_2254.Design") -> None:
        """Method does not return.
