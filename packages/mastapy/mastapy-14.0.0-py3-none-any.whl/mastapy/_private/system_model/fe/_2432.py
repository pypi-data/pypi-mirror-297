...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2430, _2456
...
class _Cast_FEEntityGroupWithSelection:
    ...
    def element_face_group_with_selection(
        self: "CastSelf",
    ) -> "_2430.ElementFaceGroupWithSelection":
        from mastapy._private.system_model.fe import _2430

        return self.__parent__._cast(_2430.ElementFaceGroupWithSelection)

    @property
    def node_group_with_selection(self: "CastSelf") -> "_2456.NodeGroupWithSelection":
        from mastapy._private.system_model.fe import _2456

        return self.__parent__._cast(_2456.NodeGroupWithSelection)
