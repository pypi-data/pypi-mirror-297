...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltCompoundStabilityAnalysis(_4024.ComponentCompoundStabilityAnalysis):
    """BoltCompoundStabilityAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3883.BoltStabilityAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_3883.BoltStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.BoltStabilityAnalysis]
