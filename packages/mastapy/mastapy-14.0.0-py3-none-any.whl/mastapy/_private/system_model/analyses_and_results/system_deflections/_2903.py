...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelGearSetSystemDeflection(_2791.BevelGearSetSystemDeflection):
    """StraightBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4253.StraightBevelGearSetPowerFlow":
    ...
    def bevel_gears_system_deflection(
        self: "Self",
    ) -> "List[_2904.StraightBevelGearSystemDeflection]":
    ...
    def bevel_meshes_system_deflection(
        self: "Self",
    ) -> "List[_2902.StraightBevelGearMeshSystemDeflection]":
