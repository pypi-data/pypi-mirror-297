...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearSetSystemDeflection(_2774.AGMAGleasonConicalGearSetSystemDeflection):
    """HypoidGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4203.HypoidGearSetPowerFlow":
    ...
    def agma_gleason_conical_gears_system_deflection(
        self: "Self",
    ) -> "List[_2849.HypoidGearSystemDeflection]":
    ...
    def agma_gleason_conical_meshes_system_deflection(
        self: "Self",
    ) -> "List[_2847.HypoidGearMeshSystemDeflection]":
