...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SynchroniserSystemDeflection(_2892.SpecialisedAssemblySystemDeflection):
    """SynchroniserSystemDeflection
    ...
    @property
    def assembly_design(self: "Self") -> "_2665.Synchroniser":
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7118.SynchroniserLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4258.SynchroniserPowerFlow":
    ...
    @property
    def cones(self: "Self") -> "List[_2907.SynchroniserHalfSystemDeflection]":
