...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PlanetCarrierSystemDeflection(_2868.MountableComponentSystemDeflection):
    """PlanetCarrierSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4226.PlanetCarrierPowerFlow":
    ...
    @property
    def windup(self: "Self") -> "List[_2932.PlanetCarrierWindup]":
