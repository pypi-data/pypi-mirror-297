...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FlexiblePinAssemblySystemDeflection(_2892.SpecialisedAssemblySystemDeflection):
    """FlexiblePinAssemblySystemDeflection
    ...
    @property
    def assembly_design(self: "Self") -> "_2509.FlexiblePinAssembly":
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7036.FlexiblePinAssemblyLoadCase":
    ...
    @property
    def flexible_pin_shaft_details(self: "Self") -> "_2890.ShaftSystemDeflection":
    ...
    @property
    def pin_analysis(self: "Self") -> "_2890.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4196.FlexiblePinAssemblyPowerFlow":
    ...
    @property
    def spindle_analyses(self: "Self") -> "_2890.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection
    ...
    @property
    def bearing_static_analyses(self: "Self") -> "List[_2782.BearingSystemDeflection]":
    ...
    def load_sharing_factor_reporters(
        self: "Self",
    ) -> "List[_2862.LoadSharingFactorReporter]":
    ...
    def observed_pin_stiffness_reporters(
        self: "Self",
    ) -> "List[_2869.ObservedPinStiffnessReporter]":
    ...
    def planet_gear_system_deflections(
        self: "Self",
    ) -> "List[_2829.CylindricalGearSystemDeflection]":
