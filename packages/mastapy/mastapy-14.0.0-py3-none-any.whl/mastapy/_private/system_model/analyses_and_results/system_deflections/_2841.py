...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FEPartSystemDeflection(_2770.AbstractShaftOrHousingSystemDeflection):
    """FEPartSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4195.FEPartPowerFlow":
    ...
    @property
    def export(self: "Self") -> "_2465.SystemDeflectionFEExportOptions":
