...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2901
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelSunGearSystemDeflection(_2901.StraightBevelDiffGearSystemDeflection):
    """StraightBevelSunGearSystemDeflection
    ...
    @property
    def component_design(self: "Self") -> "_2607.StraightBevelSunGear":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4255.StraightBevelSunGearPowerFlow":
