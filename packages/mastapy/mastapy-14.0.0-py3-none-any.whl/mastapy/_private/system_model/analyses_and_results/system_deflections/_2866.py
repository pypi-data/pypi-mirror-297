...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MicrophoneArraySystemDeflection(_2892.SpecialisedAssemblySystemDeflection):
    """MicrophoneArraySystemDeflection
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7072.MicrophoneArrayLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4216.MicrophoneArrayPowerFlow":
