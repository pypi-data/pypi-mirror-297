...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ClutchConnectionSystemDeflection(_2813.CouplingConnectionSystemDeflection):
    """ClutchConnectionSystemDeflection
    ...
    @property
    def connection_load_case(self: "Self") -> "_6980.ClutchConnectionLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4157.ClutchConnectionPowerFlow":
