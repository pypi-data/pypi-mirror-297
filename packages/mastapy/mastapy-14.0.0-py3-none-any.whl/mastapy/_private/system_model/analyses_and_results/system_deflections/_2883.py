...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RollingRingAssemblySystemDeflection(_2892.SpecialisedAssemblySystemDeflection):
    """RollingRingAssemblySystemDeflection
    ...
    @property
    def assembly_design(self: "Self") -> "_2657.RollingRingAssembly":
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7095.RollingRingAssemblyLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4234.RollingRingAssemblyPowerFlow":
