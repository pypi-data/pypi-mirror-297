...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelGearSystemDeflection(_2792.BevelGearSystemDeflection):
    """StraightBevelGearSystemDeflection
    ...
    @property
    def component_load_case(self: "Self") -> "_7112.StraightBevelGearLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4252.StraightBevelGearPowerFlow":
