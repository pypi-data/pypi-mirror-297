...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RootAssemblyCompoundSystemDeflection(_2944.AssemblyCompoundSystemDeflection):
    """RootAssemblyCompoundSystemDeflection
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2886.RootAssemblySystemDeflection]":
    ...
    @property
    def bearing_race_f_es(self: "Self") -> "List[_2462.RaceBearingFESystemDeflection]":
