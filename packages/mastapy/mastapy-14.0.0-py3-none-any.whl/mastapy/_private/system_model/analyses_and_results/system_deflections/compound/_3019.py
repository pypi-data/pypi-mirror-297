...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PartCompoundSystemDeflection(_7715.PartCompoundAnalysis):
    """PartCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_2871.PartSystemDeflection]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2871.PartSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.PartSystemDeflection]
