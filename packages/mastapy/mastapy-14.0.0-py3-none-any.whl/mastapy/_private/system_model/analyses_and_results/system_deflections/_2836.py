...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ExternalCADModelSystemDeflection(_2799.ComponentSystemDeflection):
    """ExternalCADModelSystemDeflection
    ...
    @property
    def component_design(self: "Self") -> "_2507.ExternalCADModel":
    ...
    @property
    def component_load_case(self: "Self") -> "_7031.ExternalCADModelLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4189.ExternalCADModelPowerFlow":
