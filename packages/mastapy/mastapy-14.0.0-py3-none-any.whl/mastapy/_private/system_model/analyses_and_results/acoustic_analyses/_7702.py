...
from mastapy._private.system_model.analyses_and_results.acoustic_analyses import _7701
...
class _Cast_SingleHarmonicExcitationAnalysisDetail:
    ...
    @property
    def single_excitation_details(self: "CastSelf") -> "_7701.SingleExcitationDetails":
        return self.__parent__._cast(_7701.SingleExcitationDetails)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SingleHarmonicExcitationAnalysisDetail(_7701.SingleExcitationDetails):
    """SingleHarmonicExcitationAnalysisDetail
