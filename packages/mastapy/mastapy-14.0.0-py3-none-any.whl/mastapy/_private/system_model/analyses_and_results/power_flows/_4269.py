...
class WormGearSetPowerFlow(_4199.GearSetPowerFlow):
    ...
    @property
    def gears_power_flow(self: "Self") -> "List[_4268.WormGearPowerFlow]":
    ...
    @property
    def worm_gears_power_flow(self: "Self") -> "List[_4268.WormGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: "Self") -> "List[_4267.WormGearMeshPowerFlow]":
    ...
    @property
    def worm_meshes_power_flow(self: "Self") -> "List[_4267.WormGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearMeshPowerFlow]
