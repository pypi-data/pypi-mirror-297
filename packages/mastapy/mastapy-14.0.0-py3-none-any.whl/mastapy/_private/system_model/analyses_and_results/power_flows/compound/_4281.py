...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BearingCompoundPowerFlow(_4309.ConnectorCompoundPowerFlow):
    """BearingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4144.BearingPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4144.BearingPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BearingPowerFlow]
