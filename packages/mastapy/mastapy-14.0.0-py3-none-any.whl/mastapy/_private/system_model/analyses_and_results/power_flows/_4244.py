...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearSetPowerFlow(_4154.BevelGearSetPowerFlow):
    """SpiralBevelGearSetPowerFlow
    ...
    @property
    def bevel_gears_power_flow(self: "Self") -> "List[_4243.SpiralBevelGearPowerFlow]":
    ...
    def spiral_bevel_gears_power_flow(
        self: "Self",
    ) -> "List[_4243.SpiralBevelGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SpiralBevelGearPowerFlow]
    ...
    def bevel_meshes_power_flow(
        self: "Self",
    ) -> "List[_4242.SpiralBevelGearMeshPowerFlow]":
