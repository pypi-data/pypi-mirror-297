...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OilSealCompoundPowerFlow(_4309.ConnectorCompoundPowerFlow):
    """OilSealCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4219.OilSealPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4219.OilSealPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.OilSealPowerFlow]
