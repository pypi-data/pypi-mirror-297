...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RingPinsCompoundPowerFlow(_4352.MountableComponentCompoundPowerFlow):
    """RingPinsCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4232.RingPinsPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4232.RingPinsPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.RingPinsPowerFlow]
