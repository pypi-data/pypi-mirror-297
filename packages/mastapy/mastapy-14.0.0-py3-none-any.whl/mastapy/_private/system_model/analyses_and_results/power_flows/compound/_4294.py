...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ClutchCompoundPowerFlow(_4310.CouplingCompoundPowerFlow):
    """ClutchCompoundPowerFlow
    ...
    @property
    def component_design(self: "Self") -> "_2636.Clutch":
    ...
    @property
    def assembly_analysis_cases_ready(self: "Self") -> "List[_4159.ClutchPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4159.ClutchPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ClutchPowerFlow]
