...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConnectorCompoundPowerFlow(_4352.MountableComponentCompoundPowerFlow):
    """ConnectorCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4172.ConnectorPowerFlow]":
