...
class FEPartHarmonicAnalysis(
    _5812.AbstractShaftOrHousingHarmonicAnalysis,
    _2738.IHaveFEPartHarmonicAnalysisResults,
):
    """FEPartHarmonicAnalysis
    ...
    @property
    def component_design(self: "Self") -> "_2508.FEPart":
    ...
    @property
    def component_load_case(self: "Self") -> "_7035.FEPartLoadCase":
    ...
    @property
    def coupled_modal_analysis(self: "Self") -> "_4744.FEPartModalAnalysis":
    ...
    @property
    def export(self: "Self") -> "_5895.HarmonicAnalysisFEExportOptions":
    ...
    @property
    def results(self: "Self") -> "_5990.FEPartHarmonicAnalysisResultsPropertyAccessor":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2841.FEPartSystemDeflection":
