...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _5919
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RingPinsHarmonicAnalysis(_5919.MountableComponentHarmonicAnalysis):
    """RingPinsHarmonicAnalysis
    ...
    @property
    def component_design(self: "Self") -> "_2627.RingPins":
    ...
    @property
    def component_load_case(self: "Self") -> "_7093.RingPinsLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2880.RingPinsSystemDeflection":
