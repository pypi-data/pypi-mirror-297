...
class RootAssemblyHarmonicAnalysis(
    _5817.AssemblyHarmonicAnalysis, _2739.IHaveRootHarmonicAnalysisResults
):
    """RootAssemblyHarmonicAnalysis
    ...
    @property
    def export(self: "Self") -> "_5898.HarmonicAnalysisRootAssemblyExportOptions":
    ...
    @property
    def harmonic_analysis_inputs(self: "Self") -> "_5892.HarmonicAnalysis":
    ...
    def results(
        self: "Self",
    ) -> "_6009.RootAssemblyHarmonicAnalysisResultsPropertyAccessor":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2886.RootAssemblySystemDeflection":
