...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltedJointHarmonicAnalysis(_5943.SpecialisedAssemblyHarmonicAnalysis):
    """BoltedJointHarmonicAnalysis
    ...
    @property
    def assembly_load_case(self: "Self") -> "_6978.BoltedJointLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2793.BoltedJointSystemDeflection":
