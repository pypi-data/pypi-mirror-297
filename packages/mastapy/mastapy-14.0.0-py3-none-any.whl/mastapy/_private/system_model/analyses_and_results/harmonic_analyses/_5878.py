...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearHarmonicAnalysis(_5884.GearHarmonicAnalysis):
    """FaceGearHarmonicAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_7032.FaceGearLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2840.FaceGearSystemDeflection":
