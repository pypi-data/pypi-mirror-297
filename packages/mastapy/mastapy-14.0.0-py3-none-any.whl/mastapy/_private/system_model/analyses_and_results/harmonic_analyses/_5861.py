...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _5858
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalPlanetGearHarmonicAnalysis(_5858.CylindricalGearHarmonicAnalysis):
    """CylindricalPlanetGearHarmonicAnalysis
    ...
    @property
    def component_design(self: "Self") -> "_2584.CylindricalPlanetGear":
