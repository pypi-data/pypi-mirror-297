...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearHarmonicAnalysis(_5814.AGMAGleasonConicalGearHarmonicAnalysis):
    """HypoidGearHarmonicAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_7053.HypoidGearLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2849.HypoidGearSystemDeflection":
