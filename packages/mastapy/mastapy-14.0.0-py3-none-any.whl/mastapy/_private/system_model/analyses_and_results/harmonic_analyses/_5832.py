...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ClutchHalfHarmonicAnalysis(_5849.CouplingHalfHarmonicAnalysis):
    """ClutchHalfHarmonicAnalysis
    ...
    @property
    def component_design(self: "Self") -> "_2637.ClutchHalf":
    ...
    @property
    def component_load_case(self: "Self") -> "_6981.ClutchHalfLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2796.ClutchHalfSystemDeflection":
