...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearMeshHarmonicAnalysis(_5886.GearMeshHarmonicAnalysis):
    """FaceGearMeshHarmonicAnalysis
    ...
    @property
    def connection_load_case(self: "Self") -> "_7033.FaceGearMeshLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2838.FaceGearMeshSystemDeflection":
