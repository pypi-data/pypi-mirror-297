...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SynchroniserHarmonicAnalysis(_5943.SpecialisedAssemblyHarmonicAnalysis):
    """SynchroniserHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2910.SynchroniserSystemDeflection":
