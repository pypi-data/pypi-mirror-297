...
class _Cast_PeriodicExcitationWithReferenceShaft:
    ...
    def abstract_periodic_excitation_detail(
        self: "CastSelf",
    ) -> "_5810.AbstractPeriodicExcitationDetail":
        return self.__parent__._cast(_5810.AbstractPeriodicExcitationDetail)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PeriodicExcitationWithReferenceShaft(_5810.AbstractPeriodicExcitationDetail):
    """PeriodicExcitationWithReferenceShaft
