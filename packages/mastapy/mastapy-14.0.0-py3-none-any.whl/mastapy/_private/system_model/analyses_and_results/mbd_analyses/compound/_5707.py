...
class CylindricalGearSetCompoundMultibodyDynamicsAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5553.CylindricalGearSetMultibodyDynamicsAnalysis]":
    ...
    def cylindrical_gears_compound_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5705.CylindricalGearCompoundMultibodyDynamicsAnalysis]":
    ...
    def cylindrical_meshes_compound_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5706.CylindricalGearMeshCompoundMultibodyDynamicsAnalysis]":
