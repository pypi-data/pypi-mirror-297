...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PulleyMultibodyDynamicsAnalysis(_5542.CouplingHalfMultibodyDynamicsAnalysis):
    """PulleyMultibodyDynamicsAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_7090.PulleyLoadCase":
    ...
    @property
    def peak_pulley_torque(self: "Self") -> "List[_5654.DynamicTorqueResultAtTime]":
