...
class BevelGearSetAdvancedTimeSteppingAnalysisForModulation(
    ...
    def agma_gleason_conical_gears_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7176.BevelGearAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def agma_gleason_conical_meshes_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7177.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation]":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2791.BevelGearSetSystemDeflection":
