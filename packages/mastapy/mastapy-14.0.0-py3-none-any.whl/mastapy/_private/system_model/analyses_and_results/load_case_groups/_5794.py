...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DesignState(_5789.AbstractDesignStateLoadCaseGroup):
    """DesignState
    ...
    @property
    def clutches(self: "Self") -> "List[_5792.ClutchEngagementStatus]":
    ...
    def clutch_engagement_status_for(
        self: "Self", clutch_connection: "_2396.ClutchConnection"
    ) -> "_5792.ClutchEngagementStatus":
    ...
    def concept_synchro_gear_engagement_status_for(
        self: "Self", gear: "_2582.CylindricalGear"
    ) -> "_5793.ConceptSynchroGearEngagementStatus":
