...
class SpiralBevelGearSetSteadyStateSynchronousResponseOnAShaft(
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7105.SpiralBevelGearSetLoadCase":
    ...
    def bevel_gears_steady_state_synchronous_response_on_a_shaft(
        self: "Self",
    ) -> "List[_3440.SpiralBevelGearSteadyStateSynchronousResponseOnAShaft]":
    ...
    def bevel_meshes_steady_state_synchronous_response_on_a_shaft(
        self: "Self",
    ) -> "List[_3438.SpiralBevelGearMeshSteadyStateSynchronousResponseOnAShaft]":
