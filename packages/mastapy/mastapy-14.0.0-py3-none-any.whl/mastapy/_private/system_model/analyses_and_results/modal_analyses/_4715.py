...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearSetModalAnalysis(_4749.GearSetModalAnalysis):
    """ConceptGearSetModalAnalysis
    ...
    @property
    def gears_modal_analysis(self: "Self") -> "List[_4714.ConceptGearModalAnalysis]":
    ...
    def concept_gears_modal_analysis(
        self: "Self",
    ) -> "List[_4714.ConceptGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.ConceptGearModalAnalysis]
    ...
    def meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4713.ConceptGearMeshModalAnalysis]":
