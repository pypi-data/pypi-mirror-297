...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.drawing.options import _2315, _2317
...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @chart_type.setter
    @enforce_parameter_types
    def chart_type(self: "Self", value: "_4738.DynamicsResponse3DChartType") -> None:
    ...
    @property
    def connected_component_type(self: "Self") -> "_5977.ConnectedComponentType":
    ...
    def connected_component_type(
        self: "Self", value: "_5977.ConnectedComponentType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.HarmonicAnalyses.Results.ConnectedComponentType",
    ...
    @property
    def coordinate_system(self: "Self") -> "_4721.CoordinateSystemForWhine":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.modal_analyses._4721",
    ...
    def coordinate_system(
        self: "Self", value: "_4721.CoordinateSystemForWhine"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.CoordinateSystemForWhine",
    ...
    @enforce_parameter_types
    def response_type(self: "Self", value: "_4739.DynamicsResponseType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def speed_range_for_combining_excitations(
        self: "Self",
    ) -> "_4773.MultipleExcitationsSpeedRangeOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.modal_analyses._4773",
    ...
    @enforce_parameter_types
    def speed_range_for_combining_excitations(
        self: "Self", value: "_4773.MultipleExcitationsSpeedRangeOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.MultipleExcitationsSpeedRangeOption",
    ...
    def whine_waterfall_export_option(
        self: "Self",
    ) -> "_4822.WhineWaterfallExportOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.modal_analyses._4822",
    ...
    @enforce_parameter_types
    def whine_waterfall_export_option(
        self: "Self", value: "_4822.WhineWaterfallExportOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.WhineWaterfallExportOption",
    ...
    def frequency_options(
        self: "Self",
    ) -> "_5883.FrequencyOptionsForHarmonicAnalysisResults":
    ...
    def modal_contribution_view_options(
        self: "Self",
    ) -> "_2317.ModalContributionViewOptions":
    ...
    def mode_view_options(
        self: "Self",
    ) -> "_2315.AdvancedTimeSteppingAnalysisForModulationModeViewOptions":
    ...
    @property
    def order_cuts_chart_settings(self: "Self") -> "_4775.OrderCutsChartSettings":
    ...
    def reference_speed_options(
        self: "Self",
    ) -> "_5944.SpeedOptionsForHarmonicAnalysisResults":
    ...
    def result_location_selection_groups(
        self: "Self",
    ) -> "_5985.ResultLocationSelectionGroups":
    ...
    @property
    def selected_excitations(self: "Self") -> "_5980.ExcitationSourceSelectionGroup":
    ...
    @property
    def waterfall_chart_settings(self: "Self") -> "_4821.WaterfallChartSettings":
    ...
    @property
    def active_result_locations(self: "Self") -> "List[_5986.ResultNodeSelection]":
