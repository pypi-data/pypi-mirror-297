...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetCompoundModalAnalysis(_4902.GearSetCompoundModalAnalysis):
    """FaceGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4743.FaceGearSetModalAnalysis]":
    ...
    def face_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4895.FaceGearCompoundModalAnalysis]":
    ...
    def face_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4896.FaceGearMeshCompoundModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4743.FaceGearSetModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearSetModalAnalysis]
