...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltedJointCompoundModalAnalysis(_4942.SpecialisedAssemblyCompoundModalAnalysis):
    """BoltedJointCompoundModalAnalysis
    ...
    @property
    def component_design(self: "Self") -> "_2498.BoltedJoint":
    ...
    @property
    def assembly_design(self: "Self") -> "_2498.BoltedJoint":
        """mastapy.system_model.part_model.BoltedJoint
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4703.BoltedJointModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4703.BoltedJointModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.BoltedJointModalAnalysis]
