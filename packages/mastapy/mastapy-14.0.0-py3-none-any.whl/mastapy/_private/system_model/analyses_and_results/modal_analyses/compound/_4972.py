...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearSetCompoundModalAnalysis(_4860.BevelGearSetCompoundModalAnalysis):
    """ZerolBevelGearSetCompoundModalAnalysis
    ...
    def zerol_bevel_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4970.ZerolBevelGearCompoundModalAnalysis]":
    ...
    def zerol_bevel_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4971.ZerolBevelGearMeshCompoundModalAnalysis]":
