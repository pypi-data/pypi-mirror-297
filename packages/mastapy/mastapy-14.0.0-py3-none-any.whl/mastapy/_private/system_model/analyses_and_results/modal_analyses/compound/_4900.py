...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearCompoundModalAnalysis(_4921.MountableComponentCompoundModalAnalysis):
    """GearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4748.GearModalAnalysis]":
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4748.GearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.GearModalAnalysis]
