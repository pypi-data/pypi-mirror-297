...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RollingRingModalAnalysis(_4723.CouplingHalfModalAnalysis):
    """RollingRingModalAnalysis
    ...
    @property
    def component_design(self: "Self") -> "_2656.RollingRing":
    ...
    @property
    def component_load_case(self: "Self") -> "_7097.RollingRingLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2885.RollingRingSystemDeflection":
