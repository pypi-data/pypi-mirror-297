...
class AssemblyModalAnalysisAtAStiffness(
    ...
    @property
    def bearings(self: "Self") -> "List[_4981.BearingModalAnalysisAtAStiffness]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_4983.BeltDriveModalAnalysisAtAStiffness]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_4986.BevelDifferentialGearSetModalAnalysisAtAStiffness]":
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_4992.BoltedJointModalAnalysisAtAStiffness]":
    ...
    @property
    def bolts(self: "Self") -> "List[_4993.BoltModalAnalysisAtAStiffness]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_5014.CVTModalAnalysisAtAStiffness]":
    ...
    @property
    def clutches(self: "Self") -> "List[_4996.ClutchModalAnalysisAtAStiffness]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_5001.ConceptCouplingModalAnalysisAtAStiffness]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_5004.ConceptGearSetModalAnalysisAtAStiffness]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_5016.CycloidalAssemblyModalAnalysisAtAStiffness]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_5018.CycloidalDiscModalAnalysisAtAStiffness]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_5022.CylindricalGearSetModalAnalysisAtAStiffness]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_5030.FEPartModalAnalysisAtAStiffness]":
    ...
    def face_gear_sets(
        self: "Self",
    ) -> "List[_5029.FaceGearSetModalAnalysisAtAStiffness]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_5031.FlexiblePinAssemblyModalAnalysisAtAStiffness]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_5038.HypoidGearSetModalAnalysisAtAStiffness]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_5045.KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtAStiffness]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5048.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysisAtAStiffness]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_5049.MassDiscModalAnalysisAtAStiffness]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_5050.MeasurementComponentModalAnalysisAtAStiffness]":
    ...
    @property
    def microphones(self: "Self") -> "List[_5052.MicrophoneModalAnalysisAtAStiffness]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_5055.OilSealModalAnalysisAtAStiffness]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_5059.PartToPartShearCouplingModalAnalysisAtAStiffness]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_5062.PlanetCarrierModalAnalysisAtAStiffness]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_5063.PointLoadModalAnalysisAtAStiffness]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_5064.PowerLoadModalAnalysisAtAStiffness]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_5066.RingPinsModalAnalysisAtAStiffness]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_5068.RollingRingAssemblyModalAnalysisAtAStiffness]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_5072.ShaftHubConnectionModalAnalysisAtAStiffness]":
    ...
    @property
    def shafts(self: "Self") -> "List[_5073.ShaftModalAnalysisAtAStiffness]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5078.SpiralBevelGearSetModalAnalysisAtAStiffness]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_5081.SpringDamperModalAnalysisAtAStiffness]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_5084.StraightBevelDiffGearSetModalAnalysisAtAStiffness]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5087.StraightBevelGearSetModalAnalysisAtAStiffness]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_5091.SynchroniserModalAnalysisAtAStiffness]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_5095.TorqueConverterModalAnalysisAtAStiffness]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_5098.UnbalancedMassModalAnalysisAtAStiffness]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_5102.WormGearSetModalAnalysisAtAStiffness]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5105.ZerolBevelGearSetModalAnalysisAtAStiffness]":
