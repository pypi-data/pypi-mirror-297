...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetCompoundDynamicAnalysis(_6609.GearSetCompoundDynamicAnalysis):
    """WormGearSetCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6545.WormGearSetDynamicAnalysis]":
    ...
    def worm_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6674.WormGearCompoundDynamicAnalysis]":
    ...
    def worm_meshes_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6675.WormGearMeshCompoundDynamicAnalysis]":
