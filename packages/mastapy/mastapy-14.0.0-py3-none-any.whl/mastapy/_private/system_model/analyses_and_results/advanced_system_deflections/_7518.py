...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PowerLoadAdvancedSystemDeflection(_7554.VirtualComponentAdvancedSystemDeflection):
    """PowerLoadAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self: "Self") -> "_7089.PowerLoadLoadCase":
    ...
    def component_system_deflection_results(
        self: "Self",
    ) -> "List[_2878.PowerLoadSystemDeflection]":
    ...
    def transmission_error_to_other_power_loads(
        self: "Self",
    ) -> "List[_7552.TransmissionErrorToOtherPowerLoad]":
