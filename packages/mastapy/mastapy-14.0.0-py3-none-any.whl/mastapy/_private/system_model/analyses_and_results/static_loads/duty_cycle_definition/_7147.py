...
class PointLoadInputOptions(_1900.ColumnInputOptions):
    ...
    @property
    def conversion_to_load_case(self: "Self") -> "_7138.AdditionalForcesObtainedFrom":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads.duty_cycle_definition._7138",
    ...
    def conversion_to_load_case(
        self: "Self", value: "_7138.AdditionalForcesObtainedFrom"
    ) -> None:
    ...
    @point_load.setter
    @enforce_parameter_types
    def point_load(self: "Self", value: "_2528.PointLoad") -> None:
        wrapper_type = (
