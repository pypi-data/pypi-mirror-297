...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptCouplingLoadCase(_7001.CouplingLoadCase):
    """ConceptCouplingLoadCase
    ...
    @enforce_parameter_types
    def power_load_for_reference_speed(self: "Self", value: "_2529.PowerLoad") -> None:
        wrapper_type = (
    ...
    def speed_ratio_specification_method(
        self: "Self",
    ) -> "_2256.ConceptCouplingSpeedRatioSpecificationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2256",
    ...
    @enforce_parameter_types
    def speed_ratio_specification_method(
        self: "Self", value: "_2256.ConceptCouplingSpeedRatioSpecificationMethod"
    ) -> None:
    ...
    @property
    def assembly_design(self: "Self") -> "_2639.ConceptCoupling":
