...
from mastapy._private.system_model.analyses_and_results.static_loads import _7127, _7131
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PowerLoadLoadCase(_7131.VirtualComponentLoadCase):
    """PowerLoadLoadCase
    ...
    def drag_torque_specification_method(
        self: "Self",
    ) -> "_2270.PowerLoadDragTorqueSpecificationMethod":
    ...
    @enforce_parameter_types
    def drag_torque_specification_method(
        self: "Self", value: "_2270.PowerLoadDragTorqueSpecificationMethod"
    ) -> None:
    ...
    @enforce_parameter_types
    def electric_machine_data_set_selector(
        self: "Self", value: "_2428.ElectricMachineDataSet"
    ) -> None:
    ...
    @enforce_parameter_types
    def system_deflection_torque_method(
        self: "Self", value: "_7127.TorqueSpecificationForSystemDeflection"
    ) -> None:
    ...
    def target_speed_input_type(
        self: "Self",
    ) -> "_2272.PowerLoadPIDControlSpeedInputType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2272", "PowerLoadPIDControlSpeedInputType"
        )(value)

    @target_speed_input_type.setter
    @enforce_parameter_types
    def target_speed_input_type(
        self: "Self", value: "_2272.PowerLoadPIDControlSpeedInputType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def torque_input_method(
        self: "Self", value: "_2271.PowerLoadInputTorqueSpecificationMethod"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def wheel_slip_model(self: "Self") -> "_5644.WheelSlipType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5644",
            "WheelSlipType",
        )(value)

    @wheel_slip_model.setter
    @enforce_parameter_types
    def wheel_slip_model(self: "Self", value: "_5644.WheelSlipType") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.WheelSlipType",
        )
    ...
    @property
    def component_design(self: "Self") -> "_2529.PowerLoad":
