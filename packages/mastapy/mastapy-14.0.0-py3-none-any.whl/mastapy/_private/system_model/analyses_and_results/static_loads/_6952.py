...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StaticLoadCase(_6951.LoadCase):
    """StaticLoadCase
    ...
    @property
    def system_deflection(self: "Self") -> "_2730.SystemDeflectionAnalysis":
    ...
    @property
    def power_flow(self: "Self") -> "_2725.PowerFlowAnalysis":
    ...
    @property
    def harmonic_analysis(self: "Self") -> "_2716.HarmonicAnalysis":
    ...
    @property
    def parametric_study_tool(self: "Self") -> "_2724.ParametricStudyToolAnalysis":
    ...
    @property
    def modal_analysis(self: "Self") -> "_2719.ModalAnalysis":
    ...
    @property
    def critical_speed_analysis(self: "Self") -> "_2709.CriticalSpeedAnalysis":
    ...
    @property
    def stability_analysis(self: "Self") -> "_2726.StabilityAnalysis":
    ...
    def unbalanced_mass_inclusion(
        self: "Self",
        value: "Union[_2535.UnbalancedMassInclusionOption, Tuple[_2535.UnbalancedMassInclusionOption, bool]]",
    ) -> None:
        wrapper_type = (
    ...
    def advanced_system_deflection_options(
        self: "Self",
    ) -> "_7428.AdvancedSystemDeflectionOptions":
    ...
    def te_set_up_for_dynamic_analyses_options(
        self: "Self",
    ) -> "_2767.TESetUpForDynamicAnalysisOptions":
    ...
    @property
    def clutch_engagements(self: "Self") -> "List[_5792.ClutchEngagementStatus]":
    ...
    def concept_clutch_engagements(
        self: "Self",
    ) -> "List[_5793.ConceptSynchroGearEngagementStatus]":
    ...
    @property
    def design_state_load_case_group(self: "Self") -> "_5794.DesignState":
    ...
    @enforce_parameter_types
    def duplicate(
        self: "Self", new_design_state_group: "_5794.DesignState", name: "str" = "None"
    ) -> "StaticLoadCase":
