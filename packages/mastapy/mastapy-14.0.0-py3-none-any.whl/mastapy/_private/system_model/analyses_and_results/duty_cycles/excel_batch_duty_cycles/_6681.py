...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def excel_file_details(self: "Self") -> "_6682.ExcelFileDetails":
    ...
    @property
    def masta_file_details(self: "Self") -> "_6685.MASTAFileDetails":
    ...
    def excel_sheet_design_state_selection(
        self: "Self",
    ) -> "List[_6684.ExcelSheetDesignStateSelector]":
