...
class ConceptGearSetSteadyStateSynchronousResponseAtASpeed(
    ...
    @property
    def assembly_load_case(self: "Self") -> "_6991.ConceptGearSetLoadCase":
    ...
    def gears_steady_state_synchronous_response_at_a_speed(
        self: "Self",
    ) -> "List[_3631.ConceptGearSteadyStateSynchronousResponseAtASpeed]":
    ...
    def meshes_steady_state_synchronous_response_at_a_speed(
        self: "Self",
    ) -> "List[_3629.ConceptGearMeshSteadyStateSynchronousResponseAtASpeed]":
