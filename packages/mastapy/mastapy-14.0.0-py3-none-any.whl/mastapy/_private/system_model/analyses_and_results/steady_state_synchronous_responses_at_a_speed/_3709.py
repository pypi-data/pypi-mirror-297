...
class StraightBevelDiffGearSetSteadyStateSynchronousResponseAtASpeed(
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7111.StraightBevelDiffGearSetLoadCase":
    ...
    def bevel_gears_steady_state_synchronous_response_at_a_speed(
        self: "Self",
    ) -> "List[_3710.StraightBevelDiffGearSteadyStateSynchronousResponseAtASpeed]":
    ...
    def bevel_meshes_steady_state_synchronous_response_at_a_speed(
        self: "Self",
    ) -> "List[_3708.StraightBevelDiffGearMeshSteadyStateSynchronousResponseAtASpeed]":
