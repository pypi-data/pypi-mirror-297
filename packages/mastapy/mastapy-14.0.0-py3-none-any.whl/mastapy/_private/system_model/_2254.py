...
from mastapy._private.system_model.part_model import _2529, _2532
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2259, _2265, _2266, _2276, _2277, _2278
    ...
    from mastapy._private.system_model.database_access import _2318
    from mastapy._private.system_model.fe import _2415
    from mastapy._private.system_model.optimization.system_optimiser import _2293, _2294
...
class Design(_0.APIBase):
    ...
    @enforce_parameter_types
    def gear_set_configuration(
        self: "Self", value: "_2569.ActiveGearSetDesignSelectionGroup"
    ) -> None:
    ...
    @enforce_parameter_types
    def input_power_load(self: "Self", value: "_2529.PowerLoad") -> None:
        wrapper_type = (
    ...
    @enforce_parameter_types
    def output_power_load(self: "Self", value: "_2529.PowerLoad") -> None:
        wrapper_type = (
            list_with_selected_item.ListWithSelectedItem_PowerLoad.wrapper_type()
        )
        enclosed_type = (
    ...
    @enforce_parameter_types
    def shaft_diameter_modification_due_to_rolling_bearing_rings(
        self: "Self", value: "_2532.ShaftDiameterModificationDueToRollingBearingRing"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def thermal_expansion_for_grounded_nodes(
        self: "Self",
    ) -> "_2277.ThermalExpansionOptionForGroundedNodes":
    ...
    @enforce_parameter_types
    def thermal_expansion_for_grounded_nodes(
        self: "Self", value: "_2277.ThermalExpansionOptionForGroundedNodes"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def unbalanced_mass_inclusion(
        self: "Self",
    ) -> "_2535.UnbalancedMassInclusionOption":
    ...
    @enforce_parameter_types
    def unbalanced_mass_inclusion(
        self: "Self", value: "_2535.UnbalancedMassInclusionOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def acoustic_analysis_setups(
        self: "Self",
    ) -> "_2685.AcousticAnalysisSetupCollection":
    ...
    @property
    def default_system_temperatures(self: "Self") -> "_2278.TransmissionTemperatureSet":
    ...
    @property
    def electric_machine_group(self: "Self") -> "_2265.MAAElectricMachineGroup":
    ...
    @property
    def fe_batch_operations(self: "Self") -> "_2415.BatchOperations":
    ...
    def selected_gear_set_selection_group(
        self: "Self",
    ) -> "_2569.ActiveGearSetDesignSelectionGroup":
    ...
    @property
    def settings(self: "Self") -> "_2259.DesignSettings":
    ...
    @property
    def system(self: "Self") -> "_2276.SystemReporting":
    ...
    @property
    def system_optimiser_details(self: "Self") -> "_2294.SystemOptimiserDetails":
    ...
    def bearing_detail_configurations(
        self: "Self",
    ) -> "List[_2678.BearingDetailConfiguration]":
    ...
    def fe_substructure_configurations(
        self: "Self",
    ) -> "List[_2675.ActiveFESubstructureSelectionGroup]":
    ...
    def gear_set_configurations(
        self: "Self",
    ) -> "List[_2569.ActiveGearSetDesignSelectionGroup]":
    ...
    def shaft_detail_configurations(
        self: "Self",
    ) -> "List[_2677.ActiveShaftDesignSelectionGroup]":
    ...
    @property
    def databases(self: "Self") -> "_2318.Databases":
    ...
    @property
    def design_states(self: "Self") -> "List[_5794.DesignState]":
    ...
    @property
    def duty_cycles(self: "Self") -> "List[_5795.DutyCycle]":
    ...
    @property
    def gear_set_config(self: "Self") -> "_2590.GearSetConfiguration":
    ...
    @enforce_parameter_types
    def gear_set_config(self: "Self", value: "_2590.GearSetConfiguration") -> None:
        pythonnet_property_set(self.wrapped, "GearSetConfig", value.wrapped)

    @property
    def masta_settings(self: "Self") -> "_2266.MASTASettings":
    ...
    @property
    def root_assembly(self: "Self") -> "_2531.RootAssembly":
    ...
    @property
    def static_loads(self: "Self") -> "List[_6952.StaticLoadCase]":
    ...
    @property
    def system_optimiser(self: "Self") -> "_2293.SystemOptimiser":
    ...
    def time_series_load_case_groups(
        self: "Self",
    ) -> "List[_5802.TimeSeriesLoadCaseGroup]":
    ...
    def add_synchroniser_shift_empty(self: "Self") -> "_3070.SynchroniserShift":
    ...
    @enforce_parameter_types
    def add_synchroniser_shift(self: "Self", name: "str") -> "_3070.SynchroniserShift":
        """mastapy.system_model.analyses_and_results.synchroniser_analysis.SynchroniserShift
    ...
    @enforce_parameter_types
    def design_state_named(self: "Self", name: "str") -> "_5794.DesignState":
        """mastapy.system_model.analyses_and_results.load_case_groups.DesignState
    ...
    @enforce_parameter_types
    def duty_cycle_named(self: "Self", name: "str") -> "_5795.DutyCycle":
        """mastapy.system_model.analyses_and_results.load_case_groups.DutyCycle
    ...
    def remove_synchroniser_shift(
        self: "Self", shift: "_3070.SynchroniserShift"
    ) -> None:
        """Method does not return.
    ...
    def save_load_case_results(
        self: "Self", file_name: "str", load_cases: "List[_6951.LoadCase]"
    ) -> None:
        """Method does not return.
    ...
    def all_parts_of_type_assembly(self: "Self") -> "List[_2488.Assembly]":
