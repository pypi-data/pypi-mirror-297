...
class _Cast_SteadyStateSynchronousResponseViewable:
    ...
    @property
    def rotor_dynamics_viewable(self: "CastSelf") -> "_2309.RotorDynamicsViewable":
        return self.__parent__._cast(_2309.RotorDynamicsViewable)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SteadyStateSynchronousResponseViewable(_2309.RotorDynamicsViewable):
    """SteadyStateSynchronousResponseViewable
