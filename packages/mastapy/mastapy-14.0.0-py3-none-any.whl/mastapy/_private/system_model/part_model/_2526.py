...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2499, _2516, _2525
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PlanetCarrier(_2521.MountableComponent):
    """PlanetCarrier
    ...
    @property
    def planetary_sockets(self: "Self") -> "List[_2342.PlanetarySocket]":
