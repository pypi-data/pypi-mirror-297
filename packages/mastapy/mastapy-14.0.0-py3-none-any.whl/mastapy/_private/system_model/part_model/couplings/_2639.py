...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptCoupling(_2642.Coupling):
    """ConceptCoupling
    ...
    @property
    def efficiency_vs_speed_ratio(self: "Self") -> "_1583.Vector2DListAccessor":
    ...
    @property
    def half_positioning(self: "Self") -> "_2641.ConceptCouplingHalfPositioning":
    ...
    def half_positioning(
        self: "Self", value: "_2641.ConceptCouplingHalfPositioning"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.Couplings.ConceptCouplingHalfPositioning",
