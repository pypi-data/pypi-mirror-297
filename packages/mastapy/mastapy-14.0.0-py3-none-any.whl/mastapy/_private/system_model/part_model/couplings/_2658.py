...
from mastapy._private.system_model.part_model.couplings import _2651, _2654, _2655
...
if TYPE_CHECKING:
    ...
    from mastapy._private.detailed_rigid_connectors.interference_fits import _1493
    from mastapy._private.detailed_rigid_connectors.splines import _1458, _1463
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftHubConnection(_2502.Connector):
    """ShaftHubConnection
    ...
    @property
    def spline_type(self: "Self") -> "_1458.SplineDesignTypes":
    ...
    @spline_type.setter
    @enforce_parameter_types
    def spline_type(self: "Self", value: "_1458.SplineDesignTypes") -> None:
    ...
    @enforce_parameter_types
    def stiffness_type(
        self: "Self", value: "_2651.RigidConnectorStiffnessType"
    ) -> None:
    ...
    @property
    def tilt_stiffness_type(self: "Self") -> "_2652.RigidConnectorTiltStiffnessTypes":
    ...
    def tilt_stiffness_type(
        self: "Self", value: "_2652.RigidConnectorTiltStiffnessTypes"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.Couplings.RigidConnectorTiltStiffnessTypes",
    ...
    @enforce_parameter_types
    def tooth_spacing_type(
        self: "Self", value: "_2654.RigidConnectorToothSpacingType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @type_.setter
    @enforce_parameter_types
    def type_(self: "Self", value: "_2655.RigidConnectorTypes") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def interference_fit_design(self: "Self") -> "_1493.InterferenceFitDesign":
    ...
    @property
    def left_flank_lead_relief(self: "Self") -> "_2660.SplineLeadRelief":
    ...
    @property
    def major_fit_options(self: "Self") -> "_2659.SplineFitOptions":
    ...
    @property
    def minor_fit_options(self: "Self") -> "_2659.SplineFitOptions":
        """mastapy.system_model.part_model.couplings.SplineFitOptions
    ...
    @property
    def right_flank_lead_relief(self: "Self") -> "_2660.SplineLeadRelief":
        """mastapy.system_model.part_model.couplings.SplineLeadRelief
    ...
    @property
    def spline_joint_design(self: "Self") -> "_1463.SplineJointDesign":
    ...
    @property
    def spline_pitch_error_options(self: "Self") -> "_2662.SplinePitchErrorOptions":
    ...
    @property
    def fit_options(self: "Self") -> "List[_2659.SplineFitOptions]":
    ...
    @property
    def lead_reliefs(self: "Self") -> "List[_2660.SplineLeadRelief]":
    ...
    def tooth_locations_external_spline_half(
        self: "Self",
    ) -> "List[_2653.RigidConnectorToothLocation]":
