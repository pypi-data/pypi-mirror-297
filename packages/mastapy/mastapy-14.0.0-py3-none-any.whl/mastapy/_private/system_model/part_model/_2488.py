...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _1922, _1949
    ...
    T_get_part_named = TypeVar("T_get_part_named", bound="_2525.Part")
    T_all_parts = TypeVar("T_all_parts", bound="_2525.Part")
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class Assembly(_2489.AbstractAssembly):
    """Assembly
    ...
    @property
    def oil_level_specification(self: "Self") -> "_2522.OilLevelSpecification":
    ...
    @property
    def bearings(self: "Self") -> "List[_2494.Bearing]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_2498.BoltedJoint]":
    ...
    @property
    def component_details(self: "Self") -> "List[_2499.Component]":
    ...
    @property
    def components_with_unknown_scalar_mass(self: "Self") -> "List[_2499.Component]":
        """List[mastapy.system_model.part_model.Component]
    ...
    @property
    def conical_gear_sets(self: "Self") -> "List[_2581.ConicalGearSet]":
    ...
    @property
    def cylindrical_gear_sets(self: "Self") -> "List[_2583.CylindricalGearSet]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_2508.FEPart]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_2586.FaceGearSet]":
    ...
    @property
    def gear_sets(self: "Self") -> "List[_2589.GearSet]":
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_2592.HypoidGearSet]":
    ...
    def klingelnberg_cyclo_palloid_gear_sets(
        self: "Self",
    ) -> "List[_2594.KlingelnbergCycloPalloidConicalGearSet]":
    ...
    @property
    def microphone_arrays(self: "Self") -> "List[_2520.MicrophoneArray]":
    ...
    @property
    def microphones(self: "Self") -> "List[_2519.Microphone]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_2523.OilSeal]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_2528.PointLoad]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_2529.PowerLoad]":
    ...
    @property
    def shaft_hub_connections(self: "Self") -> "List[_2658.ShaftHubConnection]":
    ...
    @property
    def shafts(self: "Self") -> "List[_2539.Shaft]":
    ...
    @property
    def spiral_bevel_gear_sets(self: "Self") -> "List[_2601.SpiralBevelGearSet]":
    ...
    @property
    def straight_bevel_gear_sets(self: "Self") -> "List[_2605.StraightBevelGearSet]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_2609.WormGearSet]":
    ...
    def get_part_named(self: "Self", name: "str") -> "_2525.Part":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_bearing(self: "Self", name: "str") -> "_2494.Bearing":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_bolt(self: "Self", name: "str") -> "_2497.Bolt":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_datum(self: "Self", name: "str") -> "_2503.Datum":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_fe_part(self: "Self", name: "str") -> "_2508.FEPart":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_mass_disc(self: "Self", name: "str") -> "_2517.MassDisc":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_oil_seal(self: "Self", name: "str") -> "_2523.OilSeal":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_shaft(self: "Self", name: "str") -> "_2539.Shaft":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_face_gear(self: "Self", name: "str") -> "_2585.FaceGear":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_gear(self: "Self", name: "str") -> "_2587.Gear":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_gear_set(self: "Self", name: "str") -> "_2589.GearSet":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_worm_gear(self: "Self", name: "str") -> "_2608.WormGear":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_ring_pins(self: "Self", name: "str") -> "_2627.RingPins":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_clutch(self: "Self", name: "str") -> "_2636.Clutch":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_coupling(self: "Self", name: "str") -> "_2642.Coupling":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_cvt(self: "Self", name: "str") -> "_2645.CVT":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_pulley(self: "Self", name: "str") -> "_2650.Pulley":
        """T_get_part_named
    ...
    def all_parts(self: "Self") -> "List[_2525.Part]":
    ...
    def all_parts_of_type_abstract_shaft(self: "Self") -> "List[_2490.AbstractShaft]":
    ...
    def all_parts_of_type_abstract_shaft_or_housing(
        self: "Self",
    ) -> "List[_2491.AbstractShaftOrHousing]":
    ...
    def all_parts_of_type_bearing(self: "Self") -> "List[_2494.Bearing]":
        """List[mastapy.system_model.part_model.Bearing]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "Bearing")
        return conversion.pn_to_mp_objects_in_list(
            pythonnet_method_call_generic(self.wrapped, "AllParts", cast_type)
    ...
    def all_parts_of_type_bolt(self: "Self") -> "List[_2497.Bolt]":
    ...
    def all_parts_of_type_bolted_joint(self: "Self") -> "List[_2498.BoltedJoint]":
        """List[mastapy.system_model.part_model.BoltedJoint]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel", "BoltedJoint"
        )
    ...
    def all_parts_of_type_component(self: "Self") -> "List[_2499.Component]":
        """List[mastapy.system_model.part_model.Component]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "Component")
        return conversion.pn_to_mp_objects_in_list(
            pythonnet_method_call_generic(self.wrapped, "AllParts", cast_type)
    ...
    def all_parts_of_type_connector(self: "Self") -> "List[_2502.Connector]":
    ...
    def all_parts_of_type_datum(self: "Self") -> "List[_2503.Datum]":
    ...
    def all_parts_of_type_fe_part(self: "Self") -> "List[_2508.FEPart]":
        """List[mastapy.system_model.part_model.FEPart]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "FEPart")
        return conversion.pn_to_mp_objects_in_list(
            pythonnet_method_call_generic(self.wrapped, "AllParts", cast_type)
    ...
    def all_parts_of_type_flexible_pin_assembly(
        self: "Self",
    ) -> "List[_2509.FlexiblePinAssembly]":
    ...
    def all_parts_of_type_guide_dxf_model(self: "Self") -> "List[_2510.GuideDxfModel]":
    ...
    def all_parts_of_type_mass_disc(self: "Self") -> "List[_2517.MassDisc]":
    ...
    def all_parts_of_type_measurement_component(
        self: "Self",
    ) -> "List[_2518.MeasurementComponent]":
    ...
    def all_parts_of_type_microphone(self: "Self") -> "List[_2519.Microphone]":
        """List[mastapy.system_model.part_model.Microphone]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel", "Microphone"
        )
    ...
    def all_parts_of_type_oil_seal(self: "Self") -> "List[_2523.OilSeal]":
        """List[mastapy.system_model.part_model.OilSeal]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "OilSeal")
        return conversion.pn_to_mp_objects_in_list(
            pythonnet_method_call_generic(self.wrapped, "AllParts", cast_type)
    ...
    def all_parts_of_type_planet_carrier(self: "Self") -> "List[_2526.PlanetCarrier]":
    ...
    def all_parts_of_type_point_load(self: "Self") -> "List[_2528.PointLoad]":
        """List[mastapy.system_model.part_model.PointLoad]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "PointLoad")
        return conversion.pn_to_mp_objects_in_list(
            pythonnet_method_call_generic(self.wrapped, "AllParts", cast_type)
    ...
    def all_parts_of_type_power_load(self: "Self") -> "List[_2529.PowerLoad]":
        """List[mastapy.system_model.part_model.PowerLoad]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "PowerLoad")
        return conversion.pn_to_mp_objects_in_list(
            pythonnet_method_call_generic(self.wrapped, "AllParts", cast_type)
    ...
    def all_parts_of_type_root_assembly(self: "Self") -> "List[_2531.RootAssembly]":
    ...
    def all_parts_of_type_specialised_assembly(
        self: "Self",
    ) -> "List[_2533.SpecialisedAssembly]":
    ...
    def all_parts_of_type_unbalanced_mass(self: "Self") -> "List[_2534.UnbalancedMass]":
    ...
    def all_parts_of_type_shaft(self: "Self") -> "List[_2539.Shaft]":
        """List[mastapy.system_model.part_model.shaft_model.Shaft]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.ShaftModel", "Shaft"
        )
    ...
    def all_parts_of_type_agma_gleason_conical_gear(
        self: "Self",
    ) -> "List[_2570.AGMAGleasonConicalGear]":
    ...
    def all_parts_of_type_agma_gleason_conical_gear_set(
        self: "Self",
    ) -> "List[_2571.AGMAGleasonConicalGearSet]":
    ...
    def all_parts_of_type_bevel_differential_gear(
        self: "Self",
    ) -> "List[_2572.BevelDifferentialGear]":
    ...
    def all_parts_of_type_bevel_differential_gear_set(
        self: "Self",
    ) -> "List[_2573.BevelDifferentialGearSet]":
    ...
    def all_parts_of_type_bevel_differential_planet_gear(
        self: "Self",
    ) -> "List[_2574.BevelDifferentialPlanetGear]":
    ...
    def all_parts_of_type_bevel_differential_sun_gear(
        self: "Self",
    ) -> "List[_2575.BevelDifferentialSunGear]":
    ...
    def all_parts_of_type_bevel_gear(self: "Self") -> "List[_2576.BevelGear]":
    ...
    def all_parts_of_type_bevel_gear_set(self: "Self") -> "List[_2577.BevelGearSet]":
    ...
    def all_parts_of_type_concept_gear(self: "Self") -> "List[_2578.ConceptGear]":
    ...
    def all_parts_of_type_conical_gear(self: "Self") -> "List[_2580.ConicalGear]":
    ...
    def all_parts_of_type_cylindrical_planet_gear(
        self: "Self",
    ) -> "List[_2584.CylindricalPlanetGear]":
    ...
    def all_parts_of_type_face_gear(self: "Self") -> "List[_2585.FaceGear]":
    ...
    def all_parts_of_type_face_gear_set(self: "Self") -> "List[_2586.FaceGearSet]":
        """List[mastapy.system_model.part_model.gears.FaceGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "FaceGearSet"
        )
    ...
    def all_parts_of_type_gear(self: "Self") -> "List[_2587.Gear]":
    ...
    def all_parts_of_type_gear_set(self: "Self") -> "List[_2589.GearSet]":
        """List[mastapy.system_model.part_model.gears.GearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "GearSet"
        )
    ...
    def all_parts_of_type_hypoid_gear(self: "Self") -> "List[_2591.HypoidGear]":
    ...
    def all_parts_of_type_hypoid_gear_set(self: "Self") -> "List[_2592.HypoidGearSet]":
        """List[mastapy.system_model.part_model.gears.HypoidGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "HypoidGearSet"
        )
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_conical_gear(
        self: "Self",
    ) -> "List[_2593.KlingelnbergCycloPalloidConicalGear]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_hypoid_gear(
        self: "Self",
    ) -> "List[_2595.KlingelnbergCycloPalloidHypoidGear]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set(
        self: "Self",
    ) -> "List[_2596.KlingelnbergCycloPalloidHypoidGearSet]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set(
        self: "Self",
    ) -> "List[_2598.KlingelnbergCycloPalloidSpiralBevelGearSet]":
    ...
    def all_parts_of_type_straight_bevel_diff_gear(
        self: "Self",
    ) -> "List[_2602.StraightBevelDiffGear]":
    ...
    def all_parts_of_type_straight_bevel_diff_gear_set(
        self: "Self",
    ) -> "List[_2603.StraightBevelDiffGearSet]":
    ...
    def all_parts_of_type_straight_bevel_gear_set(
        self: "Self",
    ) -> "List[_2605.StraightBevelGearSet]":
        """List[mastapy.system_model.part_model.gears.StraightBevelGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "StraightBevelGearSet"
        )
    ...
    def all_parts_of_type_straight_bevel_planet_gear(
        self: "Self",
    ) -> "List[_2606.StraightBevelPlanetGear]":
    ...
    def all_parts_of_type_straight_bevel_sun_gear(
        self: "Self",
    ) -> "List[_2607.StraightBevelSunGear]":
    ...
    def all_parts_of_type_worm_gear(self: "Self") -> "List[_2608.WormGear]":
    ...
    def all_parts_of_type_worm_gear_set(self: "Self") -> "List[_2609.WormGearSet]":
        """List[mastapy.system_model.part_model.gears.WormGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "WormGearSet"
        )
    ...
    def all_parts_of_type_cycloidal_disc(self: "Self") -> "List[_2626.CycloidalDisc]":
    ...
    def all_parts_of_type_ring_pins(self: "Self") -> "List[_2627.RingPins]":
    ...
    def all_parts_of_type_belt_drive(self: "Self") -> "List[_2634.BeltDrive]":
    ...
    def all_parts_of_type_clutch(self: "Self") -> "List[_2636.Clutch]":
    ...
    def all_parts_of_type_clutch_half(self: "Self") -> "List[_2637.ClutchHalf]":
    ...
    def all_parts_of_type_concept_coupling_half(
        self: "Self",
    ) -> "List[_2640.ConceptCouplingHalf]":
    ...
    def all_parts_of_type_coupling(self: "Self") -> "List[_2642.Coupling]":
    ...
    def all_parts_of_type_coupling_half(self: "Self") -> "List[_2643.CouplingHalf]":
    ...
    def all_parts_of_type_cvt(self: "Self") -> "List[_2645.CVT]":
    ...
    def all_parts_of_type_cvt_pulley(self: "Self") -> "List[_2646.CVTPulley]":
    ...
    def all_parts_of_type_part_to_part_shear_coupling(
        self: "Self",
    ) -> "List[_2647.PartToPartShearCoupling]":
    ...
    def all_parts_of_type_part_to_part_shear_coupling_half(
        self: "Self",
    ) -> "List[_2648.PartToPartShearCouplingHalf]":
    ...
    def all_parts_of_type_pulley(self: "Self") -> "List[_2650.Pulley]":
    ...
    def all_parts_of_type_rolling_ring(self: "Self") -> "List[_2656.RollingRing]":
    ...
    def all_parts_of_type_rolling_ring_assembly(
        self: "Self",
    ) -> "List[_2657.RollingRingAssembly]":
    ...
    def all_parts_of_type_spring_damper(self: "Self") -> "List[_2663.SpringDamper]":
    ...
    def all_parts_of_type_synchroniser(self: "Self") -> "List[_2665.Synchroniser]":
    ...
    def all_parts_of_type_torque_converter_pump(
        self: "Self",
    ) -> "List[_2671.TorqueConverterPump]":
    ...
    def all_parts_of_type_torque_converter_turbine(
        self: "Self",
    ) -> "List[_2673.TorqueConverterTurbine]":
    ...
    @enforce_parameter_types
    def add_bearing(self: "Self", name: "str") -> "_2494.Bearing":
        """mastapy.system_model.part_model.Bearing
    ...
    def add_bearing_with_name_and_rolling_bearing_type(
        self: "Self", name: "str", type_: "_1949.RollingBearingType"
    ) -> "_2494.Bearing":
        """mastapy.system_model.part_model.Bearing
    ...
    def add_bearing_with_name_rolling_bearing_type_and_designation(
        self: "Self", name: "str", type_: "_1949.RollingBearingType", designation: "str"
    ) -> "_2494.Bearing":
        """mastapy.system_model.part_model.Bearing
    ...
    def add_belt_drive_with_options(
        self: "Self",
        belt_creation_options: Optional["_2628.BeltCreationOptions"] = None,
    ) -> "_2634.BeltDrive":
    ...
    @enforce_parameter_types
    def add_cvt(self: "Self", name: "str" = "CVT") -> "_2645.CVT":
    ...
    @enforce_parameter_types
    def add_clutch(self: "Self", name: "str" = "Clutch") -> "_2636.Clutch":
    ...
    def add_cycloidal_assembly_with_options(
        ...
        cycloidal_assembly_creation_options: Optional[
            "_2629.CycloidalAssemblyCreationOptions"
        ] = None,
    ) -> "_2625.CycloidalAssembly":
    ...
    def add_cylindrical_gear_set_with_options(
        ...
        cylindrical_gear_linear_train_creation_options: Optional[
            "_2630.CylindricalGearLinearTrainCreationOptions"
        ] = None,
    ) -> "_2583.CylindricalGearSet":
        """mastapy.system_model.part_model.gears.CylindricalGearSet
    ...
    @enforce_parameter_types
    def add_datum(self: "Self", name: "str" = "Datum") -> "_2503.Datum":
    ...
    @enforce_parameter_types
    def add_fe_part(self: "Self", name: "str" = "FE Part") -> "_2508.FEPart":
    ...
    @enforce_parameter_types
    def add_mass_disc(self: "Self", name: "str" = "Mass Disc") -> "_2517.MassDisc":
    ...
    @enforce_parameter_types
    def add_oil_seal(self: "Self", name: "str" = "Oil Seal") -> "_2523.OilSeal":
    ...
    def add_planet_carrier_with_options(
        ...
        planet_carrier_creation_options: Optional[
            "_2632.PlanetCarrierCreationOptions"
        ] = None,
    ) -> "_2526.PlanetCarrier":
    ...
    @enforce_parameter_types
    def add_point_load(self: "Self", name: "str" = "Point Load") -> "_2528.PointLoad":
    ...
    @enforce_parameter_types
    def add_power_load(self: "Self", name: "str" = "Power Load") -> "_2529.PowerLoad":
    ...
    def add_rolling_bearing_from_catalogue(
        self: "Self", catalogue: "_1922.BearingCatalog", designation: "str", name: "str"
    ) -> "_2494.Bearing":
        """mastapy.system_model.part_model.Bearing
    ...
    def add_shaft_with_options(
        self: "Self", shaft_creation_options: "_2633.ShaftCreationOptions"
    ) -> "_2539.Shaft":
