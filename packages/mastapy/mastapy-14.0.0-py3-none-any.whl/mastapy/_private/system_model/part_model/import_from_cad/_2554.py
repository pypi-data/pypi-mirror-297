...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConnectorFromCAD(_2561.MountableComponentFromCAD):
    """ConnectorFromCAD
    ...
    @property
    def mounting(self: "Self") -> "_2560.HousedOrMounted":
    ...
    def mounting(self: "Self", value: "_2560.HousedOrMounted") -> None:
