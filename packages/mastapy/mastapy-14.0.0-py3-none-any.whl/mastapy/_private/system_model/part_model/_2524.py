...
class _Cast_OuterBearingRaceMountingOptions:
    ...
    def bearing_race_mounting_options(
        self: "CastSelf",
    ) -> "_2496.BearingRaceMountingOptions":
        return self.__parent__._cast(_2496.BearingRaceMountingOptions)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OuterBearingRaceMountingOptions(_2496.BearingRaceMountingOptions):
    """OuterBearingRaceMountingOptions
