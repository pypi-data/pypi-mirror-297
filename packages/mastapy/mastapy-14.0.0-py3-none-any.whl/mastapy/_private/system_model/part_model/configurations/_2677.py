...
from mastapy._private.system_model.part_model.configurations import _2676, _2680
...
class _Cast_ActiveShaftDesignSelectionGroup:
    ...
    @property
    def part_detail_configuration(self: "CastSelf") -> "_2680.PartDetailConfiguration":
        return self.__parent__._cast(_2680.PartDetailConfiguration)
...
class ActiveShaftDesignSelectionGroup(
    _2680.PartDetailConfiguration[
        _2676.ActiveShaftDesignSelection, _2539.Shaft, _43.SimpleShaftDefinition
    ]
):
    """ActiveShaftDesignSelectionGroup
