...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.connections_and_sockets import _2326, _2330
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class Connector(_2521.MountableComponent):
    """Connector
    ...
    @property
    def outer_component(self: "Self") -> "_2490.AbstractShaft":
    ...
    @property
    def outer_connection(self: "Self") -> "_2326.Connection":
    ...
    @property
    def outer_socket(self: "Self") -> "_2330.CylindricalSocket":
