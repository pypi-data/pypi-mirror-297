...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2489, _2519, _2525
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MicrophoneArray(_2533.SpecialisedAssembly):
    """MicrophoneArray
    ...
    @property
    def array_design(self: "Self") -> "_2695.MicrophoneArrayDesign":
