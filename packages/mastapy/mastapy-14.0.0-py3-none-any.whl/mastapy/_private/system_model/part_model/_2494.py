...
from mastapy._private.bearings.bearing_results import _1996, _2015
...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _1922, _1926, _1939
...
class Bearing(_2502.Connector):
    ...
    @enforce_parameter_types
    def bearing_tolerance_class(
        self: "Self", value: "_1956.BearingToleranceClass"
    ) -> None:
    ...
    def bearing_tolerance_definition(
        self: "Self",
    ) -> "_1957.BearingToleranceDefinitionOptions":
    ...
    @enforce_parameter_types
    def bearing_tolerance_definition(
        self: "Self", value: "_1957.BearingToleranceDefinitionOptions"
    ) -> None:
    ...
    @property
    def damping_options(self: "Self") -> "_1926.BearingDampingMatrixOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1926", "BearingDampingMatrixOption"
        )(value)

    @damping_options.setter
    @enforce_parameter_types
    def damping_options(
        self: "Self", value: "_1926.BearingDampingMatrixOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def force_at_zero_displacement_input_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model._2495", "BearingF0InputMethod"
        )(value)

    @force_at_zero_displacement_input_method.setter
    @enforce_parameter_types
    def force_at_zero_displacement_input_method(
        self: "Self", value: "_2495.BearingF0InputMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def inner_fitting_chart(self: "Self") -> "_1837.SimpleChartDefinition":
    ...
    @property
    def journal_bearing_type(self: "Self") -> "_1939.JournalBearingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1939", "JournalBearingType"
        )(value)

    @journal_bearing_type.setter
    @enforce_parameter_types
    def journal_bearing_type(self: "Self", value: "_1939.JournalBearingType") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @model.setter
    @enforce_parameter_types
    def model(self: "Self", value: "_1930.BearingModel") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def outer_fitting_chart(self: "Self") -> "_1837.SimpleChartDefinition":
        """mastapy.utility.report.SimpleChartDefinition
    ...
    @preload.setter
    @enforce_parameter_types
    def preload(self: "Self", value: "_2015.PreloadType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def axial_internal_clearance_tolerance(
        self: "Self",
    ) -> "_2493.AxialInternalClearanceTolerance":
    ...
    @property
    def detail(self: "Self") -> "_2184.BearingDesign":
    ...
    def radial_internal_clearance_tolerance(
        self: "Self",
    ) -> "_2530.RadialInternalClearanceTolerance":
    ...
    @property
    def ring_tolerance_inner(self: "Self") -> "_1959.InnerRingTolerance":
    ...
    @property
    def ring_tolerance_left(self: "Self") -> "_1970.RingTolerance":
    ...
    @property
    def ring_tolerance_outer(self: "Self") -> "_1965.OuterRingTolerance":
    ...
    @property
    def ring_tolerance_right(self: "Self") -> "_1970.RingTolerance":
        """mastapy.bearings.tolerances.RingTolerance
    ...
    @property
    def simple_bearing_detail_property(self: "Self") -> "_2184.BearingDesign":
        """mastapy.bearings.bearing_designs.BearingDesign
    ...
    @property
    def support_tolerance_inner(self: "Self") -> "_1960.InnerSupportTolerance":
        """mastapy.bearings.tolerances.InnerSupportTolerance
    ...
    @property
    def support_tolerance_left(self: "Self") -> "_1975.SupportTolerance":
    ...
    @property
    def support_tolerance_outer(self: "Self") -> "_1966.OuterSupportTolerance":
        """mastapy.bearings.tolerances.OuterSupportTolerance
    ...
    @property
    def support_tolerance_right(self: "Self") -> "_1975.SupportTolerance":
        """mastapy.bearings.tolerances.SupportTolerance
    ...
    @property
    def mounting(self: "Self") -> "List[_2496.BearingRaceMountingOptions]":
    ...
    @property
    def tolerance_combinations(self: "Self") -> "List[_1977.ToleranceCombination]":
    ...
    def try_attach_right_side_to(
        self: "Self", shaft: "_2539.Shaft", offset: "float" = float("nan")
    ...
    def set_detail_from_catalogue(
        self: "Self", catalogue: "_1922.BearingCatalog", designation: "str"
    ) -> None:
