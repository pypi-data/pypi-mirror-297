...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2682, _2684, _2687
...
class AcousticAnalysisSetup(_0.APIBase):
    ...
    @property
    def analysis_options(self: "Self") -> "_2682.AcousticAnalysisOptions":
    ...
    @property
    def cache_reporting(self: "Self") -> "_2684.AcousticAnalysisSetupCacheReporting":
    ...
    @property
    def input_surface_options(self: "Self") -> "_2687.AcousticInputSurfaceOptions":
