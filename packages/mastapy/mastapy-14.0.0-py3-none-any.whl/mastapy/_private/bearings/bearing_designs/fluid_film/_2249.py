...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TiltingPadThrustBearing(_2241.PadFluidFilmBearing):
    """TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self: "Self") -> "_1953.TiltingPadTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1953", "TiltingPadTypes"
        )(value)

    @tilting_pad_type.setter
    @enforce_parameter_types
    def tilting_pad_type(self: "Self", value: "_1953.TiltingPadTypes") -> None:
