...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.rolling.xml_import import _2234
...
class _Cast_AbstractXmlVariableAssignment:
    ...
    @property
    def xml_variable_assignment(self: "CastSelf") -> "_2234.XMLVariableAssignment":
        from mastapy._private.bearings.bearing_designs.rolling.xml_import import _2234

        return self.__parent__._cast(_2234.XMLVariableAssignment)
