...
class Overridable_BearingElementOrbitModel(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
    ...
    ) -> "_5509.BearingElementOrbitModel":
        ...
        Returns:
            _5509.BearingElementOrbitModel
        """
        return _5509.BearingElementOrbitModel
    ...
    def implicit_type(cls: "Type[Overridable_BearingElementOrbitModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _5509.BearingElementOrbitModel.type_()

    @property
    def value(self: "Self") -> "_5509.BearingElementOrbitModel":
    ...
    @property
    def override_value(self: "Self") -> "_5509.BearingElementOrbitModel":
        """mastapy.system_model.analyses_and_results.mbd_analyses.BearingElementOrbitModel
    ...
    @property
    def calculated_value(self: "Self") -> "_5509.BearingElementOrbitModel":
        """mastapy.system_model.analyses_and_results.mbd_analyses.BearingElementOrbitModel
