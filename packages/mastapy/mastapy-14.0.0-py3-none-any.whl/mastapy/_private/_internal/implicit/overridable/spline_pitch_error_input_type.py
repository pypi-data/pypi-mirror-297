...
class Overridable_SplinePitchErrorInputType(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
    ...
    ) -> "_2661.SplinePitchErrorInputType":
        ...
        Returns:
            _2661.SplinePitchErrorInputType
        """
        return _2661.SplinePitchErrorInputType
    ...
    def implicit_type(cls: "Type[Overridable_SplinePitchErrorInputType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2661.SplinePitchErrorInputType.type_()

    @property
    def value(self: "Self") -> "_2661.SplinePitchErrorInputType":
    ...
    @property
    def override_value(self: "Self") -> "_2661.SplinePitchErrorInputType":
        """mastapy.system_model.part_model.couplings.SplinePitchErrorInputType
    ...
    @property
    def calculated_value(self: "Self") -> "_2661.SplinePitchErrorInputType":
        """mastapy.system_model.part_model.couplings.SplinePitchErrorInputType
