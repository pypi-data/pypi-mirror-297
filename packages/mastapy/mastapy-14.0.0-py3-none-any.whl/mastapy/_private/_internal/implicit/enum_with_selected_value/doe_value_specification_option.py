...
class EnumWithSelectedValue_DoeValueSpecificationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_DoeValueSpecificationOption]",
    ) -> "_4457.DoeValueSpecificationOption":
        ...
        Returns:
            _4457.DoeValueSpecificationOption
        """
        return _4457.DoeValueSpecificationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _4457.DoeValueSpecificationOption.type_()

    @property
    def selected_value(self: "Self") -> "_4457.DoeValueSpecificationOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_4457.DoeValueSpecificationOption]":
