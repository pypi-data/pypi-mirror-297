...
class EnumWithSelectedValue_HarmonicAnalysisTorqueInputType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_HarmonicAnalysisTorqueInputType]",
    ) -> "_5900.HarmonicAnalysisTorqueInputType":
        ...
        Returns:
            _5900.HarmonicAnalysisTorqueInputType
        """
        return _5900.HarmonicAnalysisTorqueInputType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5900.HarmonicAnalysisTorqueInputType.type_()

    @property
    def selected_value(self: "Self") -> "_5900.HarmonicAnalysisTorqueInputType":
    ...
    @property
    def available_values(self: "Self") -> "List[_5900.HarmonicAnalysisTorqueInputType]":
