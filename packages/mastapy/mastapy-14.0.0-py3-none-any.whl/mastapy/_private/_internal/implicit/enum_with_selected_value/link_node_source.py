...
class EnumWithSelectedValue_LinkNodeSource(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_LinkNodeSource]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2453.LinkNodeSource.type_()

    @property
    def selected_value(self: "Self") -> "_2453.LinkNodeSource":
    ...
    @property
    def available_values(self: "Self") -> "List[_2453.LinkNodeSource]":
