...
class EnumWithSelectedValue_ShaftAndHousingFlexibilityOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ShaftAndHousingFlexibilityOption]",
    ) -> "_5611.ShaftAndHousingFlexibilityOption":
        ...
        Returns:
            _5611.ShaftAndHousingFlexibilityOption
        """
        return _5611.ShaftAndHousingFlexibilityOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5611.ShaftAndHousingFlexibilityOption.type_()

    @property
    def selected_value(self: "Self") -> "_5611.ShaftAndHousingFlexibilityOption":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_5611.ShaftAndHousingFlexibilityOption]":
