...
class EnumWithSelectedValue_PointLoadLoadCase_ForceSpecification(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_PointLoadLoadCase_ForceSpecification]",
    ) -> "_7088.PointLoadLoadCase.ForceSpecification":
        ...
        Returns:
            _7088.PointLoadLoadCase.ForceSpecification
        """
        return _7088.PointLoadLoadCase.ForceSpecification
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7088.PointLoadLoadCase.ForceSpecification.type_()

    @property
    def selected_value(self: "Self") -> "_7088.PointLoadLoadCase.ForceSpecification":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_7088.PointLoadLoadCase.ForceSpecification]":
