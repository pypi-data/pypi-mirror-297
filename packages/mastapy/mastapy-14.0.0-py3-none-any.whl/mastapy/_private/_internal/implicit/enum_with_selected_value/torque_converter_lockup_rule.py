...
class EnumWithSelectedValue_TorqueConverterLockupRule(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_TorqueConverterLockupRule]",
    ) -> "_5637.TorqueConverterLockupRule":
        ...
        Returns:
            _5637.TorqueConverterLockupRule
        """
        return _5637.TorqueConverterLockupRule
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5637.TorqueConverterLockupRule.type_()

    @property
    def selected_value(self: "Self") -> "_5637.TorqueConverterLockupRule":
    ...
    @property
    def available_values(self: "Self") -> "List[_5637.TorqueConverterLockupRule]":
