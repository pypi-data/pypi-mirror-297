...
class EnumWithSelectedValue_GearMeshStiffnessModel(
    ...
    def wrapped_type(
        ...
        Returns:
            _5563.GearMeshStiffnessModel
        """
        return _5563.GearMeshStiffnessModel
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5563.GearMeshStiffnessModel.type_()

    @property
    def selected_value(self: "Self") -> "_5563.GearMeshStiffnessModel":
    ...
    @property
    def available_values(self: "Self") -> "List[_5563.GearMeshStiffnessModel]":
