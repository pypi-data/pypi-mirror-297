...
class EnumWithSelectedValue_BearingStiffnessModel(
    ...
    def wrapped_type(
        ...
        Returns:
            _5511.BearingStiffnessModel
        """
        return _5511.BearingStiffnessModel
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5511.BearingStiffnessModel.type_()

    @property
    def selected_value(self: "Self") -> "_5511.BearingStiffnessModel":
    ...
    @property
    def available_values(self: "Self") -> "List[_5511.BearingStiffnessModel]":
