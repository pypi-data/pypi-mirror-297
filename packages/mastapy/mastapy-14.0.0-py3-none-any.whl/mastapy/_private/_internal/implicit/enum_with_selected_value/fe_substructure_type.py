...
class EnumWithSelectedValue_FESubstructureType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2443.FESubstructureType
        """
        return _2443.FESubstructureType
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_FESubstructureType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2443.FESubstructureType.type_()

    @property
    def selected_value(self: "Self") -> "_2443.FESubstructureType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2443.FESubstructureType]":
