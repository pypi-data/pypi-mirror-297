...
class EnumWithSelectedValue_TorqueRippleInputType(
    ...
    def wrapped_type(
        ...
        Returns:
            _7126.TorqueRippleInputType
        """
        return _7126.TorqueRippleInputType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7126.TorqueRippleInputType.type_()

    @property
    def selected_value(self: "Self") -> "_7126.TorqueRippleInputType":
    ...
    @property
    def available_values(self: "Self") -> "List[_7126.TorqueRippleInputType]":
