...
class ListWithSelectedItem_PointLoad(_2528.PointLoad, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_PointLoad]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2528.PointLoad.TYPE

    @property
    def selected_value(self: "Self") -> "_2528.PointLoad":
    ...
    @property
    def available_values(self: "Self") -> "List[_2528.PointLoad]":
