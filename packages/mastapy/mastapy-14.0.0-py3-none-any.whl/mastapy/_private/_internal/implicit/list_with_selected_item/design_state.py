...
class ListWithSelectedItem_DesignState(
    _5794.DesignState, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_DesignState]") -> "Any":
        ...
        Returns:
            Any
        """
        return _5794.DesignState.TYPE

    @property
    def selected_value(self: "Self") -> "_5794.DesignState":
    ...
    @property
    def available_values(self: "Self") -> "List[_5794.DesignState]":
