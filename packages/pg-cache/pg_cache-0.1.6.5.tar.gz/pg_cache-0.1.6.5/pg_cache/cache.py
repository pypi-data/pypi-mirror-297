...
class PgCache:
    def __init__(self, db_url: str, partition_name: str = 'default', drop_all=False, pool_size=20, max_overflow=100, pool_timeout=60,log_level: int = logging.ERROR):
        self.engine = create_engine(db_url, echo=False, pool_size=pool_size, max_overflow=max_overflow, pool_timeout=pool_timeout)
