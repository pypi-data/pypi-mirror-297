...
class PgCache:
    def __init__(self, db_url: str, partition_name: str = 'default', drop_all=False, log_level: int = logging.ERROR):
        self.engine = create_engine(db_url, echo=False, pool_size=20, max_overflow=100, pool_timeout=60)
...
class AsyncPgCache:
    def __init__(self, db_url: str, partition_name: str = 'default', drop_all=False, log_level: int = logging.ERROR):
        self.engine = create_async_engine(db_url, echo=False, pool_size=20, max_overflow=60, pool_timeout=60)
