...
class PlatformClient:
    ...
    def __init__(
        ...
        self._executor = ThreadPoolExecutor(thread_name_prefix="jquant-pc")
    ...
    def subscribe_instruments(
        ...
        self.subscribe(SubscribeMethod.INSTRUMENT, req, handler)
        ...
        try:
            for response in response_iterator:
                ...
                try:
                    ...
                    log.error(f"[{response.id}]handler error={e}, reply={reply.result}")
