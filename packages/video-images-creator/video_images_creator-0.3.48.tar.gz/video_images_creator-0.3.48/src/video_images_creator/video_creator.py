...
def build_first_feature_animation(output_directory, running_index, frames_file_path, image_url, continuation_mode, current_text):
...
def build_feature_switch_anim(output_directory, running_index, temp_text_file, image_url, continuation_mode, current_text):
...
def build_third_animation(output_directory, running_index, temp_text_file, feature_image_url, continuation_mode, current_text): 
    ...
    for f_name in sorted_list:
        ...
        pre_count = int(f_name.split("/")[1].split(".")[0].split("_")[1]) 
        ...
        f.write(f"file '{file}'\n")
        f.write(f"duration {duration:.6f}\n")
        if f_name in ["third_anim_assets/image_1_1.png", "third_anim_assets/image_2_1.png", "third_anim_assets/image_3_1.png", "third_anim_assets/image_4_1.png", "third_anim_assets/image_5_1.png", "third_anim_assets/image_56_5.png"]:
            shutil.copy(f_name, destination)
        else:
            if f_name == "third_anim_assets/image_6_1.png": 
                x = 490
                y = 0
                scale_factor_x = 5
                scale_factor_y = 3
            ...
            elif f_name == "third_anim_assets/image_7_1.png":
                x = 692
                y = 0
                scale_factor_x = 5
                scale_factor_y = 3
                ...
                crop_width = 1250
                create_overlayed_third_anim(f_name, alpha_val, destination, x, y, scale_factor_x, scale_factor_y, crop_x, crop_y, crop_width, crop_height, text, feature_image_url)
            elif f_name == "third_anim_assets/image_8_1.png":
                x = 830
                y = 0
                scale_factor_x = 5
                scale_factor_y = 3
                ...
                crop_width = 1090
                create_overlayed_third_anim(f_name, alpha_val, destination, x, y, scale_factor_x, scale_factor_y, crop_x, crop_y, crop_width, crop_height, text, feature_image_url)
            elif f_name == "third_anim_assets/image_9_1.png":
                x = 920
                y = 0
                scale_factor_x = 3.12
                scale_factor_y = 3
                ...
                crop_width = 1200
                create_overlayed_third_anim(f_name, alpha_val, destination, x, y, scale_factor_x, scale_factor_y, crop_x, crop_y, crop_width, crop_height, text, feature_image_url)
            elif f_name == "third_anim_assets/image_10_1.png":
                x = 976
                y = 74
                scale_factor_x = 2.67
                scale_factor_y = 2.67
                ...
                crop_width = 1000
                create_overlayed_third_anim(f_name, alpha_val, destination, x, y, scale_factor_x, scale_factor_y, crop_x, crop_y, crop_width, crop_height, text, feature_image_url)
            elif f_name == "third_anim_assets/image_11_1.png":
                x = 1022
                y = 138
                scale_factor_x = 2.37
                scale_factor_y = 2.37
                ...
                crop_width = 800
                create_overlayed_third_anim(f_name, alpha_val, destination, x, y, scale_factor_x, scale_factor_y, crop_x, crop_y, crop_width, crop_height, text, feature_image_url)
            elif f_name == "third_anim_assets/image_12_1.png":
                x = 1053
                y = 183
                scale_factor_x = 2.17
                scale_factor_y = 2.17
                ...
                crop_width = 800
                create_overlayed_third_anim(f_name, alpha_val, destination, x, y, scale_factor_x, scale_factor_y, crop_x, crop_y, crop_width, crop_height, text, feature_image_url) 
            elif f_name == "third_anim_assets/image_13_1.png":
                x = 1073
                y = 213
                scale_factor_x = 2.04
                scale_factor_y = 2.04
                ...
                crop_width = 800
                create_overlayed_third_anim(f_name, alpha_val, destination, x, y, scale_factor_x, scale_factor_y, crop_x, crop_y, crop_width, crop_height, text, feature_image_url) 
            elif f_name == "third_anim_assets/image_14_1.png":
                x = 1082
                y = 233
                scale_factor_x = 2
                scale_factor_y = 2
                ...
                crop_width = 750
                create_overlayed_third_anim(f_name, alpha_val, destination, x, y, scale_factor_x, scale_factor_y, crop_x, crop_y, crop_width, crop_height, text, feature_image_url)
            elif f_name in ["third_anim_assets/image_15_1.png"]:
                x = 1091
                y = 250
                scale_factor_x = 1.92
                scale_factor_y = 1.92
                ...
                crop_width = 600
                create_overlayed_third_anim(f_name, alpha_val, destination, x, y, scale_factor_x, scale_factor_y, crop_x, crop_y, crop_width, crop_height, text, feature_image_url)
            elif f_name in ["third_anim_assets/image_16_1.png"]:
                x = 1100
                y = 252
                scale_factor_x = 1.86
                scale_factor_y = 1.86
                ...
                crop_width = 600
                create_overlayed_third_anim(f_name, alpha_val, destination, x, y, scale_factor_x, scale_factor_y, crop_x, crop_y, crop_width, crop_height, text, feature_image_url)
            elif f_name in ["third_anim_assets/image_17_1.png"]:
                x = 1110
                y = 258
                scale_factor_x = 1.8
                scale_factor_y = 1.8
                ...
                crop_width = 600
                create_overlayed_third_anim(f_name, alpha_val, destination, x, y, scale_factor_x, scale_factor_y, crop_x, crop_y, crop_width, crop_height, text, feature_image_url)
            elif f_name in ["third_anim_assets/image_18_1.png", "third_anim_assets/image_19_1.png","third_anim_assets/image_20_1.png"]:
                x = 1110
                y = 265
                scale_factor_x = 1.8
                scale_factor_y = 1.8
                ...
                crop_width = 600
                create_overlayed_third_anim(f_name, alpha_val, destination, x, y, scale_factor_x, scale_factor_y, crop_x, crop_y, crop_width, crop_height, text, feature_image_url)     
            elif f_name in ["third_anim_assets/image_21_1.png"]: 
                x = 1110
                y = 270
                scale_factor_x = 1.8
                scale_factor_y = 1.8
...
def add_feature_frames_v2(current_running_index, temp_text_file, directory, feature_images_urls, feature_desciption, feature_intro_audio_length): 
    ...
    for feature_images_url in feature_images_urls: 
        ...
        if show_first_feature_anim == True:
            ...
            current_running_index = build_first_feature_animation(directory, current_running_index, temp_text_file, feature_images_url, continuation_mode, current_text)
            ...
            current_running_index = build_feature_switch_anim(directory, current_running_index, temp_text_file, feature_images_url, continuation_mode, current_text) 
            ...
            current_running_index = build_third_animation(directory, current_running_index, temp_text_file, feature_images_url, continuation_mode, current_text) 
            show_first_feature_anim = True 
            show_switch_feature_anim = False 
            show_third_feature_anim = False 
...
def build_with_new_design(build_card_name, feature_descriptions, intro_text, preview_screen_text, process_mode, feature_images_urls, feature_ids, existing_audios, device, subscription_key, service_region):
    ...
    current_running_index = add_feature_frames_v2(current_running_index, temp_text_file, directory_name, feature_images_urls, feature_descriptions, feature_intro_audio_length) 
...
def build_v3(process_dict):
    ...
    if device == "mobile" and process_dict == "byscript":
