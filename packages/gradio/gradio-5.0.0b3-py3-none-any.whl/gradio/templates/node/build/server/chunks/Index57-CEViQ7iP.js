...
import { B as Block, S as Static, c as IconButton, C as Copy } from './2-DleTh3G7.js';
...
import { I as IconButtonWrapper } from './IconButtonWrapper-s9n5xd1P.js';
import { M as MarkdownCode$1 } from './Example.svelte_svelte_type_style_lang4-BS901lAI.js';
import { D as DownloadLink } from './DownloadLink-4kzPen0P.js';
import { U as Undo } from './Undo-CbHQvbEr.js';
import { B as BlockLabel } from './BlockLabel-Dy_utYve.js';
import './index4-D_FyJKAV.js';
import './file-url-D-K40zdU.js';
import './prism-python-TjyVrIQR.js';
...
const ChatBot = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${value !== null && value.length > 0 ? `${validate_component(IconButtonWrapper, "IconButtonWrapper").$$render($$result, {}, {}, {
  ...
  })}` : ``} <div class="${escape(null_to_empty(layout === "bubble" ? "bubble-wrap" : "panel-wrap"), true) + " svelte-xsb1ea"}" role="log" aria-label="chatbot conversation" aria-live="polite"${add_attribute("this", div, 0)}>${value !== null && value.length > 0 && groupedMessages !== null ? `<div class="message-wrap svelte-xsb1ea">${each(groupedMessages, (messages, i) => {
    ...
    return `   ${``} <div class="${[
      "message-row " + escape(layout, true) + " " + escape(role, true) + "-row svelte-xsb1ea",
      (avatar_img !== null ? "with_avatar" : "") + " " + (opposite_avatar_img !== null ? "with_opposite_avatar" : "")
    ].join(" ").trim()}">${avatar_img !== null ? `<div class="avatar-container svelte-xsb1ea">${validate_component(Image$1, "Image").$$render(
      $$result,
      {
        class: "avatar-image",
        src: avatar_img?.url,
      ...
      "flex-wrap " + escape(role, true) + " svelte-xsb1ea",
      ...
      return `<div class="${[
        ...
        {},
        {}
      )}` : `${message.type === "component" && message.content.component === "file" ? `<a data-testid="chatbot-file" class="file-pil svelte-xsb1ea"${add_attribute("href", message.content.value.url, 0)} target="_blank"${add_attribute(
        "download",
  ...
  })} ${pending_message ? `${validate_component(Pending, "Pending").$$render($$result, { layout }, {}, {})}` : ``}</div>` : `<div class="placeholder-content svelte-xsb1ea">${placeholder !== null ? `<div class="placeholder svelte-xsb1ea">${validate_component(MarkdownCode$1, "Markdown").$$render(
    $$result,
    {
      message: placeholder,
      latex_delimiters,
    ...
    {},
    {}
  )}</div>` : ``} ${suggestions !== null ? `<div class="suggestions svelte-xsb1ea">${each(suggestions, (suggestion, i) => {
    return `<button class="suggestion svelte-xsb1ea">${suggestion.icon !== void 0 ? `<div class="suggestion-icon-container svelte-xsb1ea">${validate_component(Image$1, "Image").$$render(
      $$result,
      {
        class: "suggestion-icon",
        src: suggestion.icon.url,
      ...
      {},
      {}
    )} </div>` : ``} ${suggestion.display_text !== void 0 ? `<span class="suggestion-display-text svelte-xsb1ea">${escape(suggestion.display_text)}</span>` : `<span class="suggestion-text svelte-xsb1ea">${escape(suggestion.text)}</span> ${suggestion.files !== void 0 && suggestion.files.length > 1 ? `<span class="suggestion-file svelte-xsb1ea"><em class="svelte-xsb1ea">${escape(suggestion.files.length)} Files</em></span>` : `${suggestion.files !== void 0 && suggestion.files[0] !== void 0 && suggestion.files[0].mime_type?.includes("image") ? `${validate_component(Image$1, "Image").$$render(
      $$result,
      {
        class: "suggestion-image",
        src: suggestion.files[0].url,
      ...
      {},
      {}
    )}` : `${suggestion.files !== void 0 && suggestion.files[0] !== void 0 ? `<span class="suggestion-file svelte-xsb1ea"><em class="svelte-xsb1ea">${escape(suggestion.files[0].orig_name)}</em></span>` : ``}`}`}`} </button>`;
  })}</div>` : ``}</div>`} </div>`;
});
...
//# sourceMappingURL=Index57-CEViQ7iP.js.map
