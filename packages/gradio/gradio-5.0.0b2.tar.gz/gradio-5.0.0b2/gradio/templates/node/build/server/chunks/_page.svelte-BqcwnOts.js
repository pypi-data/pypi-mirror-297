...
import { Embed } from './index20-dQP3xV3X.js';
import { $ as $format, s as setupi18n, b as browser } from './2-Bdt8VggT.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { version = "5-0-0-beta-2" } = $$props;
  ...
  do {
    ...
    $$rendered = `${$$result.head += `<!-- HEAD_svelte-1083ugi_START --><link rel="stylesheet"${add_attribute("href", config?.root + "/theme.css?v=" + config?.theme_hash, 0)}><style data-svelte-h="svelte-hcwpkc"></style><!-- HEAD_svelte-1083ugi_END -->`, ""} ${validate_component(Embed, "Embed").$$render(
      $$result,
      {
...
//# sourceMappingURL=_page.svelte-BqcwnOts.js.map
