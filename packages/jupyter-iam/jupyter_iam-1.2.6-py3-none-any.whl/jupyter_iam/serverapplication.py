...
class JupyterIamExtensionApp(ExtensionAppJinjaMixin, ExtensionApp):
    ...
    def initialize_handlers(self):
        ...
        handlers = [
            ...
            (url_path_join("jupyter_iam", "oauth", "callback"), OAuthCallback),
        ]
