...
from ibm_watsonx_ai._wrappers.requests import get_httpx_client, get_async_client
...
class ModelInference(BaseModelInference):
    ...
    **Example**
    ...
    async def agenerate(
        ...
        """Generate response in asynchronous manner.

        :param prompt: the prompt string, defaults to None
        :type prompt: str | None, optional

        :param params: meta props for text generation, use ``ibm_watsonx_ai.metanames.GenTextParamsMetaNames().show()`` to view the list of MetaNames, defaults to None
        ...
        :return: Raw response containing generated content
        :rtype: dict
        """
        self._validate_type(params, "params", dict, False)
        return await self._inference._agenerate_single(
