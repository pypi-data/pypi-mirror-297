...
class VectorStore(BaseVectorStore):
    ...
    Instantiates the vector store connection in the Watson Machine Learning environment and handles necessary operations.
    ...
    Can utilize the custom embedding function. This function can be provided in the constructor or by the ``set_embeddings`` method.
