...
Refer to the Terraform Registry for docs: [`gitlab_project_access_token`](https://registry.terraform.io/providers/gitlabhq/gitlab/17.4.0/docs/resources/project_access_token).
'''
...
class ProjectAccessToken(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: The name of the project access token. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.4.0/docs/resources/project_access_token#name ProjectAccessToken#name}
        :param project: The ID or full path of the project. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.4.0/docs/resources/project_access_token#project ProjectAccessToken#project}
        ...
        :param expires_at: When the token will expire, YYYY-MM-DD format. Is automatically set when ``rotation_configuration`` is used. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.4.0/docs/resources/project_access_token#expires_at ProjectAccessToken#expires_at}
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing ProjectAccessToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.4.0/docs/resources/project_access_token#import import section} in the documentation of this resource for the id to use
    ...
    def put_rotation_configuration(
        ...
        *,
        ...
        '''
        :param expiration_days: The duration (in days) the new token should be valid for. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.4.0/docs/resources/project_access_token#expiration_days ProjectAccessToken#expiration_days}
