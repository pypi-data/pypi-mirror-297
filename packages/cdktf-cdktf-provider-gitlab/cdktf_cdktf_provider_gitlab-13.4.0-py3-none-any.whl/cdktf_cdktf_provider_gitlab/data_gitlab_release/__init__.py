...
class DataGitlabRelease(
    ...
    def __init__(
        ...
        *,
        ...
        :param project_id: The ID or URL-encoded path of the project. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.4.0/docs/data-sources/release#project_id DataGitlabRelease#project_id}
        :param tag_name: The Git tag the release is associated with. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.4.0/docs/data-sources/release#tag_name DataGitlabRelease#tag_name}
        :param assets: assets block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.4.0/docs/data-sources/release#assets DataGitlabRelease#assets}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataGitlabRelease that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.4.0/docs/data-sources/release#import import section} in the documentation of this resource for the id to use
    ...
    def put_assets(
        ...
        *,
        ...
        '''
        :param links: links block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.4.0/docs/data-sources/release#links DataGitlabRelease#links}
        :param sources: sources block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.4.0/docs/data-sources/release#sources DataGitlabRelease#sources}
        '''
