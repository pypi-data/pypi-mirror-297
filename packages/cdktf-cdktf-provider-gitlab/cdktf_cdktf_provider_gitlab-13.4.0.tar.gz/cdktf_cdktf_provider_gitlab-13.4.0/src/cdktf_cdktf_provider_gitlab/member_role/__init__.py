...
class MemberRole(
    ...
    def __init__(
        ...
        *,
        ...
        :param base_access_level: The base access level for the custom role. Valid values are: ``DEVELOPER``, ``GUEST``, ``MAINTAINER``, ``MINIMAL_ACCESS``, ``OWNER``, ``REPORTER``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.4.0/docs/resources/member_role#base_access_level MemberRole#base_access_level}
        ...
        :param name: Name for the member role. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.4.0/docs/resources/member_role#name MemberRole#name}
        :param description: Description for the member role. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.4.0/docs/resources/member_role#description MemberRole#description}
        :param group_path: Full path of the namespace to create the member role in. **Required for SAAS** **Not allowed for self-managed**. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.4.0/docs/resources/member_role#group_path MemberRole#group_path}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing MemberRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.4.0/docs/resources/member_role#import import section} in the documentation of this resource for the id to use
