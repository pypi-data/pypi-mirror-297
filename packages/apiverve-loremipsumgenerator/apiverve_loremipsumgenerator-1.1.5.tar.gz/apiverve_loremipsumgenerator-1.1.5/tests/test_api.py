...
class TestLoremipsumgeneratorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = LoremipsumgeneratorAPIClient(self.api_key)

    @patch('apiverve_loremipsumgenerator.apiClient.requests.get')
