...
class TestRandomusergeneratorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = RandomusergeneratorAPIClient(self.api_key)

    @patch('apiverve_randomusergenerator.apiClient.requests.get')
