...
def generate_meta_model(name, description, framework, area, mode, properties, input_datasets, output_datasets, input_models, output_models, docker_image, ports, json=json):
