...
# %% ../../nbs/classes/50_DomoPage.ipynb 60
...
# %% ../../nbs/classes/50_DomoPage.ipynb 61
@patch_to(DomoPage)
...
# %% ../../nbs/classes/50_DomoPage.ipynb 66
@patch_to(DomoPage)
...
# %% ../../nbs/classes/50_DomoPage.ipynb 69
@patch_to(DomoPage)
async def get_accesslist(
    self,
    auth: dmda.DomoAuth = None,
...
# %% ../../nbs/classes/50_DomoPage.ipynb 77
@patch_to(DomoPage)
async def share(
    self: DomoPage,
    auth: dmda.DomoAuth = None,
...
# %% ../../nbs/classes/50_DomoPage.ipynb 84
@patch_to(DomoPage, cls_method=True)
async def get_cards(
    cls,
    auth: dmda.DomoAuth,
...
# %% ../../nbs/classes/50_DomoPage.ipynb 92
...
# %% ../../nbs/classes/50_DomoPage.ipynb 99
@patch_to(DomoPage, cls_method=True)
