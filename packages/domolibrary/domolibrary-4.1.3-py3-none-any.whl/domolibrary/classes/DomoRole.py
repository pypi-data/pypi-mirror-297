...
# %% ../../nbs/classes/50_DomoRole.ipynb 58
...
# %% ../../nbs/classes/50_DomoRole.ipynb 60
@patch_to(DomoRole, cls_method=True)
...
# %% ../../nbs/classes/50_DomoRole.ipynb 62
@patch_to(DomoRole, cls_method=True)
async def delete_role(
    cls: DomoRole,
    role_id: int,
...
# %% ../../nbs/classes/50_DomoRole.ipynb 71
@dataclass
class DomoRoles:
    auth: dmda.DomoAuth

# %% ../../nbs/classes/50_DomoRole.ipynb 72
...
# %% ../../nbs/classes/50_DomoRole.ipynb 79
...
# %% ../../nbs/classes/50_DomoRole.ipynb 80
@patch_to(DomoRoles, cls_method=True)
...
# %% ../../nbs/classes/50_DomoRole.ipynb 88
...
# %% ../../nbs/classes/50_DomoRole.ipynb 89
@patch_to(DomoRoles, cls_method=True)
...
# %% ../../nbs/classes/50_DomoRole.ipynb 96
@patch_to(DomoRoles, cls_method=True)
...
# %% ../../nbs/classes/50_DomoRole.ipynb 103
@patch_to(DomoRoles, cls_method=True)
...
# %% ../../nbs/classes/50_DomoRole.ipynb 109
@patch_to(DomoRole)
