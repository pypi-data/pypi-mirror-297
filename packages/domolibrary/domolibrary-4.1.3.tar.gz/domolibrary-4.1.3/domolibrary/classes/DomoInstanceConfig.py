...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 87
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 94
@patch_to(DomoInstanceConfig)
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 102
@patch_to(DomoInstanceConfig)
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 110
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 118
@patch_to(DomoInstanceConfig)
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 126
@patch_to(DomoInstanceConfig)
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 136
@patch_to(DomoInstanceConfig)
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 143
@patch_to(DomoInstanceConfig)
async def get_roles(
    self,
    auth: dmda.DomoAuth = None,
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 151
@patch_to(DomoInstanceConfig)
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 158
@patch_to(DomoInstanceConfig, cls_method=True)
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 160
@patch_to(DomoInstanceConfig)
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 168
@patch_to(DomoInstanceConfig, cls_method=True)
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 171
@patch_to(DomoInstanceConfig, cls_method=True)
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 173
@patch_to(DomoInstanceConfig, cls_method=True)
async def get_applications(
    cls,
    auth: dmda.DomoAuth,
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 181
@patch_to(DomoInstanceConfig)
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 189
@dataclass
class DomoConnector:
    id: str
    label: str
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 190
@patch_to(DomoInstanceConfig)
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 197
@patch_to(DomoInstanceConfig)
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 200
@patch_to(DomoInstanceConfig)
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 202
@patch_to(DomoInstanceConfig)
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 205
@patch_to(DomoInstanceConfig)
async def generate_access_token(
    self: DomoInstanceConfig,
    owner: None,  # DomoUser
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 207
@patch_to(DomoInstanceConfig)
async def regenerate_access_token(
    self,
