...
# %% ../../nbs/classes/50_DomoPublish.ipynb 36
@patch_to(DomoPublication_Subscription)
...
# %% ../../nbs/classes/50_DomoPublish.ipynb 38
@patch_to(DomoPublication_Subscription)
async def get_publication(self, debug_api: bool = False, debug_num_stacks_to_drop=2):
    self.publication = await DomoPublication.get_from_id(
        publication_id=self.publication_id,
...
# %% ../../nbs/classes/50_DomoPublish.ipynb 42
@dataclass
...
# %% ../../nbs/classes/50_DomoPublish.ipynb 49
...
# %% ../../nbs/classes/50_DomoPublish.ipynb 55
...
# %% ../../nbs/classes/50_DomoPublish.ipynb 56
@patch_to(DomoPublication, cls_method=True)
...
# %% ../../nbs/classes/50_DomoPublish.ipynb 62
@patch_to(DomoPublication, cls_method=True)
...
# %% ../../nbs/classes/50_DomoPublish.ipynb 68
@patch_to(DomoPublication, cls_method=True)
