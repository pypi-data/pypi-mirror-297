...
__all__ = ['Datacenter_Enum', 'Dataflow_Type_Filter_Enum', 'Datacenter_Filter_Field_Enum',
           ...
           'get_connectors', 'get_lineage_upstream', 'ShareResource_Error', 'ShareResource_Enum', 'share_resource']
...
# %% ../../nbs/routes/datacenter.ipynb 26
@gd.route_function
async def get_connectors(
    auth: dmda.DomoAuth,
    search_text=None,
...
# %% ../../nbs/routes/datacenter.ipynb 29
@gd.route_function
...
# %% ../../nbs/routes/datacenter.ipynb 33
...
# %% ../../nbs/routes/datacenter.ipynb 36
class ShareResource_Enum(Enum):
    PAGE = "page"
    CARD = "badge"
