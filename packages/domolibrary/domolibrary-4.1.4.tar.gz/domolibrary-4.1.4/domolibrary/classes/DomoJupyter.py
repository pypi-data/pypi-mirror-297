...
class DomoJupyterWorkspace:
    ...
    last_run_dt: dt.datetime = None
    instances: List[dict] = None
    input_configuration: List[DomoJupyterDataSource] = None
    output_configuration: List[DomoJupyterDataSource] = None
    account_configuration: List[DomoJupyterAccount] = None
    collection_configuration: List[dict] = None
    fileshare_configuration: List[dict] = None
...
@patch_to(DomoJupyterWorkspace)
async def add_input_dataset_to_config(
    self,
    domo_dataset: dmds.DomoDataset,
    domo_user: dmdu.DomoUser = None,
    update_config: bool = True,
    ...
    while retry <= 1:
        try:
            ...
            await domo_dataset.share(
                domo_user=domo_user, auth=auth, debug_api=debug_api, session=session
            )
...
@patch_to(DomoJupyterWorkspace)
async def add_output_dataset_to_config(
    self,
    domo_dataset: dmds.DomoDataset,
    domo_user: dmdu.DomoUser = None,
    update_config: bool = True,
