...
class TestSentimentanalysisAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = SentimentanalysisAPIClient(self.api_key)

    @patch('apiverve_sentimentanalysis.apiClient.requests.get')
