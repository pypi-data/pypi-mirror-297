...
def update_pulje_by_id(
    ...
    *,
    ...
    body = {
        ...
        "altinn_tilgjengelig": altinn_tilgjengelig.isoformat() if altinn_tilgjengelig else None,
        "altinn_svarfrist": altinn_svarfrist.isoformat() if altinn_svarfrist else None,
        "tvangsmulkt_svarfrist": tvangsmulkt_svarfrist.isoformat() if tvangsmulkt_svarfrist else None,
        "send_si": send_si,
        "endret_av": user,
    }
