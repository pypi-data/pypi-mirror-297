...
def update_periode_by_id(
    ...
    *,
    ...
    # Convert boolean to string using the helper function. If None is returned, the code falls back to the value from periode
    vis_oppgavebyrde_str = bool_to_str(vis_oppgavebyrde) or periode["vis_oppgavebyrde"]
    vis_brukeropplevelse_str = bool_to_str(vis_brukeropplevelse) or periode["vis_brukeropplevelse"]
    har_skjemadata_str = bool_to_str(har_skjemadata) or periode["har_skjemadata"]
    ...
    body = {
        ...
        "periode_dato": periode_dato.isoformat() if periode_dato is not None else periode["periode_dato"],
        ...
        "journalnummer": journalnummer if journalnummer is not None else periode["journalnummer"],
        "endret_av": user,
    }
...
def update_periode_by_skjema_id(
    ...
    *,
    ...
    periode_list = get_perioder_by_skjema_id(self=self, skjema_id=skjema_id, periode_type=periode_type, periode_aar=periode_aar,periode_nr=periode_nr)
...
def create_periode(
    ...
    *,
    ...
    vis_oppgavebyrde_str = bool_to_str(vis_oppgavebyrde) or "N"
    vis_brukeropplevelse_str = bool_to_str(vis_brukeropplevelse) or "N"
    har_skjemadata_str = bool_to_str(har_skjemadata) or "N"
