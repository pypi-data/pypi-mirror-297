...
Note: optional [{Fore.light_red}e{Fore.light_green}] executes after copy {Fore.black}{Back.deep_sky_blue_4a} TimeInShell:{InShellElapsed} {Style.reset} 
...
'''
            ...
            ph_age=detectGetOrSet('PH_AGE',60*60*24*90)
            #ph_age=5
            if not noHistory:
