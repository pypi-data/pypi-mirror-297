...
class QueryServiceAgent:
    ...
    def _ExecuteCore(self, request, operation):
        ...
        elif type(request).__name__ == "QueryRequestCollection":
        ...
        # query_request_json = json.dumps(request.to_dict(), default=self.convert_default)
        query_request_json = json.dumps(request.to_dict())
