...
class RouteTableEntry(BaseModel):
    ...
    as_path: Optional[List[StrictInt]] = Field(default=None, alias="asPath")
    connection: Optional[RouteTableEntryConnection] = None
    change_log: Changelog = Field(alias="changeLog")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "protocolType", "state", "age", "prefix", "nextHop", "metric", "localPreference", "asPath", "connection", "changeLog"]
