...
class PtpAdvanceConfiguration(BaseModel):
    ...
    domain: Optional[Annotated[int, Field(le=127, strict=True, ge=0)]] = None
    priority1: Optional[Annotated[int, Field(le=248, strict=True, ge=0)]] = None
    priority2: Optional[Annotated[int, Field(le=248, strict=True, ge=0)]] = None
    log_announce_interval: Optional[StrictInt] = Field(default=None, description="The mean time interval between Announce messages. A shorter interval makes ptp4l react faster to the changes in the master-slave hierarchy. The interval should be the same in the whole domain. It's specified as a power of two in seconds. The default is 1 (2 seconds).", alias="logAnnounceInterval")
    log_sync_interval: Optional[StrictInt] = Field(default=None, description="The mean time interval between Sync messages. A shorter interval may improve accuracy of the local clock. It's specified as a power of two in seconds. The default is 0 (1 second).", alias="logSyncInterval")
    log_delay_req_interval: Optional[StrictInt] = Field(default=None, alias="logDelayReqInterval")
