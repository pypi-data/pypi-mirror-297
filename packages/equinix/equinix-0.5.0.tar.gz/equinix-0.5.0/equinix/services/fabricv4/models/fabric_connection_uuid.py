...
class FabricConnectionUuid(BaseModel):
    """
    UUID of the Fabric Connection Instance
    """ # noqa: E501
    uuid: StrictStr = Field(description="uuid of the Fabric L2 connection")
    href: Optional[StrictStr] = Field(default=None, description="the href for the L2 connection")
