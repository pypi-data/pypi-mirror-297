...
class LinkProtocolUntagged(BaseModel):
    """
    Connection link protocol configuration - UNTAGGED
    """ # noqa: E501
    type: Optional[LinkProtocolType] = None
    ipv4: Optional[LinkProtocolIpv4Ipv6Config] = None
    ipv6: Optional[LinkProtocolIpv4Ipv6Config] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "ipv4", "ipv6"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "ipv4": LinkProtocolIpv4Ipv6Config.from_dict(obj["ipv4"]) if obj.get("ipv4") is not None else None,
            "ipv6": LinkProtocolIpv4Ipv6Config.from_dict(obj["ipv6"]) if obj.get("ipv6") is not None else None
        })
