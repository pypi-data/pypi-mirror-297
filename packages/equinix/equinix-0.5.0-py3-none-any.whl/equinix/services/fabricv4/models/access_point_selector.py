...
class AccessPointSelector(BaseModel):
    ...
    link_protocol: Optional[LinkProtocol] = Field(default=None, alias="linkProtocol")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "port", "linkProtocol"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "linkProtocol": LinkProtocol.from_dict(obj["linkProtocol"]) if obj.get("linkProtocol") is not None else None
        })
