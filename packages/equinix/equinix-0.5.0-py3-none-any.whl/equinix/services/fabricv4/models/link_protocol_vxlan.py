...
class LinkProtocolVxlan(BaseModel):
    """
    Connection link protocol configuration - VXLAN
    """ # noqa: E501
    type: Optional[LinkProtocolType] = None
    vni: Annotated[int, Field(le=16777215, strict=True, ge=4097)] = Field(description="Virtual Network Identifier")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "vni"]
