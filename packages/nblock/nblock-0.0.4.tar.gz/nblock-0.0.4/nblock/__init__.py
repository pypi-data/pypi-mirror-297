...
def is_latest_version() -> bool:
    ...
    """
    import feedparser
    feed = feedparser.parse('https://pypi.org/rss/project/n_block/releases.xml')
...
def update_n_block() -> None:
    ...
    subprocess.run(['python', '-m', 'pip', 'install', '-U', 'n_block'], stdout=subprocess.DEVNULL)
