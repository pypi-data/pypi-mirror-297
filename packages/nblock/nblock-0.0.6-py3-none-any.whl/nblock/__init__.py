...
def is_latest_version() -> bool:
    ...
    """
    import feedparser
    feed = feedparser.parse('https://pypi.org/rss/project/nblock/releases.xml')
...
def update_nblock() -> None:
    ...
    subprocess.run(['python', '-m', 'pip', 'install', '-U', 'nblock'], stdout=subprocess.DEVNULL)
