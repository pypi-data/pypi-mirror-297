...
from connector.generated.models.refresh_access_token import RefreshAccessToken
...
class RefreshAccessTokenRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": RefreshAccessToken.from_dict(obj["request"]) if obj.get("request") is not None else None,
