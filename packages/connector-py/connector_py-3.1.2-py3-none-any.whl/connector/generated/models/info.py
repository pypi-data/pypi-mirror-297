...
class Info(BaseModel):
    ...
    authentication_schema: Optional[Dict[str, Any]] = None
    ...
    __properties: ClassVar[List[str]] = ["app_id", "capabilities", "capability_schema", "authentication_schema", "logo_url", "user_friendly_name", "description", "categories"]
