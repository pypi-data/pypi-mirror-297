...
from connector.generated.models.get_authorization_url import GetAuthorizationUrl
from connector.generated.models.page import Page
from typing import Optional, Set
from typing_extensions import Self

class GetAuthorizationUrlRequest(BaseModel):
    """
    GetAuthorizationUrlRequest
    """ # noqa: E501
    request: GetAuthorizationUrl
    include_raw_data: Optional[StrictBool] = None
    page: Optional[Page] = None
    __properties: ClassVar[List[str]] = ["request", "include_raw_data", "page"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAuthorizationUrlRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAuthorizationUrlRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "request": GetAuthorizationUrl.from_dict(obj["request"]) if obj.get("request") is not None else None,
