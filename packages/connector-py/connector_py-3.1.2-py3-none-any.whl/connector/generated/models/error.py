...
from connector.generated.models.error_code import ErrorCode
...
class Error(BaseModel):
    ...
    status_code: Optional[StrictInt] = Field(default=None, description="An http status code (if applicable) corresponding to the underlying app's HTTP response that triggered this error.")
    error_code: StrictStr = Field(description="An application-specific code string that can tell us more details about the underlying application code or request that triggered the error.")
    std_error: Optional[ErrorCode] = Field(default=None, description="A standard error code used by Lumos callers to respond to this error.")
    raised_by: Optional[StrictStr] = Field(default=None, description="What type of exception triggered this error (if any)")
    raised_in: Optional[StrictStr] = Field(default=None, description="Where the exception was raised")
    __properties: ClassVar[List[str]] = ["message", "status_code", "error_code", "std_error", "raised_by", "raised_in"]
