...
def main(
    ...
    if num_workers > 1:
        ...
        #     futures = [
        #         executor.submit(single_nifti_stats, nifti, task_list, mark_complete)
        ...
        with Pool(num_workers) as pool:
            for _ in pool.imap_unordered(
                partial(single_nifti_stats, task_list=task_list, mark_complete=mark_complete, gaussian=gaussian),
                nifti_files,
            ):
                pbar.update(1)
    else:
