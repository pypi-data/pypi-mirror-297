...
from mircato_stats.configs.logging import configure_logging, get_project_root
from mircato_stats.dicom import convert_dicom_folders_to_nifti, update
from mircato_stats.statistics import main as calculate_nifti_stats
import shutil


def mircato_stats():
    """
    MirCATo Stats Only CLI tool
    """
