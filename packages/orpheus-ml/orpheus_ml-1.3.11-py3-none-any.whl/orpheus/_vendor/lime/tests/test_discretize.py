...
class TestDiscretize(TestCase):
    ...
    def check_random_state_for_discretizer_class(self, DiscretizerClass):
        ...
        # ----------------------------------------------------------------------
        discretizer = DiscretizerClass(self.x, [], self.feature_names, self.y, random_state=10)
        ...
        discretizer = DiscretizerClass(self.x, [], self.feature_names, self.y, random_state=20)
        x_2 = discretizer.undiscretize(discretizer.discretize(self.x))
