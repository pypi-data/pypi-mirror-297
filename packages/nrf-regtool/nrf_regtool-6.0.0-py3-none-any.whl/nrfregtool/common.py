...
class DomainID(_HaltiumID):
    ...
    def from_processor(cls, processor: Union[ProcessorID, int]):
        ...
        processor_domain = {
            ...
            ProcessorID.CELLCORE.value: cls.CELLCORE,
            ProcessorID.CELLDSP.value: cls.CELLDSP,
            ProcessorID.CELLRF.value: cls.CELLRF,
            ProcessorID.ISIMCORE.value: cls.ISIMCORE,
...
class OwnerID(_HaltiumID):
    ...
    def from_domain(cls, domain: DomainID):
        ...
        domain_owner = {
            ...
            DomainID.CELLCORE.value: cls.CELL,
            DomainID.CELLDSP.value: cls.CELL,
            DomainID.CELLRF.value: cls.CELL,
            DomainID.ISIMCORE.value: cls.ISIMCORE,
...
class ProcessorID(_HaltiumID):
    ...
    def from_domain(cls, domain: DomainID):
        ...
        domain_processor = {
            ...
            DomainID.APPLICATION.value: cls.APPLICATION,
            DomainID.RADIOCORE.value: cls.RADIOCORE,
            DomainID.CELLCORE.value: cls.CELLCORE,
            DomainID.CELLDSP.value: cls.CELLDSP,
            DomainID.CELLRF.value: cls.CELLRF,
            DomainID.ISIMCORE.value: cls.ISIMCORE,
            DomainID.GLOBAL_FAST.value: cls.SYSCTRL,
...
NRF_PSEL_FUN_MASK = 0x3FFF << NRF_PSEL_FUN_POS
# Pull this from DT
GPIO_PIN_COUNT = 32
