...
class Species18003___ToStringTag8469(Enum):
    SHARED_ARRAY_BUFFER = "SharedArrayBuffer"


@dataclass
class SharedArrayBuffer:
    species_18003: Optional['SharedArrayBuffer'] = None
    to_string_tag_8469: Optional[Species18003___ToStringTag8469] = None
    byte_length: Optional[float] = None

    @staticmethod
    def from_dict(obj: Any) -> 'SharedArrayBuffer':
        assert isinstance(obj, dict)
        species_18003 = from_union([SharedArrayBuffer.from_dict, from_none], obj.get("__@species@18003"))
        to_string_tag_8469 = from_union([Species18003___ToStringTag8469, from_none], obj.get("__@toStringTag@8469"))
        byte_length = from_union([from_float, from_none], obj.get("byteLength"))
        return SharedArrayBuffer(species_18003, to_string_tag_8469, byte_length)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.species_18003 is not None:
            result["__@species@18003"] = from_union([lambda x: to_class(SharedArrayBuffer, x), from_none], self.species_18003)
        if self.to_string_tag_8469 is not None:
            result["__@toStringTag@8469"] = from_union([lambda x: to_enum(Species18003___ToStringTag8469, x), from_none], self.to_string_tag_8469)
...
class ArrayBufferLike:
    ...
    def from_dict(obj: Any) -> 'ArrayBufferLike':
        ...
        byte_length = from_union([from_float, from_none], obj.get("byteLength"))
        species_18003 = from_union([SharedArrayBuffer.from_dict, from_none], obj.get("__@species@18003"))
        return ArrayBufferLike(to_string_tag_8469, byte_length, species_18003)
